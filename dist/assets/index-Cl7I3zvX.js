 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xd;function If(){if(Xd)return Vn;Xd=1;var r=Ko(),s=Symbol.for("react.element"),o=Symbol.for("react.fragment"),c=Object.prototype.hasOwnProperty,m=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function u(b,h,x){var y,g={},E=null,D=null;x!==void 0&&(E=""+x),h.key!==void 0&&(E=""+h.key),h.ref!==void 0&&(D=h.ref);for(y in h)c.call(h,y)&&!p.hasOwnProperty(y)&&(g[y]=h[y]);if(b&&b.defaultProps)for(y in h=b.defaultProps,h)g[y]===void 0&&(g[y]=h[y]);return{$$typeof:s,type:b,key:E,ref:D,props:g,_owner:m.current}}return Vn.Fragment=o,Vn.jsx=u,Vn.jsxs=u,Vn}var Zd;function Pf(){return Zd||(Zd=1,vo.exports=If()),vo.exports}var e=Pf(),v=Ko();const Se=wi(v),Bf=Ef({__proto__:null,default:Se},[v]);var fi={},So={exports:{}},Qe={},wo={exports:{}},Co={};/**
 * @license React
 ...
 *
 * @license MIT
 */function er(){return er=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},er.apply(this,arguments)}var ca;(function(r){r.Pop="POP",r.Push="PUSH",r.Replace="REPLACE"})(ca||(ca={}));const hp="popstate";function mh(r){r===void 0&&(r={});function s(c,m){let{pathname:p,search:u,hash:b}=c.location;return Go("",{pathname:p,search:u,hash:b},m.state&&m.state.usr||null,m.state&&m.state.key||"default")}function o(c,m){return typeof m=="string"?m:Si(m)}return fh(s,o,null,r)}function ke(r,s){if(r===!1||r===null||typeof r>"u")throw new Error(s)}function Qo(r,s){if(!r){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function uh(){return Math.random().toString(36).substr(2,8)}function gp(r,s){return{usr:r.state,key:r.key,idx:s}}function Go(r,s,o,c){return o===void 0&&(o=null),er({pathname:typeof r=="string"?r:r.pathname,search:"",hash:""},typeof s=="string"?ln(s):s,{state:o,key:s&&s.key||c||uh()})}function Si(r){let{pathname:s="/",search:o="",hash:c=""}=r;return o&&o!=="?"&&(s+=o.charAt(0)==="?"?o:"?"+o),c&&c!=="#"&&(s+=c.charAt(0)==="#"?c:"#"+c),s}function ln(r){let s={};if(r){let o=r.indexOf("#");o>=0&&(s.hash=r.substr(o),r=r.substr(0,o));let c=r.indexOf("?");c>=0&&(s.search=r.substr(c),r=r.substr(0,c)),r&&(s.pathname=r)}return s}function fh(r,s,o,c){c===void 0&&(c={});let{window:m=document.defaultView,v5Compat:p=!1}=c,u=m.history,b=ca.Pop,h=null,x=y();x==null&&(x=0,u.replaceState(er({},u.state,{idx:x}),""));function y(){return(u.state||{idx:null}).idx}function g(){b=ca.Pop;let z=y(),N=z==null?null:z-x;x=z,h&&h({action:b,location:I.location,delta:N})}function E(z,N){b=ca.Push;let R=Go(I.location,z,N);x=y()+1;let L=gp(R,x),q=I.createHref(R);try{u.pushState(L,"",q)}catch(he){if(he instanceof DOMException&&he.name==="DataCloneError")throw he;m.location.assign(q)}p&&h&&h({action:b,location:I.location,delta:1})}function D(z,N){b=ca.Replace;let R=Go(I.location,z,N);x=y();let L=gp(R,x),q=I.createHref(R);u.replaceState(L,"",q),p&&h&&h({action:b,location:I.location,delta:0})}function F(z){let N=m.location.origin!=="null"?m.location.origin:m.location.href,R=typeof z=="string"?z:Si(z);return R=R.replace(/ $/,"%20"),ke(N,"No window.location.(origin|href) available to create URL for href: "+R),new URL(R,N)}let I={get action(){return b},get location(){return r(m,u)},listen(z){if(h)throw new Error("A history only accepts one active listener");return m.addEventListener(hp,g),h=z,()=>{m.removeEventListener(hp,g),h=null}},createHref(z){return s(m,z)},createURL:F,encodeLocation(z){let N=F(z);return{pathname:N.pathname,search:N.search,hash:N.hash}},push:E,replace:D,go(z){return u.go(z)}};return I}var xp;(function(r){r.data="data",r.deferred="deferred",r.redirect="redirect",r.error="error"})(xp||(xp={}));function hh(r,s,o){return o===void 0&&(o="/"),gh(r,s,o)}function gh(r,s,o,c){let m=typeof s=="string"?ln(s):s,p=Xo(m.pathname||"/",o);if(p==null)return null;let u=lm(r);xh(u);let b=null;for(let h=0;b==null&&h<u.length;++h){let x=Eh(p);b=kh(u[h],x)}return b}function lm(r,s,o,c){s===void 0&&(s=[]),o===void 0&&(o=[]),c===void 0&&(c="");let m=(p,u,b)=>{let h={relativePath:b===void 0?p.path||"":b,caseSensitive:p.caseSensitive===!0,childrenIndex:u,route:p};h.relativePath.startsWith("/")&&(ke(h.relativePath.startsWith(c),'Absolute route path "'+h.relativePath+'" nested under path '+('"'+c+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),h.relativePath=h.relativePath.slice(c.length));let x=da([c,h.relativePath]),y=o.concat(h);p.children&&p.children.length>0&&(ke(p.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+x+'".')),lm(p.children,s,y,x)),!(p.path==null&&!p.index)&&s.push({path:x,score:Ch(x,p.index),routesMeta:y})};return r.forEach((p,u)=>{var b;if(p.path===""||!((b=p.path)!=null&&b.includes("?")))m(p,u);else for(let h of cm(p.path))m(p,u,h)}),s}function cm(r){let s=r.split("/");if(s.length===0)return[];let[o,...c]=s,m=o.endsWith("?"),p=o.replace(/\?$/,"");if(c.length===0)return m?[p,""]:[p];let u=cm(c.join("/")),b=[];return b.push(...u.map(h=>h===""?p:[p,h].join("/"))),m&&b.push(...u),b.map(h=>r.startsWith("/")&&h===""?"/":h)}function xh(r){r.sort((s,o)=>s.score!==o.score?o.score-s.score:Ah(s.routesMeta.map(c=>c.childrenIndex),o.routesMeta.map(c=>c.childrenIndex)))}const bh=/^:[\w-]+$/,yh=3,vh=2,jh=1,Sh=10,wh=-2,bp=r=>r==="*";function Ch(r,s){let o=r.split("/"),c=o.length;return o.some(bp)&&(c+=wh),s&&(c+=vh),o.filter(m=>!bp(m)).reduce((m,p)=>m+(bh.test(p)?yh:p===""?jh:Sh),c)}function Ah(r,s){return r.length===s.length&&r.slice(0,-1).every((c,m)=>c===s[m])?r[r.length-1]-s[s.length-1]:0}function kh(r,s,o){let{routesMeta:c}=r,m={},p="/",u=[];for(let b=0;b<c.length;++b){let h=c[b],x=b===c.length-1,y=p==="/"?s:s.slice(p.length)||"/",g=Nh({path:h.relativePath,caseSensitive:h.caseSensitive,end:x},y),E=h.route;if(!g)return null;Object.assign(m,g.params),u.push({params:m,pathname:da([p,g.pathname]),pathnameBase:Mh(da([p,g.pathnameBase])),route:E}),g.pathnameBase!=="/"&&(p=da([p,g.pathnameBase]))}return u}function Nh(r,s){typeof r=="string"&&(r={path:r,caseSensitive:!1,end:!0});let[o,c]=Th(r.path,r.caseSensitive,r.end),m=s.match(o);if(!m)return null;let p=m[0],u=p.replace(/(.)\/+$/,"$1"),b=m.slice(1);return{params:c.reduce((x,y,g)=>{let{paramName:E,isOptional:D}=y;if(E==="*"){let I=b[g]||"";u=p.slice(0,p.length-I.length).replace(/(.)\/+$/,"$1")}const F=b[g];return D&&!F?x[E]=void 0:x[E]=(F||"").replace(/%2F/g,"/"),x},{}),pathname:p,pathnameBase:u,pattern:r}}function Th(r,s,o){s===void 0&&(s=!1),o===void 0&&(o=!0),Qo(r==="*"||!r.endsWith("*")||r.endsWith("/*"),'Route path "'+r+'" will be treated as if it were '+('"'+r.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+r.replace(/\*$/,"/*")+'".'));let c=[],m="^"+r.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,b,h)=>(c.push({paramName:b,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)"));return r.endsWith("*")?(c.push({paramName:"*"}),m+=r==="*"||r==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?m+="\\/*$":r!==""&&r!=="/"&&(m+="(?:(?=\\/|$))"),[new RegExp(m,s?void 0:"i"),c]}function Eh(r){try{return r.split("/").map(s=>decodeURIComponent(s).replace(/\//g,"%2F")).join("/")}catch(s){return Qo(!1,'The URL path "'+r+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+s+").")),r}}function Xo(r,s){if(s==="/")return r;if(!r.toLowerCase().startsWith(s.toLowerCase()))return null;let o=s.endsWith("/")?s.length-1:s.length,c=r.charAt(o);return c&&c!=="/"?null:r.slice(o)||"/"}const Rh=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ih=r=>Rh.test(r);function Ph(r,s){s===void 0&&(s="/");let{pathname:o,search:c="",hash:m=""}=typeof r=="string"?ln(r):r,p;if(o)if(Ih(o))p=o;else{if(o.includes("//")){let u=o;o=o.replace(/\/\/+/g,"/"),Qo(!1,"Pathnames cannot have embedded double slashes - normalizing "+(u+" -> "+o))}o.startsWith("/")?p=yp(o.substring(1),"/"):p=yp(o,s)}else p=s;return{pathname:p,search:zh(c),hash:Oh(m)}}function yp(r,s){let o=s.replace(/\/+$/,"").split("/");return r.split("/").forEach(m=>{m===".."?o.length>1&&o.pop():m!=="."&&o.push(m)}),o.length>1?o.join("/"):"/"}function Po(r,s,o,c){return"Cannot include a '"+r+"' character in a manually specified "+("`to."+s+"` field ["+JSON.stringify(c)+"].  Please separate it out to the ")+("`to."+o+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Bh(r){return r.filter((s,o)=>o===0||s.route.path&&s.route.path.length>0)}function dm(r,s){let o=Bh(r);return s?o.map((c,m)=>m===o.length-1?c.pathname:c.pathnameBase):o.map(c=>c.pathnameBase)}function pm(r,s,o,c){c===void 0&&(c=!1);let m;typeof r=="string"?m=ln(r):(m=er({},r),ke(!m.pathname||!m.pathname.includes("?"),Po("?","pathname","search",m)),ke(!m.pathname||!m.pathname.includes("#"),Po("#","pathname","hash",m)),ke(!m.search||!m.search.includes("#"),Po("#","search","hash",m)));let p=r===""||m.pathname==="",u=p?"/":m.pathname,b;if(u==null)b=o;else{let g=s.length-1;if(!c&&u.startsWith("..")){let E=u.split("/");for(;E[0]==="..";)E.shift(),g-=1;m.pathname=E.join("/")}b=g>=0?s[g]:"/"}let h=Ph(m,b),x=u&&u!=="/"&&u.endsWith("/"),y=(p||u===".")&&o.endsWith("/");return!h.pathname.endsWith("/")&&(x||y)&&(h.pathname+="/"),h}const da=r=>r.join("/").replace(/\/\/+/g,"/"),Mh=r=>r.replace(/\/+$/,"").replace(/^\/*/,"/"),zh=r=>!r||r==="?"?"":r.startsWith("?")?r:"?"+r,Oh=r=>!r||r==="#"?"":r.startsWith("#")?r:"#"+r;function Dh(r){return r!=null&&typeof r.status=="number"&&typeof r.statusText=="string"&&typeof r.internal=="boolean"&&"data"in r}const mm=["post","put","patch","delete"];new Set(mm);const Wh=["get",...mm];new Set(Wh);/**
 ...
 *
 * @license MIT
 */function tr(){return tr=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},tr.apply(this,arguments)}const Zo=v.createContext(null),Lh=v.createContext(null),ka=v.createContext(null),Ai=v.createContext(null),Na=v.createContext({outlet:null,matches:[],isDataRoute:!1}),um=v.createContext(null);function Hh(r,s){let{relative:o}=s===void 0?{}:s;ar()||ke(!1);let{basename:c,navigator:m}=v.useContext(ka),{hash:p,pathname:u,search:b}=hm(r,{relative:o}),h=u;return c!=="/"&&(h=u==="/"?c:da([c,u])),m.createHref({pathname:h,search:b,hash:p})}function ar(){return v.useContext(Ai)!=null}function Ft(){return ar()||ke(!1),v.useContext(Ai).location}function fm(r){v.useContext(ka).static||v.useLayoutEffect(r)}function nr(){let{isDataRoute:r}=v.useContext(Na);return r?Zh():Fh()}function Fh(){ar()||ke(!1);let r=v.useContext(Zo),{basename:s,future:o,navigator:c}=v.useContext(ka),{matches:m}=v.useContext(Na),{pathname:p}=Ft(),u=JSON.stringify(dm(m,o.v7_relativeSplatPath)),b=v.useRef(!1);return fm(()=>{b.current=!0}),v.useCallback(function(x,y){if(y===void 0&&(y={}),!b.current)return;if(typeof x=="number"){c.go(x);return}let g=pm(x,JSON.parse(u),p,y.relative==="path");r==null&&s!=="/"&&(g.pathname=g.pathname==="/"?s:da([s,g.pathname])),(y.replace?c.replace:c.push)(g,y.state,y)},[s,c,u,p,r])}function hm(r,s){let{relative:o}=s===void 0?{}:s,{future:c}=v.useContext(ka),{matches:m}=v.useContext(Na),{pathname:p}=Ft(),u=JSON.stringify(dm(m,c.v7_relativeSplatPath));return v.useMemo(()=>pm(r,JSON.parse(u),p,o==="path"),[r,u,p,o])}function Uh(r,s){return _h(r,s)}function _h(r,s,o,c){ar()||ke(!1);let{navigator:m}=v.useContext(ka),{matches:p}=v.useContext(Na),u=p[p.length-1],b=u?u.params:{};u&&u.pathname;let h=u?u.pathnameBase:"/";u&&u.route;let x=Ft(),y;if(s){var g;let z=typeof s=="string"?ln(s):s;h==="/"||(g=z.pathname)!=null&&g.startsWith(h)||ke(!1),y=z}else y=x;let E=y.pathname||"/",D=E;if(h!=="/"){let z=h.replace(/^\//,"").split("/");D="/"+E.replace(/^\//,"").split("/").slice(z.length).join("/")}let F=hh(r,{pathname:D}),I=Vh(F&&F.map(z=>Object.assign({},z,{params:Object.assign({},b,z.params),pathname:da([h,m.encodeLocation?m.encodeLocation(z.pathname).pathname:z.pathname]),pathnameBase:z.pathnameBase==="/"?h:da([h,m.encodeLocation?m.encodeLocation(z.pathnameBase).pathname:z.pathnameBase])})),p,o,c);return s&&I?v.createElement(Ai.Provider,{value:{location:tr({pathname:"/",search:"",hash:"",state:null,key:"default"},y),navigationType:ca.Pop}},I):I}function $h(){let r=Xh(),s=Dh(r)?r.status+" "+r.statusText:r instanceof Error?r.message:JSON.stringify(r),o=r instanceof Error?r.stack:null,m={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return v.createElement(v.Fragment,null,v.createElement("h2",null,"Unexpected Application Error!"),v.createElement("h3",{style:{fontStyle:"italic"}},s),o?v.createElement("pre",{style:m},o):null,null)}const Gh=v.createElement($h,null);class Yh extends v.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,o){return o.location!==s.location||o.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:o.error,location:o.location,revalidation:s.revalidation||o.revalidation}}componentDidCatch(s,o){console.error("React Router caught the following error during render",s,o)}render(){return this.state.error!==void 0?v.createElement(Na.Provider,{value:this.props.routeContext},v.createElement(um.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function Jh(r){let{routeContext:s,match:o,children:c}=r,m=v.useContext(Zo);return m&&m.static&&m.staticContext&&(o.route.errorElement||o.route.ErrorBoundary)&&(m.staticContext._deepestRenderedBoundaryId=o.route.id),v.createElement(Na.Provider,{value:s},c)}function Vh(r,s,o,c){var m;if(s===void 0&&(s=[]),o===void 0&&(o=null),c===void 0&&(c=null),r==null){var p;if(!o)return null;if(o.errors)r=o.matches;else if((p=c)!=null&&p.v7_partialHydration&&s.length===0&&!o.initialized&&o.matches.length>0)r=o.matches;else return null}let u=r,b=(m=o)==null?void 0:m.errors;if(b!=null){let y=u.findIndex(g=>g.route.id&&(b==null?void 0:b[g.route.id])!==void 0);y>=0||ke(!1),u=u.slice(0,Math.min(u.length,y+1))}let h=!1,x=-1;if(o&&c&&c.v7_partialHydration)for(let y=0;y<u.length;y++){let g=u[y];if((g.route.HydrateFallback||g.route.hydrateFallbackElement)&&(x=y),g.route.id){let{loaderData:E,errors:D}=o,F=g.route.loader&&E[g.route.id]===void 0&&(!D||D[g.route.id]===void 0);if(g.route.lazy||F){h=!0,x>=0?u=u.slice(0,x+1):u=[u[0]];break}}}return u.reduceRight((y,g,E)=>{let D,F=!1,I=null,z=null;o&&(D=b&&g.route.id?b[g.route.id]:void 0,I=g.route.errorElement||Gh,h&&(x<0&&E===0?(eg("route-fallback"),F=!0,z=null):x===E&&(F=!0,z=g.route.hydrateFallbackElement||null)));let N=s.concat(u.slice(0,E+1)),R=()=>{let L;return D?L=I:F?L=z:g.route.Component?L=v.createElement(g.route.Component,null):g.route.element?L=g.route.element:L=y,v.createElement(Jh,{match:g,routeContext:{outlet:y,matches:N,isDataRoute:o!=null},children:L})};return o&&(g.route.ErrorBoundary||g.route.errorElement||E===0)?v.createElement(Yh,{location:o.location,revalidation:o.revalidation,component:I,error:D,children:R(),routeContext:{outlet:null,matches:N,isDataRoute:!0}}):R()},null)}var gm=(function(r){return r.UseBlocker="useBlocker",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r})(gm||{}),xm=(function(r){return r.UseBlocker="useBlocker",r.UseLoaderData="useLoaderData",r.UseActionData="useActionData",r.UseRouteError="useRouteError",r.UseNavigation="useNavigation",r.UseRouteLoaderData="useRouteLoaderData",r.UseMatches="useMatches",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r.UseRouteId="useRouteId",r})(xm||{});function Kh(r){let s=v.useContext(Zo);return s||ke(!1),s}function qh(r){let s=v.useContext(Lh);return s||ke(!1),s}function Qh(r){let s=v.useContext(Na);return s||ke(!1),s}function bm(r){let s=Qh(),o=s.matches[s.matches.length-1];return o.route.id||ke(!1),o.route.id}function Xh(){var r;let s=v.useContext(um),o=qh(),c=bm();return s!==void 0?s:(r=o.errors)==null?void 0:r[c]}function Zh(){let{router:r}=Kh(gm.UseNavigateStable),s=bm(xm.UseNavigateStable),o=v.useRef(!1);return fm(()=>{o.current=!0}),v.useCallback(function(m,p){p===void 0&&(p={}),o.current&&(typeof m=="number"?r.navigate(m):r.navigate(m,tr({fromRouteId:s},p)))},[r,s])}const vp={};function eg(r,s,o){vp[r]||(vp[r]=!0)}function tg(r,s){r==null||r.v7_startTransition,r==null||r.v7_relativeSplatPath}function X(r){ke(!1)}function ag(r){let{basename:s="/",children:o=null,location:c,navigationType:m=ca.Pop,navigator:p,static:u=!1,future:b}=r;ar()&&ke(!1);let h=s.replace(/^\/*/,"/"),x=v.useMemo(()=>({basename:h,navigator:p,static:u,future:tr({v7_relativeSplatPath:!1},b)}),[h,b,p,u]);typeof c=="string"&&(c=ln(c));let{pathname:y="/",search:g="",hash:E="",state:D=null,key:F="default"}=c,I=v.useMemo(()=>{let z=Xo(y,h);return z==null?null:{location:{pathname:z,search:g,hash:E,state:D,key:F},navigationType:m}},[h,y,g,E,D,F,m]);return I==null?null:v.createElement(ka.Provider,{value:x},v.createElement(Ai.Provider,{children:o,value:I}))}function ng(r){let{children:s,location:o}=r;return Uh(Yo(s),o)}new Promise(()=>{});function Yo(r,s){s===void 0&&(s=[]);let o=[];return v.Children.forEach(r,(c,m)=>{if(!v.isValidElement(c))return;let p=[...s,m];if(c.type===v.Fragment){o.push.apply(o,Yo(c.props.children,p));return}c.type!==X&&ke(!1),!c.props.index||!c.props.children||ke(!1);let u={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(u.children=Yo(c.props.children,p)),o.push(u)}),o}/**
 ...
 *
 * @license MIT
 */function Jo(){return Jo=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},Jo.apply(this,arguments)}function rg(r,s){if(r==null)return{};var o={},c=Object.keys(r),m,p;for(p=0;p<c.length;p++)m=c[p],!(s.indexOf(m)>=0)&&(o[m]=r[m]);return o}function ig(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function sg(r,s){return r.button===0&&(!s||s==="_self")&&!ig(r)}const og=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],lg="6";try{window.__reactRouterVersion=lg}catch{}const cg="startTransition",jp=Bf[cg];function dg(r){let{basename:s,children:o,future:c,window:m}=r,p=v.useRef();p.current==null&&(p.current=mh({window:m,v5Compat:!0}));let u=p.current,[b,h]=v.useState({action:u.action,location:u.location}),{v7_startTransition:x}=c||{},y=v.useCallback(g=>{x&&jp?jp(()=>h(g)):h(g)},[h,x]);return v.useLayoutEffect(()=>u.listen(y),[u,y]),v.useEffect(()=>tg(c),[c]),v.createElement(ag,{basename:s,children:o,location:b.location,navigationType:b.action,navigator:u,future:c})}const pg=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",mg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,fe=v.forwardRef(function(s,o){let{onClick:c,relative:m,reloadDocument:p,replace:u,state:b,target:h,to:x,preventScrollReset:y,viewTransition:g}=s,E=rg(s,og),{basename:D}=v.useContext(ka),F,I=!1;if(typeof x=="string"&&mg.test(x)&&(F=x,pg))try{let L=new URL(window.location.href),q=x.startsWith("//")?new URL(L.protocol+x):new URL(x),he=Xo(q.pathname,D);q.origin===L.origin&&he!=null?x=he+q.search+q.hash:I=!0}catch{}let z=Hh(x,{relative:m}),N=ug(x,{replace:u,state:b,target:h,preventScrollReset:y,relative:m,viewTransition:g});function R(L){c&&c(L),L.defaultPrevented||N(L)}return v.createElement("a",Jo({},E,{href:F||z,onClick:I||p?c:R,ref:o,target:h}))});var Sp;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(Sp||(Sp={}));var wp;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(wp||(wp={}));function ug(r,s){let{target:o,replace:c,state:m,preventScrollReset:p,relative:u,viewTransition:b}=s===void 0?{}:s,h=nr(),x=Ft(),y=hm(r,{relative:u});return v.useCallback(g=>{if(sg(g,o)){g.preventDefault();let E=c!==void 0?c:Si(x)===Si(y);h(r,{replace:E,state:m,preventScrollReset:p,relative:u,viewTransition:b})}},[x,h,y,c,m,o,r,p,u,b])}function fg(){const{pathname:r}=Ft();return v.useEffect(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0,setTimeout(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0},0),setTimeout(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0},10)},[r]),null}function hg(){const r="ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ | Creative Techno College, Angul — AICTE Approved & Affiliated to Utkal University | Admissions Open for 2026-27 | BBA | BCA | B.Sc (CS) | B.Sc (Data Science) | MBA | MCA | 100% Placement Assistance | Contact: +91 9778427170";return e.jsx("div",{className:"marquee-bar",children:e.jsxs("div",{className:"marquee-track-wrap",children:[e.jsx("span",{className:"marquee-item",children:r}),e.jsx("span",{className:"marquee-item marquee-odia",children:"ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ |  "}),e.jsx("span",{className:"marquee-item",children:r}),e.jsx("span",{className:"marquee-item marquee-odia",children:"ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ |  "})]})})}const gg=[{label:"Home",to:"/"},{label:"About",children:[{label:"About Trust",to:"/about/trust"},{label:"About CTC",to:"/about/ctc"},{label:"Our Team",to:"/about/team"}]},{label:"Admission",to:"/admission"},{label:"Academics",children:[{label:"Courses",children:[{label:"Regular Courses",to:"/academics/regular"},{label:"Value Added Courses",to:"/academics/value-added"}]},{label:"Enhancement Programs",to:"/academics/enhancement"}]},{label:"Placement",children:[{label:"Development Program",to:"/placement/programs"},{label:"Placement Statistics",to:"/placement/statistics"},{label:"Placement Brochure",to:"/placement/brochure"}]},{label:"Gymkhana",to:"/gymkhana"},{label:"Gallery",to:"/gallery"},{label:"IQAC",children:[{label:"IQAC Item 1",to:"/iqac/item1"},{label:"IQAC Item 2",to:"/iqac/item2"},{label:"IQAC Item 3",to:"/iqac/item3"},{label:"IQAC Item 4",to:"/iqac/item4"}]},{label:"AICTE",children:[{label:"LOA 2024-25",to:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/LOA Report 2024-2025.PDF",external:!0,newTab:!0},{label:"EOA 2025-26",to:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/EOA Report 2025-26.PDF",external:!0,newTab:!0},{label:"Documents",to:"/aicte/documents"},{label:"Mandatory Disclosure",to:"/aicte/mandatory-disclosure"}]},{label:"CKF Skills",to:"/ckf-skills"},{label:"Contacts",to:"/contacts"},{label:"ICC",to:"/icc"},{label:"GRC",to:"/grc"},{label:"Logins",children:[{label:"Portal Login",to:"/login"},{label:"NBA",to:"/nba"},{label:"NAAC",to:"/naac"}]}],Cp="#0a1628",Ap="#e8f0fe",Ht={dropdown:{position:"absolute",top:"100%",left:0,minWidth:210,background:Cp,borderRadius:10,boxShadow:"0 8px 32px rgba(10,22,40,0.35)",listStyle:"none",padding:"6px 0",margin:0,zIndex:9999,border:"1px solid rgba(255,255,255,0.1)"},subDropdown:{position:"absolute",top:0,left:"100%",minWidth:210,background:Cp,borderRadius:10,boxShadow:"0 8px 32px rgba(10,22,40,0.35)",listStyle:"none",padding:"6px 0",margin:0,zIndex:9999,border:"1px solid rgba(255,255,255,0.1)"},mobileNested:{position:"static",boxShadow:"none",borderRadius:0,paddingLeft:18,background:"rgba(0,0,0,0.2)",listStyle:"none",margin:0,border:"none"},li:{position:"relative"},link:{display:"block",padding:"9px 20px",color:Ap,textDecoration:"none",fontSize:"0.88rem",fontWeight:600,whiteSpace:"nowrap"},trigger:{display:"flex",alignItems:"center",gap:6,padding:"9px 20px",color:Ap,fontSize:"0.88rem",fontWeight:600,whiteSpace:"nowrap",cursor:"pointer",userSelect:"none"}};function ym({item:r,isMobile:s,onClose:o}){const[c,m]=v.useState(!1),p=()=>m(x=>!x),u=()=>m(!0),b=()=>m(!1);if(!r.children){const x=r.external?e.jsx("a",{href:r.to,target:r.newTab?"_blank":"_self",rel:"noreferrer",style:Ht.link,onClick:o,children:r.label}):e.jsx(fe,{to:r.to,style:Ht.link,onClick:o,children:r.label});return e.jsx("li",{style:Ht.li,onMouseEnter:y=>{var g;return((g=y.currentTarget.querySelector("a,span"))==null?void 0:g.style)&&(y.currentTarget.style.background="#2563eb")},onMouseLeave:y=>y.currentTarget.style.background="",children:x})}const h=s?Ht.mobileNested:Ht.subDropdown;return e.jsxs("li",{style:Ht.li,onMouseEnter:s?void 0:u,onMouseLeave:s?void 0:b,children:[e.jsxs("div",{style:{...Ht.trigger,background:c?"#2563eb":""},onClick:s?p:void 0,children:[r.label,e.jsx("i",{className:"fa-solid fa-chevron-right",style:{fontSize:"0.5rem",marginLeft:"auto",transform:c?"rotate(90deg)":"none",transition:"transform 0.22s"}})]}),c&&e.jsx("ul",{style:h,children:r.children.map((x,y)=>e.jsx(ym,{item:x,isMobile:s,onClose:o},y))})]})}function xg({item:r,isMobile:s,onClose:o,isActive:c}){const[m,p]=v.useState(!1),u=Ft();v.useEffect(()=>{p(!1)},[u]);const b=()=>{s||p(!0)},h=()=>{s||p(!1)},x=()=>{s&&p(y=>!y)};return e.jsxs("li",{className:"nav-item",style:{position:"relative"},onMouseEnter:b,onMouseLeave:h,children:[e.jsxs("span",{className:`nav-trigger${c?" active":""}`,onClick:x,children:[r.label,e.jsx("i",{className:"fa-solid fa-chevron-down nav-arrow",style:{transform:m?"rotate(180deg)":"rotate(0)",transition:"transform 0.22s"}})]}),m&&e.jsx("ul",{style:s?{...Ht.dropdown,position:"static",boxShadow:"none",background:"rgba(0,0,0,0.2)",border:"none"}:Ht.dropdown,children:r.children.map((y,g)=>e.jsx(ym,{item:y,isMobile:s,onClose:()=>{p(!1),o()}},g))})]})}function bg(){const[r,s]=v.useState(!1),o=Ft();return v.useEffect(()=>{s(!1)},[o]),v.useEffect(()=>{const c=m=>{m.target.closest(".navbar")||s(!1)};return document.addEventListener("mousedown",c),()=>document.removeEventListener("mousedown",c)},[]),e.jsxs("nav",{className:"navbar",children:[e.jsx("ul",{className:`nav-list${r?" open":""}`,children:gg.map((c,m)=>c.children?e.jsx(xg,{item:c,isMobile:r,onClose:()=>s(!1),isActive:o.pathname.startsWith("/"+c.label.toLowerCase())},m):e.jsx("li",{className:"nav-item",children:e.jsx(fe,{to:c.to,className:`nav-link${o.pathname===c.to?" active":""}`,onClick:()=>s(!1),children:c.label})},m))}),e.jsxs("button",{className:`hamburger${r?" open":""}`,onClick:()=>s(c=>!c),"aria-label":"Toggle menu",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})}function yg(){return e.jsxs("footer",{className:"site-footer",children:[e.jsxs("div",{className:"footer-grid",children:[e.jsxs("div",{className:"footer-brand",children:[e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/LOGO FINAL.png",alt:"CTC Logo"}),e.jsx("p",{children:"Creative Techno College, Angul is a premier institution committed to academic excellence, innovation, and holistic development. AICTE approved & affiliated to Utkal University."}),e.jsx("div",{className:"footer-social",children:[{icon:"fa-brands fa-facebook-f",href:"https://www.facebook.com/creativetechnocollege.angul"},{icon:"fa-brands fa-instagram",href:"https://www.instagram.com/creative_techno_college_angul"},{icon:"fa-brands fa-youtube",href:"https://www.youtube.com/@creativetechnocollegeiangu9750"},{icon:"fa-brands fa-linkedin-in",href:"https://www.linkedin.com/in/creative-techno-college-angul/"},{icon:"fa-brands fa-twitter",href:"https://x.com/creative__1998?lang=en"}].map((r,s)=>e.jsx("a",{href:r.href,target:"_blank",rel:"noreferrer",children:e.jsx("i",{className:r.icon})},s))})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Quick Links"}),[{label:"Home",to:"/"},{label:"About CTC",to:"/about/ctc"},{label:"About Trust",to:"/about/trust"},{label:"Our Team",to:"/about/team"},{label:"Admission",to:"/admission"},{label:"Gallery",to:"/gallery"},{label:"Contacts",to:"/contacts"},{label:"ICC",to:"/icc"}].map((r,s)=>e.jsx(fe,{to:r.to,children:r.label},s))]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"College Services"}),[{label:"Academics",to:"/academics/regular"},{label:"Placement",to:"/placement/statistics"},{label:"Gymkhana",to:"/gymkhana"},{label:"Technocrat",to:"/gymkhana/technocrat"},{label:"Disha & CSR",to:"/gymkhana/disha-csr"},{label:"Sports",to:"/gymkhana/sports"},{label:"Cultural",to:"/gymkhana/cultural"},{label:"Portal Login",to:"/login"}].map((r,s)=>e.jsx(fe,{to:r.to,children:r.label},s))]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Contact Us"}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-location-dot"}),e.jsx("span",{children:"Creative Techno College, Angul, Odisha – 759122"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-phone"}),e.jsx("span",{children:"+91 9778427170 / 9668284222"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-envelope"}),e.jsx("span",{children:"principal.creativecollege@gmail.com"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-clock"}),e.jsx("span",{children:"Mon – Sat: 9:00 AM – 5:00 PM"})]})]})]}),e.jsxs("div",{className:"footer-bottom",children:[e.jsxs("p",{children:["© 2010 – 2025 ",e.jsx("span",{children:"Creative Techno College"}),". All Rights Reserved."]}),e.jsxs("p",{children:["A Unit of ",e.jsx("span",{children:"Creative Knowledge Foundation"})]}),e.jsxs("p",{children:["Developed by ",e.jsx("span",{children:"Technocrat Club"})]})]})]})}function vg({isOpen:r,hasUnread:s,onClick:o}){return e.jsxs("button",{id:"ctc-chatbot-fab",className:"ctc-chatbot-fab",onClick:o,"aria-label":r?"Close chat":"Open CTC Assistant",title:r?"Close chat":"Chat with CTC Bot",children:[s&&!r&&e.jsx("span",{className:"ctc-fab-dot","aria-hidden":"true"}),e.jsx("span",{className:`ctc-fab-icon ${r?"open":""}`,"aria-hidden":"true",children:r?"✕":e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"Technocrat Logo",className:"fab-img"})})]})}function jg(r){return r.split(/(\*\*[^*]+\*\*)/g).map((o,c)=>o.startsWith("**")&&o.endsWith("**")?e.jsx("strong",{children:o.slice(2,-2)},c):o)}function Sg(r){return new Intl.DateTimeFormat("en-IN",{hour:"2-digit",minute:"2-digit",hour12:!0}).format(r)}function wg({message:r,onQuickReply:s}){const o=r.sender==="bot";return e.jsxs("div",{className:`ctc-message ${o?"bot":"user"}`,children:[o&&e.jsx("div",{className:"ctc-msg-avatar",role:"img","aria-label":"CTC Bot",children:e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"CTC Bot",className:"ctc-avatar-img"})}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",maxWidth:"100%"},children:[e.jsxs("div",{className:"ctc-msg-bubble",children:[e.jsx("span",{className:"ctc-msg-text",children:jg(r.text)}),o&&r.links&&r.links.length>0&&e.jsx("div",{className:"ctc-msg-links",children:r.links.map((c,m)=>e.jsxs(fe,{to:c.path,className:"ctc-msg-link",title:`Go to ${c.label}`,children:["🔗 ",c.label]},m))})]}),e.jsx("span",{className:"ctc-msg-time",children:Sg(r.timestamp)})]})]})}const Cg=[{id:"greeting",keywords:["hello","hi","hey","good morning","good afternoon","good evening","hola","namaste","greetings"],response:{text:`👋 Hello! Welcome to **Creative Techno College, Angul**!
...
.tf-nav-btn-primary:hover {
  ...
  `}),e.jsxs("div",{className:"portal-page",children:[e.jsx(Xx,{color:m.color}),e.jsxs("div",{className:`portal-main${R?" visible":""}`,children:[e.jsxs("div",{className:"portal-logo-area",children:[e.jsxs("div",{className:"portal-logo-ring",style:{borderColor:`${m.color}40`,boxShadow:`0 0 32px ${m.glow}`},children:[e.jsx("div",{className:"portal-logo-ring-glow",style:{borderColor:m.color}}),e.jsx("img",{src:"https://creativecollege.in/Admission_Dashboard/images/CTC%20logo.png",alt:"CTC"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"portal-wordmark",children:["Creative Techno ",e.jsx("span",{children:"College"})]}),e.jsx("div",{className:"portal-tagline",children:"Unified Portal · Angul, Odisha"})]})]}),e.jsxs("div",{className:"portal-card",children:[z&&e.jsxs("div",{className:"portal-success-overlay",children:[e.jsx("div",{className:"portal-success-icon",children:e.jsx("i",{className:"fa-solid fa-check"})}),e.jsx("span",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,color:"#fff",fontSize:"1rem"},children:"Login Successful!"}),e.jsx("span",{style:{fontSize:"0.78rem",color:"rgba(255,255,255,0.4)"},children:"Redirecting you…"})]}),e.jsx("div",{className:"portal-role-grid",children:Wo.map(oe=>e.jsx(Zx,{role:oe,isActive:m.id===oe.id,onClick:()=>he(oe)},oe.id))}),e.jsxs("div",{className:"portal-divider",children:[e.jsx("div",{className:"portal-divider-line"}),e.jsxs("span",{className:"portal-divider-text",children:["Sign in as ",m.label]}),e.jsx("div",{className:"portal-divider-line"})]}),e.jsxs("h2",{className:"portal-heading",style:{color:m.color},children:[m.emoji," ",m.label," Login"]}),e.jsx("p",{className:"portal-subhead",children:m.sub}),E&&e.jsxs("div",{className:"portal-error",children:[e.jsx("i",{className:"fa-solid fa-circle-exclamation"}),E]}),e.jsxs("form",{ref:q,onSubmit:Ne,noValidate:!0,children:[e.jsxs("div",{className:"portal-field",children:[e.jsxs("label",{className:"portal-field-label",children:[e.jsx("i",{className:"fa-solid fa-id-badge",style:{color:m.color}}),m.idLabel]}),e.jsxs("div",{className:"portal-input-wrap",style:{"--ac":m.color},children:[e.jsx("span",{className:"portal-input-icon",children:e.jsx("i",{className:"fa-solid fa-user"})}),e.jsx("input",{type:"text",value:u,onChange:oe=>b(oe.target.value),placeholder:m.idPlaceholder,autoComplete:"username"}),e.jsx("div",{className:"portal-input-focus-bar",style:{background:m.color}})]})]}),e.jsxs("div",{className:"portal-field",children:[e.jsxs("label",{className:"portal-field-label",children:[e.jsx("i",{className:"fa-solid fa-lock",style:{color:m.color}}),m.passLabel]}),e.jsxs("div",{className:"portal-input-wrap",children:[e.jsx("span",{className:"portal-input-icon",children:e.jsx("i",{className:"fa-solid fa-key"})}),e.jsx("input",{type:y?"text":"password",value:h,onChange:oe=>x(oe.target.value),placeholder:m.passPH,autoComplete:"current-password"}),e.jsx("button",{type:"button",className:"portal-eye-btn",onClick:()=>g(oe=>!oe),children:e.jsx("i",{className:`fa-solid ${y?"fa-eye-slash":"fa-eye"}`})}),e.jsx("div",{className:"portal-input-focus-bar",style:{background:m.color}})]})]}),e.jsxs("button",{type:"submit",className:"portal-submit",disabled:F,style:{background:m.grad,boxShadow:`0 8px 32px ${m.glow}`},children:[!F&&e.jsx("div",{className:"portal-submit-shimmer"}),F?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"portal-spinner"})," Authenticating…"]}):e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fa-solid fa-right-to-bracket"})," Sign In to Portal"]})]})]})]})]})]})]})}const Rt=({title:r})=>e.jsxs("div",{style:{textAlign:"center",padding:"80px 20px"},children:[e.jsx("h1",{style:{color:"#0c2340",fontSize:"2.5rem"},children:r}),e.jsx("p",{style:{color:"#666",marginTop:"20px",fontSize:"1.1rem"},children:"This page is coming soon."})]});function eb(){const r=Ft();return v.useEffect(()=>{if(typeof window<"u"&&typeof window.gtag=="function"){const s=r.pathname+r.search;window.gtag("config","G-53E5PMMFF8",{page_path:s}),window.gtag("config","GT-NSV9FQGQ",{page_path:s})}},[r]),null}function tb(){return e.jsxs(dg,{basename:"/CTC%20NEW%20REACT%20WEBSITE",children:[e.jsx(eb,{}),e.jsx(fg,{}),e.jsx(Rg,{children:e.jsxs(ng,{children:[e.jsx(X,{path:"/",element:e.jsx(Fg,{})}),e.jsx(X,{path:"/about/trust",element:e.jsx(Yg,{})}),e.jsx(X,{path:"/about/ctc",element:e.jsx(Kg,{})}),e.jsx(X,{path:"/about/team",element:e.jsx(Xg,{})}),e.jsx(X,{path:"/admission",element:e.jsx(o0,{})}),e.jsx(X,{path:"/admission/apply",element:e.jsx(c0,{})}),e.jsx(X,{path:"/academics/regular",element:e.jsx(g0,{})}),e.jsx(X,{path:"/academics/value-added",element:e.jsx(v0,{})}),e.jsx(X,{path:"/academics/enhancement",element:e.jsx(C0,{})}),e.jsx(X,{path:"/placement",element:e.jsx(zp,{})}),e.jsx(X,{path:"/placement/programs",element:e.jsx(O0,{})}),e.jsx(X,{path:"/placement/statistics",element:e.jsx(zp,{})}),e.jsx(X,{path:"/placement/brochure",element:e.jsx(D0,{})}),e.jsx(X,{path:"/placement/mission40",element:e.jsx(X0,{})}),e.jsx(X,{path:"/gymkhana",element:e.jsx(tx,{})}),e.jsx(X,{path:"/gymkhana/cultural",element:e.jsx(Ix,{})}),e.jsx(X,{path:"/gymkhana/sports",element:e.jsx(Nx,{})}),e.jsx(X,{path:"/gymkhana/technocrat",element:e.jsx(Cx,{})}),e.jsx(X,{path:"/gymkhana/disha-csr",element:e.jsx(Mx,{})}),e.jsx(X,{path:"/gymkhana/techfest/1",element:e.jsx(Kp,{})}),e.jsx(X,{path:"/gymkhana/techfest/2",element:e.jsx(qp,{})}),e.jsx(X,{path:"/gymkhana/techfest/3",element:e.jsx(Qp,{})}),e.jsx(X,{path:"/gymkhana/techfest-1",element:e.jsx(Kp,{})}),e.jsx(X,{path:"/gymkhana/techfest-2",element:e.jsx(qp,{})}),e.jsx(X,{path:"/gymkhana/techfest-3",element:e.jsx(Qp,{})}),e.jsx(X,{path:"/gallery",element:e.jsx(nx,{})}),e.jsx(X,{path:"/iqac",element:e.jsx(Rt,{title:"IQAC"})}),e.jsx(X,{path:"/iqac/item1",element:e.jsx(Rt,{title:"IQAC — Item 1"})}),e.jsx(X,{path:"/iqac/item2",element:e.jsx(Rt,{title:"IQAC — Item 2"})}),e.jsx(X,{path:"/iqac/item3",element:e.jsx(Rt,{title:"IQAC — Item 3"})}),e.jsx(X,{path:"/iqac/item4",element:e.jsx(Rt,{title:"IQAC — Item 4"})}),e.jsx(X,{path:"/aicte",element:e.jsx(Rt,{title:"AICTE"})}),e.jsx(X,{path:"/aicte/documents",element:e.jsx(Rt,{title:"AICTE — Documents"})}),e.jsx(X,{path:"/aicte/mandatory-disclosure",element:e.jsx(Rt,{title:"AICTE — Mandatory Disclosure"})}),e.jsx(X,{path:"/ckf-skills",element:e.jsx(Rt,{title:"CKF Skills"})}),e.jsx(X,{path:"/contacts",element:e.jsx(lx,{})}),e.jsx(X,{path:"/icc",element:e.jsx(hx,{})}),e.jsx(X,{path:"/grc",element:e.jsx(bx,{})}),e.jsx(X,{path:"/naac",element:e.jsx(Fx,{})}),e.jsx(X,{path:"/nba",element:e.jsx(Jx,{})}),e.jsx(X,{path:"/vikshit-bharat",element:e.jsx(Qx,{})}),e.jsx(X,{path:"/login",element:e.jsx(rn,{})}),e.jsx(X,{path:"/login/student",element:e.jsx(rn,{})}),e.jsx(X,{path:"/login/staff",element:e.jsx(rn,{})}),e.jsx(X,{path:"/login/admin",element:e.jsx(rn,{})}),e.jsx(X,{path:"/login/principal",element:e.jsx(rn,{})}),e.jsx(X,{path:"/login/admission",element:e.jsx(rn,{})}),e.jsx(X,{path:"*",element:e.jsx(Rt,{title:"Page Not Found"})})]})})]})}typeof window<"u"&&(window.history.scrollRestoration="manual");Wf.createRoot(document.getElementById("root")).render(e.jsx(v.StrictMode,{children:e.jsx(sm,{children:e.jsx(tb,{})})}));
