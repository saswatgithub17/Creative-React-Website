 ...
 */var Xd;function If(){if(Xd)return ne;Xd=1;var r=Symbol.for("react.element"),s=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),m=Symbol.for("react.profiler"),p=Symbol.for("react.provider"),u=Symbol.for("react.context"),x=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),g=Symbol.iterator;function T(C){return C===null||typeof C!="object"?null:(C=g&&C[g]||C["@@iterator"],typeof C=="function"?C:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},F=Object.assign,R={};function M(C,z,ae){this.props=C,this.context=z,this.refs=R,this.updater=ae||E}M.prototype.isReactComponent={},M.prototype.setState=function(C,z){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,z,"setState")},M.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function I(){}I.prototype=M.prototype;function P(C,z,ae){this.props=C,this.context=z,this.refs=R,this.updater=ae||E}var U=P.prototype=new I;U.constructor=P,F(U,M.prototype),U.isPureReactComponent=!0;var K=Array.isArray,V=Object.prototype.hasOwnProperty,te={current:null},ke={key:!0,ref:!0,__self:!0,__source:!0};function ce(C,z,ae){var re,se={},oe=null,me=null;if(z!=null)for(re in z.ref!==void 0&&(me=z.ref),z.key!==void 0&&(oe=""+z.key),z)V.call(z,re)&&!ke.hasOwnProperty(re)&&(se[re]=z[re]);var de=arguments.length-2;if(de===1)se.children=ae;else if(1<de){for(var xe=Array(de),Ze=0;Ze<de;Ze++)xe[Ze]=arguments[Ze+2];se.children=xe}if(C&&C.defaultProps)for(re in de=C.defaultProps,de)se[re]===void 0&&(se[re]=de[re]);return{$$typeof:r,type:C,key:oe,ref:me,props:se,_owner:te.current}}function $e(C,z){return{$$typeof:r,type:C.type,key:z,ref:C.ref,props:C.props,_owner:C._owner}}function St(C){return typeof C=="object"&&C!==null&&C.$$typeof===r}function pt(C){var z={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(ae){return z[ae]})}var ze=/\/+/g;function Xe(C,z){return typeof C=="object"&&C!==null&&C.key!=null?pt(""+C.key):z.toString(36)}function mt(C,z,ae,re,se){var oe=typeof C;(oe==="undefined"||oe==="boolean")&&(C=null);var me=!1;if(C===null)me=!0;else switch(oe){case"string":case"number":me=!0;break;case"object":switch(C.$$typeof){case r:case s:me=!0}}if(me)return me=C,se=se(me),C=re===""?"."+Xe(me,0):re,K(se)?(ae="",C!=null&&(ae=C.replace(ze,"$&/")+"/"),mt(se,z,ae,"",function(Ze){return Ze})):se!=null&&(St(se)&&(se=$e(se,ae+(!se.key||me&&me.key===se.key?"":(""+se.key).replace(ze,"$&/")+"/")+C)),z.push(se)),1;if(me=0,re=re===""?".":re+":",K(C))for(var de=0;de<C.length;de++){oe=C[de];var xe=re+Xe(oe,de);me+=mt(oe,z,ae,xe,se)}else if(xe=T(C),typeof xe=="function")for(C=xe.call(C),de=0;!(oe=C.next()).done;)oe=oe.value,xe=re+Xe(oe,de++),me+=mt(oe,z,ae,xe,se);else if(oe==="object")throw z=String(C),Error("Objects are not valid as a React child (found: "+(z==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":z)+"). If you meant to render a collection of children, use an array instead.");return me}function wt(C,z,ae){if(C==null)return C;var re=[],se=0;return mt(C,re,"","",function(oe){return z.call(ae,oe,se++)}),re}function Ge(C){if(C._status===-1){var z=C._result;z=z(),z.then(function(ae){(C._status===0||C._status===-1)&&(C._status=1,C._result=ae)},function(ae){(C._status===0||C._status===-1)&&(C._status=2,C._result=ae)}),C._status===-1&&(C._status=0,C._result=z)}if(C._status===1)return C._result.default;throw C._result}var je={current:null},L={transition:null},X={ReactCurrentDispatcher:je,ReactCurrentBatchConfig:L,ReactCurrentOwner:te};function $(){throw Error("act(...) is not supported in production builds of React.")}return ne.Children={map:wt,forEach:function(C,z,ae){wt(C,function(){z.apply(this,arguments)},ae)},count:function(C){var z=0;return wt(C,function(){z++}),z},toArray:function(C){return wt(C,function(z){return z})||[]},only:function(C){if(!St(C))throw Error("React.Children.only expected to receive a single React element child.");return C}},ne.Component=M,ne.Fragment=o,ne.Profiler=m,ne.PureComponent=P,ne.StrictMode=c,ne.Suspense=h,ne.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=X,ne.act=$,ne.cloneElement=function(C,z,ae){if(C==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+C+".");var re=F({},C.props),se=C.key,oe=C.ref,me=C._owner;if(z!=null){if(z.ref!==void 0&&(oe=z.ref,me=te.current),z.key!==void 0&&(se=""+z.key),C.type&&C.type.defaultProps)var de=C.type.defaultProps;for(xe in z)V.call(z,xe)&&!ke.hasOwnProperty(xe)&&(re[xe]=z[xe]===void 0&&de!==void 0?de[xe]:z[xe])}var xe=arguments.length-2;if(xe===1)re.children=ae;else if(1<xe){de=Array(xe);for(var Ze=0;Ze<xe;Ze++)de[Ze]=arguments[Ze+2];re.children=de}return{$$typeof:r,type:C.type,key:se,ref:oe,props:re,_owner:me}},ne.createContext=function(C){return C={$$typeof:u,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},C.Provider={$$typeof:p,_context:C},C.Consumer=C},ne.createElement=ce,ne.createFactory=function(C){var z=ce.bind(null,C);return z.type=C,z},ne.createRef=function(){return{current:null}},ne.forwardRef=function(C){return{$$typeof:x,render:C}},ne.isValidElement=St,ne.lazy=function(C){return{$$typeof:y,_payload:{_status:-1,_result:C},_init:Ge}},ne.memo=function(C,z){return{$$typeof:b,type:C,compare:z===void 0?null:z}},ne.startTransition=function(C){var z=L.transition;L.transition={};try{C()}finally{L.transition=z}},ne.unstable_act=$,ne.useCallback=function(C,z){return je.current.useCallback(C,z)},ne.useContext=function(C){return je.current.useContext(C)},ne.useDebugValue=function(){},ne.useDeferredValue=function(C){return je.current.useDeferredValue(C)},ne.useEffect=function(C,z){return je.current.useEffect(C,z)},ne.useId=function(){return je.current.useId()},ne.useImperativeHandle=function(C,z,ae){return je.current.useImperativeHandle(C,z,ae)},ne.useInsertionEffect=function(C,z){return je.current.useInsertionEffect(C,z)},ne.useLayoutEffect=function(C,z){return je.current.useLayoutEffect(C,z)},ne.useMemo=function(C,z){return je.current.useMemo(C,z)},ne.useReducer=function(C,z,ae){return je.current.useReducer(C,z,ae)},ne.useRef=function(C){return je.current.useRef(C)},ne.useState=function(C){return je.current.useState(C)},ne.useSyncExternalStore=function(C,z,ae){return je.current.useSyncExternalStore(C,z,ae)},ne.useTransition=function(){return je.current.useTransition()},ne.version="18.3.1",ne}var Zd;function Qo(){return Zd||(Zd=1,jo.exports=If()),jo.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ep;function Bf(){if(ep)return Vn;ep=1;var r=Qo(),s=Symbol.for("react.element"),o=Symbol.for("react.fragment"),c=Object.prototype.hasOwnProperty,m=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function u(x,h,b){var y,g={},T=null,E=null;b!==void 0&&(T=""+b),h.key!==void 0&&(T=""+h.key),h.ref!==void 0&&(E=h.ref);for(y in h)c.call(h,y)&&!p.hasOwnProperty(y)&&(g[y]=h[y]);if(x&&x.defaultProps)for(y in h=x.defaultProps,h)g[y]===void 0&&(g[y]=h[y]);return{$$typeof:s,type:x,key:T,ref:E,props:g,_owner:m.current}}return Vn.Fragment=o,Vn.jsx=u,Vn.jsxs=u,Vn}var tp;function Mf(){return tp||(tp=1,vo.exports=Bf()),vo.exports}var e=Mf(),v=Qo();const we=wi(v),zf=Pf({__proto__:null,default:we},[v]);var fi={},So={exports:{}},Qe={},wo={exports:{}},Co={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ap;function Of(){return ap||(ap=1,(function(r){function s(L,X){var $=L.length;L.push(X);e:for(;0<$;){var C=$-1>>>1,z=L[C];if(0<m(z,X))L[C]=X,L[$]=z,$=C;else break e}}function o(L){return L.length===0?null:L[0]}function c(L){if(L.length===0)return null;var X=L[0],$=L.pop();if($!==X){L[0]=$;e:for(var C=0,z=L.length,ae=z>>>1;C<ae;){var re=2*(C+1)-1,se=L[re],oe=re+1,me=L[oe];if(0>m(se,$))oe<z&&0>m(me,se)?(L[C]=me,L[oe]=$,C=oe):(L[C]=se,L[re]=$,C=re);else if(oe<z&&0>m(me,$))L[C]=me,L[oe]=$,C=oe;else break e}}return X}function m(L,X){var $=L.sortIndex-X.sortIndex;return $!==0?$:L.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var p=performance;r.unstable_now=function(){return p.now()}}else{var u=Date,x=u.now();r.unstable_now=function(){return u.now()-x}}var h=[],b=[],y=1,g=null,T=3,E=!1,F=!1,R=!1,M=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function U(L){for(var X=o(b);X!==null;){if(X.callback===null)c(b);else if(X.startTime<=L)c(b),X.sortIndex=X.expirationTime,s(h,X);else break;X=o(b)}}function K(L){if(R=!1,U(L),!F)if(o(h)!==null)F=!0,Ge(V);else{var X=o(b);X!==null&&je(K,X.startTime-L)}}function V(L,X){F=!1,R&&(R=!1,I(ce),ce=-1),E=!0;var $=T;try{for(U(X),g=o(h);g!==null&&(!(g.expirationTime>X)||L&&!pt());){var C=g.callback;if(typeof C=="function"){g.callback=null,T=g.priorityLevel;var z=C(g.expirationTime<=X);X=r.unstable_now(),typeof z=="function"?g.callback=z:g===o(h)&&c(h),U(X)}else c(h);g=o(h)}if(g!==null)var ae=!0;else{var re=o(b);re!==null&&je(K,re.startTime-X),ae=!1}return ae}finally{g=null,T=$,E=!1}}var te=!1,ke=null,ce=-1,$e=5,St=-1;function pt(){return!(r.unstable_now()-St<$e)}function ze(){if(ke!==null){var L=r.unstable_now();St=L;var X=!0;try{X=ke(!0,L)}finally{X?Xe():(te=!1,ke=null)}}else te=!1}var Xe;if(typeof P=="function")Xe=function(){P(ze)};else if(typeof MessageChannel<"u"){var mt=new MessageChannel,wt=mt.port2;mt.port1.onmessage=ze,Xe=function(){wt.postMessage(null)}}else Xe=function(){M(ze,0)};function Ge(L){ke=L,te||(te=!0,Xe())}function je(L,X){ce=M(function(){L(r.unstable_now())},X)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(L){L.callback=null},r.unstable_continueExecution=function(){F||E||(F=!0,Ge(V))},r.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$e=0<L?Math.floor(1e3/L):5},r.unstable_getCurrentPriorityLevel=function(){return T},r.unstable_getFirstCallbackNode=function(){return o(h)},r.unstable_next=function(L){switch(T){case 1:case 2:case 3:var X=3;break;default:X=T}var $=T;T=X;try{return L()}finally{T=$}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(L,X){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var $=T;T=L;try{return X()}finally{T=$}},r.unstable_scheduleCallback=function(L,X,$){var C=r.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?C+$:C):$=C,L){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=$+z,L={id:y++,callback:X,priorityLevel:L,startTime:$,expirationTime:z,sortIndex:-1},$>C?(L.sortIndex=$,s(b,L),o(h)===null&&L===o(b)&&(R?(I(ce),ce=-1):R=!0,je(K,$-C))):(L.sortIndex=z,s(h,L),F||E||(F=!0,Ge(V))),L},r.unstable_shouldYield=pt,r.unstable_wrapCallback=function(L){var X=T;return function(){var $=T;T=X;try{return L.apply(this,arguments)}finally{T=$}}}})(Co)),Co}var np;function Df(){return np||(np=1,wo.exports=Of()),wo.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rp;function Wf(){if(rp)return Qe;rp=1;var r=Qo(),s=Df();function o(t){for(var a="https://reactjs.org/docs/error-decoder.html?invariant="+t,n=1;n<arguments.length;n++)a+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+t+"; visit "+a+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var c=new Set,m={};function p(t,a){u(t,a),u(t+"Capture",a)}function u(t,a){for(m[t]=a,t=0;t<a.length;t++)c.add(a[t])}var x=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),h=Object.prototype.hasOwnProperty,b=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,y={},g={};function T(t){return h.call(g,t)?!0:h.call(y,t)?!1:b.test(t)?g[t]=!0:(y[t]=!0,!1)}function E(t,a,n,i){if(n!==null&&n.type===0)return!1;switch(typeof a){case"function":case"symbol":return!0;case"boolean":return i?!1:n!==null?!n.acceptsBooleans:(t=t.toLowerCase().slice(0,5),t!=="data-"&&t!=="aria-");default:return!1}}function F(t,a,n,i){if(a===null||typeof a>"u"||E(t,a,n,i))return!0;if(i)return!1;if(n!==null)switch(n.type){case 3:return!a;case 4:return a===!1;case 5:return isNaN(a);case 6:return isNaN(a)||1>a}return!1}function R(t,a,n,i,l,d,f){this.acceptsBooleans=a===2||a===3||a===4,this.attributeName=i,this.attributeNamespace=l,this.mustUseProperty=n,this.propertyName=t,this.type=a,this.sanitizeURL=d,this.removeEmptyString=f}var M={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(t){M[t]=new R(t,0,!1,t,null,!1,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(t){var a=t[0];M[a]=new R(a,1,!1,t[1],null,!1,!1)}),["contentEditable","draggable","spellCheck","value"].forEach(function(t){M[t]=new R(t,2,!1,t.toLowerCase(),null,!1,!1)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(t){M[t]=new R(t,2,!1,t,null,!1,!1)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(t){M[t]=new R(t,3,!1,t.toLowerCase(),null,!1,!1)}),["checked","multiple","muted","selected"].forEach(function(t){M[t]=new R(t,3,!0,t,null,!1,!1)}),["capture","download"].forEach(function(t){M[t]=new R(t,4,!1,t,null,!1,!1)}),["cols","rows","size","span"].forEach(function(t){M[t]=new R(t,6,!1,t,null,!1,!1)}),["rowSpan","start"].forEach(function(t){M[t]=new R(t,5,!1,t.toLowerCase(),null,!1,!1)});var I=/[\-:]([a-z])/g;function P(t){return t[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(t){var a=t.replace(I,P);M[a]=new R(a,1,!1,t,null,!1,!1)}),"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(t){var a=t.replace(I,P);M[a]=new R(a,1,!1,t,"http://www.w3.org/1999/xlink",!1,!1)}),["xml:base","xml:lang","xml:space"].forEach(function(t){var a=t.replace(I,P);M[a]=new R(a,1,!1,t,"http://www.w3.org/XML/1998/namespace",!1,!1)}),["tabIndex","crossOrigin"].forEach(function(t){M[t]=new R(t,1,!1,t.toLowerCase(),null,!1,!1)}),M.xlinkHref=new R("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1),["src","href","action","formAction"].forEach(function(t){M[t]=new R(t,1,!1,t.toLowerCase(),null,!0,!0)});function U(t,a,n,i){var l=M.hasOwnProperty(a)?M[a]:null;(l!==null?l.type!==0:i||!(2<a.length)||a[0]!=="o"&&a[0]!=="O"||a[1]!=="n"&&a[1]!=="N")&&(F(a,n,l,i)&&(n=null),i||l===null?T(a)&&(n===null?t.removeAttribute(a):t.setAttribute(a,""+n)):l.mustUseProperty?t[l.propertyName]=n===null?l.type===3?!1:"":n:(a=l.attributeName,i=l.attributeNamespace,n===null?t.removeAttribute(a):(l=l.type,n=l===3||l===4&&n===!0?"":""+n,i?t.setAttributeNS(i,a,n):t.setAttribute(a,n))))}var K=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,V=Symbol.for("react.element"),te=Symbol.for("react.portal"),ke=Symbol.for("react.fragment"),ce=Symbol.for("react.strict_mode"),$e=Symbol.for("react.profiler"),St=Symbol.for("react.provider"),pt=Symbol.for("react.context"),ze=Symbol.for("react.forward_ref"),Xe=Symbol.for("react.suspense"),mt=Symbol.for("react.suspense_list"),wt=Symbol.for("react.memo"),Ge=Symbol.for("react.lazy"),je=Symbol.for("react.offscreen"),L=Symbol.iterator;function X(t){return t===null||typeof t!="object"?null:(t=L&&t[L]||t["@@iterator"],typeof t=="function"?t:null)}var $=Object.assign,C;function z(t){if(C===void 0)try{throw Error()}catch(n){var a=n.stack.trim().match(/\n( *(at )?)/);C=a&&a[1]||""}return`
...
`+l[f].replace(" at new "," at ");return t.displayName&&S.includes("<anonymous>")&&(S=S.replace("<anonymous>",t.displayName)),S}while(1<=f&&0<=j);break}}}finally{ae=!1,Error.prepareStackTrace=n}return(t=t?t.displayName||t.name:"")?z(t):""}function se(t){switch(t.tag){case 5:return z(t.type);case 16:return z("Lazy");case 13:return z("Suspense");case 19:return z("SuspenseList");case 0:case 2:case 15:return t=re(t.type,!1),t;case 11:return t=re(t.type.render,!1),t;case 1:return t=re(t.type,!0),t;default:return""}}function oe(t){if(t==null)return null;if(typeof t=="function")return t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case ke:return"Fragment";case te:return"Portal";case $e:return"Profiler";case ce:return"StrictMode";case Xe:return"Suspense";case mt:return"SuspenseList"}if(typeof t=="object")switch(t.$$typeof){case pt:return(t.displayName||"Context")+".Consumer";case St:return(t._context.displayName||"Context")+".Provider";case ze:var a=t.render;return t=t.displayName,t||(t=a.displayName||a.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case wt:return a=t.displayName||null,a!==null?a:oe(t.type)||"Memo";case Ge:a=t._payload,t=t._init;try{return oe(t(a))}catch{}}return null}function me(t){var a=t.type;switch(t.tag){case 24:return"Cache";case 9:return(a.displayName||"Context")+".Consumer";case 10:return(a._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return t=a.render,t=t.displayName||t.name||"",a.displayName||(t!==""?"ForwardRef("+t+")":"ForwardRef");case 7:return"Fragment";case 5:return a;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return oe(a);case 8:return a===ce?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof a=="function")return a.displayName||a.name||null;if(typeof a=="string")return a}return null}function de(t){switch(typeof t){case"boolean":case"number":case"string":case"undefined":return t;case"object":return t;default:return""}}function xe(t){var a=t.type;return(t=t.nodeName)&&t.toLowerCase()==="input"&&(a==="checkbox"||a==="radio")}function Ze(t){var a=xe(t)?"checked":"value",n=Object.getOwnPropertyDescriptor(t.constructor.prototype,a),i=""+t[a];if(!t.hasOwnProperty(a)&&typeof n<"u"&&typeof n.get=="function"&&typeof n.set=="function"){var l=n.get,d=n.set;return Object.defineProperty(t,a,{configurable:!0,get:function(){return l.call(this)},set:function(f){i=""+f,d.call(this,f)}}),Object.defineProperty(t,a,{enumerable:n.enumerable}),{getValue:function(){return i},setValue:function(f){i=""+f},stopTracking:function(){t._valueTracker=null,delete t[a]}}}}function rr(t){t._valueTracker||(t._valueTracker=Ze(t))}function rl(t){if(!t)return!1;var a=t._valueTracker;if(!a)return!0;var n=a.getValue(),i="";return t&&(i=xe(t)?t.checked?"true":"false":t.value),t=i,t!==n?(a.setValue(t),!0):!1}function ir(t){if(t=t||(typeof document<"u"?document:void 0),typeof t>"u")return null;try{return t.activeElement||t.body}catch{return t.body}}function ki(t,a){var n=a.checked;return $({},a,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:n??t._wrapperState.initialChecked})}function il(t,a){var n=a.defaultValue==null?"":a.defaultValue,i=a.checked!=null?a.checked:a.defaultChecked;n=de(a.value!=null?a.value:n),t._wrapperState={initialChecked:i,initialValue:n,controlled:a.type==="checkbox"||a.type==="radio"?a.checked!=null:a.value!=null}}function sl(t,a){a=a.checked,a!=null&&U(t,"checked",a,!1)}function Ni(t,a){sl(t,a);var n=de(a.value),i=a.type;if(n!=null)i==="number"?(n===0&&t.value===""||t.value!=n)&&(t.value=""+n):t.value!==""+n&&(t.value=""+n);else if(i==="submit"||i==="reset"){t.removeAttribute("value");return}a.hasOwnProperty("value")?Ti(t,a.type,n):a.hasOwnProperty("defaultValue")&&Ti(t,a.type,de(a.defaultValue)),a.checked==null&&a.defaultChecked!=null&&(t.defaultChecked=!!a.defaultChecked)}function ol(t,a,n){if(a.hasOwnProperty("value")||a.hasOwnProperty("defaultValue")){var i=a.type;if(!(i!=="submit"&&i!=="reset"||a.value!==void 0&&a.value!==null))return;a=""+t._wrapperState.initialValue,n||a===t.value||(t.value=a),t.defaultValue=a}n=t.name,n!==""&&(t.name=""),t.defaultChecked=!!t._wrapperState.initialChecked,n!==""&&(t.name=n)}function Ti(t,a,n){(a!=="number"||ir(t.ownerDocument)!==t)&&(n==null?t.defaultValue=""+t._wrapperState.initialValue:t.defaultValue!==""+n&&(t.defaultValue=""+n))}var cn=Array.isArray;function Ea(t,a,n,i){if(t=t.options,a){a={};for(var l=0;l<n.length;l++)a["$"+n[l]]=!0;for(n=0;n<t.length;n++)l=a.hasOwnProperty("$"+t[n].value),t[n].selected!==l&&(t[n].selected=l),l&&i&&(t[n].defaultSelected=!0)}else{for(n=""+de(n),a=null,l=0;l<t.length;l++){if(t[l].value===n){t[l].selected=!0,i&&(t[l].defaultSelected=!0);return}a!==null||t[l].disabled||(a=t[l])}a!==null&&(a.selected=!0)}}function Ei(t,a){if(a.dangerouslySetInnerHTML!=null)throw Error(o(91));return $({},a,{value:void 0,defaultValue:void 0,children:""+t._wrapperState.initialValue})}function ll(t,a){var n=a.value;if(n==null){if(n=a.children,a=a.defaultValue,n!=null){if(a!=null)throw Error(o(92));if(cn(n)){if(1<n.length)throw Error(o(93));n=n[0]}a=n}a==null&&(a=""),n=a}t._wrapperState={initialValue:de(n)}}function cl(t,a){var n=de(a.value),i=de(a.defaultValue);n!=null&&(n=""+n,n!==t.value&&(t.value=n),a.defaultValue==null&&t.defaultValue!==n&&(t.defaultValue=n)),i!=null&&(t.defaultValue=""+i)}function dl(t){var a=t.textContent;a===t._wrapperState.initialValue&&a!==""&&a!==null&&(t.value=a)}function pl(t){switch(t){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function Ri(t,a){return t==null||t==="http://www.w3.org/1999/xhtml"?pl(a):t==="http://www.w3.org/2000/svg"&&a==="foreignObject"?"http://www.w3.org/1999/xhtml":t}var sr,ml=(function(t){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(a,n,i,l){MSApp.execUnsafeLocalFunction(function(){return t(a,n,i,l)})}:t})(function(t,a){if(t.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in t)t.innerHTML=a;else{for(sr=sr||document.createElement("div"),sr.innerHTML="<svg>"+a.valueOf().toString()+"</svg>",a=sr.firstChild;t.firstChild;)t.removeChild(t.firstChild);for(;a.firstChild;)t.appendChild(a.firstChild)}});function dn(t,a){if(a){var n=t.firstChild;if(n&&n===t.lastChild&&n.nodeType===3){n.nodeValue=a;return}}t.textContent=a}var pn={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Im=["Webkit","ms","Moz","O"];Object.keys(pn).forEach(function(t){Im.forEach(function(a){a=a+t.charAt(0).toUpperCase()+t.substring(1),pn[a]=pn[t]})});function ul(t,a,n){return a==null||typeof a=="boolean"||a===""?"":n||typeof a!="number"||a===0||pn.hasOwnProperty(t)&&pn[t]?(""+a).trim():a+"px"}function fl(t,a){t=t.style;for(var n in a)if(a.hasOwnProperty(n)){var i=n.indexOf("--")===0,l=ul(n,a[n],i);n==="float"&&(n="cssFloat"),i?t.setProperty(n,l):t[n]=l}}var Bm=$({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function Pi(t,a){if(a){if(Bm[t]&&(a.children!=null||a.dangerouslySetInnerHTML!=null))throw Error(o(137,t));if(a.dangerouslySetInnerHTML!=null){if(a.children!=null)throw Error(o(60));if(typeof a.dangerouslySetInnerHTML!="object"||!("__html"in a.dangerouslySetInnerHTML))throw Error(o(61))}if(a.style!=null&&typeof a.style!="object")throw Error(o(62))}}function Ii(t,a){if(t.indexOf("-")===-1)return typeof a.is=="string";switch(t){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var Bi=null;function Mi(t){return t=t.target||t.srcElement||window,t.correspondingUseElement&&(t=t.correspondingUseElement),t.nodeType===3?t.parentNode:t}var zi=null,Ra=null,Pa=null;function hl(t){if(t=Bn(t)){if(typeof zi!="function")throw Error(o(280));var a=t.stateNode;a&&(a=Er(a),zi(t.stateNode,t.type,a))}}function gl(t){Ra?Pa?Pa.push(t):Pa=[t]:Ra=t}function xl(){if(Ra){var t=Ra,a=Pa;if(Pa=Ra=null,hl(t),a)for(t=0;t<a.length;t++)hl(a[t])}}function bl(t,a){return t(a)}function yl(){}var Oi=!1;function vl(t,a,n){if(Oi)return t(a,n);Oi=!0;try{return bl(t,a,n)}finally{Oi=!1,(Ra!==null||Pa!==null)&&(yl(),xl())}}function mn(t,a){var n=t.stateNode;if(n===null)return null;var i=Er(n);if(i===null)return null;n=i[a];e:switch(a){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(t=t.type,i=!(t==="button"||t==="input"||t==="select"||t==="textarea")),t=!i;break e;default:t=!1}if(t)return null;if(n&&typeof n!="function")throw Error(o(231,a,typeof n));return n}var Di=!1;if(x)try{var un={};Object.defineProperty(un,"passive",{get:function(){Di=!0}}),window.addEventListener("test",un,un),window.removeEventListener("test",un,un)}catch{Di=!1}function Mm(t,a,n,i,l,d,f,j,S){var N=Array.prototype.slice.call(arguments,3);try{a.apply(n,N)}catch(O){this.onError(O)}}var fn=!1,or=null,lr=!1,Wi=null,zm={onError:function(t){fn=!0,or=t}};function Om(t,a,n,i,l,d,f,j,S){fn=!1,or=null,Mm.apply(zm,arguments)}function Dm(t,a,n,i,l,d,f,j,S){if(Om.apply(this,arguments),fn){if(fn){var N=or;fn=!1,or=null}else throw Error(o(198));lr||(lr=!0,Wi=N)}}function pa(t){var a=t,n=t;if(t.alternate)for(;a.return;)a=a.return;else{t=a;do a=t,(a.flags&4098)!==0&&(n=a.return),t=a.return;while(t)}return a.tag===3?n:null}function jl(t){if(t.tag===13){var a=t.memoizedState;if(a===null&&(t=t.alternate,t!==null&&(a=t.memoizedState)),a!==null)return a.dehydrated}return null}function Sl(t){if(pa(t)!==t)throw Error(o(188))}function Wm(t){var a=t.alternate;if(!a){if(a=pa(t),a===null)throw Error(o(188));return a!==t?null:t}for(var n=t,i=a;;){var l=n.return;if(l===null)break;var d=l.alternate;if(d===null){if(i=l.return,i!==null){n=i;continue}break}if(l.child===d.child){for(d=l.child;d;){if(d===n)return Sl(l),t;if(d===i)return Sl(l),a;d=d.sibling}throw Error(o(188))}if(n.return!==i.return)n=l,i=d;else{for(var f=!1,j=l.child;j;){if(j===n){f=!0,n=l,i=d;break}if(j===i){f=!0,i=l,n=d;break}j=j.sibling}if(!f){for(j=d.child;j;){if(j===n){f=!0,n=d,i=l;break}if(j===i){f=!0,i=d,n=l;break}j=j.sibling}if(!f)throw Error(o(189))}}if(n.alternate!==i)throw Error(o(190))}if(n.tag!==3)throw Error(o(188));return n.stateNode.current===n?t:a}function wl(t){return t=Wm(t),t!==null?Cl(t):null}function Cl(t){if(t.tag===5||t.tag===6)return t;for(t=t.child;t!==null;){var a=Cl(t);if(a!==null)return a;t=t.sibling}return null}var Al=s.unstable_scheduleCallback,kl=s.unstable_cancelCallback,Lm=s.unstable_shouldYield,Hm=s.unstable_requestPaint,Ce=s.unstable_now,Fm=s.unstable_getCurrentPriorityLevel,Li=s.unstable_ImmediatePriority,Nl=s.unstable_UserBlockingPriority,cr=s.unstable_NormalPriority,Um=s.unstable_LowPriority,Tl=s.unstable_IdlePriority,dr=null,Ct=null;function _m(t){if(Ct&&typeof Ct.onCommitFiberRoot=="function")try{Ct.onCommitFiberRoot(dr,t,void 0,(t.current.flags&128)===128)}catch{}}var ut=Math.clz32?Math.clz32:Ym,$m=Math.log,Gm=Math.LN2;function Ym(t){return t>>>=0,t===0?32:31-($m(t)/Gm|0)|0}var pr=64,mr=4194304;function hn(t){switch(t&-t){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return t&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return t&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return t}}function ur(t,a){var n=t.pendingLanes;if(n===0)return 0;var i=0,l=t.suspendedLanes,d=t.pingedLanes,f=n&268435455;if(f!==0){var j=f&~l;j!==0?i=hn(j):(d&=f,d!==0&&(i=hn(d)))}else f=n&~l,f!==0?i=hn(f):d!==0&&(i=hn(d));if(i===0)return 0;if(a!==0&&a!==i&&(a&l)===0&&(l=i&-i,d=a&-a,l>=d||l===16&&(d&4194240)!==0))return a;if((i&4)!==0&&(i|=n&16),a=t.entangledLanes,a!==0)for(t=t.entanglements,a&=i;0<a;)n=31-ut(a),l=1<<n,i|=t[n],a&=~l;return i}function Jm(t,a){switch(t){case 1:case 2:case 4:return a+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return a+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function Vm(t,a){for(var n=t.suspendedLanes,i=t.pingedLanes,l=t.expirationTimes,d=t.pendingLanes;0<d;){var f=31-ut(d),j=1<<f,S=l[f];S===-1?((j&n)===0||(j&i)!==0)&&(l[f]=Jm(j,a)):S<=a&&(t.expiredLanes|=j),d&=~j}}function Hi(t){return t=t.pendingLanes&-1073741825,t!==0?t:t&1073741824?1073741824:0}function El(){var t=pr;return pr<<=1,(pr&4194240)===0&&(pr=64),t}function Fi(t){for(var a=[],n=0;31>n;n++)a.push(t);return a}function gn(t,a,n){t.pendingLanes|=a,a!==536870912&&(t.suspendedLanes=0,t.pingedLanes=0),t=t.eventTimes,a=31-ut(a),t[a]=n}function Km(t,a){var n=t.pendingLanes&~a;t.pendingLanes=a,t.suspendedLanes=0,t.pingedLanes=0,t.expiredLanes&=a,t.mutableReadLanes&=a,t.entangledLanes&=a,a=t.entanglements;var i=t.eventTimes;for(t=t.expirationTimes;0<n;){var l=31-ut(n),d=1<<l;a[l]=0,i[l]=-1,t[l]=-1,n&=~d}}function Ui(t,a){var n=t.entangledLanes|=a;for(t=t.entanglements;n;){var i=31-ut(n),l=1<<i;l&a|t[i]&a&&(t[i]|=a),n&=~l}}var pe=0;function Rl(t){return t&=-t,1<t?4<t?(t&268435455)!==0?16:536870912:4:1}var Pl,_i,Il,Bl,Ml,$i=!1,fr=[],Ft=null,Ut=null,_t=null,xn=new Map,bn=new Map,$t=[],qm="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function zl(t,a){switch(t){case"focusin":case"focusout":Ft=null;break;case"dragenter":case"dragleave":Ut=null;break;case"mouseover":case"mouseout":_t=null;break;case"pointerover":case"pointerout":xn.delete(a.pointerId);break;case"gotpointercapture":case"lostpointercapture":bn.delete(a.pointerId)}}function yn(t,a,n,i,l,d){return t===null||t.nativeEvent!==d?(t={blockedOn:a,domEventName:n,eventSystemFlags:i,nativeEvent:d,targetContainers:[l]},a!==null&&(a=Bn(a),a!==null&&_i(a)),t):(t.eventSystemFlags|=i,a=t.targetContainers,l!==null&&a.indexOf(l)===-1&&a.push(l),t)}function Qm(t,a,n,i,l){switch(a){case"focusin":return Ft=yn(Ft,t,a,n,i,l),!0;case"dragenter":return Ut=yn(Ut,t,a,n,i,l),!0;case"mouseover":return _t=yn(_t,t,a,n,i,l),!0;case"pointerover":var d=l.pointerId;return xn.set(d,yn(xn.get(d)||null,t,a,n,i,l)),!0;case"gotpointercapture":return d=l.pointerId,bn.set(d,yn(bn.get(d)||null,t,a,n,i,l)),!0}return!1}function Ol(t){var a=ma(t.target);if(a!==null){var n=pa(a);if(n!==null){if(a=n.tag,a===13){if(a=jl(n),a!==null){t.blockedOn=a,Ml(t.priority,function(){Il(n)});return}}else if(a===3&&n.stateNode.current.memoizedState.isDehydrated){t.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}t.blockedOn=null}function hr(t){if(t.blockedOn!==null)return!1;for(var a=t.targetContainers;0<a.length;){var n=Yi(t.domEventName,t.eventSystemFlags,a[0],t.nativeEvent);if(n===null){n=t.nativeEvent;var i=new n.constructor(n.type,n);Bi=i,n.target.dispatchEvent(i),Bi=null}else return a=Bn(n),a!==null&&_i(a),t.blockedOn=n,!1;a.shift()}return!0}function Dl(t,a,n){hr(t)&&n.delete(a)}function Xm(){$i=!1,Ft!==null&&hr(Ft)&&(Ft=null),Ut!==null&&hr(Ut)&&(Ut=null),_t!==null&&hr(_t)&&(_t=null),xn.forEach(Dl),bn.forEach(Dl)}function vn(t,a){t.blockedOn===a&&(t.blockedOn=null,$i||($i=!0,s.unstable_scheduleCallback(s.unstable_NormalPriority,Xm)))}function jn(t){function a(l){return vn(l,t)}if(0<fr.length){vn(fr[0],t);for(var n=1;n<fr.length;n++){var i=fr[n];i.blockedOn===t&&(i.blockedOn=null)}}for(Ft!==null&&vn(Ft,t),Ut!==null&&vn(Ut,t),_t!==null&&vn(_t,t),xn.forEach(a),bn.forEach(a),n=0;n<$t.length;n++)i=$t[n],i.blockedOn===t&&(i.blockedOn=null);for(;0<$t.length&&(n=$t[0],n.blockedOn===null);)Ol(n),n.blockedOn===null&&$t.shift()}var Ia=K.ReactCurrentBatchConfig,gr=!0;function Zm(t,a,n,i){var l=pe,d=Ia.transition;Ia.transition=null;try{pe=1,Gi(t,a,n,i)}finally{pe=l,Ia.transition=d}}function eu(t,a,n,i){var l=pe,d=Ia.transition;Ia.transition=null;try{pe=4,Gi(t,a,n,i)}finally{pe=l,Ia.transition=d}}function Gi(t,a,n,i){if(gr){var l=Yi(t,a,n,i);if(l===null)cs(t,a,i,xr,n),zl(t,i);else if(Qm(l,t,a,n,i))i.stopPropagation();else if(zl(t,i),a&4&&-1<qm.indexOf(t)){for(;l!==null;){var d=Bn(l);if(d!==null&&Pl(d),d=Yi(t,a,n,i),d===null&&cs(t,a,i,xr,n),d===l)break;l=d}l!==null&&i.stopPropagation()}else cs(t,a,i,null,n)}}var xr=null;function Yi(t,a,n,i){if(xr=null,t=Mi(i),t=ma(t),t!==null)if(a=pa(t),a===null)t=null;else if(n=a.tag,n===13){if(t=jl(a),t!==null)return t;t=null}else if(n===3){if(a.stateNode.current.memoizedState.isDehydrated)return a.tag===3?a.stateNode.containerInfo:null;t=null}else a!==t&&(t=null);return xr=t,null}function Wl(t){switch(t){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(Fm()){case Li:return 1;case Nl:return 4;case cr:case Um:return 16;case Tl:return 536870912;default:return 16}default:return 16}}var Gt=null,Ji=null,br=null;function Ll(){if(br)return br;var t,a=Ji,n=a.length,i,l="value"in Gt?Gt.value:Gt.textContent,d=l.length;for(t=0;t<n&&a[t]===l[t];t++);var f=n-t;for(i=1;i<=f&&a[n-i]===l[d-i];i++);return br=l.slice(t,1<i?1-i:void 0)}function yr(t){var a=t.keyCode;return"charCode"in t?(t=t.charCode,t===0&&a===13&&(t=13)):t=a,t===10&&(t=13),32<=t||t===13?t:0}function vr(){return!0}function Hl(){return!1}function et(t){function a(n,i,l,d,f){this._reactName=n,this._targetInst=l,this.type=i,this.nativeEvent=d,this.target=f,this.currentTarget=null;for(var j in t)t.hasOwnProperty(j)&&(n=t[j],this[j]=n?n(d):d[j]);return this.isDefaultPrevented=(d.defaultPrevented!=null?d.defaultPrevented:d.returnValue===!1)?vr:Hl,this.isPropagationStopped=Hl,this}return $(a.prototype,{preventDefault:function(){this.defaultPrevented=!0;var n=this.nativeEvent;n&&(n.preventDefault?n.preventDefault():typeof n.returnValue!="unknown"&&(n.returnValue=!1),this.isDefaultPrevented=vr)},stopPropagation:function(){var n=this.nativeEvent;n&&(n.stopPropagation?n.stopPropagation():typeof n.cancelBubble!="unknown"&&(n.cancelBubble=!0),this.isPropagationStopped=vr)},persist:function(){},isPersistent:vr}),a}var Ba={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(t){return t.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Vi=et(Ba),Sn=$({},Ba,{view:0,detail:0}),tu=et(Sn),Ki,qi,wn,jr=$({},Sn,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Xi,button:0,buttons:0,relatedTarget:function(t){return t.relatedTarget===void 0?t.fromElement===t.srcElement?t.toElement:t.fromElement:t.relatedTarget},movementX:function(t){return"movementX"in t?t.movementX:(t!==wn&&(wn&&t.type==="mousemove"?(Ki=t.screenX-wn.screenX,qi=t.screenY-wn.screenY):qi=Ki=0,wn=t),Ki)},movementY:function(t){return"movementY"in t?t.movementY:qi}}),Fl=et(jr),au=$({},jr,{dataTransfer:0}),nu=et(au),ru=$({},Sn,{relatedTarget:0}),Qi=et(ru),iu=$({},Ba,{animationName:0,elapsedTime:0,pseudoElement:0}),su=et(iu),ou=$({},Ba,{clipboardData:function(t){return"clipboardData"in t?t.clipboardData:window.clipboardData}}),lu=et(ou),cu=$({},Ba,{data:0}),Ul=et(cu),du={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},pu={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},mu={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function uu(t){var a=this.nativeEvent;return a.getModifierState?a.getModifierState(t):(t=mu[t])?!!a[t]:!1}function Xi(){return uu}var fu=$({},Sn,{key:function(t){if(t.key){var a=du[t.key]||t.key;if(a!=="Unidentified")return a}return t.type==="keypress"?(t=yr(t),t===13?"Enter":String.fromCharCode(t)):t.type==="keydown"||t.type==="keyup"?pu[t.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Xi,charCode:function(t){return t.type==="keypress"?yr(t):0},keyCode:function(t){return t.type==="keydown"||t.type==="keyup"?t.keyCode:0},which:function(t){return t.type==="keypress"?yr(t):t.type==="keydown"||t.type==="keyup"?t.keyCode:0}}),hu=et(fu),gu=$({},jr,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),_l=et(gu),xu=$({},Sn,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Xi}),bu=et(xu),yu=$({},Ba,{propertyName:0,elapsedTime:0,pseudoElement:0}),vu=et(yu),ju=$({},jr,{deltaX:function(t){return"deltaX"in t?t.deltaX:"wheelDeltaX"in t?-t.wheelDeltaX:0},deltaY:function(t){return"deltaY"in t?t.deltaY:"wheelDeltaY"in t?-t.wheelDeltaY:"wheelDelta"in t?-t.wheelDelta:0},deltaZ:0,deltaMode:0}),Su=et(ju),wu=[9,13,27,32],Zi=x&&"CompositionEvent"in window,Cn=null;x&&"documentMode"in document&&(Cn=document.documentMode);var Cu=x&&"TextEvent"in window&&!Cn,$l=x&&(!Zi||Cn&&8<Cn&&11>=Cn),Gl=" ",Yl=!1;function Jl(t,a){switch(t){case"keyup":return wu.indexOf(a.keyCode)!==-1;case"keydown":return a.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Vl(t){return t=t.detail,typeof t=="object"&&"data"in t?t.data:null}var Ma=!1;function Au(t,a){switch(t){case"compositionend":return Vl(a);case"keypress":return a.which!==32?null:(Yl=!0,Gl);case"textInput":return t=a.data,t===Gl&&Yl?null:t;default:return null}}function ku(t,a){if(Ma)return t==="compositionend"||!Zi&&Jl(t,a)?(t=Ll(),br=Ji=Gt=null,Ma=!1,t):null;switch(t){case"paste":return null;case"keypress":if(!(a.ctrlKey||a.altKey||a.metaKey)||a.ctrlKey&&a.altKey){if(a.char&&1<a.char.length)return a.char;if(a.which)return String.fromCharCode(a.which)}return null;case"compositionend":return $l&&a.locale!=="ko"?null:a.data;default:return null}}var Nu={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Kl(t){var a=t&&t.nodeName&&t.nodeName.toLowerCase();return a==="input"?!!Nu[t.type]:a==="textarea"}function ql(t,a,n,i){gl(i),a=kr(a,"onChange"),0<a.length&&(n=new Vi("onChange","change",null,n,i),t.push({event:n,listeners:a}))}var An=null,kn=null;function Tu(t){fc(t,0)}function Sr(t){var a=La(t);if(rl(a))return t}function Eu(t,a){if(t==="change")return a}var Ql=!1;if(x){var es;if(x){var ts="oninput"in document;if(!ts){var Xl=document.createElement("div");Xl.setAttribute("oninput","return;"),ts=typeof Xl.oninput=="function"}es=ts}else es=!1;Ql=es&&(!document.documentMode||9<document.documentMode)}function Zl(){An&&(An.detachEvent("onpropertychange",ec),kn=An=null)}function ec(t){if(t.propertyName==="value"&&Sr(kn)){var a=[];ql(a,kn,t,Mi(t)),vl(Tu,a)}}function Ru(t,a,n){t==="focusin"?(Zl(),An=a,kn=n,An.attachEvent("onpropertychange",ec)):t==="focusout"&&Zl()}function Pu(t){if(t==="selectionchange"||t==="keyup"||t==="keydown")return Sr(kn)}function Iu(t,a){if(t==="click")return Sr(a)}function Bu(t,a){if(t==="input"||t==="change")return Sr(a)}function Mu(t,a){return t===a&&(t!==0||1/t===1/a)||t!==t&&a!==a}var ft=typeof Object.is=="function"?Object.is:Mu;function Nn(t,a){if(ft(t,a))return!0;if(typeof t!="object"||t===null||typeof a!="object"||a===null)return!1;var n=Object.keys(t),i=Object.keys(a);if(n.length!==i.length)return!1;for(i=0;i<n.length;i++){var l=n[i];if(!h.call(a,l)||!ft(t[l],a[l]))return!1}return!0}function tc(t){for(;t&&t.firstChild;)t=t.firstChild;return t}function ac(t,a){var n=tc(t);t=0;for(var i;n;){if(n.nodeType===3){if(i=t+n.textContent.length,t<=a&&i>=a)return{node:n,offset:a-t};t=i}e:{for(;n;){if(n.nextSibling){n=n.nextSibling;break e}n=n.parentNode}n=void 0}n=tc(n)}}function nc(t,a){return t&&a?t===a?!0:t&&t.nodeType===3?!1:a&&a.nodeType===3?nc(t,a.parentNode):"contains"in t?t.contains(a):t.compareDocumentPosition?!!(t.compareDocumentPosition(a)&16):!1:!1}function rc(){for(var t=window,a=ir();a instanceof t.HTMLIFrameElement;){try{var n=typeof a.contentWindow.location.href=="string"}catch{n=!1}if(n)t=a.contentWindow;else break;a=ir(t.document)}return a}function as(t){var a=t&&t.nodeName&&t.nodeName.toLowerCase();return a&&(a==="input"&&(t.type==="text"||t.type==="search"||t.type==="tel"||t.type==="url"||t.type==="password")||a==="textarea"||t.contentEditable==="true")}function zu(t){var a=rc(),n=t.focusedElem,i=t.selectionRange;if(a!==n&&n&&n.ownerDocument&&nc(n.ownerDocument.documentElement,n)){if(i!==null&&as(n)){if(a=i.start,t=i.end,t===void 0&&(t=a),"selectionStart"in n)n.selectionStart=a,n.selectionEnd=Math.min(t,n.value.length);else if(t=(a=n.ownerDocument||document)&&a.defaultView||window,t.getSelection){t=t.getSelection();var l=n.textContent.length,d=Math.min(i.start,l);i=i.end===void 0?d:Math.min(i.end,l),!t.extend&&d>i&&(l=i,i=d,d=l),l=ac(n,d);var f=ac(n,i);l&&f&&(t.rangeCount!==1||t.anchorNode!==l.node||t.anchorOffset!==l.offset||t.focusNode!==f.node||t.focusOffset!==f.offset)&&(a=a.createRange(),a.setStart(l.node,l.offset),t.removeAllRanges(),d>i?(t.addRange(a),t.extend(f.node,f.offset)):(a.setEnd(f.node,f.offset),t.addRange(a)))}}for(a=[],t=n;t=t.parentNode;)t.nodeType===1&&a.push({element:t,left:t.scrollLeft,top:t.scrollTop});for(typeof n.focus=="function"&&n.focus(),n=0;n<a.length;n++)t=a[n],t.element.scrollLeft=t.left,t.element.scrollTop=t.top}}var Ou=x&&"documentMode"in document&&11>=document.documentMode,za=null,ns=null,Tn=null,rs=!1;function ic(t,a,n){var i=n.window===n?n.document:n.nodeType===9?n:n.ownerDocument;rs||za==null||za!==ir(i)||(i=za,"selectionStart"in i&&as(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),Tn&&Nn(Tn,i)||(Tn=i,i=kr(ns,"onSelect"),0<i.length&&(a=new Vi("onSelect","select",null,a,n),t.push({event:a,listeners:i}),a.target=za)))}function wr(t,a){var n={};return n[t.toLowerCase()]=a.toLowerCase(),n["Webkit"+t]="webkit"+a,n["Moz"+t]="moz"+a,n}var Oa={animationend:wr("Animation","AnimationEnd"),animationiteration:wr("Animation","AnimationIteration"),animationstart:wr("Animation","AnimationStart"),transitionend:wr("Transition","TransitionEnd")},is={},sc={};x&&(sc=document.createElement("div").style,"AnimationEvent"in window||(delete Oa.animationend.animation,delete Oa.animationiteration.animation,delete Oa.animationstart.animation),"TransitionEvent"in window||delete Oa.transitionend.transition);function Cr(t){if(is[t])return is[t];if(!Oa[t])return t;var a=Oa[t],n;for(n in a)if(a.hasOwnProperty(n)&&n in sc)return is[t]=a[n];return t}var oc=Cr("animationend"),lc=Cr("animationiteration"),cc=Cr("animationstart"),dc=Cr("transitionend"),pc=new Map,mc="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function Yt(t,a){pc.set(t,a),p(a,[t])}for(var ss=0;ss<mc.length;ss++){var os=mc[ss],Du=os.toLowerCase(),Wu=os[0].toUpperCase()+os.slice(1);Yt(Du,"on"+Wu)}Yt(oc,"onAnimationEnd"),Yt(lc,"onAnimationIteration"),Yt(cc,"onAnimationStart"),Yt("dblclick","onDoubleClick"),Yt("focusin","onFocus"),Yt("focusout","onBlur"),Yt(dc,"onTransitionEnd"),u("onMouseEnter",["mouseout","mouseover"]),u("onMouseLeave",["mouseout","mouseover"]),u("onPointerEnter",["pointerout","pointerover"]),u("onPointerLeave",["pointerout","pointerover"]),p("onChange","change click focusin focusout input keydown keyup selectionchange".split(" ")),p("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")),p("onBeforeInput",["compositionend","keypress","textInput","paste"]),p("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" ")),p("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" ")),p("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var En="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Lu=new Set("cancel close invalid load scroll toggle".split(" ").concat(En));function uc(t,a,n){var i=t.type||"unknown-event";t.currentTarget=n,Dm(i,a,void 0,t),t.currentTarget=null}function fc(t,a){a=(a&4)!==0;for(var n=0;n<t.length;n++){var i=t[n],l=i.event;i=i.listeners;e:{var d=void 0;if(a)for(var f=i.length-1;0<=f;f--){var j=i[f],S=j.instance,N=j.currentTarget;if(j=j.listener,S!==d&&l.isPropagationStopped())break e;uc(l,j,N),d=S}else for(f=0;f<i.length;f++){if(j=i[f],S=j.instance,N=j.currentTarget,j=j.listener,S!==d&&l.isPropagationStopped())break e;uc(l,j,N),d=S}}}if(lr)throw t=Wi,lr=!1,Wi=null,t}function fe(t,a){var n=a[hs];n===void 0&&(n=a[hs]=new Set);var i=t+"__bubble";n.has(i)||(hc(a,t,2,!1),n.add(i))}function ls(t,a,n){var i=0;a&&(i|=4),hc(n,t,i,a)}var Ar="_reactListening"+Math.random().toString(36).slice(2);function Rn(t){if(!t[Ar]){t[Ar]=!0,c.forEach(function(n){n!=="selectionchange"&&(Lu.has(n)||ls(n,!1,t),ls(n,!0,t))});var a=t.nodeType===9?t:t.ownerDocument;a===null||a[Ar]||(a[Ar]=!0,ls("selectionchange",!1,a))}}function hc(t,a,n,i){switch(Wl(a)){case 1:var l=Zm;break;case 4:l=eu;break;default:l=Gi}n=l.bind(null,a,n,t),l=void 0,!Di||a!=="touchstart"&&a!=="touchmove"&&a!=="wheel"||(l=!0),i?l!==void 0?t.addEventListener(a,n,{capture:!0,passive:l}):t.addEventListener(a,n,!0):l!==void 0?t.addEventListener(a,n,{passive:l}):t.addEventListener(a,n,!1)}function cs(t,a,n,i,l){var d=i;if((a&1)===0&&(a&2)===0&&i!==null)e:for(;;){if(i===null)return;var f=i.tag;if(f===3||f===4){var j=i.stateNode.containerInfo;if(j===l||j.nodeType===8&&j.parentNode===l)break;if(f===4)for(f=i.return;f!==null;){var S=f.tag;if((S===3||S===4)&&(S=f.stateNode.containerInfo,S===l||S.nodeType===8&&S.parentNode===l))return;f=f.return}for(;j!==null;){if(f=ma(j),f===null)return;if(S=f.tag,S===5||S===6){i=d=f;continue e}j=j.parentNode}}i=i.return}vl(function(){var N=d,O=Mi(n),D=[];e:{var B=pc.get(t);if(B!==void 0){var H=Vi,G=t;switch(t){case"keypress":if(yr(n)===0)break e;case"keydown":case"keyup":H=hu;break;case"focusin":G="focus",H=Qi;break;case"focusout":G="blur",H=Qi;break;case"beforeblur":case"afterblur":H=Qi;break;case"click":if(n.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":H=Fl;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":H=nu;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":H=bu;break;case oc:case lc:case cc:H=su;break;case dc:H=vu;break;case"scroll":H=tu;break;case"wheel":H=Su;break;case"copy":case"cut":case"paste":H=lu;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":H=_l}var Y=(a&4)!==0,Ae=!Y&&t==="scroll",A=Y?B!==null?B+"Capture":null:B;Y=[];for(var w=N,k;w!==null;){k=w;var W=k.stateNode;if(k.tag===5&&W!==null&&(k=W,A!==null&&(W=mn(w,A),W!=null&&Y.push(Pn(w,W,k)))),Ae)break;w=w.return}0<Y.length&&(B=new H(B,G,null,n,O),D.push({event:B,listeners:Y}))}}if((a&7)===0){e:{if(B=t==="mouseover"||t==="pointerover",H=t==="mouseout"||t==="pointerout",B&&n!==Bi&&(G=n.relatedTarget||n.fromElement)&&(ma(G)||G[Pt]))break e;if((H||B)&&(B=O.window===O?O:(B=O.ownerDocument)?B.defaultView||B.parentWindow:window,H?(G=n.relatedTarget||n.toElement,H=N,G=G?ma(G):null,G!==null&&(Ae=pa(G),G!==Ae||G.tag!==5&&G.tag!==6)&&(G=null)):(H=null,G=N),H!==G)){if(Y=Fl,W="onMouseLeave",A="onMouseEnter",w="mouse",(t==="pointerout"||t==="pointerover")&&(Y=_l,W="onPointerLeave",A="onPointerEnter",w="pointer"),Ae=H==null?B:La(H),k=G==null?B:La(G),B=new Y(W,w+"leave",H,n,O),B.target=Ae,B.relatedTarget=k,W=null,ma(O)===N&&(Y=new Y(A,w+"enter",G,n,O),Y.target=k,Y.relatedTarget=Ae,W=Y),Ae=W,H&&G)t:{for(Y=H,A=G,w=0,k=Y;k;k=Da(k))w++;for(k=0,W=A;W;W=Da(W))k++;for(;0<w-k;)Y=Da(Y),w--;for(;0<k-w;)A=Da(A),k--;for(;w--;){if(Y===A||A!==null&&Y===A.alternate)break t;Y=Da(Y),A=Da(A)}Y=null}else Y=null;H!==null&&gc(D,B,H,Y,!1),G!==null&&Ae!==null&&gc(D,Ae,G,Y,!0)}}e:{if(B=N?La(N):window,H=B.nodeName&&B.nodeName.toLowerCase(),H==="select"||H==="input"&&B.type==="file")var J=Eu;else if(Kl(B))if(Ql)J=Bu;else{J=Pu;var q=Ru}else(H=B.nodeName)&&H.toLowerCase()==="input"&&(B.type==="checkbox"||B.type==="radio")&&(J=Iu);if(J&&(J=J(t,N))){ql(D,J,n,O);break e}q&&q(t,B,N),t==="focusout"&&(q=B._wrapperState)&&q.controlled&&B.type==="number"&&Ti(B,"number",B.value)}switch(q=N?La(N):window,t){case"focusin":(Kl(q)||q.contentEditable==="true")&&(za=q,ns=N,Tn=null);break;case"focusout":Tn=ns=za=null;break;case"mousedown":rs=!0;break;case"contextmenu":case"mouseup":case"dragend":rs=!1,ic(D,n,O);break;case"selectionchange":if(Ou)break;case"keydown":case"keyup":ic(D,n,O)}var Q;if(Zi)e:{switch(t){case"compositionstart":var ee="onCompositionStart";break e;case"compositionend":ee="onCompositionEnd";break e;case"compositionupdate":ee="onCompositionUpdate";break e}ee=void 0}else Ma?Jl(t,n)&&(ee="onCompositionEnd"):t==="keydown"&&n.keyCode===229&&(ee="onCompositionStart");ee&&($l&&n.locale!=="ko"&&(Ma||ee!=="onCompositionStart"?ee==="onCompositionEnd"&&Ma&&(Q=Ll()):(Gt=O,Ji="value"in Gt?Gt.value:Gt.textContent,Ma=!0)),q=kr(N,ee),0<q.length&&(ee=new Ul(ee,t,null,n,O),D.push({event:ee,listeners:q}),Q?ee.data=Q:(Q=Vl(n),Q!==null&&(ee.data=Q)))),(Q=Cu?Au(t,n):ku(t,n))&&(N=kr(N,"onBeforeInput"),0<N.length&&(O=new Ul("onBeforeInput","beforeinput",null,n,O),D.push({event:O,listeners:N}),O.data=Q))}fc(D,a)})}function Pn(t,a,n){return{instance:t,listener:a,currentTarget:n}}function kr(t,a){for(var n=a+"Capture",i=[];t!==null;){var l=t,d=l.stateNode;l.tag===5&&d!==null&&(l=d,d=mn(t,n),d!=null&&i.unshift(Pn(t,d,l)),d=mn(t,a),d!=null&&i.push(Pn(t,d,l))),t=t.return}return i}function Da(t){if(t===null)return null;do t=t.return;while(t&&t.tag!==5);return t||null}function gc(t,a,n,i,l){for(var d=a._reactName,f=[];n!==null&&n!==i;){var j=n,S=j.alternate,N=j.stateNode;if(S!==null&&S===i)break;j.tag===5&&N!==null&&(j=N,l?(S=mn(n,d),S!=null&&f.unshift(Pn(n,S,j))):l||(S=mn(n,d),S!=null&&f.push(Pn(n,S,j)))),n=n.return}f.length!==0&&t.push({event:a,listeners:f})}var Hu=/\r\n?/g,Fu=/\u0000|\uFFFD/g;function xc(t){return(typeof t=="string"?t:""+t).replace(Hu,`
`).replace(Fu,"")}function Nr(t,a,n){if(a=xc(a),xc(t)!==a&&n)throw Error(o(425))}function Tr(){}var ds=null,ps=null;function ms(t,a){return t==="textarea"||t==="noscript"||typeof a.children=="string"||typeof a.children=="number"||typeof a.dangerouslySetInnerHTML=="object"&&a.dangerouslySetInnerHTML!==null&&a.dangerouslySetInnerHTML.__html!=null}var us=typeof setTimeout=="function"?setTimeout:void 0,Uu=typeof clearTimeout=="function"?clearTimeout:void 0,bc=typeof Promise=="function"?Promise:void 0,_u=typeof queueMicrotask=="function"?queueMicrotask:typeof bc<"u"?function(t){return bc.resolve(null).then(t).catch($u)}:us;function $u(t){setTimeout(function(){throw t})}function fs(t,a){var n=a,i=0;do{var l=n.nextSibling;if(t.removeChild(n),l&&l.nodeType===8)if(n=l.data,n==="/$"){if(i===0){t.removeChild(l),jn(a);return}i--}else n!=="$"&&n!=="$?"&&n!=="$!"||i++;n=l}while(n);jn(a)}function Jt(t){for(;t!=null;t=t.nextSibling){var a=t.nodeType;if(a===1||a===3)break;if(a===8){if(a=t.data,a==="$"||a==="$!"||a==="$?")break;if(a==="/$")return null}}return t}function yc(t){t=t.previousSibling;for(var a=0;t;){if(t.nodeType===8){var n=t.data;if(n==="$"||n==="$!"||n==="$?"){if(a===0)return t;a--}else n==="/$"&&a++}t=t.previousSibling}return null}var Wa=Math.random().toString(36).slice(2),At="__reactFiber$"+Wa,In="__reactProps$"+Wa,Pt="__reactContainer$"+Wa,hs="__reactEvents$"+Wa,Gu="__reactListeners$"+Wa,Yu="__reactHandles$"+Wa;function ma(t){var a=t[At];if(a)return a;for(var n=t.parentNode;n;){if(a=n[Pt]||n[At]){if(n=a.alternate,a.child!==null||n!==null&&n.child!==null)for(t=yc(t);t!==null;){if(n=t[At])return n;t=yc(t)}return a}t=n,n=t.parentNode}return null}function Bn(t){return t=t[At]||t[Pt],!t||t.tag!==5&&t.tag!==6&&t.tag!==13&&t.tag!==3?null:t}function La(t){if(t.tag===5||t.tag===6)return t.stateNode;throw Error(o(33))}function Er(t){return t[In]||null}var gs=[],Ha=-1;function Vt(t){return{current:t}}function he(t){0>Ha||(t.current=gs[Ha],gs[Ha]=null,Ha--)}function ue(t,a){Ha++,gs[Ha]=t.current,t.current=a}var Kt={},We=Vt(Kt),Ye=Vt(!1),ua=Kt;function Fa(t,a){var n=t.type.contextTypes;if(!n)return Kt;var i=t.stateNode;if(i&&i.__reactInternalMemoizedUnmaskedChildContext===a)return i.__reactInternalMemoizedMaskedChildContext;var l={},d;for(d in n)l[d]=a[d];return i&&(t=t.stateNode,t.__reactInternalMemoizedUnmaskedChildContext=a,t.__reactInternalMemoizedMaskedChildContext=l),l}function Je(t){return t=t.childContextTypes,t!=null}function Rr(){he(Ye),he(We)}function vc(t,a,n){if(We.current!==Kt)throw Error(o(168));ue(We,a),ue(Ye,n)}function jc(t,a,n){var i=t.stateNode;if(a=a.childContextTypes,typeof i.getChildContext!="function")return n;i=i.getChildContext();for(var l in i)if(!(l in a))throw Error(o(108,me(t)||"Unknown",l));return $({},n,i)}function Pr(t){return t=(t=t.stateNode)&&t.__reactInternalMemoizedMergedChildContext||Kt,ua=We.current,ue(We,t),ue(Ye,Ye.current),!0}function Sc(t,a,n){var i=t.stateNode;if(!i)throw Error(o(169));n?(t=jc(t,a,ua),i.__reactInternalMemoizedMergedChildContext=t,he(Ye),he(We),ue(We,t)):he(Ye),ue(Ye,n)}var It=null,Ir=!1,xs=!1;function wc(t){It===null?It=[t]:It.push(t)}function Ju(t){Ir=!0,wc(t)}function qt(){if(!xs&&It!==null){xs=!0;var t=0,a=pe;try{var n=It;for(pe=1;t<n.length;t++){var i=n[t];do i=i(!0);while(i!==null)}It=null,Ir=!1}catch(l){throw It!==null&&(It=It.slice(t+1)),Al(Li,qt),l}finally{pe=a,xs=!1}}return null}var Ua=[],_a=0,Br=null,Mr=0,rt=[],it=0,fa=null,Bt=1,Mt="";function ha(t,a){Ua[_a++]=Mr,Ua[_a++]=Br,Br=t,Mr=a}function Cc(t,a,n){rt[it++]=Bt,rt[it++]=Mt,rt[it++]=fa,fa=t;var i=Bt;t=Mt;var l=32-ut(i)-1;i&=~(1<<l),n+=1;var d=32-ut(a)+l;if(30<d){var f=l-l%5;d=(i&(1<<f)-1).toString(32),i>>=f,l-=f,Bt=1<<32-ut(a)+l|n<<l|i,Mt=d+t}else Bt=1<<d|n<<l|i,Mt=t}function bs(t){t.return!==null&&(ha(t,1),Cc(t,1,0))}function ys(t){for(;t===Br;)Br=Ua[--_a],Ua[_a]=null,Mr=Ua[--_a],Ua[_a]=null;for(;t===fa;)fa=rt[--it],rt[it]=null,Mt=rt[--it],rt[it]=null,Bt=rt[--it],rt[it]=null}var tt=null,at=null,be=!1,ht=null;function Ac(t,a){var n=ct(5,null,null,0);n.elementType="DELETED",n.stateNode=a,n.return=t,a=t.deletions,a===null?(t.deletions=[n],t.flags|=16):a.push(n)}function kc(t,a){switch(t.tag){case 5:var n=t.type;return a=a.nodeType!==1||n.toLowerCase()!==a.nodeName.toLowerCase()?null:a,a!==null?(t.stateNode=a,tt=t,at=Jt(a.firstChild),!0):!1;case 6:return a=t.pendingProps===""||a.nodeType!==3?null:a,a!==null?(t.stateNode=a,tt=t,at=null,!0):!1;case 13:return a=a.nodeType!==8?null:a,a!==null?(n=fa!==null?{id:Bt,overflow:Mt}:null,t.memoizedState={dehydrated:a,treeContext:n,retryLane:1073741824},n=ct(18,null,null,0),n.stateNode=a,n.return=t,t.child=n,tt=t,at=null,!0):!1;default:return!1}}function vs(t){return(t.mode&1)!==0&&(t.flags&128)===0}function js(t){if(be){var a=at;if(a){var n=a;if(!kc(t,a)){if(vs(t))throw Error(o(418));a=Jt(n.nextSibling);var i=tt;a&&kc(t,a)?Ac(i,n):(t.flags=t.flags&-4097|2,be=!1,tt=t)}}else{if(vs(t))throw Error(o(418));t.flags=t.flags&-4097|2,be=!1,tt=t}}}function Nc(t){for(t=t.return;t!==null&&t.tag!==5&&t.tag!==3&&t.tag!==13;)t=t.return;tt=t}function zr(t){if(t!==tt)return!1;if(!be)return Nc(t),be=!0,!1;var a;if((a=t.tag!==3)&&!(a=t.tag!==5)&&(a=t.type,a=a!=="head"&&a!=="body"&&!ms(t.type,t.memoizedProps)),a&&(a=at)){if(vs(t))throw Tc(),Error(o(418));for(;a;)Ac(t,a),a=Jt(a.nextSibling)}if(Nc(t),t.tag===13){if(t=t.memoizedState,t=t!==null?t.dehydrated:null,!t)throw Error(o(317));e:{for(t=t.nextSibling,a=0;t;){if(t.nodeType===8){var n=t.data;if(n==="/$"){if(a===0){at=Jt(t.nextSibling);break e}a--}else n!=="$"&&n!=="$!"&&n!=="$?"||a++}t=t.nextSibling}at=null}}else at=tt?Jt(t.stateNode.nextSibling):null;return!0}function Tc(){for(var t=at;t;)t=Jt(t.nextSibling)}function $a(){at=tt=null,be=!1}function Ss(t){ht===null?ht=[t]:ht.push(t)}var Vu=K.ReactCurrentBatchConfig;function Mn(t,a,n){if(t=n.ref,t!==null&&typeof t!="function"&&typeof t!="object"){if(n._owner){if(n=n._owner,n){if(n.tag!==1)throw Error(o(309));var i=n.stateNode}if(!i)throw Error(o(147,t));var l=i,d=""+t;return a!==null&&a.ref!==null&&typeof a.ref=="function"&&a.ref._stringRef===d?a.ref:(a=function(f){var j=l.refs;f===null?delete j[d]:j[d]=f},a._stringRef=d,a)}if(typeof t!="string")throw Error(o(284));if(!n._owner)throw Error(o(290,t))}return t}function Or(t,a){throw t=Object.prototype.toString.call(a),Error(o(31,t==="[object Object]"?"object with keys {"+Object.keys(a).join(", ")+"}":t))}function Ec(t){var a=t._init;return a(t._payload)}function Rc(t){function a(A,w){if(t){var k=A.deletions;k===null?(A.deletions=[w],A.flags|=16):k.push(w)}}function n(A,w){if(!t)return null;for(;w!==null;)a(A,w),w=w.sibling;return null}function i(A,w){for(A=new Map;w!==null;)w.key!==null?A.set(w.key,w):A.set(w.index,w),w=w.sibling;return A}function l(A,w){return A=ra(A,w),A.index=0,A.sibling=null,A}function d(A,w,k){return A.index=k,t?(k=A.alternate,k!==null?(k=k.index,k<w?(A.flags|=2,w):k):(A.flags|=2,w)):(A.flags|=1048576,w)}function f(A){return t&&A.alternate===null&&(A.flags|=2),A}function j(A,w,k,W){return w===null||w.tag!==6?(w=fo(k,A.mode,W),w.return=A,w):(w=l(w,k),w.return=A,w)}function S(A,w,k,W){var J=k.type;return J===ke?O(A,w,k.props.children,W,k.key):w!==null&&(w.elementType===J||typeof J=="object"&&J!==null&&J.$$typeof===Ge&&Ec(J)===w.type)?(W=l(w,k.props),W.ref=Mn(A,w,k),W.return=A,W):(W=si(k.type,k.key,k.props,null,A.mode,W),W.ref=Mn(A,w,k),W.return=A,W)}function N(A,w,k,W){return w===null||w.tag!==4||w.stateNode.containerInfo!==k.containerInfo||w.stateNode.implementation!==k.implementation?(w=ho(k,A.mode,W),w.return=A,w):(w=l(w,k.children||[]),w.return=A,w)}function O(A,w,k,W,J){return w===null||w.tag!==7?(w=wa(k,A.mode,W,J),w.return=A,w):(w=l(w,k),w.return=A,w)}function D(A,w,k){if(typeof w=="string"&&w!==""||typeof w=="number")return w=fo(""+w,A.mode,k),w.return=A,w;if(typeof w=="object"&&w!==null){switch(w.$$typeof){case V:return k=si(w.type,w.key,w.props,null,A.mode,k),k.ref=Mn(A,null,w),k.return=A,k;case te:return w=ho(w,A.mode,k),w.return=A,w;case Ge:var W=w._init;return D(A,W(w._payload),k)}if(cn(w)||X(w))return w=wa(w,A.mode,k,null),w.return=A,w;Or(A,w)}return null}function B(A,w,k,W){var J=w!==null?w.key:null;if(typeof k=="string"&&k!==""||typeof k=="number")return J!==null?null:j(A,w,""+k,W);if(typeof k=="object"&&k!==null){switch(k.$$typeof){case V:return k.key===J?S(A,w,k,W):null;case te:return k.key===J?N(A,w,k,W):null;case Ge:return J=k._init,B(A,w,J(k._payload),W)}if(cn(k)||X(k))return J!==null?null:O(A,w,k,W,null);Or(A,k)}return null}function H(A,w,k,W,J){if(typeof W=="string"&&W!==""||typeof W=="number")return A=A.get(k)||null,j(w,A,""+W,J);if(typeof W=="object"&&W!==null){switch(W.$$typeof){case V:return A=A.get(W.key===null?k:W.key)||null,S(w,A,W,J);case te:return A=A.get(W.key===null?k:W.key)||null,N(w,A,W,J);case Ge:var q=W._init;return H(A,w,k,q(W._payload),J)}if(cn(W)||X(W))return A=A.get(k)||null,O(w,A,W,J,null);Or(w,W)}return null}function G(A,w,k,W){for(var J=null,q=null,Q=w,ee=w=0,Me=null;Q!==null&&ee<k.length;ee++){Q.index>ee?(Me=Q,Q=null):Me=Q.sibling;var le=B(A,Q,k[ee],W);if(le===null){Q===null&&(Q=Me);break}t&&Q&&le.alternate===null&&a(A,Q),w=d(le,w,ee),q===null?J=le:q.sibling=le,q=le,Q=Me}if(ee===k.length)return n(A,Q),be&&ha(A,ee),J;if(Q===null){for(;ee<k.length;ee++)Q=D(A,k[ee],W),Q!==null&&(w=d(Q,w,ee),q===null?J=Q:q.sibling=Q,q=Q);return be&&ha(A,ee),J}for(Q=i(A,Q);ee<k.length;ee++)Me=H(Q,A,ee,k[ee],W),Me!==null&&(t&&Me.alternate!==null&&Q.delete(Me.key===null?ee:Me.key),w=d(Me,w,ee),q===null?J=Me:q.sibling=Me,q=Me);return t&&Q.forEach(function(ia){return a(A,ia)}),be&&ha(A,ee),J}function Y(A,w,k,W){var J=X(k);if(typeof J!="function")throw Error(o(150));if(k=J.call(k),k==null)throw Error(o(151));for(var q=J=null,Q=w,ee=w=0,Me=null,le=k.next();Q!==null&&!le.done;ee++,le=k.next()){Q.index>ee?(Me=Q,Q=null):Me=Q.sibling;var ia=B(A,Q,le.value,W);if(ia===null){Q===null&&(Q=Me);break}t&&Q&&ia.alternate===null&&a(A,Q),w=d(ia,w,ee),q===null?J=ia:q.sibling=ia,q=ia,Q=Me}if(le.done)return n(A,Q),be&&ha(A,ee),J;if(Q===null){for(;!le.done;ee++,le=k.next())le=D(A,le.value,W),le!==null&&(w=d(le,w,ee),q===null?J=le:q.sibling=le,q=le);return be&&ha(A,ee),J}for(Q=i(A,Q);!le.done;ee++,le=k.next())le=H(Q,A,ee,le.value,W),le!==null&&(t&&le.alternate!==null&&Q.delete(le.key===null?ee:le.key),w=d(le,w,ee),q===null?J=le:q.sibling=le,q=le);return t&&Q.forEach(function(Tf){return a(A,Tf)}),be&&ha(A,ee),J}function Ae(A,w,k,W){if(typeof k=="object"&&k!==null&&k.type===ke&&k.key===null&&(k=k.props.children),typeof k=="object"&&k!==null){switch(k.$$typeof){case V:e:{for(var J=k.key,q=w;q!==null;){if(q.key===J){if(J=k.type,J===ke){if(q.tag===7){n(A,q.sibling),w=l(q,k.props.children),w.return=A,A=w;break e}}else if(q.elementType===J||typeof J=="object"&&J!==null&&J.$$typeof===Ge&&Ec(J)===q.type){n(A,q.sibling),w=l(q,k.props),w.ref=Mn(A,q,k),w.return=A,A=w;break e}n(A,q);break}else a(A,q);q=q.sibling}k.type===ke?(w=wa(k.props.children,A.mode,W,k.key),w.return=A,A=w):(W=si(k.type,k.key,k.props,null,A.mode,W),W.ref=Mn(A,w,k),W.return=A,A=W)}return f(A);case te:e:{for(q=k.key;w!==null;){if(w.key===q)if(w.tag===4&&w.stateNode.containerInfo===k.containerInfo&&w.stateNode.implementation===k.implementation){n(A,w.sibling),w=l(w,k.children||[]),w.return=A,A=w;break e}else{n(A,w);break}else a(A,w);w=w.sibling}w=ho(k,A.mode,W),w.return=A,A=w}return f(A);case Ge:return q=k._init,Ae(A,w,q(k._payload),W)}if(cn(k))return G(A,w,k,W);if(X(k))return Y(A,w,k,W);Or(A,k)}return typeof k=="string"&&k!==""||typeof k=="number"?(k=""+k,w!==null&&w.tag===6?(n(A,w.sibling),w=l(w,k),w.return=A,A=w):(n(A,w),w=fo(k,A.mode,W),w.return=A,A=w),f(A)):n(A,w)}return Ae}var Ga=Rc(!0),Pc=Rc(!1),Dr=Vt(null),Wr=null,Ya=null,ws=null;function Cs(){ws=Ya=Wr=null}function As(t){var a=Dr.current;he(Dr),t._currentValue=a}function ks(t,a,n){for(;t!==null;){var i=t.alternate;if((t.childLanes&a)!==a?(t.childLanes|=a,i!==null&&(i.childLanes|=a)):i!==null&&(i.childLanes&a)!==a&&(i.childLanes|=a),t===n)break;t=t.return}}function Ja(t,a){Wr=t,ws=Ya=null,t=t.dependencies,t!==null&&t.firstContext!==null&&((t.lanes&a)!==0&&(Ve=!0),t.firstContext=null)}function st(t){var a=t._currentValue;if(ws!==t)if(t={context:t,memoizedValue:a,next:null},Ya===null){if(Wr===null)throw Error(o(308));Ya=t,Wr.dependencies={lanes:0,firstContext:t}}else Ya=Ya.next=t;return a}var ga=null;function Ns(t){ga===null?ga=[t]:ga.push(t)}function Ic(t,a,n,i){var l=a.interleaved;return l===null?(n.next=n,Ns(a)):(n.next=l.next,l.next=n),a.interleaved=n,zt(t,i)}function zt(t,a){t.lanes|=a;var n=t.alternate;for(n!==null&&(n.lanes|=a),n=t,t=t.return;t!==null;)t.childLanes|=a,n=t.alternate,n!==null&&(n.childLanes|=a),n=t,t=t.return;return n.tag===3?n.stateNode:null}var Qt=!1;function Ts(t){t.updateQueue={baseState:t.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function Bc(t,a){t=t.updateQueue,a.updateQueue===t&&(a.updateQueue={baseState:t.baseState,firstBaseUpdate:t.firstBaseUpdate,lastBaseUpdate:t.lastBaseUpdate,shared:t.shared,effects:t.effects})}function Ot(t,a){return{eventTime:t,lane:a,tag:0,payload:null,callback:null,next:null}}function Xt(t,a,n){var i=t.updateQueue;if(i===null)return null;if(i=i.shared,(ie&2)!==0){var l=i.pending;return l===null?a.next=a:(a.next=l.next,l.next=a),i.pending=a,zt(t,n)}return l=i.interleaved,l===null?(a.next=a,Ns(i)):(a.next=l.next,l.next=a),i.interleaved=a,zt(t,n)}function Lr(t,a,n){if(a=a.updateQueue,a!==null&&(a=a.shared,(n&4194240)!==0)){var i=a.lanes;i&=t.pendingLanes,n|=i,a.lanes=n,Ui(t,n)}}function Mc(t,a){var n=t.updateQueue,i=t.alternate;if(i!==null&&(i=i.updateQueue,n===i)){var l=null,d=null;if(n=n.firstBaseUpdate,n!==null){do{var f={eventTime:n.eventTime,lane:n.lane,tag:n.tag,payload:n.payload,callback:n.callback,next:null};d===null?l=d=f:d=d.next=f,n=n.next}while(n!==null);d===null?l=d=a:d=d.next=a}else l=d=a;n={baseState:i.baseState,firstBaseUpdate:l,lastBaseUpdate:d,shared:i.shared,effects:i.effects},t.updateQueue=n;return}t=n.lastBaseUpdate,t===null?n.firstBaseUpdate=a:t.next=a,n.lastBaseUpdate=a}function Hr(t,a,n,i){var l=t.updateQueue;Qt=!1;var d=l.firstBaseUpdate,f=l.lastBaseUpdate,j=l.shared.pending;if(j!==null){l.shared.pending=null;var S=j,N=S.next;S.next=null,f===null?d=N:f.next=N,f=S;var O=t.alternate;O!==null&&(O=O.updateQueue,j=O.lastBaseUpdate,j!==f&&(j===null?O.firstBaseUpdate=N:j.next=N,O.lastBaseUpdate=S))}if(d!==null){var D=l.baseState;f=0,O=N=S=null,j=d;do{var B=j.lane,H=j.eventTime;if((i&B)===B){O!==null&&(O=O.next={eventTime:H,lane:0,tag:j.tag,payload:j.payload,callback:j.callback,next:null});e:{var G=t,Y=j;switch(B=a,H=n,Y.tag){case 1:if(G=Y.payload,typeof G=="function"){D=G.call(H,D,B);break e}D=G;break e;case 3:G.flags=G.flags&-65537|128;case 0:if(G=Y.payload,B=typeof G=="function"?G.call(H,D,B):G,B==null)break e;D=$({},D,B);break e;case 2:Qt=!0}}j.callback!==null&&j.lane!==0&&(t.flags|=64,B=l.effects,B===null?l.effects=[j]:B.push(j))}else H={eventTime:H,lane:B,tag:j.tag,payload:j.payload,callback:j.callback,next:null},O===null?(N=O=H,S=D):O=O.next=H,f|=B;if(j=j.next,j===null){if(j=l.shared.pending,j===null)break;B=j,j=B.next,B.next=null,l.lastBaseUpdate=B,l.shared.pending=null}}while(!0);if(O===null&&(S=D),l.baseState=S,l.firstBaseUpdate=N,l.lastBaseUpdate=O,a=l.shared.interleaved,a!==null){l=a;do f|=l.lane,l=l.next;while(l!==a)}else d===null&&(l.shared.lanes=0);ya|=f,t.lanes=f,t.memoizedState=D}}function zc(t,a,n){if(t=a.effects,a.effects=null,t!==null)for(a=0;a<t.length;a++){var i=t[a],l=i.callback;if(l!==null){if(i.callback=null,i=n,typeof l!="function")throw Error(o(191,l));l.call(i)}}}var zn={},kt=Vt(zn),On=Vt(zn),Dn=Vt(zn);function xa(t){if(t===zn)throw Error(o(174));return t}function Es(t,a){switch(ue(Dn,a),ue(On,t),ue(kt,zn),t=a.nodeType,t){case 9:case 11:a=(a=a.documentElement)?a.namespaceURI:Ri(null,"");break;default:t=t===8?a.parentNode:a,a=t.namespaceURI||null,t=t.tagName,a=Ri(a,t)}he(kt),ue(kt,a)}function Va(){he(kt),he(On),he(Dn)}function Oc(t){xa(Dn.current);var a=xa(kt.current),n=Ri(a,t.type);a!==n&&(ue(On,t),ue(kt,n))}function Rs(t){On.current===t&&(he(kt),he(On))}var ye=Vt(0);function Fr(t){for(var a=t;a!==null;){if(a.tag===13){var n=a.memoizedState;if(n!==null&&(n=n.dehydrated,n===null||n.data==="$?"||n.data==="$!"))return a}else if(a.tag===19&&a.memoizedProps.revealOrder!==void 0){if((a.flags&128)!==0)return a}else if(a.child!==null){a.child.return=a,a=a.child;continue}if(a===t)break;for(;a.sibling===null;){if(a.return===null||a.return===t)return null;a=a.return}a.sibling.return=a.return,a=a.sibling}return null}var Ps=[];function Is(){for(var t=0;t<Ps.length;t++)Ps[t]._workInProgressVersionPrimary=null;Ps.length=0}var Ur=K.ReactCurrentDispatcher,Bs=K.ReactCurrentBatchConfig,ba=0,ve=null,Ee=null,Ie=null,_r=!1,Wn=!1,Ln=0,Ku=0;function Le(){throw Error(o(321))}function Ms(t,a){if(a===null)return!1;for(var n=0;n<a.length&&n<t.length;n++)if(!ft(t[n],a[n]))return!1;return!0}function zs(t,a,n,i,l,d){if(ba=d,ve=a,a.memoizedState=null,a.updateQueue=null,a.lanes=0,Ur.current=t===null||t.memoizedState===null?Zu:ef,t=n(i,l),Wn){d=0;do{if(Wn=!1,Ln=0,25<=d)throw Error(o(301));d+=1,Ie=Ee=null,a.updateQueue=null,Ur.current=tf,t=n(i,l)}while(Wn)}if(Ur.current=Yr,a=Ee!==null&&Ee.next!==null,ba=0,Ie=Ee=ve=null,_r=!1,a)throw Error(o(300));return t}function Os(){var t=Ln!==0;return Ln=0,t}function Nt(){var t={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return Ie===null?ve.memoizedState=Ie=t:Ie=Ie.next=t,Ie}function ot(){if(Ee===null){var t=ve.alternate;t=t!==null?t.memoizedState:null}else t=Ee.next;var a=Ie===null?ve.memoizedState:Ie.next;if(a!==null)Ie=a,Ee=t;else{if(t===null)throw Error(o(310));Ee=t,t={memoizedState:Ee.memoizedState,baseState:Ee.baseState,baseQueue:Ee.baseQueue,queue:Ee.queue,next:null},Ie===null?ve.memoizedState=Ie=t:Ie=Ie.next=t}return Ie}function Hn(t,a){return typeof a=="function"?a(t):a}function Ds(t){var a=ot(),n=a.queue;if(n===null)throw Error(o(311));n.lastRenderedReducer=t;var i=Ee,l=i.baseQueue,d=n.pending;if(d!==null){if(l!==null){var f=l.next;l.next=d.next,d.next=f}i.baseQueue=l=d,n.pending=null}if(l!==null){d=l.next,i=i.baseState;var j=f=null,S=null,N=d;do{var O=N.lane;if((ba&O)===O)S!==null&&(S=S.next={lane:0,action:N.action,hasEagerState:N.hasEagerState,eagerState:N.eagerState,next:null}),i=N.hasEagerState?N.eagerState:t(i,N.action);else{var D={lane:O,action:N.action,hasEagerState:N.hasEagerState,eagerState:N.eagerState,next:null};S===null?(j=S=D,f=i):S=S.next=D,ve.lanes|=O,ya|=O}N=N.next}while(N!==null&&N!==d);S===null?f=i:S.next=j,ft(i,a.memoizedState)||(Ve=!0),a.memoizedState=i,a.baseState=f,a.baseQueue=S,n.lastRenderedState=i}if(t=n.interleaved,t!==null){l=t;do d=l.lane,ve.lanes|=d,ya|=d,l=l.next;while(l!==t)}else l===null&&(n.lanes=0);return[a.memoizedState,n.dispatch]}function Ws(t){var a=ot(),n=a.queue;if(n===null)throw Error(o(311));n.lastRenderedReducer=t;var i=n.dispatch,l=n.pending,d=a.memoizedState;if(l!==null){n.pending=null;var f=l=l.next;do d=t(d,f.action),f=f.next;while(f!==l);ft(d,a.memoizedState)||(Ve=!0),a.memoizedState=d,a.baseQueue===null&&(a.baseState=d),n.lastRenderedState=d}return[d,i]}function Dc(){}function Wc(t,a){var n=ve,i=ot(),l=a(),d=!ft(i.memoizedState,l);if(d&&(i.memoizedState=l,Ve=!0),i=i.queue,Ls(Fc.bind(null,n,i,t),[t]),i.getSnapshot!==a||d||Ie!==null&&Ie.memoizedState.tag&1){if(n.flags|=2048,Fn(9,Hc.bind(null,n,i,l,a),void 0,null),Be===null)throw Error(o(349));(ba&30)!==0||Lc(n,a,l)}return l}function Lc(t,a,n){t.flags|=16384,t={getSnapshot:a,value:n},a=ve.updateQueue,a===null?(a={lastEffect:null,stores:null},ve.updateQueue=a,a.stores=[t]):(n=a.stores,n===null?a.stores=[t]:n.push(t))}function Hc(t,a,n,i){a.value=n,a.getSnapshot=i,Uc(a)&&_c(t)}function Fc(t,a,n){return n(function(){Uc(a)&&_c(t)})}function Uc(t){var a=t.getSnapshot;t=t.value;try{var n=a();return!ft(t,n)}catch{return!0}}function _c(t){var a=zt(t,1);a!==null&&yt(a,t,1,-1)}function $c(t){var a=Nt();return typeof t=="function"&&(t=t()),a.memoizedState=a.baseState=t,t={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Hn,lastRenderedState:t},a.queue=t,t=t.dispatch=Xu.bind(null,ve,t),[a.memoizedState,t]}function Fn(t,a,n,i){return t={tag:t,create:a,destroy:n,deps:i,next:null},a=ve.updateQueue,a===null?(a={lastEffect:null,stores:null},ve.updateQueue=a,a.lastEffect=t.next=t):(n=a.lastEffect,n===null?a.lastEffect=t.next=t:(i=n.next,n.next=t,t.next=i,a.lastEffect=t)),t}function Gc(){return ot().memoizedState}function $r(t,a,n,i){var l=Nt();ve.flags|=t,l.memoizedState=Fn(1|a,n,void 0,i===void 0?null:i)}function Gr(t,a,n,i){var l=ot();i=i===void 0?null:i;var d=void 0;if(Ee!==null){var f=Ee.memoizedState;if(d=f.destroy,i!==null&&Ms(i,f.deps)){l.memoizedState=Fn(a,n,d,i);return}}ve.flags|=t,l.memoizedState=Fn(1|a,n,d,i)}function Yc(t,a){return $r(8390656,8,t,a)}function Ls(t,a){return Gr(2048,8,t,a)}function Jc(t,a){return Gr(4,2,t,a)}function Vc(t,a){return Gr(4,4,t,a)}function Kc(t,a){if(typeof a=="function")return t=t(),a(t),function(){a(null)};if(a!=null)return t=t(),a.current=t,function(){a.current=null}}function qc(t,a,n){return n=n!=null?n.concat([t]):null,Gr(4,4,Kc.bind(null,a,t),n)}function Hs(){}function Qc(t,a){var n=ot();a=a===void 0?null:a;var i=n.memoizedState;return i!==null&&a!==null&&Ms(a,i[1])?i[0]:(n.memoizedState=[t,a],t)}function Xc(t,a){var n=ot();a=a===void 0?null:a;var i=n.memoizedState;return i!==null&&a!==null&&Ms(a,i[1])?i[0]:(t=t(),n.memoizedState=[t,a],t)}function Zc(t,a,n){return(ba&21)===0?(t.baseState&&(t.baseState=!1,Ve=!0),t.memoizedState=n):(ft(n,a)||(n=El(),ve.lanes|=n,ya|=n,t.baseState=!0),a)}function qu(t,a){var n=pe;pe=n!==0&&4>n?n:4,t(!0);var i=Bs.transition;Bs.transition={};try{t(!1),a()}finally{pe=n,Bs.transition=i}}function ed(){return ot().memoizedState}function Qu(t,a,n){var i=aa(t);if(n={lane:i,action:n,hasEagerState:!1,eagerState:null,next:null},td(t))ad(a,n);else if(n=Ic(t,a,n,i),n!==null){var l=_e();yt(n,t,i,l),nd(n,a,i)}}function Xu(t,a,n){var i=aa(t),l={lane:i,action:n,hasEagerState:!1,eagerState:null,next:null};if(td(t))ad(a,l);else{var d=t.alternate;if(t.lanes===0&&(d===null||d.lanes===0)&&(d=a.lastRenderedReducer,d!==null))try{var f=a.lastRenderedState,j=d(f,n);if(l.hasEagerState=!0,l.eagerState=j,ft(j,f)){var S=a.interleaved;S===null?(l.next=l,Ns(a)):(l.next=S.next,S.next=l),a.interleaved=l;return}}catch{}finally{}n=Ic(t,a,l,i),n!==null&&(l=_e(),yt(n,t,i,l),nd(n,a,i))}}function td(t){var a=t.alternate;return t===ve||a!==null&&a===ve}function ad(t,a){Wn=_r=!0;var n=t.pending;n===null?a.next=a:(a.next=n.next,n.next=a),t.pending=a}function nd(t,a,n){if((n&4194240)!==0){var i=a.lanes;i&=t.pendingLanes,n|=i,a.lanes=n,Ui(t,n)}}var Yr={readContext:st,useCallback:Le,useContext:Le,useEffect:Le,useImperativeHandle:Le,useInsertionEffect:Le,useLayoutEffect:Le,useMemo:Le,useReducer:Le,useRef:Le,useState:Le,useDebugValue:Le,useDeferredValue:Le,useTransition:Le,useMutableSource:Le,useSyncExternalStore:Le,useId:Le,unstable_isNewReconciler:!1},Zu={readContext:st,useCallback:function(t,a){return Nt().memoizedState=[t,a===void 0?null:a],t},useContext:st,useEffect:Yc,useImperativeHandle:function(t,a,n){return n=n!=null?n.concat([t]):null,$r(4194308,4,Kc.bind(null,a,t),n)},useLayoutEffect:function(t,a){return $r(4194308,4,t,a)},useInsertionEffect:function(t,a){return $r(4,2,t,a)},useMemo:function(t,a){var n=Nt();return a=a===void 0?null:a,t=t(),n.memoizedState=[t,a],t},useReducer:function(t,a,n){var i=Nt();return a=n!==void 0?n(a):a,i.memoizedState=i.baseState=a,t={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:t,lastRenderedState:a},i.queue=t,t=t.dispatch=Qu.bind(null,ve,t),[i.memoizedState,t]},useRef:function(t){var a=Nt();return t={current:t},a.memoizedState=t},useState:$c,useDebugValue:Hs,useDeferredValue:function(t){return Nt().memoizedState=t},useTransition:function(){var t=$c(!1),a=t[0];return t=qu.bind(null,t[1]),Nt().memoizedState=t,[a,t]},useMutableSource:function(){},useSyncExternalStore:function(t,a,n){var i=ve,l=Nt();if(be){if(n===void 0)throw Error(o(407));n=n()}else{if(n=a(),Be===null)throw Error(o(349));(ba&30)!==0||Lc(i,a,n)}l.memoizedState=n;var d={value:n,getSnapshot:a};return l.queue=d,Yc(Fc.bind(null,i,d,t),[t]),i.flags|=2048,Fn(9,Hc.bind(null,i,d,n,a),void 0,null),n},useId:function(){var t=Nt(),a=Be.identifierPrefix;if(be){var n=Mt,i=Bt;n=(i&~(1<<32-ut(i)-1)).toString(32)+n,a=":"+a+"R"+n,n=Ln++,0<n&&(a+="H"+n.toString(32)),a+=":"}else n=Ku++,a=":"+a+"r"+n.toString(32)+":";return t.memoizedState=a},unstable_isNewReconciler:!1},ef={readContext:st,useCallback:Qc,useContext:st,useEffect:Ls,useImperativeHandle:qc,useInsertionEffect:Jc,useLayoutEffect:Vc,useMemo:Xc,useReducer:Ds,useRef:Gc,useState:function(){return Ds(Hn)},useDebugValue:Hs,useDeferredValue:function(t){var a=ot();return Zc(a,Ee.memoizedState,t)},useTransition:function(){var t=Ds(Hn)[0],a=ot().memoizedState;return[t,a]},useMutableSource:Dc,useSyncExternalStore:Wc,useId:ed,unstable_isNewReconciler:!1},tf={readContext:st,useCallback:Qc,useContext:st,useEffect:Ls,useImperativeHandle:qc,useInsertionEffect:Jc,useLayoutEffect:Vc,useMemo:Xc,useReducer:Ws,useRef:Gc,useState:function(){return Ws(Hn)},useDebugValue:Hs,useDeferredValue:function(t){var a=ot();return Ee===null?a.memoizedState=t:Zc(a,Ee.memoizedState,t)},useTransition:function(){var t=Ws(Hn)[0],a=ot().memoizedState;return[t,a]},useMutableSource:Dc,useSyncExternalStore:Wc,useId:ed,unstable_isNewReconciler:!1};function gt(t,a){if(t&&t.defaultProps){a=$({},a),t=t.defaultProps;for(var n in t)a[n]===void 0&&(a[n]=t[n]);return a}return a}function Fs(t,a,n,i){a=t.memoizedState,n=n(i,a),n=n==null?a:$({},a,n),t.memoizedState=n,t.lanes===0&&(t.updateQueue.baseState=n)}var Jr={isMounted:function(t){return(t=t._reactInternals)?pa(t)===t:!1},enqueueSetState:function(t,a,n){t=t._reactInternals;var i=_e(),l=aa(t),d=Ot(i,l);d.payload=a,n!=null&&(d.callback=n),a=Xt(t,d,l),a!==null&&(yt(a,t,l,i),Lr(a,t,l))},enqueueReplaceState:function(t,a,n){t=t._reactInternals;var i=_e(),l=aa(t),d=Ot(i,l);d.tag=1,d.payload=a,n!=null&&(d.callback=n),a=Xt(t,d,l),a!==null&&(yt(a,t,l,i),Lr(a,t,l))},enqueueForceUpdate:function(t,a){t=t._reactInternals;var n=_e(),i=aa(t),l=Ot(n,i);l.tag=2,a!=null&&(l.callback=a),a=Xt(t,l,i),a!==null&&(yt(a,t,i,n),Lr(a,t,i))}};function rd(t,a,n,i,l,d,f){return t=t.stateNode,typeof t.shouldComponentUpdate=="function"?t.shouldComponentUpdate(i,d,f):a.prototype&&a.prototype.isPureReactComponent?!Nn(n,i)||!Nn(l,d):!0}function id(t,a,n){var i=!1,l=Kt,d=a.contextType;return typeof d=="object"&&d!==null?d=st(d):(l=Je(a)?ua:We.current,i=a.contextTypes,d=(i=i!=null)?Fa(t,l):Kt),a=new a(n,d),t.memoizedState=a.state!==null&&a.state!==void 0?a.state:null,a.updater=Jr,t.stateNode=a,a._reactInternals=t,i&&(t=t.stateNode,t.__reactInternalMemoizedUnmaskedChildContext=l,t.__reactInternalMemoizedMaskedChildContext=d),a}function sd(t,a,n,i){t=a.state,typeof a.componentWillReceiveProps=="function"&&a.componentWillReceiveProps(n,i),typeof a.UNSAFE_componentWillReceiveProps=="function"&&a.UNSAFE_componentWillReceiveProps(n,i),a.state!==t&&Jr.enqueueReplaceState(a,a.state,null)}function Us(t,a,n,i){var l=t.stateNode;l.props=n,l.state=t.memoizedState,l.refs={},Ts(t);var d=a.contextType;typeof d=="object"&&d!==null?l.context=st(d):(d=Je(a)?ua:We.current,l.context=Fa(t,d)),l.state=t.memoizedState,d=a.getDerivedStateFromProps,typeof d=="function"&&(Fs(t,a,d,n),l.state=t.memoizedState),typeof a.getDerivedStateFromProps=="function"||typeof l.getSnapshotBeforeUpdate=="function"||typeof l.UNSAFE_componentWillMount!="function"&&typeof l.componentWillMount!="function"||(a=l.state,typeof l.componentWillMount=="function"&&l.componentWillMount(),typeof l.UNSAFE_componentWillMount=="function"&&l.UNSAFE_componentWillMount(),a!==l.state&&Jr.enqueueReplaceState(l,l.state,null),Hr(t,n,l,i),l.state=t.memoizedState),typeof l.componentDidMount=="function"&&(t.flags|=4194308)}function Ka(t,a){try{var n="",i=a;do n+=se(i),i=i.return;while(i);var l=n}catch(d){l=`
Error generating stack: `+d.message+`
`+d.stack}return{value:t,source:a,stack:l,digest:null}}function _s(t,a,n){return{value:t,source:null,stack:n??null,digest:a??null}}function $s(t,a){try{console.error(a.value)}catch(n){setTimeout(function(){throw n})}}var af=typeof WeakMap=="function"?WeakMap:Map;function od(t,a,n){n=Ot(-1,n),n.tag=3,n.payload={element:null};var i=a.value;return n.callback=function(){ei||(ei=!0,io=i),$s(t,a)},n}function ld(t,a,n){n=Ot(-1,n),n.tag=3;var i=t.type.getDerivedStateFromError;if(typeof i=="function"){var l=a.value;n.payload=function(){return i(l)},n.callback=function(){$s(t,a)}}var d=t.stateNode;return d!==null&&typeof d.componentDidCatch=="function"&&(n.callback=function(){$s(t,a),typeof i!="function"&&(ea===null?ea=new Set([this]):ea.add(this));var f=a.stack;this.componentDidCatch(a.value,{componentStack:f!==null?f:""})}),n}function cd(t,a,n){var i=t.pingCache;if(i===null){i=t.pingCache=new af;var l=new Set;i.set(a,l)}else l=i.get(a),l===void 0&&(l=new Set,i.set(a,l));l.has(n)||(l.add(n),t=xf.bind(null,t,a,n),a.then(t,t))}function dd(t){do{var a;if((a=t.tag===13)&&(a=t.memoizedState,a=a!==null?a.dehydrated!==null:!0),a)return t;t=t.return}while(t!==null);return null}function pd(t,a,n,i,l){return(t.mode&1)===0?(t===a?t.flags|=65536:(t.flags|=128,n.flags|=131072,n.flags&=-52805,n.tag===1&&(n.alternate===null?n.tag=17:(a=Ot(-1,1),a.tag=2,Xt(n,a,1))),n.lanes|=1),t):(t.flags|=65536,t.lanes=l,t)}var nf=K.ReactCurrentOwner,Ve=!1;function Ue(t,a,n,i){a.child=t===null?Pc(a,null,n,i):Ga(a,t.child,n,i)}function md(t,a,n,i,l){n=n.render;var d=a.ref;return Ja(a,l),i=zs(t,a,n,i,d,l),n=Os(),t!==null&&!Ve?(a.updateQueue=t.updateQueue,a.flags&=-2053,t.lanes&=~l,Dt(t,a,l)):(be&&n&&bs(a),a.flags|=1,Ue(t,a,i,l),a.child)}function ud(t,a,n,i,l){if(t===null){var d=n.type;return typeof d=="function"&&!uo(d)&&d.defaultProps===void 0&&n.compare===null&&n.defaultProps===void 0?(a.tag=15,a.type=d,fd(t,a,d,i,l)):(t=si(n.type,null,i,a,a.mode,l),t.ref=a.ref,t.return=a,a.child=t)}if(d=t.child,(t.lanes&l)===0){var f=d.memoizedProps;if(n=n.compare,n=n!==null?n:Nn,n(f,i)&&t.ref===a.ref)return Dt(t,a,l)}return a.flags|=1,t=ra(d,i),t.ref=a.ref,t.return=a,a.child=t}function fd(t,a,n,i,l){if(t!==null){var d=t.memoizedProps;if(Nn(d,i)&&t.ref===a.ref)if(Ve=!1,a.pendingProps=i=d,(t.lanes&l)!==0)(t.flags&131072)!==0&&(Ve=!0);else return a.lanes=t.lanes,Dt(t,a,l)}return Gs(t,a,n,i,l)}function hd(t,a,n){var i=a.pendingProps,l=i.children,d=t!==null?t.memoizedState:null;if(i.mode==="hidden")if((a.mode&1)===0)a.memoizedState={baseLanes:0,cachePool:null,transitions:null},ue(Qa,nt),nt|=n;else{if((n&1073741824)===0)return t=d!==null?d.baseLanes|n:n,a.lanes=a.childLanes=1073741824,a.memoizedState={baseLanes:t,cachePool:null,transitions:null},a.updateQueue=null,ue(Qa,nt),nt|=t,null;a.memoizedState={baseLanes:0,cachePool:null,transitions:null},i=d!==null?d.baseLanes:n,ue(Qa,nt),nt|=i}else d!==null?(i=d.baseLanes|n,a.memoizedState=null):i=n,ue(Qa,nt),nt|=i;return Ue(t,a,l,n),a.child}function gd(t,a){var n=a.ref;(t===null&&n!==null||t!==null&&t.ref!==n)&&(a.flags|=512,a.flags|=2097152)}function Gs(t,a,n,i,l){var d=Je(n)?ua:We.current;return d=Fa(a,d),Ja(a,l),n=zs(t,a,n,i,d,l),i=Os(),t!==null&&!Ve?(a.updateQueue=t.updateQueue,a.flags&=-2053,t.lanes&=~l,Dt(t,a,l)):(be&&i&&bs(a),a.flags|=1,Ue(t,a,n,l),a.child)}function xd(t,a,n,i,l){if(Je(n)){var d=!0;Pr(a)}else d=!1;if(Ja(a,l),a.stateNode===null)Kr(t,a),id(a,n,i),Us(a,n,i,l),i=!0;else if(t===null){var f=a.stateNode,j=a.memoizedProps;f.props=j;var S=f.context,N=n.contextType;typeof N=="object"&&N!==null?N=st(N):(N=Je(n)?ua:We.current,N=Fa(a,N));var O=n.getDerivedStateFromProps,D=typeof O=="function"||typeof f.getSnapshotBeforeUpdate=="function";D||typeof f.UNSAFE_componentWillReceiveProps!="function"&&typeof f.componentWillReceiveProps!="function"||(j!==i||S!==N)&&sd(a,f,i,N),Qt=!1;var B=a.memoizedState;f.state=B,Hr(a,i,f,l),S=a.memoizedState,j!==i||B!==S||Ye.current||Qt?(typeof O=="function"&&(Fs(a,n,O,i),S=a.memoizedState),(j=Qt||rd(a,n,j,i,B,S,N))?(D||typeof f.UNSAFE_componentWillMount!="function"&&typeof f.componentWillMount!="function"||(typeof f.componentWillMount=="function"&&f.componentWillMount(),typeof f.UNSAFE_componentWillMount=="function"&&f.UNSAFE_componentWillMount()),typeof f.componentDidMount=="function"&&(a.flags|=4194308)):(typeof f.componentDidMount=="function"&&(a.flags|=4194308),a.memoizedProps=i,a.memoizedState=S),f.props=i,f.state=S,f.context=N,i=j):(typeof f.componentDidMount=="function"&&(a.flags|=4194308),i=!1)}else{f=a.stateNode,Bc(t,a),j=a.memoizedProps,N=a.type===a.elementType?j:gt(a.type,j),f.props=N,D=a.pendingProps,B=f.context,S=n.contextType,typeof S=="object"&&S!==null?S=st(S):(S=Je(n)?ua:We.current,S=Fa(a,S));var H=n.getDerivedStateFromProps;(O=typeof H=="function"||typeof f.getSnapshotBeforeUpdate=="function")||typeof f.UNSAFE_componentWillReceiveProps!="function"&&typeof f.componentWillReceiveProps!="function"||(j!==D||B!==S)&&sd(a,f,i,S),Qt=!1,B=a.memoizedState,f.state=B,Hr(a,i,f,l);var G=a.memoizedState;j!==D||B!==G||Ye.current||Qt?(typeof H=="function"&&(Fs(a,n,H,i),G=a.memoizedState),(N=Qt||rd(a,n,N,i,B,G,S)||!1)?(O||typeof f.UNSAFE_componentWillUpdate!="function"&&typeof f.componentWillUpdate!="function"||(typeof f.componentWillUpdate=="function"&&f.componentWillUpdate(i,G,S),typeof f.UNSAFE_componentWillUpdate=="function"&&f.UNSAFE_componentWillUpdate(i,G,S)),typeof f.componentDidUpdate=="function"&&(a.flags|=4),typeof f.getSnapshotBeforeUpdate=="function"&&(a.flags|=1024)):(typeof f.componentDidUpdate!="function"||j===t.memoizedProps&&B===t.memoizedState||(a.flags|=4),typeof f.getSnapshotBeforeUpdate!="function"||j===t.memoizedProps&&B===t.memoizedState||(a.flags|=1024),a.memoizedProps=i,a.memoizedState=G),f.props=i,f.state=G,f.context=S,i=N):(typeof f.componentDidUpdate!="function"||j===t.memoizedProps&&B===t.memoizedState||(a.flags|=4),typeof f.getSnapshotBeforeUpdate!="function"||j===t.memoizedProps&&B===t.memoizedState||(a.flags|=1024),i=!1)}return Ys(t,a,n,i,d,l)}function Ys(t,a,n,i,l,d){gd(t,a);var f=(a.flags&128)!==0;if(!i&&!f)return l&&Sc(a,n,!1),Dt(t,a,d);i=a.stateNode,nf.current=a;var j=f&&typeof n.getDerivedStateFromError!="function"?null:i.render();return a.flags|=1,t!==null&&f?(a.child=Ga(a,t.child,null,d),a.child=Ga(a,null,j,d)):Ue(t,a,j,d),a.memoizedState=i.state,l&&Sc(a,n,!0),a.child}function bd(t){var a=t.stateNode;a.pendingContext?vc(t,a.pendingContext,a.pendingContext!==a.context):a.context&&vc(t,a.context,!1),Es(t,a.containerInfo)}function yd(t,a,n,i,l){return $a(),Ss(l),a.flags|=256,Ue(t,a,n,i),a.child}var Js={dehydrated:null,treeContext:null,retryLane:0};function Vs(t){return{baseLanes:t,cachePool:null,transitions:null}}function vd(t,a,n){var i=a.pendingProps,l=ye.current,d=!1,f=(a.flags&128)!==0,j;if((j=f)||(j=t!==null&&t.memoizedState===null?!1:(l&2)!==0),j?(d=!0,a.flags&=-129):(t===null||t.memoizedState!==null)&&(l|=1),ue(ye,l&1),t===null)return js(a),t=a.memoizedState,t!==null&&(t=t.dehydrated,t!==null)?((a.mode&1)===0?a.lanes=1:t.data==="$!"?a.lanes=8:a.lanes=1073741824,null):(f=i.children,t=i.fallback,d?(i=a.mode,d=a.child,f={mode:"hidden",children:f},(i&1)===0&&d!==null?(d.childLanes=0,d.pendingProps=f):d=oi(f,i,0,null),t=wa(t,i,n,null),d.return=a,t.return=a,d.sibling=t,a.child=d,a.child.memoizedState=Vs(n),a.memoizedState=Js,t):Ks(a,f));if(l=t.memoizedState,l!==null&&(j=l.dehydrated,j!==null))return rf(t,a,f,i,j,l,n);if(d){d=i.fallback,f=a.mode,l=t.child,j=l.sibling;var S={mode:"hidden",children:i.children};return(f&1)===0&&a.child!==l?(i=a.child,i.childLanes=0,i.pendingProps=S,a.deletions=null):(i=ra(l,S),i.subtreeFlags=l.subtreeFlags&14680064),j!==null?d=ra(j,d):(d=wa(d,f,n,null),d.flags|=2),d.return=a,i.return=a,i.sibling=d,a.child=i,i=d,d=a.child,f=t.child.memoizedState,f=f===null?Vs(n):{baseLanes:f.baseLanes|n,cachePool:null,transitions:f.transitions},d.memoizedState=f,d.childLanes=t.childLanes&~n,a.memoizedState=Js,i}return d=t.child,t=d.sibling,i=ra(d,{mode:"visible",children:i.children}),(a.mode&1)===0&&(i.lanes=n),i.return=a,i.sibling=null,t!==null&&(n=a.deletions,n===null?(a.deletions=[t],a.flags|=16):n.push(t)),a.child=i,a.memoizedState=null,i}function Ks(t,a){return a=oi({mode:"visible",children:a},t.mode,0,null),a.return=t,t.child=a}function Vr(t,a,n,i){return i!==null&&Ss(i),Ga(a,t.child,null,n),t=Ks(a,a.pendingProps.children),t.flags|=2,a.memoizedState=null,t}function rf(t,a,n,i,l,d,f){if(n)return a.flags&256?(a.flags&=-257,i=_s(Error(o(422))),Vr(t,a,f,i)):a.memoizedState!==null?(a.child=t.child,a.flags|=128,null):(d=i.fallback,l=a.mode,i=oi({mode:"visible",children:i.children},l,0,null),d=wa(d,l,f,null),d.flags|=2,i.return=a,d.return=a,i.sibling=d,a.child=i,(a.mode&1)!==0&&Ga(a,t.child,null,f),a.child.memoizedState=Vs(f),a.memoizedState=Js,d);if((a.mode&1)===0)return Vr(t,a,f,null);if(l.data==="$!"){if(i=l.nextSibling&&l.nextSibling.dataset,i)var j=i.dgst;return i=j,d=Error(o(419)),i=_s(d,i,void 0),Vr(t,a,f,i)}if(j=(f&t.childLanes)!==0,Ve||j){if(i=Be,i!==null){switch(f&-f){case 4:l=2;break;case 16:l=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:l=32;break;case 536870912:l=268435456;break;default:l=0}l=(l&(i.suspendedLanes|f))!==0?0:l,l!==0&&l!==d.retryLane&&(d.retryLane=l,zt(t,l),yt(i,t,l,-1))}return mo(),i=_s(Error(o(421))),Vr(t,a,f,i)}return l.data==="$?"?(a.flags|=128,a.child=t.child,a=bf.bind(null,t),l._reactRetry=a,null):(t=d.treeContext,at=Jt(l.nextSibling),tt=a,be=!0,ht=null,t!==null&&(rt[it++]=Bt,rt[it++]=Mt,rt[it++]=fa,Bt=t.id,Mt=t.overflow,fa=a),a=Ks(a,i.children),a.flags|=4096,a)}function jd(t,a,n){t.lanes|=a;var i=t.alternate;i!==null&&(i.lanes|=a),ks(t.return,a,n)}function qs(t,a,n,i,l){var d=t.memoizedState;d===null?t.memoizedState={isBackwards:a,rendering:null,renderingStartTime:0,last:i,tail:n,tailMode:l}:(d.isBackwards=a,d.rendering=null,d.renderingStartTime=0,d.last=i,d.tail=n,d.tailMode=l)}function Sd(t,a,n){var i=a.pendingProps,l=i.revealOrder,d=i.tail;if(Ue(t,a,i.children,n),i=ye.current,(i&2)!==0)i=i&1|2,a.flags|=128;else{if(t!==null&&(t.flags&128)!==0)e:for(t=a.child;t!==null;){if(t.tag===13)t.memoizedState!==null&&jd(t,n,a);else if(t.tag===19)jd(t,n,a);else if(t.child!==null){t.child.return=t,t=t.child;continue}if(t===a)break e;for(;t.sibling===null;){if(t.return===null||t.return===a)break e;t=t.return}t.sibling.return=t.return,t=t.sibling}i&=1}if(ue(ye,i),(a.mode&1)===0)a.memoizedState=null;else switch(l){case"forwards":for(n=a.child,l=null;n!==null;)t=n.alternate,t!==null&&Fr(t)===null&&(l=n),n=n.sibling;n=l,n===null?(l=a.child,a.child=null):(l=n.sibling,n.sibling=null),qs(a,!1,l,n,d);break;case"backwards":for(n=null,l=a.child,a.child=null;l!==null;){if(t=l.alternate,t!==null&&Fr(t)===null){a.child=l;break}t=l.sibling,l.sibling=n,n=l,l=t}qs(a,!0,n,null,d);break;case"together":qs(a,!1,null,null,void 0);break;default:a.memoizedState=null}return a.child}function Kr(t,a){(a.mode&1)===0&&t!==null&&(t.alternate=null,a.alternate=null,a.flags|=2)}function Dt(t,a,n){if(t!==null&&(a.dependencies=t.dependencies),ya|=a.lanes,(n&a.childLanes)===0)return null;if(t!==null&&a.child!==t.child)throw Error(o(153));if(a.child!==null){for(t=a.child,n=ra(t,t.pendingProps),a.child=n,n.return=a;t.sibling!==null;)t=t.sibling,n=n.sibling=ra(t,t.pendingProps),n.return=a;n.sibling=null}return a.child}function sf(t,a,n){switch(a.tag){case 3:bd(a),$a();break;case 5:Oc(a);break;case 1:Je(a.type)&&Pr(a);break;case 4:Es(a,a.stateNode.containerInfo);break;case 10:var i=a.type._context,l=a.memoizedProps.value;ue(Dr,i._currentValue),i._currentValue=l;break;case 13:if(i=a.memoizedState,i!==null)return i.dehydrated!==null?(ue(ye,ye.current&1),a.flags|=128,null):(n&a.child.childLanes)!==0?vd(t,a,n):(ue(ye,ye.current&1),t=Dt(t,a,n),t!==null?t.sibling:null);ue(ye,ye.current&1);break;case 19:if(i=(n&a.childLanes)!==0,(t.flags&128)!==0){if(i)return Sd(t,a,n);a.flags|=128}if(l=a.memoizedState,l!==null&&(l.rendering=null,l.tail=null,l.lastEffect=null),ue(ye,ye.current),i)break;return null;case 22:case 23:return a.lanes=0,hd(t,a,n)}return Dt(t,a,n)}var wd,Qs,Cd,Ad;wd=function(t,a){for(var n=a.child;n!==null;){if(n.tag===5||n.tag===6)t.appendChild(n.stateNode);else if(n.tag!==4&&n.child!==null){n.child.return=n,n=n.child;continue}if(n===a)break;for(;n.sibling===null;){if(n.return===null||n.return===a)return;n=n.return}n.sibling.return=n.return,n=n.sibling}},Qs=function(){},Cd=function(t,a,n,i){var l=t.memoizedProps;if(l!==i){t=a.stateNode,xa(kt.current);var d=null;switch(n){case"input":l=ki(t,l),i=ki(t,i),d=[];break;case"select":l=$({},l,{value:void 0}),i=$({},i,{value:void 0}),d=[];break;case"textarea":l=Ei(t,l),i=Ei(t,i),d=[];break;default:typeof l.onClick!="function"&&typeof i.onClick=="function"&&(t.onclick=Tr)}Pi(n,i);var f;n=null;for(N in l)if(!i.hasOwnProperty(N)&&l.hasOwnProperty(N)&&l[N]!=null)if(N==="style"){var j=l[N];for(f in j)j.hasOwnProperty(f)&&(n||(n={}),n[f]="")}else N!=="dangerouslySetInnerHTML"&&N!=="children"&&N!=="suppressContentEditableWarning"&&N!=="suppressHydrationWarning"&&N!=="autoFocus"&&(m.hasOwnProperty(N)?d||(d=[]):(d=d||[]).push(N,null));for(N in i){var S=i[N];if(j=l!=null?l[N]:void 0,i.hasOwnProperty(N)&&S!==j&&(S!=null||j!=null))if(N==="style")if(j){for(f in j)!j.hasOwnProperty(f)||S&&S.hasOwnProperty(f)||(n||(n={}),n[f]="");for(f in S)S.hasOwnProperty(f)&&j[f]!==S[f]&&(n||(n={}),n[f]=S[f])}else n||(d||(d=[]),d.push(N,n)),n=S;else N==="dangerouslySetInnerHTML"?(S=S?S.__html:void 0,j=j?j.__html:void 0,S!=null&&j!==S&&(d=d||[]).push(N,S)):N==="children"?typeof S!="string"&&typeof S!="number"||(d=d||[]).push(N,""+S):N!=="suppressContentEditableWarning"&&N!=="suppressHydrationWarning"&&(m.hasOwnProperty(N)?(S!=null&&N==="onScroll"&&fe("scroll",t),d||j===S||(d=[])):(d=d||[]).push(N,S))}n&&(d=d||[]).push("style",n);var N=d;(a.updateQueue=N)&&(a.flags|=4)}},Ad=function(t,a,n,i){n!==i&&(a.flags|=4)};function Un(t,a){if(!be)switch(t.tailMode){case"hidden":a=t.tail;for(var n=null;a!==null;)a.alternate!==null&&(n=a),a=a.sibling;n===null?t.tail=null:n.sibling=null;break;case"collapsed":n=t.tail;for(var i=null;n!==null;)n.alternate!==null&&(i=n),n=n.sibling;i===null?a||t.tail===null?t.tail=null:t.tail.sibling=null:i.sibling=null}}function He(t){var a=t.alternate!==null&&t.alternate.child===t.child,n=0,i=0;if(a)for(var l=t.child;l!==null;)n|=l.lanes|l.childLanes,i|=l.subtreeFlags&14680064,i|=l.flags&14680064,l.return=t,l=l.sibling;else for(l=t.child;l!==null;)n|=l.lanes|l.childLanes,i|=l.subtreeFlags,i|=l.flags,l.return=t,l=l.sibling;return t.subtreeFlags|=i,t.childLanes=n,a}function of(t,a,n){var i=a.pendingProps;switch(ys(a),a.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return He(a),null;case 1:return Je(a.type)&&Rr(),He(a),null;case 3:return i=a.stateNode,Va(),he(Ye),he(We),Is(),i.pendingContext&&(i.context=i.pendingContext,i.pendingContext=null),(t===null||t.child===null)&&(zr(a)?a.flags|=4:t===null||t.memoizedState.isDehydrated&&(a.flags&256)===0||(a.flags|=1024,ht!==null&&(lo(ht),ht=null))),Qs(t,a),He(a),null;case 5:Rs(a);var l=xa(Dn.current);if(n=a.type,t!==null&&a.stateNode!=null)Cd(t,a,n,i,l),t.ref!==a.ref&&(a.flags|=512,a.flags|=2097152);else{if(!i){if(a.stateNode===null)throw Error(o(166));return He(a),null}if(t=xa(kt.current),zr(a)){i=a.stateNode,n=a.type;var d=a.memoizedProps;switch(i[At]=a,i[In]=d,t=(a.mode&1)!==0,n){case"dialog":fe("cancel",i),fe("close",i);break;case"iframe":case"object":case"embed":fe("load",i);break;case"video":case"audio":for(l=0;l<En.length;l++)fe(En[l],i);break;case"source":fe("error",i);break;case"img":case"image":case"link":fe("error",i),fe("load",i);break;case"details":fe("toggle",i);break;case"input":il(i,d),fe("invalid",i);break;case"select":i._wrapperState={wasMultiple:!!d.multiple},fe("invalid",i);break;case"textarea":ll(i,d),fe("invalid",i)}Pi(n,d),l=null;for(var f in d)if(d.hasOwnProperty(f)){var j=d[f];f==="children"?typeof j=="string"?i.textContent!==j&&(d.suppressHydrationWarning!==!0&&Nr(i.textContent,j,t),l=["children",j]):typeof j=="number"&&i.textContent!==""+j&&(d.suppressHydrationWarning!==!0&&Nr(i.textContent,j,t),l=["children",""+j]):m.hasOwnProperty(f)&&j!=null&&f==="onScroll"&&fe("scroll",i)}switch(n){case"input":rr(i),ol(i,d,!0);break;case"textarea":rr(i),dl(i);break;case"select":case"option":break;default:typeof d.onClick=="function"&&(i.onclick=Tr)}i=l,a.updateQueue=i,i!==null&&(a.flags|=4)}else{f=l.nodeType===9?l:l.ownerDocument,t==="http://www.w3.org/1999/xhtml"&&(t=pl(n)),t==="http://www.w3.org/1999/xhtml"?n==="script"?(t=f.createElement("div"),t.innerHTML="<script><\/script>",t=t.removeChild(t.firstChild)):typeof i.is=="string"?t=f.createElement(n,{is:i.is}):(t=f.createElement(n),n==="select"&&(f=t,i.multiple?f.multiple=!0:i.size&&(f.size=i.size))):t=f.createElementNS(t,n),t[At]=a,t[In]=i,wd(t,a,!1,!1),a.stateNode=t;e:{switch(f=Ii(n,i),n){case"dialog":fe("cancel",t),fe("close",t),l=i;break;case"iframe":case"object":case"embed":fe("load",t),l=i;break;case"video":case"audio":for(l=0;l<En.length;l++)fe(En[l],t);l=i;break;case"source":fe("error",t),l=i;break;case"img":case"image":case"link":fe("error",t),fe("load",t),l=i;break;case"details":fe("toggle",t),l=i;break;case"input":il(t,i),l=ki(t,i),fe("invalid",t);break;case"option":l=i;break;case"select":t._wrapperState={wasMultiple:!!i.multiple},l=$({},i,{value:void 0}),fe("invalid",t);break;case"textarea":ll(t,i),l=Ei(t,i),fe("invalid",t);break;default:l=i}Pi(n,l),j=l;for(d in j)if(j.hasOwnProperty(d)){var S=j[d];d==="style"?fl(t,S):d==="dangerouslySetInnerHTML"?(S=S?S.__html:void 0,S!=null&&ml(t,S)):d==="children"?typeof S=="string"?(n!=="textarea"||S!=="")&&dn(t,S):typeof S=="number"&&dn(t,""+S):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(m.hasOwnProperty(d)?S!=null&&d==="onScroll"&&fe("scroll",t):S!=null&&U(t,d,S,f))}switch(n){case"input":rr(t),ol(t,i,!1);break;case"textarea":rr(t),dl(t);break;case"option":i.value!=null&&t.setAttribute("value",""+de(i.value));break;case"select":t.multiple=!!i.multiple,d=i.value,d!=null?Ea(t,!!i.multiple,d,!1):i.defaultValue!=null&&Ea(t,!!i.multiple,i.defaultValue,!0);break;default:typeof l.onClick=="function"&&(t.onclick=Tr)}switch(n){case"button":case"input":case"select":case"textarea":i=!!i.autoFocus;break e;case"img":i=!0;break e;default:i=!1}}i&&(a.flags|=4)}a.ref!==null&&(a.flags|=512,a.flags|=2097152)}return He(a),null;case 6:if(t&&a.stateNode!=null)Ad(t,a,t.memoizedProps,i);else{if(typeof i!="string"&&a.stateNode===null)throw Error(o(166));if(n=xa(Dn.current),xa(kt.current),zr(a)){if(i=a.stateNode,n=a.memoizedProps,i[At]=a,(d=i.nodeValue!==n)&&(t=tt,t!==null))switch(t.tag){case 3:Nr(i.nodeValue,n,(t.mode&1)!==0);break;case 5:t.memoizedProps.suppressHydrationWarning!==!0&&Nr(i.nodeValue,n,(t.mode&1)!==0)}d&&(a.flags|=4)}else i=(n.nodeType===9?n:n.ownerDocument).createTextNode(i),i[At]=a,a.stateNode=i}return He(a),null;case 13:if(he(ye),i=a.memoizedState,t===null||t.memoizedState!==null&&t.memoizedState.dehydrated!==null){if(be&&at!==null&&(a.mode&1)!==0&&(a.flags&128)===0)Tc(),$a(),a.flags|=98560,d=!1;else if(d=zr(a),i!==null&&i.dehydrated!==null){if(t===null){if(!d)throw Error(o(318));if(d=a.memoizedState,d=d!==null?d.dehydrated:null,!d)throw Error(o(317));d[At]=a}else $a(),(a.flags&128)===0&&(a.memoizedState=null),a.flags|=4;He(a),d=!1}else ht!==null&&(lo(ht),ht=null),d=!0;if(!d)return a.flags&65536?a:null}return(a.flags&128)!==0?(a.lanes=n,a):(i=i!==null,i!==(t!==null&&t.memoizedState!==null)&&i&&(a.child.flags|=8192,(a.mode&1)!==0&&(t===null||(ye.current&1)!==0?Re===0&&(Re=3):mo())),a.updateQueue!==null&&(a.flags|=4),He(a),null);case 4:return Va(),Qs(t,a),t===null&&Rn(a.stateNode.containerInfo),He(a),null;case 10:return As(a.type._context),He(a),null;case 17:return Je(a.type)&&Rr(),He(a),null;case 19:if(he(ye),d=a.memoizedState,d===null)return He(a),null;if(i=(a.flags&128)!==0,f=d.rendering,f===null)if(i)Un(d,!1);else{if(Re!==0||t!==null&&(t.flags&128)!==0)for(t=a.child;t!==null;){if(f=Fr(t),f!==null){for(a.flags|=128,Un(d,!1),i=f.updateQueue,i!==null&&(a.updateQueue=i,a.flags|=4),a.subtreeFlags=0,i=n,n=a.child;n!==null;)d=n,t=i,d.flags&=14680066,f=d.alternate,f===null?(d.childLanes=0,d.lanes=t,d.child=null,d.subtreeFlags=0,d.memoizedProps=null,d.memoizedState=null,d.updateQueue=null,d.dependencies=null,d.stateNode=null):(d.childLanes=f.childLanes,d.lanes=f.lanes,d.child=f.child,d.subtreeFlags=0,d.deletions=null,d.memoizedProps=f.memoizedProps,d.memoizedState=f.memoizedState,d.updateQueue=f.updateQueue,d.type=f.type,t=f.dependencies,d.dependencies=t===null?null:{lanes:t.lanes,firstContext:t.firstContext}),n=n.sibling;return ue(ye,ye.current&1|2),a.child}t=t.sibling}d.tail!==null&&Ce()>Xa&&(a.flags|=128,i=!0,Un(d,!1),a.lanes=4194304)}else{if(!i)if(t=Fr(f),t!==null){if(a.flags|=128,i=!0,n=t.updateQueue,n!==null&&(a.updateQueue=n,a.flags|=4),Un(d,!0),d.tail===null&&d.tailMode==="hidden"&&!f.alternate&&!be)return He(a),null}else 2*Ce()-d.renderingStartTime>Xa&&n!==1073741824&&(a.flags|=128,i=!0,Un(d,!1),a.lanes=4194304);d.isBackwards?(f.sibling=a.child,a.child=f):(n=d.last,n!==null?n.sibling=f:a.child=f,d.last=f)}return d.tail!==null?(a=d.tail,d.rendering=a,d.tail=a.sibling,d.renderingStartTime=Ce(),a.sibling=null,n=ye.current,ue(ye,i?n&1|2:n&1),a):(He(a),null);case 22:case 23:return po(),i=a.memoizedState!==null,t!==null&&t.memoizedState!==null!==i&&(a.flags|=8192),i&&(a.mode&1)!==0?(nt&1073741824)!==0&&(He(a),a.subtreeFlags&6&&(a.flags|=8192)):He(a),null;case 24:return null;case 25:return null}throw Error(o(156,a.tag))}function lf(t,a){switch(ys(a),a.tag){case 1:return Je(a.type)&&Rr(),t=a.flags,t&65536?(a.flags=t&-65537|128,a):null;case 3:return Va(),he(Ye),he(We),Is(),t=a.flags,(t&65536)!==0&&(t&128)===0?(a.flags=t&-65537|128,a):null;case 5:return Rs(a),null;case 13:if(he(ye),t=a.memoizedState,t!==null&&t.dehydrated!==null){if(a.alternate===null)throw Error(o(340));$a()}return t=a.flags,t&65536?(a.flags=t&-65537|128,a):null;case 19:return he(ye),null;case 4:return Va(),null;case 10:return As(a.type._context),null;case 22:case 23:return po(),null;case 24:return null;default:return null}}var qr=!1,Fe=!1,cf=typeof WeakSet=="function"?WeakSet:Set,_=null;function qa(t,a){var n=t.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(i){Se(t,a,i)}else n.current=null}function Xs(t,a,n){try{n()}catch(i){Se(t,a,i)}}var kd=!1;function df(t,a){if(ds=gr,t=rc(),as(t)){if("selectionStart"in t)var n={start:t.selectionStart,end:t.selectionEnd};else e:{n=(n=t.ownerDocument)&&n.defaultView||window;var i=n.getSelection&&n.getSelection();if(i&&i.rangeCount!==0){n=i.anchorNode;var l=i.anchorOffset,d=i.focusNode;i=i.focusOffset;try{n.nodeType,d.nodeType}catch{n=null;break e}var f=0,j=-1,S=-1,N=0,O=0,D=t,B=null;t:for(;;){for(var H;D!==n||l!==0&&D.nodeType!==3||(j=f+l),D!==d||i!==0&&D.nodeType!==3||(S=f+i),D.nodeType===3&&(f+=D.nodeValue.length),(H=D.firstChild)!==null;)B=D,D=H;for(;;){if(D===t)break t;if(B===n&&++N===l&&(j=f),B===d&&++O===i&&(S=f),(H=D.nextSibling)!==null)break;D=B,B=D.parentNode}D=H}n=j===-1||S===-1?null:{start:j,end:S}}else n=null}n=n||{start:0,end:0}}else n=null;for(ps={focusedElem:t,selectionRange:n},gr=!1,_=a;_!==null;)if(a=_,t=a.child,(a.subtreeFlags&1028)!==0&&t!==null)t.return=a,_=t;else for(;_!==null;){a=_;try{var G=a.alternate;if((a.flags&1024)!==0)switch(a.tag){case 0:case 11:case 15:break;case 1:if(G!==null){var Y=G.memoizedProps,Ae=G.memoizedState,A=a.stateNode,w=A.getSnapshotBeforeUpdate(a.elementType===a.type?Y:gt(a.type,Y),Ae);A.__reactInternalSnapshotBeforeUpdate=w}break;case 3:var k=a.stateNode.containerInfo;k.nodeType===1?k.textContent="":k.nodeType===9&&k.documentElement&&k.removeChild(k.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(o(163))}}catch(W){Se(a,a.return,W)}if(t=a.sibling,t!==null){t.return=a.return,_=t;break}_=a.return}return G=kd,kd=!1,G}function _n(t,a,n){var i=a.updateQueue;if(i=i!==null?i.lastEffect:null,i!==null){var l=i=i.next;do{if((l.tag&t)===t){var d=l.destroy;l.destroy=void 0,d!==void 0&&Xs(a,n,d)}l=l.next}while(l!==i)}}function Qr(t,a){if(a=a.updateQueue,a=a!==null?a.lastEffect:null,a!==null){var n=a=a.next;do{if((n.tag&t)===t){var i=n.create;n.destroy=i()}n=n.next}while(n!==a)}}function Zs(t){var a=t.ref;if(a!==null){var n=t.stateNode;switch(t.tag){case 5:t=n;break;default:t=n}typeof a=="function"?a(t):a.current=t}}function Nd(t){var a=t.alternate;a!==null&&(t.alternate=null,Nd(a)),t.child=null,t.deletions=null,t.sibling=null,t.tag===5&&(a=t.stateNode,a!==null&&(delete a[At],delete a[In],delete a[hs],delete a[Gu],delete a[Yu])),t.stateNode=null,t.return=null,t.dependencies=null,t.memoizedProps=null,t.memoizedState=null,t.pendingProps=null,t.stateNode=null,t.updateQueue=null}function Td(t){return t.tag===5||t.tag===3||t.tag===4}function Ed(t){e:for(;;){for(;t.sibling===null;){if(t.return===null||Td(t.return))return null;t=t.return}for(t.sibling.return=t.return,t=t.sibling;t.tag!==5&&t.tag!==6&&t.tag!==18;){if(t.flags&2||t.child===null||t.tag===4)continue e;t.child.return=t,t=t.child}if(!(t.flags&2))return t.stateNode}}function eo(t,a,n){var i=t.tag;if(i===5||i===6)t=t.stateNode,a?n.nodeType===8?n.parentNode.insertBefore(t,a):n.insertBefore(t,a):(n.nodeType===8?(a=n.parentNode,a.insertBefore(t,n)):(a=n,a.appendChild(t)),n=n._reactRootContainer,n!=null||a.onclick!==null||(a.onclick=Tr));else if(i!==4&&(t=t.child,t!==null))for(eo(t,a,n),t=t.sibling;t!==null;)eo(t,a,n),t=t.sibling}function to(t,a,n){var i=t.tag;if(i===5||i===6)t=t.stateNode,a?n.insertBefore(t,a):n.appendChild(t);else if(i!==4&&(t=t.child,t!==null))for(to(t,a,n),t=t.sibling;t!==null;)to(t,a,n),t=t.sibling}var Oe=null,xt=!1;function Zt(t,a,n){for(n=n.child;n!==null;)Rd(t,a,n),n=n.sibling}function Rd(t,a,n){if(Ct&&typeof Ct.onCommitFiberUnmount=="function")try{Ct.onCommitFiberUnmount(dr,n)}catch{}switch(n.tag){case 5:Fe||qa(n,a);case 6:var i=Oe,l=xt;Oe=null,Zt(t,a,n),Oe=i,xt=l,Oe!==null&&(xt?(t=Oe,n=n.stateNode,t.nodeType===8?t.parentNode.removeChild(n):t.removeChild(n)):Oe.removeChild(n.stateNode));break;case 18:Oe!==null&&(xt?(t=Oe,n=n.stateNode,t.nodeType===8?fs(t.parentNode,n):t.nodeType===1&&fs(t,n),jn(t)):fs(Oe,n.stateNode));break;case 4:i=Oe,l=xt,Oe=n.stateNode.containerInfo,xt=!0,Zt(t,a,n),Oe=i,xt=l;break;case 0:case 11:case 14:case 15:if(!Fe&&(i=n.updateQueue,i!==null&&(i=i.lastEffect,i!==null))){l=i=i.next;do{var d=l,f=d.destroy;d=d.tag,f!==void 0&&((d&2)!==0||(d&4)!==0)&&Xs(n,a,f),l=l.next}while(l!==i)}Zt(t,a,n);break;case 1:if(!Fe&&(qa(n,a),i=n.stateNode,typeof i.componentWillUnmount=="function"))try{i.props=n.memoizedProps,i.state=n.memoizedState,i.componentWillUnmount()}catch(j){Se(n,a,j)}Zt(t,a,n);break;case 21:Zt(t,a,n);break;case 22:n.mode&1?(Fe=(i=Fe)||n.memoizedState!==null,Zt(t,a,n),Fe=i):Zt(t,a,n);break;default:Zt(t,a,n)}}function Pd(t){var a=t.updateQueue;if(a!==null){t.updateQueue=null;var n=t.stateNode;n===null&&(n=t.stateNode=new cf),a.forEach(function(i){var l=yf.bind(null,t,i);n.has(i)||(n.add(i),i.then(l,l))})}}function bt(t,a){var n=a.deletions;if(n!==null)for(var i=0;i<n.length;i++){var l=n[i];try{var d=t,f=a,j=f;e:for(;j!==null;){switch(j.tag){case 5:Oe=j.stateNode,xt=!1;break e;case 3:Oe=j.stateNode.containerInfo,xt=!0;break e;case 4:Oe=j.stateNode.containerInfo,xt=!0;break e}j=j.return}if(Oe===null)throw Error(o(160));Rd(d,f,l),Oe=null,xt=!1;var S=l.alternate;S!==null&&(S.return=null),l.return=null}catch(N){Se(l,a,N)}}if(a.subtreeFlags&12854)for(a=a.child;a!==null;)Id(a,t),a=a.sibling}function Id(t,a){var n=t.alternate,i=t.flags;switch(t.tag){case 0:case 11:case 14:case 15:if(bt(a,t),Tt(t),i&4){try{_n(3,t,t.return),Qr(3,t)}catch(Y){Se(t,t.return,Y)}try{_n(5,t,t.return)}catch(Y){Se(t,t.return,Y)}}break;case 1:bt(a,t),Tt(t),i&512&&n!==null&&qa(n,n.return);break;case 5:if(bt(a,t),Tt(t),i&512&&n!==null&&qa(n,n.return),t.flags&32){var l=t.stateNode;try{dn(l,"")}catch(Y){Se(t,t.return,Y)}}if(i&4&&(l=t.stateNode,l!=null)){var d=t.memoizedProps,f=n!==null?n.memoizedProps:d,j=t.type,S=t.updateQueue;if(t.updateQueue=null,S!==null)try{j==="input"&&d.type==="radio"&&d.name!=null&&sl(l,d),Ii(j,f);var N=Ii(j,d);for(f=0;f<S.length;f+=2){var O=S[f],D=S[f+1];O==="style"?fl(l,D):O==="dangerouslySetInnerHTML"?ml(l,D):O==="children"?dn(l,D):U(l,O,D,N)}switch(j){case"input":Ni(l,d);break;case"textarea":cl(l,d);break;case"select":var B=l._wrapperState.wasMultiple;l._wrapperState.wasMultiple=!!d.multiple;var H=d.value;H!=null?Ea(l,!!d.multiple,H,!1):B!==!!d.multiple&&(d.defaultValue!=null?Ea(l,!!d.multiple,d.defaultValue,!0):Ea(l,!!d.multiple,d.multiple?[]:"",!1))}l[In]=d}catch(Y){Se(t,t.return,Y)}}break;case 6:if(bt(a,t),Tt(t),i&4){if(t.stateNode===null)throw Error(o(162));l=t.stateNode,d=t.memoizedProps;try{l.nodeValue=d}catch(Y){Se(t,t.return,Y)}}break;case 3:if(bt(a,t),Tt(t),i&4&&n!==null&&n.memoizedState.isDehydrated)try{jn(a.containerInfo)}catch(Y){Se(t,t.return,Y)}break;case 4:bt(a,t),Tt(t);break;case 13:bt(a,t),Tt(t),l=t.child,l.flags&8192&&(d=l.memoizedState!==null,l.stateNode.isHidden=d,!d||l.alternate!==null&&l.alternate.memoizedState!==null||(ro=Ce())),i&4&&Pd(t);break;case 22:if(O=n!==null&&n.memoizedState!==null,t.mode&1?(Fe=(N=Fe)||O,bt(a,t),Fe=N):bt(a,t),Tt(t),i&8192){if(N=t.memoizedState!==null,(t.stateNode.isHidden=N)&&!O&&(t.mode&1)!==0)for(_=t,O=t.child;O!==null;){for(D=_=O;_!==null;){switch(B=_,H=B.child,B.tag){case 0:case 11:case 14:case 15:_n(4,B,B.return);break;case 1:qa(B,B.return);var G=B.stateNode;if(typeof G.componentWillUnmount=="function"){i=B,n=B.return;try{a=i,G.props=a.memoizedProps,G.state=a.memoizedState,G.componentWillUnmount()}catch(Y){Se(i,n,Y)}}break;case 5:qa(B,B.return);break;case 22:if(B.memoizedState!==null){zd(D);continue}}H!==null?(H.return=B,_=H):zd(D)}O=O.sibling}e:for(O=null,D=t;;){if(D.tag===5){if(O===null){O=D;try{l=D.stateNode,N?(d=l.style,typeof d.setProperty=="function"?d.setProperty("display","none","important"):d.display="none"):(j=D.stateNode,S=D.memoizedProps.style,f=S!=null&&S.hasOwnProperty("display")?S.display:null,j.style.display=ul("display",f))}catch(Y){Se(t,t.return,Y)}}}else if(D.tag===6){if(O===null)try{D.stateNode.nodeValue=N?"":D.memoizedProps}catch(Y){Se(t,t.return,Y)}}else if((D.tag!==22&&D.tag!==23||D.memoizedState===null||D===t)&&D.child!==null){D.child.return=D,D=D.child;continue}if(D===t)break e;for(;D.sibling===null;){if(D.return===null||D.return===t)break e;O===D&&(O=null),D=D.return}O===D&&(O=null),D.sibling.return=D.return,D=D.sibling}}break;case 19:bt(a,t),Tt(t),i&4&&Pd(t);break;case 21:break;default:bt(a,t),Tt(t)}}function Tt(t){var a=t.flags;if(a&2){try{e:{for(var n=t.return;n!==null;){if(Td(n)){var i=n;break e}n=n.return}throw Error(o(160))}switch(i.tag){case 5:var l=i.stateNode;i.flags&32&&(dn(l,""),i.flags&=-33);var d=Ed(t);to(t,d,l);break;case 3:case 4:var f=i.stateNode.containerInfo,j=Ed(t);eo(t,j,f);break;default:throw Error(o(161))}}catch(S){Se(t,t.return,S)}t.flags&=-3}a&4096&&(t.flags&=-4097)}function pf(t,a,n){_=t,Bd(t)}function Bd(t,a,n){for(var i=(t.mode&1)!==0;_!==null;){var l=_,d=l.child;if(l.tag===22&&i){var f=l.memoizedState!==null||qr;if(!f){var j=l.alternate,S=j!==null&&j.memoizedState!==null||Fe;j=qr;var N=Fe;if(qr=f,(Fe=S)&&!N)for(_=l;_!==null;)f=_,S=f.child,f.tag===22&&f.memoizedState!==null?Od(l):S!==null?(S.return=f,_=S):Od(l);for(;d!==null;)_=d,Bd(d),d=d.sibling;_=l,qr=j,Fe=N}Md(t)}else(l.subtreeFlags&8772)!==0&&d!==null?(d.return=l,_=d):Md(t)}}function Md(t){for(;_!==null;){var a=_;if((a.flags&8772)!==0){var n=a.alternate;try{if((a.flags&8772)!==0)switch(a.tag){case 0:case 11:case 15:Fe||Qr(5,a);break;case 1:var i=a.stateNode;if(a.flags&4&&!Fe)if(n===null)i.componentDidMount();else{var l=a.elementType===a.type?n.memoizedProps:gt(a.type,n.memoizedProps);i.componentDidUpdate(l,n.memoizedState,i.__reactInternalSnapshotBeforeUpdate)}var d=a.updateQueue;d!==null&&zc(a,d,i);break;case 3:var f=a.updateQueue;if(f!==null){if(n=null,a.child!==null)switch(a.child.tag){case 5:n=a.child.stateNode;break;case 1:n=a.child.stateNode}zc(a,f,n)}break;case 5:var j=a.stateNode;if(n===null&&a.flags&4){n=j;var S=a.memoizedProps;switch(a.type){case"button":case"input":case"select":case"textarea":S.autoFocus&&n.focus();break;case"img":S.src&&(n.src=S.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(a.memoizedState===null){var N=a.alternate;if(N!==null){var O=N.memoizedState;if(O!==null){var D=O.dehydrated;D!==null&&jn(D)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(o(163))}Fe||a.flags&512&&Zs(a)}catch(B){Se(a,a.return,B)}}if(a===t){_=null;break}if(n=a.sibling,n!==null){n.return=a.return,_=n;break}_=a.return}}function zd(t){for(;_!==null;){var a=_;if(a===t){_=null;break}var n=a.sibling;if(n!==null){n.return=a.return,_=n;break}_=a.return}}function Od(t){for(;_!==null;){var a=_;try{switch(a.tag){case 0:case 11:case 15:var n=a.return;try{Qr(4,a)}catch(S){Se(a,n,S)}break;case 1:var i=a.stateNode;if(typeof i.componentDidMount=="function"){var l=a.return;try{i.componentDidMount()}catch(S){Se(a,l,S)}}var d=a.return;try{Zs(a)}catch(S){Se(a,d,S)}break;case 5:var f=a.return;try{Zs(a)}catch(S){Se(a,f,S)}}}catch(S){Se(a,a.return,S)}if(a===t){_=null;break}var j=a.sibling;if(j!==null){j.return=a.return,_=j;break}_=a.return}}var mf=Math.ceil,Xr=K.ReactCurrentDispatcher,ao=K.ReactCurrentOwner,lt=K.ReactCurrentBatchConfig,ie=0,Be=null,Ne=null,De=0,nt=0,Qa=Vt(0),Re=0,$n=null,ya=0,Zr=0,no=0,Gn=null,Ke=null,ro=0,Xa=1/0,Wt=null,ei=!1,io=null,ea=null,ti=!1,ta=null,ai=0,Yn=0,so=null,ni=-1,ri=0;function _e(){return(ie&6)!==0?Ce():ni!==-1?ni:ni=Ce()}function aa(t){return(t.mode&1)===0?1:(ie&2)!==0&&De!==0?De&-De:Vu.transition!==null?(ri===0&&(ri=El()),ri):(t=pe,t!==0||(t=window.event,t=t===void 0?16:Wl(t.type)),t)}function yt(t,a,n,i){if(50<Yn)throw Yn=0,so=null,Error(o(185));gn(t,n,i),((ie&2)===0||t!==Be)&&(t===Be&&((ie&2)===0&&(Zr|=n),Re===4&&na(t,De)),qe(t,i),n===1&&ie===0&&(a.mode&1)===0&&(Xa=Ce()+500,Ir&&qt()))}function qe(t,a){var n=t.callbackNode;Vm(t,a);var i=ur(t,t===Be?De:0);if(i===0)n!==null&&kl(n),t.callbackNode=null,t.callbackPriority=0;else if(a=i&-i,t.callbackPriority!==a){if(n!=null&&kl(n),a===1)t.tag===0?Ju(Wd.bind(null,t)):wc(Wd.bind(null,t)),_u(function(){(ie&6)===0&&qt()}),n=null;else{switch(Rl(i)){case 1:n=Li;break;case 4:n=Nl;break;case 16:n=cr;break;case 536870912:n=Tl;break;default:n=cr}n=Yd(n,Dd.bind(null,t))}t.callbackPriority=a,t.callbackNode=n}}function Dd(t,a){if(ni=-1,ri=0,(ie&6)!==0)throw Error(o(327));var n=t.callbackNode;if(Za()&&t.callbackNode!==n)return null;var i=ur(t,t===Be?De:0);if(i===0)return null;if((i&30)!==0||(i&t.expiredLanes)!==0||a)a=ii(t,i);else{a=i;var l=ie;ie|=2;var d=Hd();(Be!==t||De!==a)&&(Wt=null,Xa=Ce()+500,ja(t,a));do try{hf();break}catch(j){Ld(t,j)}while(!0);Cs(),Xr.current=d,ie=l,Ne!==null?a=0:(Be=null,De=0,a=Re)}if(a!==0){if(a===2&&(l=Hi(t),l!==0&&(i=l,a=oo(t,l))),a===1)throw n=$n,ja(t,0),na(t,i),qe(t,Ce()),n;if(a===6)na(t,i);else{if(l=t.current.alternate,(i&30)===0&&!uf(l)&&(a=ii(t,i),a===2&&(d=Hi(t),d!==0&&(i=d,a=oo(t,d))),a===1))throw n=$n,ja(t,0),na(t,i),qe(t,Ce()),n;switch(t.finishedWork=l,t.finishedLanes=i,a){case 0:case 1:throw Error(o(345));case 2:Sa(t,Ke,Wt);break;case 3:if(na(t,i),(i&130023424)===i&&(a=ro+500-Ce(),10<a)){if(ur(t,0)!==0)break;if(l=t.suspendedLanes,(l&i)!==i){_e(),t.pingedLanes|=t.suspendedLanes&l;break}t.timeoutHandle=us(Sa.bind(null,t,Ke,Wt),a);break}Sa(t,Ke,Wt);break;case 4:if(na(t,i),(i&4194240)===i)break;for(a=t.eventTimes,l=-1;0<i;){var f=31-ut(i);d=1<<f,f=a[f],f>l&&(l=f),i&=~d}if(i=l,i=Ce()-i,i=(120>i?120:480>i?480:1080>i?1080:1920>i?1920:3e3>i?3e3:4320>i?4320:1960*mf(i/1960))-i,10<i){t.timeoutHandle=us(Sa.bind(null,t,Ke,Wt),i);break}Sa(t,Ke,Wt);break;case 5:Sa(t,Ke,Wt);break;default:throw Error(o(329))}}}return qe(t,Ce()),t.callbackNode===n?Dd.bind(null,t):null}function oo(t,a){var n=Gn;return t.current.memoizedState.isDehydrated&&(ja(t,a).flags|=256),t=ii(t,a),t!==2&&(a=Ke,Ke=n,a!==null&&lo(a)),t}function lo(t){Ke===null?Ke=t:Ke.push.apply(Ke,t)}function uf(t){for(var a=t;;){if(a.flags&16384){var n=a.updateQueue;if(n!==null&&(n=n.stores,n!==null))for(var i=0;i<n.length;i++){var l=n[i],d=l.getSnapshot;l=l.value;try{if(!ft(d(),l))return!1}catch{return!1}}}if(n=a.child,a.subtreeFlags&16384&&n!==null)n.return=a,a=n;else{if(a===t)break;for(;a.sibling===null;){if(a.return===null||a.return===t)return!0;a=a.return}a.sibling.return=a.return,a=a.sibling}}return!0}function na(t,a){for(a&=~no,a&=~Zr,t.suspendedLanes|=a,t.pingedLanes&=~a,t=t.expirationTimes;0<a;){var n=31-ut(a),i=1<<n;t[n]=-1,a&=~i}}function Wd(t){if((ie&6)!==0)throw Error(o(327));Za();var a=ur(t,0);if((a&1)===0)return qe(t,Ce()),null;var n=ii(t,a);if(t.tag!==0&&n===2){var i=Hi(t);i!==0&&(a=i,n=oo(t,i))}if(n===1)throw n=$n,ja(t,0),na(t,a),qe(t,Ce()),n;if(n===6)throw Error(o(345));return t.finishedWork=t.current.alternate,t.finishedLanes=a,Sa(t,Ke,Wt),qe(t,Ce()),null}function co(t,a){var n=ie;ie|=1;try{return t(a)}finally{ie=n,ie===0&&(Xa=Ce()+500,Ir&&qt())}}function va(t){ta!==null&&ta.tag===0&&(ie&6)===0&&Za();var a=ie;ie|=1;var n=lt.transition,i=pe;try{if(lt.transition=null,pe=1,t)return t()}finally{pe=i,lt.transition=n,ie=a,(ie&6)===0&&qt()}}function po(){nt=Qa.current,he(Qa)}function ja(t,a){t.finishedWork=null,t.finishedLanes=0;var n=t.timeoutHandle;if(n!==-1&&(t.timeoutHandle=-1,Uu(n)),Ne!==null)for(n=Ne.return;n!==null;){var i=n;switch(ys(i),i.tag){case 1:i=i.type.childContextTypes,i!=null&&Rr();break;case 3:Va(),he(Ye),he(We),Is();break;case 5:Rs(i);break;case 4:Va();break;case 13:he(ye);break;case 19:he(ye);break;case 10:As(i.type._context);break;case 22:case 23:po()}n=n.return}if(Be=t,Ne=t=ra(t.current,null),De=nt=a,Re=0,$n=null,no=Zr=ya=0,Ke=Gn=null,ga!==null){for(a=0;a<ga.length;a++)if(n=ga[a],i=n.interleaved,i!==null){n.interleaved=null;var l=i.next,d=n.pending;if(d!==null){var f=d.next;d.next=l,i.next=f}n.pending=i}ga=null}return t}function Ld(t,a){do{var n=Ne;try{if(Cs(),Ur.current=Yr,_r){for(var i=ve.memoizedState;i!==null;){var l=i.queue;l!==null&&(l.pending=null),i=i.next}_r=!1}if(ba=0,Ie=Ee=ve=null,Wn=!1,Ln=0,ao.current=null,n===null||n.return===null){Re=1,$n=a,Ne=null;break}e:{var d=t,f=n.return,j=n,S=a;if(a=De,j.flags|=32768,S!==null&&typeof S=="object"&&typeof S.then=="function"){var N=S,O=j,D=O.tag;if((O.mode&1)===0&&(D===0||D===11||D===15)){var B=O.alternate;B?(O.updateQueue=B.updateQueue,O.memoizedState=B.memoizedState,O.lanes=B.lanes):(O.updateQueue=null,O.memoizedState=null)}var H=dd(f);if(H!==null){H.flags&=-257,pd(H,f,j,d,a),H.mode&1&&cd(d,N,a),a=H,S=N;var G=a.updateQueue;if(G===null){var Y=new Set;Y.add(S),a.updateQueue=Y}else G.add(S);break e}else{if((a&1)===0){cd(d,N,a),mo();break e}S=Error(o(426))}}else if(be&&j.mode&1){var Ae=dd(f);if(Ae!==null){(Ae.flags&65536)===0&&(Ae.flags|=256),pd(Ae,f,j,d,a),Ss(Ka(S,j));break e}}d=S=Ka(S,j),Re!==4&&(Re=2),Gn===null?Gn=[d]:Gn.push(d),d=f;do{switch(d.tag){case 3:d.flags|=65536,a&=-a,d.lanes|=a;var A=od(d,S,a);Mc(d,A);break e;case 1:j=S;var w=d.type,k=d.stateNode;if((d.flags&128)===0&&(typeof w.getDerivedStateFromError=="function"||k!==null&&typeof k.componentDidCatch=="function"&&(ea===null||!ea.has(k)))){d.flags|=65536,a&=-a,d.lanes|=a;var W=ld(d,j,a);Mc(d,W);break e}}d=d.return}while(d!==null)}Ud(n)}catch(J){a=J,Ne===n&&n!==null&&(Ne=n=n.return);continue}break}while(!0)}function Hd(){var t=Xr.current;return Xr.current=Yr,t===null?Yr:t}function mo(){(Re===0||Re===3||Re===2)&&(Re=4),Be===null||(ya&268435455)===0&&(Zr&268435455)===0||na(Be,De)}function ii(t,a){var n=ie;ie|=2;var i=Hd();(Be!==t||De!==a)&&(Wt=null,ja(t,a));do try{ff();break}catch(l){Ld(t,l)}while(!0);if(Cs(),ie=n,Xr.current=i,Ne!==null)throw Error(o(261));return Be=null,De=0,Re}function ff(){for(;Ne!==null;)Fd(Ne)}function hf(){for(;Ne!==null&&!Lm();)Fd(Ne)}function Fd(t){var a=Gd(t.alternate,t,nt);t.memoizedProps=t.pendingProps,a===null?Ud(t):Ne=a,ao.current=null}function Ud(t){var a=t;do{var n=a.alternate;if(t=a.return,(a.flags&32768)===0){if(n=of(n,a,nt),n!==null){Ne=n;return}}else{if(n=lf(n,a),n!==null){n.flags&=32767,Ne=n;return}if(t!==null)t.flags|=32768,t.subtreeFlags=0,t.deletions=null;else{Re=6,Ne=null;return}}if(a=a.sibling,a!==null){Ne=a;return}Ne=a=t}while(a!==null);Re===0&&(Re=5)}function Sa(t,a,n){var i=pe,l=lt.transition;try{lt.transition=null,pe=1,gf(t,a,n,i)}finally{lt.transition=l,pe=i}return null}function gf(t,a,n,i){do Za();while(ta!==null);if((ie&6)!==0)throw Error(o(327));n=t.finishedWork;var l=t.finishedLanes;if(n===null)return null;if(t.finishedWork=null,t.finishedLanes=0,n===t.current)throw Error(o(177));t.callbackNode=null,t.callbackPriority=0;var d=n.lanes|n.childLanes;if(Km(t,d),t===Be&&(Ne=Be=null,De=0),(n.subtreeFlags&2064)===0&&(n.flags&2064)===0||ti||(ti=!0,Yd(cr,function(){return Za(),null})),d=(n.flags&15990)!==0,(n.subtreeFlags&15990)!==0||d){d=lt.transition,lt.transition=null;var f=pe;pe=1;var j=ie;ie|=4,ao.current=null,df(t,n),Id(n,t),zu(ps),gr=!!ds,ps=ds=null,t.current=n,pf(n),Hm(),ie=j,pe=f,lt.transition=d}else t.current=n;if(ti&&(ti=!1,ta=t,ai=l),d=t.pendingLanes,d===0&&(ea=null),_m(n.stateNode),qe(t,Ce()),a!==null)for(i=t.onRecoverableError,n=0;n<a.length;n++)l=a[n],i(l.value,{componentStack:l.stack,digest:l.digest});if(ei)throw ei=!1,t=io,io=null,t;return(ai&1)!==0&&t.tag!==0&&Za(),d=t.pendingLanes,(d&1)!==0?t===so?Yn++:(Yn=0,so=t):Yn=0,qt(),null}function Za(){if(ta!==null){var t=Rl(ai),a=lt.transition,n=pe;try{if(lt.transition=null,pe=16>t?16:t,ta===null)var i=!1;else{if(t=ta,ta=null,ai=0,(ie&6)!==0)throw Error(o(331));var l=ie;for(ie|=4,_=t.current;_!==null;){var d=_,f=d.child;if((_.flags&16)!==0){var j=d.deletions;if(j!==null){for(var S=0;S<j.length;S++){var N=j[S];for(_=N;_!==null;){var O=_;switch(O.tag){case 0:case 11:case 15:_n(8,O,d)}var D=O.child;if(D!==null)D.return=O,_=D;else for(;_!==null;){O=_;var B=O.sibling,H=O.return;if(Nd(O),O===N){_=null;break}if(B!==null){B.return=H,_=B;break}_=H}}}var G=d.alternate;if(G!==null){var Y=G.child;if(Y!==null){G.child=null;do{var Ae=Y.sibling;Y.sibling=null,Y=Ae}while(Y!==null)}}_=d}}if((d.subtreeFlags&2064)!==0&&f!==null)f.return=d,_=f;else e:for(;_!==null;){if(d=_,(d.flags&2048)!==0)switch(d.tag){case 0:case 11:case 15:_n(9,d,d.return)}var A=d.sibling;if(A!==null){A.return=d.return,_=A;break e}_=d.return}}var w=t.current;for(_=w;_!==null;){f=_;var k=f.child;if((f.subtreeFlags&2064)!==0&&k!==null)k.return=f,_=k;else e:for(f=w;_!==null;){if(j=_,(j.flags&2048)!==0)try{switch(j.tag){case 0:case 11:case 15:Qr(9,j)}}catch(J){Se(j,j.return,J)}if(j===f){_=null;break e}var W=j.sibling;if(W!==null){W.return=j.return,_=W;break e}_=j.return}}if(ie=l,qt(),Ct&&typeof Ct.onPostCommitFiberRoot=="function")try{Ct.onPostCommitFiberRoot(dr,t)}catch{}i=!0}return i}finally{pe=n,lt.transition=a}}return!1}function _d(t,a,n){a=Ka(n,a),a=od(t,a,1),t=Xt(t,a,1),a=_e(),t!==null&&(gn(t,1,a),qe(t,a))}function Se(t,a,n){if(t.tag===3)_d(t,t,n);else for(;a!==null;){if(a.tag===3){_d(a,t,n);break}else if(a.tag===1){var i=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(ea===null||!ea.has(i))){t=Ka(n,t),t=ld(a,t,1),a=Xt(a,t,1),t=_e(),a!==null&&(gn(a,1,t),qe(a,t));break}}a=a.return}}function xf(t,a,n){var i=t.pingCache;i!==null&&i.delete(a),a=_e(),t.pingedLanes|=t.suspendedLanes&n,Be===t&&(De&n)===n&&(Re===4||Re===3&&(De&130023424)===De&&500>Ce()-ro?ja(t,0):no|=n),qe(t,a)}function $d(t,a){a===0&&((t.mode&1)===0?a=1:(a=mr,mr<<=1,(mr&130023424)===0&&(mr=4194304)));var n=_e();t=zt(t,a),t!==null&&(gn(t,a,n),qe(t,n))}function bf(t){var a=t.memoizedState,n=0;a!==null&&(n=a.retryLane),$d(t,n)}function yf(t,a){var n=0;switch(t.tag){case 13:var i=t.stateNode,l=t.memoizedState;l!==null&&(n=l.retryLane);break;case 19:i=t.stateNode;break;default:throw Error(o(314))}i!==null&&i.delete(a),$d(t,n)}var Gd;Gd=function(t,a,n){if(t!==null)if(t.memoizedProps!==a.pendingProps||Ye.current)Ve=!0;else{if((t.lanes&n)===0&&(a.flags&128)===0)return Ve=!1,sf(t,a,n);Ve=(t.flags&131072)!==0}else Ve=!1,be&&(a.flags&1048576)!==0&&Cc(a,Mr,a.index);switch(a.lanes=0,a.tag){case 2:var i=a.type;Kr(t,a),t=a.pendingProps;var l=Fa(a,We.current);Ja(a,n),l=zs(null,a,i,t,l,n);var d=Os();return a.flags|=1,typeof l=="object"&&l!==null&&typeof l.render=="function"&&l.$$typeof===void 0?(a.tag=1,a.memoizedState=null,a.updateQueue=null,Je(i)?(d=!0,Pr(a)):d=!1,a.memoizedState=l.state!==null&&l.state!==void 0?l.state:null,Ts(a),l.updater=Jr,a.stateNode=l,l._reactInternals=a,Us(a,i,t,n),a=Ys(null,a,i,!0,d,n)):(a.tag=0,be&&d&&bs(a),Ue(null,a,l,n),a=a.child),a;case 16:i=a.elementType;e:{switch(Kr(t,a),t=a.pendingProps,l=i._init,i=l(i._payload),a.type=i,l=a.tag=jf(i),t=gt(i,t),l){case 0:a=Gs(null,a,i,t,n);break e;case 1:a=xd(null,a,i,t,n);break e;case 11:a=md(null,a,i,t,n);break e;case 14:a=ud(null,a,i,gt(i.type,t),n);break e}throw Error(o(306,i,""))}return a;case 0:return i=a.type,l=a.pendingProps,l=a.elementType===i?l:gt(i,l),Gs(t,a,i,l,n);case 1:return i=a.type,l=a.pendingProps,l=a.elementType===i?l:gt(i,l),xd(t,a,i,l,n);case 3:e:{if(bd(a),t===null)throw Error(o(387));i=a.pendingProps,d=a.memoizedState,l=d.element,Bc(t,a),Hr(a,i,null,n);var f=a.memoizedState;if(i=f.element,d.isDehydrated)if(d={element:i,isDehydrated:!1,cache:f.cache,pendingSuspenseBoundaries:f.pendingSuspenseBoundaries,transitions:f.transitions},a.updateQueue.baseState=d,a.memoizedState=d,a.flags&256){l=Ka(Error(o(423)),a),a=yd(t,a,i,n,l);break e}else if(i!==l){l=Ka(Error(o(424)),a),a=yd(t,a,i,n,l);break e}else for(at=Jt(a.stateNode.containerInfo.firstChild),tt=a,be=!0,ht=null,n=Pc(a,null,i,n),a.child=n;n;)n.flags=n.flags&-3|4096,n=n.sibling;else{if($a(),i===l){a=Dt(t,a,n);break e}Ue(t,a,i,n)}a=a.child}return a;case 5:return Oc(a),t===null&&js(a),i=a.type,l=a.pendingProps,d=t!==null?t.memoizedProps:null,f=l.children,ms(i,l)?f=null:d!==null&&ms(i,d)&&(a.flags|=32),gd(t,a),Ue(t,a,f,n),a.child;case 6:return t===null&&js(a),null;case 13:return vd(t,a,n);case 4:return Es(a,a.stateNode.containerInfo),i=a.pendingProps,t===null?a.child=Ga(a,null,i,n):Ue(t,a,i,n),a.child;case 11:return i=a.type,l=a.pendingProps,l=a.elementType===i?l:gt(i,l),md(t,a,i,l,n);case 7:return Ue(t,a,a.pendingProps,n),a.child;case 8:return Ue(t,a,a.pendingProps.children,n),a.child;case 12:return Ue(t,a,a.pendingProps.children,n),a.child;case 10:e:{if(i=a.type._context,l=a.pendingProps,d=a.memoizedProps,f=l.value,ue(Dr,i._currentValue),i._currentValue=f,d!==null)if(ft(d.value,f)){if(d.children===l.children&&!Ye.current){a=Dt(t,a,n);break e}}else for(d=a.child,d!==null&&(d.return=a);d!==null;){var j=d.dependencies;if(j!==null){f=d.child;for(var S=j.firstContext;S!==null;){if(S.context===i){if(d.tag===1){S=Ot(-1,n&-n),S.tag=2;var N=d.updateQueue;if(N!==null){N=N.shared;var O=N.pending;O===null?S.next=S:(S.next=O.next,O.next=S),N.pending=S}}d.lanes|=n,S=d.alternate,S!==null&&(S.lanes|=n),ks(d.return,n,a),j.lanes|=n;break}S=S.next}}else if(d.tag===10)f=d.type===a.type?null:d.child;else if(d.tag===18){if(f=d.return,f===null)throw Error(o(341));f.lanes|=n,j=f.alternate,j!==null&&(j.lanes|=n),ks(f,n,a),f=d.sibling}else f=d.child;if(f!==null)f.return=d;else for(f=d;f!==null;){if(f===a){f=null;break}if(d=f.sibling,d!==null){d.return=f.return,f=d;break}f=f.return}d=f}Ue(t,a,l.children,n),a=a.child}return a;case 9:return l=a.type,i=a.pendingProps.children,Ja(a,n),l=st(l),i=i(l),a.flags|=1,Ue(t,a,i,n),a.child;case 14:return i=a.type,l=gt(i,a.pendingProps),l=gt(i.type,l),ud(t,a,i,l,n);case 15:return fd(t,a,a.type,a.pendingProps,n);case 17:return i=a.type,l=a.pendingProps,l=a.elementType===i?l:gt(i,l),Kr(t,a),a.tag=1,Je(i)?(t=!0,Pr(a)):t=!1,Ja(a,n),id(a,i,l),Us(a,i,l,n),Ys(null,a,i,!0,t,n);case 19:return Sd(t,a,n);case 22:return hd(t,a,n)}throw Error(o(156,a.tag))};function Yd(t,a){return Al(t,a)}function vf(t,a,n,i){this.tag=t,this.key=n,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=a,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function ct(t,a,n,i){return new vf(t,a,n,i)}function uo(t){return t=t.prototype,!(!t||!t.isReactComponent)}function jf(t){if(typeof t=="function")return uo(t)?1:0;if(t!=null){if(t=t.$$typeof,t===ze)return 11;if(t===wt)return 14}return 2}function ra(t,a){var n=t.alternate;return n===null?(n=ct(t.tag,a,t.key,t.mode),n.elementType=t.elementType,n.type=t.type,n.stateNode=t.stateNode,n.alternate=t,t.alternate=n):(n.pendingProps=a,n.type=t.type,n.flags=0,n.subtreeFlags=0,n.deletions=null),n.flags=t.flags&14680064,n.childLanes=t.childLanes,n.lanes=t.lanes,n.child=t.child,n.memoizedProps=t.memoizedProps,n.memoizedState=t.memoizedState,n.updateQueue=t.updateQueue,a=t.dependencies,n.dependencies=a===null?null:{lanes:a.lanes,firstContext:a.firstContext},n.sibling=t.sibling,n.index=t.index,n.ref=t.ref,n}function si(t,a,n,i,l,d){var f=2;if(i=t,typeof t=="function")uo(t)&&(f=1);else if(typeof t=="string")f=5;else e:switch(t){case ke:return wa(n.children,l,d,a);case ce:f=8,l|=8;break;case $e:return t=ct(12,n,a,l|2),t.elementType=$e,t.lanes=d,t;case Xe:return t=ct(13,n,a,l),t.elementType=Xe,t.lanes=d,t;case mt:return t=ct(19,n,a,l),t.elementType=mt,t.lanes=d,t;case je:return oi(n,l,d,a);default:if(typeof t=="object"&&t!==null)switch(t.$$typeof){case St:f=10;break e;case pt:f=9;break e;case ze:f=11;break e;case wt:f=14;break e;case Ge:f=16,i=null;break e}throw Error(o(130,t==null?t:typeof t,""))}return a=ct(f,n,a,l),a.elementType=t,a.type=i,a.lanes=d,a}function wa(t,a,n,i){return t=ct(7,t,i,a),t.lanes=n,t}function oi(t,a,n,i){return t=ct(22,t,i,a),t.elementType=je,t.lanes=n,t.stateNode={isHidden:!1},t}function fo(t,a,n){return t=ct(6,t,null,a),t.lanes=n,t}function ho(t,a,n){return a=ct(4,t.children!==null?t.children:[],t.key,a),a.lanes=n,a.stateNode={containerInfo:t.containerInfo,pendingChildren:null,implementation:t.implementation},a}function Sf(t,a,n,i,l){this.tag=a,this.containerInfo=t,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Fi(0),this.expirationTimes=Fi(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Fi(0),this.identifierPrefix=i,this.onRecoverableError=l,this.mutableSourceEagerHydrationData=null}function go(t,a,n,i,l,d,f,j,S){return t=new Sf(t,a,n,j,S),a===1?(a=1,d===!0&&(a|=8)):a=0,d=ct(3,null,null,a),t.current=d,d.stateNode=t,d.memoizedState={element:i,isDehydrated:n,cache:null,transitions:null,pendingSuspenseBoundaries:null},Ts(d),t}function wf(t,a,n){var i=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:te,key:i==null?null:""+i,children:t,containerInfo:a,implementation:n}}function Jd(t){if(!t)return Kt;t=t._reactInternals;e:{if(pa(t)!==t||t.tag!==1)throw Error(o(170));var a=t;do{switch(a.tag){case 3:a=a.stateNode.context;break e;case 1:if(Je(a.type)){a=a.stateNode.__reactInternalMemoizedMergedChildContext;break e}}a=a.return}while(a!==null);throw Error(o(171))}if(t.tag===1){var n=t.type;if(Je(n))return jc(t,n,a)}return a}function Vd(t,a,n,i,l,d,f,j,S){return t=go(n,i,!0,t,l,d,f,j,S),t.context=Jd(null),n=t.current,i=_e(),l=aa(n),d=Ot(i,l),d.callback=a??null,Xt(n,d,l),t.current.lanes=l,gn(t,l,i),qe(t,i),t}function li(t,a,n,i){var l=a.current,d=_e(),f=aa(l);return n=Jd(n),a.context===null?a.context=n:a.pendingContext=n,a=Ot(d,f),a.payload={element:t},i=i===void 0?null:i,i!==null&&(a.callback=i),t=Xt(l,a,f),t!==null&&(yt(t,l,f,d),Lr(t,l,f)),f}function ci(t){if(t=t.current,!t.child)return null;switch(t.child.tag){case 5:return t.child.stateNode;default:return t.child.stateNode}}function Kd(t,a){if(t=t.memoizedState,t!==null&&t.dehydrated!==null){var n=t.retryLane;t.retryLane=n!==0&&n<a?n:a}}function xo(t,a){Kd(t,a),(t=t.alternate)&&Kd(t,a)}function Cf(){return null}var qd=typeof reportError=="function"?reportError:function(t){console.error(t)};function bo(t){this._internalRoot=t}di.prototype.render=bo.prototype.render=function(t){var a=this._internalRoot;if(a===null)throw Error(o(409));li(t,a,null,null)},di.prototype.unmount=bo.prototype.unmount=function(){var t=this._internalRoot;if(t!==null){this._internalRoot=null;var a=t.containerInfo;va(function(){li(null,t,null,null)}),a[Pt]=null}};function di(t){this._internalRoot=t}di.prototype.unstable_scheduleHydration=function(t){if(t){var a=Bl();t={blockedOn:null,target:t,priority:a};for(var n=0;n<$t.length&&a!==0&&a<$t[n].priority;n++);$t.splice(n,0,t),n===0&&Ol(t)}};function yo(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function pi(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11&&(t.nodeType!==8||t.nodeValue!==" react-mount-point-unstable "))}function Qd(){}function Af(t,a,n,i,l){if(l){if(typeof i=="function"){var d=i;i=function(){var N=ci(f);d.call(N)}}var f=Vd(a,i,t,0,null,!1,!1,"",Qd);return t._reactRootContainer=f,t[Pt]=f.current,Rn(t.nodeType===8?t.parentNode:t),va(),f}for(;l=t.lastChild;)t.removeChild(l);if(typeof i=="function"){var j=i;i=function(){var N=ci(S);j.call(N)}}var S=go(t,0,!1,null,null,!1,!1,"",Qd);return t._reactRootContainer=S,t[Pt]=S.current,Rn(t.nodeType===8?t.parentNode:t),va(function(){li(a,S,n,i)}),S}function mi(t,a,n,i,l){var d=n._reactRootContainer;if(d){var f=d;if(typeof l=="function"){var j=l;l=function(){var S=ci(f);j.call(S)}}li(a,f,t,l)}else f=Af(n,a,t,l,i);return ci(f)}Pl=function(t){switch(t.tag){case 3:var a=t.stateNode;if(a.current.memoizedState.isDehydrated){var n=hn(a.pendingLanes);n!==0&&(Ui(a,n|1),qe(a,Ce()),(ie&6)===0&&(Xa=Ce()+500,qt()))}break;case 13:va(function(){var i=zt(t,1);if(i!==null){var l=_e();yt(i,t,1,l)}}),xo(t,1)}},_i=function(t){if(t.tag===13){var a=zt(t,134217728);if(a!==null){var n=_e();yt(a,t,134217728,n)}xo(t,134217728)}},Il=function(t){if(t.tag===13){var a=aa(t),n=zt(t,a);if(n!==null){var i=_e();yt(n,t,a,i)}xo(t,a)}},Bl=function(){return pe},Ml=function(t,a){var n=pe;try{return pe=t,a()}finally{pe=n}},zi=function(t,a,n){switch(a){case"input":if(Ni(t,n),a=n.name,n.type==="radio"&&a!=null){for(n=t;n.parentNode;)n=n.parentNode;for(n=n.querySelectorAll("input[name="+JSON.stringify(""+a)+'][type="radio"]'),a=0;a<n.length;a++){var i=n[a];if(i!==t&&i.form===t.form){var l=Er(i);if(!l)throw Error(o(90));rl(i),Ni(i,l)}}}break;case"textarea":cl(t,n);break;case"select":a=n.value,a!=null&&Ea(t,!!n.multiple,a,!1)}},bl=co,yl=va;var kf={usingClientEntryPoint:!1,Events:[Bn,La,Er,gl,xl,co]},Jn={findFiberByHostInstance:ma,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},Nf={bundleType:Jn.bundleType,version:Jn.version,rendererPackageName:Jn.rendererPackageName,rendererConfig:Jn.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:K.ReactCurrentDispatcher,findHostInstanceByFiber:function(t){return t=wl(t),t===null?null:t.stateNode},findFiberByHostInstance:Jn.findFiberByHostInstance||Cf,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var ui=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!ui.isDisabled&&ui.supportsFiber)try{dr=ui.inject(Nf),Ct=ui}catch{}}return Qe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=kf,Qe.createPortal=function(t,a){var n=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!yo(a))throw Error(o(200));return wf(t,a,null,n)},Qe.createRoot=function(t,a){if(!yo(t))throw Error(o(299));var n=!1,i="",l=qd;return a!=null&&(a.unstable_strictMode===!0&&(n=!0),a.identifierPrefix!==void 0&&(i=a.identifierPrefix),a.onRecoverableError!==void 0&&(l=a.onRecoverableError)),a=go(t,1,!1,null,null,n,!1,i,l),t[Pt]=a.current,Rn(t.nodeType===8?t.parentNode:t),new bo(a)},Qe.findDOMNode=function(t){if(t==null)return null;if(t.nodeType===1)return t;var a=t._reactInternals;if(a===void 0)throw typeof t.render=="function"?Error(o(188)):(t=Object.keys(t).join(","),Error(o(268,t)));return t=wl(a),t=t===null?null:t.stateNode,t},Qe.flushSync=function(t){return va(t)},Qe.hydrate=function(t,a,n){if(!pi(a))throw Error(o(200));return mi(null,t,a,!0,n)},Qe.hydrateRoot=function(t,a,n){if(!yo(t))throw Error(o(405));var i=n!=null&&n.hydratedSources||null,l=!1,d="",f=qd;if(n!=null&&(n.unstable_strictMode===!0&&(l=!0),n.identifierPrefix!==void 0&&(d=n.identifierPrefix),n.onRecoverableError!==void 0&&(f=n.onRecoverableError)),a=Vd(a,null,t,1,n??null,l,!1,d,f),t[Pt]=a.current,Rn(t),i)for(t=0;t<i.length;t++)n=i[t],l=n._getVersion,l=l(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,l]:a.mutableSourceEagerHydrationData.push(n,l);return new di(a)},Qe.render=function(t,a,n){if(!pi(a))throw Error(o(200));return mi(null,t,a,!1,n)},Qe.unmountComponentAtNode=function(t){if(!pi(t))throw Error(o(40));return t._reactRootContainer?(va(function(){mi(null,null,t,!1,function(){t._reactRootContainer=null,t[Pt]=null})}),!0):!1},Qe.unstable_batchedUpdates=co,Qe.unstable_renderSubtreeIntoContainer=function(t,a,n,i){if(!pi(n))throw Error(o(200));if(t==null||t._reactInternals===void 0)throw Error(o(38));return mi(t,a,n,!1,i)},Qe.version="18.3.1-next-f1338f8080-20240426",Qe}var ip;function tm(){if(ip)return So.exports;ip=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(s){console.error(s)}}return r(),So.exports=Wf(),So.exports}var sp;function Lf(){if(sp)return fi;sp=1;var r=tm();return fi.createRoot=r.createRoot,fi.hydrateRoot=r.hydrateRoot,fi}var Hf=Lf(),Ao,op;function Ff(){if(op)return Ao;op=1;var r=typeof Element<"u",s=typeof Map=="function",o=typeof Set=="function",c=typeof ArrayBuffer=="function"&&!!ArrayBuffer.isView;function m(p,u){if(p===u)return!0;if(p&&u&&typeof p=="object"&&typeof u=="object"){if(p.constructor!==u.constructor)return!1;var x,h,b;if(Array.isArray(p)){if(x=p.length,x!=u.length)return!1;for(h=x;h--!==0;)if(!m(p[h],u[h]))return!1;return!0}var y;if(s&&p instanceof Map&&u instanceof Map){if(p.size!==u.size)return!1;for(y=p.entries();!(h=y.next()).done;)if(!u.has(h.value[0]))return!1;for(y=p.entries();!(h=y.next()).done;)if(!m(h.value[1],u.get(h.value[0])))return!1;return!0}if(o&&p instanceof Set&&u instanceof Set){if(p.size!==u.size)return!1;for(y=p.entries();!(h=y.next()).done;)if(!u.has(h.value[0]))return!1;return!0}if(c&&ArrayBuffer.isView(p)&&ArrayBuffer.isView(u)){if(x=p.length,x!=u.length)return!1;for(h=x;h--!==0;)if(p[h]!==u[h])return!1;return!0}if(p.constructor===RegExp)return p.source===u.source&&p.flags===u.flags;if(p.valueOf!==Object.prototype.valueOf&&typeof p.valueOf=="function"&&typeof u.valueOf=="function")return p.valueOf()===u.valueOf();if(p.toString!==Object.prototype.toString&&typeof p.toString=="function"&&typeof u.toString=="function")return p.toString()===u.toString();if(b=Object.keys(p),x=b.length,x!==Object.keys(u).length)return!1;for(h=x;h--!==0;)if(!Object.prototype.hasOwnProperty.call(u,b[h]))return!1;if(r&&p instanceof Element)return!1;for(h=x;h--!==0;)if(!((b[h]==="_owner"||b[h]==="__v"||b[h]==="__o")&&p.$$typeof)&&!m(p[b[h]],u[b[h]]))return!1;return!0}return p!==p&&u!==u}return Ao=function(u,x){try{return m(u,x)}catch(h){if((h.message||"").match(/stack|recursion/i))return console.warn("react-fast-compare cannot handle circular refs"),!1;throw h}},Ao}var Uf=Ff();const _f=wi(Uf);var ko,lp;function $f(){if(lp)return ko;lp=1;var r=function(s,o,c,m,p,u,x,h){if(!s){var b;if(o===void 0)b=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var y=[c,m,p,u,x,h],g=0;b=new Error(o.replace(/%s/g,function(){return y[g++]})),b.name="Invariant Violation"}throw b.framesToPop=1,b}};return ko=r,ko}var Gf=$f();const cp=wi(Gf);var No,dp;function Yf(){return dp||(dp=1,No=function(s,o,c,m){var p=c?c.call(m,s,o):void 0;if(p!==void 0)return!!p;if(s===o)return!0;if(typeof s!="object"||!s||typeof o!="object"||!o)return!1;var u=Object.keys(s),x=Object.keys(o);if(u.length!==x.length)return!1;for(var h=Object.prototype.hasOwnProperty.bind(o),b=0;b<u.length;b++){var y=u[b];if(!h(y))return!1;var g=s[y],T=o[y];if(p=c?c.call(m,g,T,y):void 0,p===!1||p===void 0&&g!==T)return!1}return!0}),No}var Jf=Yf();const Vf=wi(Jf);var am=(r=>(r.BASE="base",r.BODY="body",r.HEAD="head",r.HTML="html",r.LINK="link",r.META="meta",r.NOSCRIPT="noscript",r.SCRIPT="script",r.STYLE="style",r.TITLE="title",r.FRAGMENT="Symbol(react.fragment)",r))(am||{}),To={link:{rel:["amphtml","canonical","alternate"]},script:{type:["application/ld+json"]},meta:{charset:"",name:["generator","robots","description"],property:["og:type","og:title","og:url","og:image","og:image:alt","og:description","twitter:url","twitter:title","twitter:description","twitter:image","twitter:image:alt","twitter:card","twitter:site"]}},pp=Object.values(am),Ci={accesskey:"accessKey",charset:"charSet",class:"className",contenteditable:"contentEditable",contextmenu:"contextMenu","http-equiv":"httpEquiv",itemprop:"itemProp",tabindex:"tabIndex"},nm=Object.entries(Ci).reduce((r,[s,o])=>(r[o]=s,r),{}),jt="data-rh",sn={DEFAULT_TITLE:"defaultTitle",DEFER:"defer",ENCODE_SPECIAL_CHARACTERS:"encodeSpecialCharacters",ON_CHANGE_CLIENT_STATE:"onChangeClientState",TITLE_TEMPLATE:"titleTemplate",PRIORITIZE_SEO_TAGS:"prioritizeSeoTags"},on=(r,s)=>{for(let o=r.length-1;o>=0;o-=1){const c=r[o];if(Object.prototype.hasOwnProperty.call(c,s))return c[s]}return null},Kf=r=>{let s=on(r,"title");const o=on(r,sn.TITLE_TEMPLATE);if(Array.isArray(s)&&(s=s.join("")),o&&s)return o.replace(/%s/g,()=>s);const c=on(r,sn.DEFAULT_TITLE);return s||c||void 0},qf=r=>on(r,sn.ON_CHANGE_CLIENT_STATE)||(()=>{}),Eo=(r,s)=>s.filter(o=>typeof o[r]<"u").map(o=>o[r]).reduce((o,c)=>({...o,...c}),{}),Qf=(r,s)=>s.filter(o=>typeof o.base<"u").map(o=>o.base).reverse().reduce((o,c)=>{if(!o.length){const m=Object.keys(c);for(let p=0;p<m.length;p+=1){const x=m[p].toLowerCase();if(r.indexOf(x)!==-1&&c[x])return o.concat(c)}}return o},[]),Xf=r=>console&&typeof console.warn=="function"&&console.warn(r),Kn=(r,s,o)=>{const c={};return o.filter(m=>Array.isArray(m[r])?!0:(typeof m[r]<"u"&&Xf(`Helmet: ${r} should be of type "Array". Instead found type "${typeof m[r]}"`),!1)).map(m=>m[r]).reverse().reduce((m,p)=>{const u={};p.filter(h=>{let b;const y=Object.keys(h);for(let T=0;T<y.length;T+=1){const E=y[T],F=E.toLowerCase();s.indexOf(F)!==-1&&!(b==="rel"&&h[b].toLowerCase()==="canonical")&&!(F==="rel"&&h[F].toLowerCase()==="stylesheet")&&(b=F),s.indexOf(E)!==-1&&(E==="innerHTML"||E==="cssText"||E==="itemprop")&&(b=E)}if(!b||!h[b])return!1;const g=h[b].toLowerCase();return c[b]||(c[b]={}),u[b]||(u[b]={}),c[b][g]?!1:(u[b][g]=!0,!0)}).reverse().forEach(h=>m.push(h));const x=Object.keys(u);for(let h=0;h<x.length;h+=1){const b=x[h],y={...c[b],...u[b]};c[b]=y}return m},[]).reverse()},Zf=(r,s)=>{if(Array.isArray(r)&&r.length){for(let o=0;o<r.length;o+=1)if(r[o][s])return!0}return!1},eh=r=>({baseTag:Qf(["href"],r),bodyAttributes:Eo("bodyAttributes",r),defer:on(r,sn.DEFER),encode:on(r,sn.ENCODE_SPECIAL_CHARACTERS),htmlAttributes:Eo("htmlAttributes",r),linkTags:Kn("link",["rel","href"],r),metaTags:Kn("meta",["name","charset","http-equiv","property","itemprop"],r),noscriptTags:Kn("noscript",["innerHTML"],r),onChangeClientState:qf(r),scriptTags:Kn("script",["src","innerHTML"],r),styleTags:Kn("style",["cssText"],r),title:Kf(r),titleAttributes:Eo("titleAttributes",r),prioritizeSeoTags:Zf(r,sn.PRIORITIZE_SEO_TAGS)}),rm=r=>Array.isArray(r)?r.join(""):r,th=(r,s)=>{const o=Object.keys(r);for(let c=0;c<o.length;c+=1)if(s[o[c]]&&s[o[c]].includes(r[o[c]]))return!0;return!1},Ro=(r,s)=>Array.isArray(r)?r.reduce((o,c)=>(th(c,s)?o.priority.push(c):o.default.push(c),o),{priority:[],default:[]}):{default:r,priority:[]},mp=(r,s)=>({...r,[s]:void 0}),ah=["noscript","script","style"],Fo=(r,s=!0)=>s===!1?String(r):String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;"),im=r=>Object.keys(r).reduce((s,o)=>{const c=typeof r[o]<"u"?`${o}="${r[o]}"`:`${o}`;return s?`${s} ${c}`:c},""),nh=(r,s,o,c)=>{const m=im(o),p=rm(s);return m?`<${r} ${jt}="true" ${m}>${Fo(p,c)}</${r}>`:`<${r} ${jt}="true">${Fo(p,c)}</${r}>`},rh=(r,s,o=!0)=>s.reduce((c,m)=>{const p=m,u=Object.keys(p).filter(b=>!(b==="innerHTML"||b==="cssText")).reduce((b,y)=>{const g=typeof p[y]>"u"?y:`${y}="${Fo(p[y],o)}"`;return b?`${b} ${g}`:g},""),x=p.innerHTML||p.cssText||"",h=ah.indexOf(r)===-1;return`${c}<${r} ${jt}="true" ${u}${h?"/>":`>${x}</${r}>`}`},""),sm=(r,s={})=>Object.keys(r).reduce((o,c)=>{const m=Ci[c];return o[m||c]=r[c],o},s),ih=(r,s,o)=>{const c={key:s,[jt]:!0},m=sm(o,c);return[we.createElement("title",m,s)]},vi=(r,s)=>s.map((o,c)=>{const m={key:c,[jt]:!0};return Object.keys(o).forEach(p=>{const x=Ci[p]||p;if(x==="innerHTML"||x==="cssText"){const h=o.innerHTML||o.cssText;m.dangerouslySetInnerHTML={__html:h}}else m[x]=o[p]}),we.createElement(r,m)}),dt=(r,s,o=!0)=>{switch(r){case"title":return{toComponent:()=>ih(r,s.title,s.titleAttributes),toString:()=>nh(r,s.title,s.titleAttributes,o)};case"bodyAttributes":case"htmlAttributes":return{toComponent:()=>sm(s),toString:()=>im(s)};default:return{toComponent:()=>vi(r,s),toString:()=>rh(r,s,o)}}},sh=({metaTags:r,linkTags:s,scriptTags:o,encode:c})=>{const m=Ro(r,To.meta),p=Ro(s,To.link),u=Ro(o,To.script);return{priorityMethods:{toComponent:()=>[...vi("meta",m.priority),...vi("link",p.priority),...vi("script",u.priority)],toString:()=>`${dt("meta",m.priority,c)} ${dt("link",p.priority,c)} ${dt("script",u.priority,c)}`},metaTags:m.default,linkTags:p.default,scriptTags:u.default}},oh=r=>{const{baseTag:s,bodyAttributes:o,encode:c=!0,htmlAttributes:m,noscriptTags:p,styleTags:u,title:x="",titleAttributes:h,prioritizeSeoTags:b}=r;let{linkTags:y,metaTags:g,scriptTags:T}=r,E={toComponent:()=>[],toString:()=>""};return b&&({priorityMethods:E,linkTags:y,metaTags:g,scriptTags:T}=sh(r)),{priority:E,base:dt("base",s,c),bodyAttributes:dt("bodyAttributes",o,c),htmlAttributes:dt("htmlAttributes",m,c),link:dt("link",y,c),meta:dt("meta",g,c),noscript:dt("noscript",p,c),script:dt("script",T,c),style:dt("style",u,c),title:dt("title",{title:x,titleAttributes:h},c)}},Uo=oh,hi=[],Xo=!!(typeof window<"u"&&window.document&&window.document.createElement),_o=class{constructor(r,s){Lt(this,"instances",[]);Lt(this,"canUseDOM",Xo);Lt(this,"context");Lt(this,"value",{setHelmet:r=>{this.context.helmet=r},helmetInstances:{get:()=>this.canUseDOM?hi:this.instances,add:r=>{(this.canUseDOM?hi:this.instances).push(r)},remove:r=>{const s=(this.canUseDOM?hi:this.instances).indexOf(r);(this.canUseDOM?hi:this.instances).splice(s,1)}}});this.context=r,this.canUseDOM=s||!1,s||(r.helmet=Uo({baseTag:[],bodyAttributes:{},htmlAttributes:{},linkTags:[],metaTags:[],noscriptTags:[],scriptTags:[],styleTags:[],title:"",titleAttributes:{}}))}},lh=parseInt(we.version.split(".")[0],10),$o=lh>=19,ch={},om=we.createContext(ch),Aa,lm=(Aa=class extends v.Component{constructor(o){super(o);Lt(this,"helmetData");$o?this.helmetData=null:this.helmetData=new _o(this.props.context||{},Aa.canUseDOM)}render(){return $o?we.createElement(we.Fragment,null,this.props.children):we.createElement(om.Provider,{value:this.helmetData.value},this.props.children)}},Lt(Aa,"canUseDOM",Xo),Aa),en=(r,s)=>{const o=document.head||document.querySelector("head"),c=o.querySelectorAll(`${r}[${jt}]`),m=[].slice.call(c),p=[];let u;return s&&s.length&&s.forEach(x=>{const h=document.createElement(r);for(const b in x)if(Object.prototype.hasOwnProperty.call(x,b))if(b==="innerHTML")h.innerHTML=x.innerHTML;else if(b==="cssText"){const y=x.cssText;h.appendChild(document.createTextNode(y))}else{const y=b,g=typeof x[y]>"u"?"":x[y];h.setAttribute(b,g)}h.setAttribute(jt,"true"),m.some((b,y)=>(u=y,h.isEqualNode(b)))?m.splice(u,1):p.push(h)}),m.forEach(x=>{var h;return(h=x.parentNode)==null?void 0:h.removeChild(x)}),p.forEach(x=>o.appendChild(x)),{oldTags:m,newTags:p}},Go=(r,s)=>{const o=document.getElementsByTagName(r)[0];if(!o)return;const c=o.getAttribute(jt),m=c?c.split(","):[],p=[...m],u=Object.keys(s);for(const x of u){const h=s[x]||"";o.getAttribute(x)!==h&&o.setAttribute(x,h),m.indexOf(x)===-1&&m.push(x);const b=p.indexOf(x);b!==-1&&p.splice(b,1)}for(let x=p.length-1;x>=0;x-=1)o.removeAttribute(p[x]);m.length===p.length?o.removeAttribute(jt):o.getAttribute(jt)!==u.join(",")&&o.setAttribute(jt,u.join(","))},dh=(r,s)=>{typeof r<"u"&&document.title!==r&&(document.title=rm(r)),Go("title",s)},up=(r,s)=>{const{baseTag:o,bodyAttributes:c,htmlAttributes:m,linkTags:p,metaTags:u,noscriptTags:x,onChangeClientState:h,scriptTags:b,styleTags:y,title:g,titleAttributes:T}=r;Go("body",c),Go("html",m),dh(g,T);const E={baseTag:en("base",o),linkTags:en("link",p),metaTags:en("meta",u),noscriptTags:en("noscript",x),scriptTags:en("script",b),styleTags:en("style",y)},F={},R={};Object.keys(E).forEach(M=>{const{newTags:I,oldTags:P}=E[M];I.length&&(F[M]=I),P.length&&(R[M]=E[M].oldTags)}),s&&s(),h(r,F,R)},qn=null,ph=r=>{qn&&cancelAnimationFrame(qn),r.defer?qn=requestAnimationFrame(()=>{up(r,()=>{qn=null})}):(up(r),qn=null)},mh=ph,fp=class extends v.Component{constructor(){super(...arguments);Lt(this,"rendered",!1)}shouldComponentUpdate(s){return!Vf(s,this.props)}componentDidUpdate(){this.emitChange()}componentWillUnmount(){const{helmetInstances:s}=this.props.context;s.remove(this),this.emitChange()}emitChange(){const{helmetInstances:s,setHelmet:o}=this.props.context;let c=null;const m=eh(s.get().map(p=>{const{context:u,...x}=p.props;return x}));lm.canUseDOM?mh(m):Uo&&(c=Uo(m)),o(c)}init(){if(this.rendered)return;this.rendered=!0;const{helmetInstances:s}=this.props.context;s.add(this),this.emitChange()}render(){return this.init(),null}},ji=[],hp=r=>{const s={};for(const o of Object.keys(r))s[nm[o]||o]=r[o];return s},Ca=r=>{const s={};for(const o of Object.keys(r)){const c=Ci[o];s[c||o]=r[o]}return s},gp=(r,s)=>{if(!Xo)return;const o=document.getElementsByTagName(r)[0];if(!o)return;const c="data-rh-managed",m=o.getAttribute(c),p=m?m.split(","):[],u=Object.keys(s);for(const x of p)u.includes(x)||o.removeAttribute(x);for(const x of u){const h=s[x];h==null||h===!1?o.removeAttribute(x):h===!0?o.setAttribute(x,""):o.setAttribute(x,String(h))}u.length>0?o.setAttribute(c,u.join(",")):o.removeAttribute(c)},Po=()=>{const r={},s={};for(const o of ji){const{htmlAttributes:c,bodyAttributes:m}=o.props;c&&Object.assign(r,hp(c)),m&&Object.assign(s,hp(m))}gp("html",r),gp("body",s)},uh=class extends v.Component{componentDidMount(){ji.push(this),Po()}componentDidUpdate(){Po()}componentWillUnmount(){const r=ji.indexOf(this);r!==-1&&ji.splice(r,1),Po()}resolveTitle(){const{title:r,titleTemplate:s,defaultTitle:o}=this.props;return r&&s?s.replace(/%s/g,()=>Array.isArray(r)?r.join(""):r):r||o||void 0}renderTitle(){const r=this.resolveTitle();if(r===void 0)return null;const s=this.props.titleAttributes||{};return we.createElement("title",Ca(s),r)}renderBase(){const{base:r}=this.props;return r?we.createElement("base",Ca(r)):null}renderMeta(){const{meta:r}=this.props;return!r||!Array.isArray(r)?null:r.map((s,o)=>we.createElement("meta",{key:o,...Ca(s)}))}renderLink(){const{link:r}=this.props;return!r||!Array.isArray(r)?null:r.map((s,o)=>we.createElement("link",{key:o,...Ca(s)}))}renderScript(){const{script:r}=this.props;return!r||!Array.isArray(r)?null:r.map((s,o)=>{const{innerHTML:c,...m}=s,p=Ca(m);return c&&(p.dangerouslySetInnerHTML={__html:c}),we.createElement("script",{key:o,...p})})}renderStyle(){const{style:r}=this.props;return!r||!Array.isArray(r)?null:r.map((s,o)=>{const{cssText:c,...m}=s,p=Ca(m);return c&&(p.dangerouslySetInnerHTML={__html:c}),we.createElement("style",{key:o,...p})})}renderNoscript(){const{noscript:r}=this.props;return!r||!Array.isArray(r)?null:r.map((s,o)=>{const{innerHTML:c,...m}=s,p=Ca(m);return c&&(p.dangerouslySetInnerHTML={__html:c}),we.createElement("noscript",{key:o,...p})})}render(){return we.createElement(we.Fragment,null,this.renderTitle(),this.renderBase(),this.renderMeta(),this.renderLink(),this.renderScript(),this.renderStyle(),this.renderNoscript())}},Ho,cm=(Ho=class extends v.Component{shouldComponentUpdate(r){return!_f(mp(this.props,"helmetData"),mp(r,"helmetData"))}mapNestedChildrenToProps(r,s){if(!s)return null;switch(r.type){case"script":case"noscript":return{innerHTML:s};case"style":return{cssText:s};default:throw new Error(`<${r.type} /> elements are self-closing and can not contain children. Refer to our API for more information.`)}}flattenArrayTypeChildren(r,s,o,c){return{...s,[r.type]:[...s[r.type]||[],{...o,...this.mapNestedChildrenToProps(r,c)}]}}mapObjectTypeChildren(r,s,o,c){switch(r.type){case"title":return{...s,[r.type]:c,titleAttributes:{...o}};case"body":return{...s,bodyAttributes:{...o}};case"html":return{...s,htmlAttributes:{...o}};default:return{...s,[r.type]:{...o}}}}mapArrayTypeChildrenToProps(r,s){let o={...s};return Object.keys(r).forEach(c=>{o={...o,[c]:r[c]}}),o}warnOnInvalidChildren(r,s){return cp(pp.some(o=>r.type===o),typeof r.type=="function"?"You may be attempting to nest <Helmet> components within each other, which is not allowed. Refer to our API for more information.":`Only elements types ${pp.join(", ")} are allowed. Helmet does not support rendering <${r.type}> elements. Refer to our API for more information.`),cp(!s||typeof s=="string"||Array.isArray(s)&&!s.some(o=>typeof o!="string"),`Helmet expects a string as a child of <${r.type}>. Did you forget to wrap your children in braces? ( <${r.type}>{\`\`}</${r.type}> ) Refer to our API for more information.`),!0}mapChildrenToProps(r,s){let o={};return we.Children.forEach(r,c=>{if(!c||!c.props)return;const{children:m,...p}=c.props,u=Object.keys(p).reduce((h,b)=>(h[nm[b]||b]=p[b],h),{});let{type:x}=c;switch(typeof x=="symbol"?x=x.toString():this.warnOnInvalidChildren(c,m),x){case"Symbol(react.fragment)":s=this.mapChildrenToProps(m,s);break;case"link":case"meta":case"noscript":case"script":case"style":o=this.flattenArrayTypeChildren(c,o,u,m);break;default:s=this.mapObjectTypeChildren(c,s,u,m);break}}),this.mapArrayTypeChildrenToProps(o,s)}render(){const{children:r,...s}=this.props;let o={...s},{helmetData:c}=s;if(r&&(o=this.mapChildrenToProps(r,o)),c&&!(c instanceof _o)){const m=c;c=new _o(m.context,!0),delete o.helmetData}return $o?we.createElement(uh,{...o}):c?we.createElement(fp,{...o,context:c.value}):we.createElement(om.Consumer,null,m=>we.createElement(fp,{...o,context:m}))}},Lt(Ho,"defaultProps",{defer:!0,encodeSpecialCharacters:!0,prioritizeSeoTags:!1}),Ho);tm();/**
 ...
 *
 * @license MIT
 */function er(){return er=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},er.apply(this,arguments)}var la;(function(r){r.Pop="POP",r.Push="PUSH",r.Replace="REPLACE"})(la||(la={}));const xp="popstate";function fh(r){r===void 0&&(r={});function s(c,m){let{pathname:p,search:u,hash:x}=c.location;return Yo("",{pathname:p,search:u,hash:x},m.state&&m.state.usr||null,m.state&&m.state.key||"default")}function o(c,m){return typeof m=="string"?m:Si(m)}return gh(s,o,null,r)}function Te(r,s){if(r===!1||r===null||typeof r>"u")throw new Error(s)}function Zo(r,s){if(!r){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function hh(){return Math.random().toString(36).substr(2,8)}function bp(r,s){return{usr:r.state,key:r.key,idx:s}}function Yo(r,s,o,c){return o===void 0&&(o=null),er({pathname:typeof r=="string"?r:r.pathname,search:"",hash:""},typeof s=="string"?ln(s):s,{state:o,key:s&&s.key||c||hh()})}function Si(r){let{pathname:s="/",search:o="",hash:c=""}=r;return o&&o!=="?"&&(s+=o.charAt(0)==="?"?o:"?"+o),c&&c!=="#"&&(s+=c.charAt(0)==="#"?c:"#"+c),s}function ln(r){let s={};if(r){let o=r.indexOf("#");o>=0&&(s.hash=r.substr(o),r=r.substr(0,o));let c=r.indexOf("?");c>=0&&(s.search=r.substr(c),r=r.substr(0,c)),r&&(s.pathname=r)}return s}function gh(r,s,o,c){c===void 0&&(c={});let{window:m=document.defaultView,v5Compat:p=!1}=c,u=m.history,x=la.Pop,h=null,b=y();b==null&&(b=0,u.replaceState(er({},u.state,{idx:b}),""));function y(){return(u.state||{idx:null}).idx}function g(){x=la.Pop;let M=y(),I=M==null?null:M-b;b=M,h&&h({action:x,location:R.location,delta:I})}function T(M,I){x=la.Push;let P=Yo(R.location,M,I);b=y()+1;let U=bp(P,b),K=R.createHref(P);try{u.pushState(U,"",K)}catch(V){if(V instanceof DOMException&&V.name==="DataCloneError")throw V;m.location.assign(K)}p&&h&&h({action:x,location:R.location,delta:1})}function E(M,I){x=la.Replace;let P=Yo(R.location,M,I);b=y();let U=bp(P,b),K=R.createHref(P);u.replaceState(U,"",K),p&&h&&h({action:x,location:R.location,delta:0})}function F(M){let I=m.location.origin!=="null"?m.location.origin:m.location.href,P=typeof M=="string"?M:Si(M);return P=P.replace(/ $/,"%20"),Te(I,"No window.location.(origin|href) available to create URL for href: "+P),new URL(P,I)}let R={get action(){return x},get location(){return r(m,u)},listen(M){if(h)throw new Error("A history only accepts one active listener");return m.addEventListener(xp,g),h=M,()=>{m.removeEventListener(xp,g),h=null}},createHref(M){return s(m,M)},createURL:F,encodeLocation(M){let I=F(M);return{pathname:I.pathname,search:I.search,hash:I.hash}},push:T,replace:E,go(M){return u.go(M)}};return R}var yp;(function(r){r.data="data",r.deferred="deferred",r.redirect="redirect",r.error="error"})(yp||(yp={}));function xh(r,s,o){return o===void 0&&(o="/"),bh(r,s,o)}function bh(r,s,o,c){let m=typeof s=="string"?ln(s):s,p=el(m.pathname||"/",o);if(p==null)return null;let u=dm(r);yh(u);let x=null;for(let h=0;x==null&&h<u.length;++h){let b=Ph(p);x=Th(u[h],b)}return x}function dm(r,s,o,c){s===void 0&&(s=[]),o===void 0&&(o=[]),c===void 0&&(c="");let m=(p,u,x)=>{let h={relativePath:x===void 0?p.path||"":x,caseSensitive:p.caseSensitive===!0,childrenIndex:u,route:p};h.relativePath.startsWith("/")&&(Te(h.relativePath.startsWith(c),'Absolute route path "'+h.relativePath+'" nested under path '+('"'+c+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),h.relativePath=h.relativePath.slice(c.length));let b=ca([c,h.relativePath]),y=o.concat(h);p.children&&p.children.length>0&&(Te(p.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+b+'".')),dm(p.children,s,y,b)),!(p.path==null&&!p.index)&&s.push({path:b,score:kh(b,p.index),routesMeta:y})};return r.forEach((p,u)=>{var x;if(p.path===""||!((x=p.path)!=null&&x.includes("?")))m(p,u);else for(let h of pm(p.path))m(p,u,h)}),s}function pm(r){let s=r.split("/");if(s.length===0)return[];let[o,...c]=s,m=o.endsWith("?"),p=o.replace(/\?$/,"");if(c.length===0)return m?[p,""]:[p];let u=pm(c.join("/")),x=[];return x.push(...u.map(h=>h===""?p:[p,h].join("/"))),m&&x.push(...u),x.map(h=>r.startsWith("/")&&h===""?"/":h)}function yh(r){r.sort((s,o)=>s.score!==o.score?o.score-s.score:Nh(s.routesMeta.map(c=>c.childrenIndex),o.routesMeta.map(c=>c.childrenIndex)))}const vh=/^:[\w-]+$/,jh=3,Sh=2,wh=1,Ch=10,Ah=-2,vp=r=>r==="*";function kh(r,s){let o=r.split("/"),c=o.length;return o.some(vp)&&(c+=Ah),s&&(c+=Sh),o.filter(m=>!vp(m)).reduce((m,p)=>m+(vh.test(p)?jh:p===""?wh:Ch),c)}function Nh(r,s){return r.length===s.length&&r.slice(0,-1).every((c,m)=>c===s[m])?r[r.length-1]-s[s.length-1]:0}function Th(r,s,o){let{routesMeta:c}=r,m={},p="/",u=[];for(let x=0;x<c.length;++x){let h=c[x],b=x===c.length-1,y=p==="/"?s:s.slice(p.length)||"/",g=Eh({path:h.relativePath,caseSensitive:h.caseSensitive,end:b},y),T=h.route;if(!g)return null;Object.assign(m,g.params),u.push({params:m,pathname:ca([p,g.pathname]),pathnameBase:Oh(ca([p,g.pathnameBase])),route:T}),g.pathnameBase!=="/"&&(p=ca([p,g.pathnameBase]))}return u}function Eh(r,s){typeof r=="string"&&(r={path:r,caseSensitive:!1,end:!0});let[o,c]=Rh(r.path,r.caseSensitive,r.end),m=s.match(o);if(!m)return null;let p=m[0],u=p.replace(/(.)\/+$/,"$1"),x=m.slice(1);return{params:c.reduce((b,y,g)=>{let{paramName:T,isOptional:E}=y;if(T==="*"){let R=x[g]||"";u=p.slice(0,p.length-R.length).replace(/(.)\/+$/,"$1")}const F=x[g];return E&&!F?b[T]=void 0:b[T]=(F||"").replace(/%2F/g,"/"),b},{}),pathname:p,pathnameBase:u,pattern:r}}function Rh(r,s,o){s===void 0&&(s=!1),o===void 0&&(o=!0),Zo(r==="*"||!r.endsWith("*")||r.endsWith("/*"),'Route path "'+r+'" will be treated as if it were '+('"'+r.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+r.replace(/\*$/,"/*")+'".'));let c=[],m="^"+r.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,x,h)=>(c.push({paramName:x,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)"));return r.endsWith("*")?(c.push({paramName:"*"}),m+=r==="*"||r==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):o?m+="\\/*$":r!==""&&r!=="/"&&(m+="(?:(?=\\/|$))"),[new RegExp(m,s?void 0:"i"),c]}function Ph(r){try{return r.split("/").map(s=>decodeURIComponent(s).replace(/\//g,"%2F")).join("/")}catch(s){return Zo(!1,'The URL path "'+r+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+s+").")),r}}function el(r,s){if(s==="/")return r;if(!r.toLowerCase().startsWith(s.toLowerCase()))return null;let o=s.endsWith("/")?s.length-1:s.length,c=r.charAt(o);return c&&c!=="/"?null:r.slice(o)||"/"}const Ih=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Bh=r=>Ih.test(r);function Mh(r,s){s===void 0&&(s="/");let{pathname:o,search:c="",hash:m=""}=typeof r=="string"?ln(r):r,p;if(o)if(Bh(o))p=o;else{if(o.includes("//")){let u=o;o=o.replace(/\/\/+/g,"/"),Zo(!1,"Pathnames cannot have embedded double slashes - normalizing "+(u+" -> "+o))}o.startsWith("/")?p=jp(o.substring(1),"/"):p=jp(o,s)}else p=s;return{pathname:p,search:Dh(c),hash:Wh(m)}}function jp(r,s){let o=s.replace(/\/+$/,"").split("/");return r.split("/").forEach(m=>{m===".."?o.length>1&&o.pop():m!=="."&&o.push(m)}),o.length>1?o.join("/"):"/"}function Io(r,s,o,c){return"Cannot include a '"+r+"' character in a manually specified "+("`to."+s+"` field ["+JSON.stringify(c)+"].  Please separate it out to the ")+("`to."+o+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function zh(r){return r.filter((s,o)=>o===0||s.route.path&&s.route.path.length>0)}function mm(r,s){let o=zh(r);return s?o.map((c,m)=>m===o.length-1?c.pathname:c.pathnameBase):o.map(c=>c.pathnameBase)}function um(r,s,o,c){c===void 0&&(c=!1);let m;typeof r=="string"?m=ln(r):(m=er({},r),Te(!m.pathname||!m.pathname.includes("?"),Io("?","pathname","search",m)),Te(!m.pathname||!m.pathname.includes("#"),Io("#","pathname","hash",m)),Te(!m.search||!m.search.includes("#"),Io("#","search","hash",m)));let p=r===""||m.pathname==="",u=p?"/":m.pathname,x;if(u==null)x=o;else{let g=s.length-1;if(!c&&u.startsWith("..")){let T=u.split("/");for(;T[0]==="..";)T.shift(),g-=1;m.pathname=T.join("/")}x=g>=0?s[g]:"/"}let h=Mh(m,x),b=u&&u!=="/"&&u.endsWith("/"),y=(p||u===".")&&o.endsWith("/");return!h.pathname.endsWith("/")&&(b||y)&&(h.pathname+="/"),h}const ca=r=>r.join("/").replace(/\/\/+/g,"/"),Oh=r=>r.replace(/\/+$/,"").replace(/^\/*/,"/"),Dh=r=>!r||r==="?"?"":r.startsWith("?")?r:"?"+r,Wh=r=>!r||r==="#"?"":r.startsWith("#")?r:"#"+r;function Lh(r){return r!=null&&typeof r.status=="number"&&typeof r.statusText=="string"&&typeof r.internal=="boolean"&&"data"in r}const fm=["post","put","patch","delete"];new Set(fm);const Hh=["get",...fm];new Set(Hh);/**
 ...
 *
 * @license MIT
 */function tr(){return tr=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},tr.apply(this,arguments)}const tl=v.createContext(null),Fh=v.createContext(null),ka=v.createContext(null),Ai=v.createContext(null),Na=v.createContext({outlet:null,matches:[],isDataRoute:!1}),hm=v.createContext(null);function Uh(r,s){let{relative:o}=s===void 0?{}:s;ar()||Te(!1);let{basename:c,navigator:m}=v.useContext(ka),{hash:p,pathname:u,search:x}=xm(r,{relative:o}),h=u;return c!=="/"&&(h=u==="/"?c:ca([c,u])),m.createHref({pathname:h,search:x,hash:p})}function ar(){return v.useContext(Ai)!=null}function da(){return ar()||Te(!1),v.useContext(Ai).location}function gm(r){v.useContext(ka).static||v.useLayoutEffect(r)}function nr(){let{isDataRoute:r}=v.useContext(Na);return r?tg():_h()}function _h(){ar()||Te(!1);let r=v.useContext(tl),{basename:s,future:o,navigator:c}=v.useContext(ka),{matches:m}=v.useContext(Na),{pathname:p}=da(),u=JSON.stringify(mm(m,o.v7_relativeSplatPath)),x=v.useRef(!1);return gm(()=>{x.current=!0}),v.useCallback(function(b,y){if(y===void 0&&(y={}),!x.current)return;if(typeof b=="number"){c.go(b);return}let g=um(b,JSON.parse(u),p,y.relative==="path");r==null&&s!=="/"&&(g.pathname=g.pathname==="/"?s:ca([s,g.pathname])),(y.replace?c.replace:c.push)(g,y.state,y)},[s,c,u,p,r])}function xm(r,s){let{relative:o}=s===void 0?{}:s,{future:c}=v.useContext(ka),{matches:m}=v.useContext(Na),{pathname:p}=da(),u=JSON.stringify(mm(m,c.v7_relativeSplatPath));return v.useMemo(()=>um(r,JSON.parse(u),p,o==="path"),[r,u,p,o])}function $h(r,s){return Gh(r,s)}function Gh(r,s,o,c){ar()||Te(!1);let{navigator:m}=v.useContext(ka),{matches:p}=v.useContext(Na),u=p[p.length-1],x=u?u.params:{};u&&u.pathname;let h=u?u.pathnameBase:"/";u&&u.route;let b=da(),y;if(s){var g;let M=typeof s=="string"?ln(s):s;h==="/"||(g=M.pathname)!=null&&g.startsWith(h)||Te(!1),y=M}else y=b;let T=y.pathname||"/",E=T;if(h!=="/"){let M=h.replace(/^\//,"").split("/");E="/"+T.replace(/^\//,"").split("/").slice(M.length).join("/")}let F=xh(r,{pathname:E}),R=qh(F&&F.map(M=>Object.assign({},M,{params:Object.assign({},x,M.params),pathname:ca([h,m.encodeLocation?m.encodeLocation(M.pathname).pathname:M.pathname]),pathnameBase:M.pathnameBase==="/"?h:ca([h,m.encodeLocation?m.encodeLocation(M.pathnameBase).pathname:M.pathnameBase])})),p,o,c);return s&&R?v.createElement(Ai.Provider,{value:{location:tr({pathname:"/",search:"",hash:"",state:null,key:"default"},y),navigationType:la.Pop}},R):R}function Yh(){let r=eg(),s=Lh(r)?r.status+" "+r.statusText:r instanceof Error?r.message:JSON.stringify(r),o=r instanceof Error?r.stack:null,m={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return v.createElement(v.Fragment,null,v.createElement("h2",null,"Unexpected Application Error!"),v.createElement("h3",{style:{fontStyle:"italic"}},s),o?v.createElement("pre",{style:m},o):null,null)}const Jh=v.createElement(Yh,null);class Vh extends v.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,o){return o.location!==s.location||o.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:o.error,location:o.location,revalidation:s.revalidation||o.revalidation}}componentDidCatch(s,o){console.error("React Router caught the following error during render",s,o)}render(){return this.state.error!==void 0?v.createElement(Na.Provider,{value:this.props.routeContext},v.createElement(hm.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function Kh(r){let{routeContext:s,match:o,children:c}=r,m=v.useContext(tl);return m&&m.static&&m.staticContext&&(o.route.errorElement||o.route.ErrorBoundary)&&(m.staticContext._deepestRenderedBoundaryId=o.route.id),v.createElement(Na.Provider,{value:s},c)}function qh(r,s,o,c){var m;if(s===void 0&&(s=[]),o===void 0&&(o=null),c===void 0&&(c=null),r==null){var p;if(!o)return null;if(o.errors)r=o.matches;else if((p=c)!=null&&p.v7_partialHydration&&s.length===0&&!o.initialized&&o.matches.length>0)r=o.matches;else return null}let u=r,x=(m=o)==null?void 0:m.errors;if(x!=null){let y=u.findIndex(g=>g.route.id&&(x==null?void 0:x[g.route.id])!==void 0);y>=0||Te(!1),u=u.slice(0,Math.min(u.length,y+1))}let h=!1,b=-1;if(o&&c&&c.v7_partialHydration)for(let y=0;y<u.length;y++){let g=u[y];if((g.route.HydrateFallback||g.route.hydrateFallbackElement)&&(b=y),g.route.id){let{loaderData:T,errors:E}=o,F=g.route.loader&&T[g.route.id]===void 0&&(!E||E[g.route.id]===void 0);if(g.route.lazy||F){h=!0,b>=0?u=u.slice(0,b+1):u=[u[0]];break}}}return u.reduceRight((y,g,T)=>{let E,F=!1,R=null,M=null;o&&(E=x&&g.route.id?x[g.route.id]:void 0,R=g.route.errorElement||Jh,h&&(b<0&&T===0?(ag("route-fallback"),F=!0,M=null):b===T&&(F=!0,M=g.route.hydrateFallbackElement||null)));let I=s.concat(u.slice(0,T+1)),P=()=>{let U;return E?U=R:F?U=M:g.route.Component?U=v.createElement(g.route.Component,null):g.route.element?U=g.route.element:U=y,v.createElement(Kh,{match:g,routeContext:{outlet:y,matches:I,isDataRoute:o!=null},children:U})};return o&&(g.route.ErrorBoundary||g.route.errorElement||T===0)?v.createElement(Vh,{location:o.location,revalidation:o.revalidation,component:R,error:E,children:P(),routeContext:{outlet:null,matches:I,isDataRoute:!0}}):P()},null)}var bm=(function(r){return r.UseBlocker="useBlocker",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r})(bm||{}),ym=(function(r){return r.UseBlocker="useBlocker",r.UseLoaderData="useLoaderData",r.UseActionData="useActionData",r.UseRouteError="useRouteError",r.UseNavigation="useNavigation",r.UseRouteLoaderData="useRouteLoaderData",r.UseMatches="useMatches",r.UseRevalidator="useRevalidator",r.UseNavigateStable="useNavigate",r.UseRouteId="useRouteId",r})(ym||{});function Qh(r){let s=v.useContext(tl);return s||Te(!1),s}function Xh(r){let s=v.useContext(Fh);return s||Te(!1),s}function Zh(r){let s=v.useContext(Na);return s||Te(!1),s}function vm(r){let s=Zh(),o=s.matches[s.matches.length-1];return o.route.id||Te(!1),o.route.id}function eg(){var r;let s=v.useContext(hm),o=Xh(),c=vm();return s!==void 0?s:(r=o.errors)==null?void 0:r[c]}function tg(){let{router:r}=Qh(bm.UseNavigateStable),s=vm(ym.UseNavigateStable),o=v.useRef(!1);return gm(()=>{o.current=!0}),v.useCallback(function(m,p){p===void 0&&(p={}),o.current&&(typeof m=="number"?r.navigate(m):r.navigate(m,tr({fromRouteId:s},p)))},[r,s])}const Sp={};function ag(r,s,o){Sp[r]||(Sp[r]=!0)}function ng(r,s){r==null||r.v7_startTransition,r==null||r.v7_relativeSplatPath}function Z(r){Te(!1)}function rg(r){let{basename:s="/",children:o=null,location:c,navigationType:m=la.Pop,navigator:p,static:u=!1,future:x}=r;ar()&&Te(!1);let h=s.replace(/^\/*/,"/"),b=v.useMemo(()=>({basename:h,navigator:p,static:u,future:tr({v7_relativeSplatPath:!1},x)}),[h,x,p,u]);typeof c=="string"&&(c=ln(c));let{pathname:y="/",search:g="",hash:T="",state:E=null,key:F="default"}=c,R=v.useMemo(()=>{let M=el(y,h);return M==null?null:{location:{pathname:M,search:g,hash:T,state:E,key:F},navigationType:m}},[h,y,g,T,E,F,m]);return R==null?null:v.createElement(ka.Provider,{value:b},v.createElement(Ai.Provider,{children:o,value:R}))}function ig(r){let{children:s,location:o}=r;return $h(Jo(s),o)}new Promise(()=>{});function Jo(r,s){s===void 0&&(s=[]);let o=[];return v.Children.forEach(r,(c,m)=>{if(!v.isValidElement(c))return;let p=[...s,m];if(c.type===v.Fragment){o.push.apply(o,Jo(c.props.children,p));return}c.type!==Z&&Te(!1),!c.props.index||!c.props.children||Te(!1);let u={id:c.props.id||p.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,loader:c.props.loader,action:c.props.action,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(u.children=Jo(c.props.children,p)),o.push(u)}),o}/**
 ...
 *
 * @license MIT
 */function Vo(){return Vo=Object.assign?Object.assign.bind():function(r){for(var s=1;s<arguments.length;s++){var o=arguments[s];for(var c in o)Object.prototype.hasOwnProperty.call(o,c)&&(r[c]=o[c])}return r},Vo.apply(this,arguments)}function sg(r,s){if(r==null)return{};var o={},c=Object.keys(r),m,p;for(p=0;p<c.length;p++)m=c[p],!(s.indexOf(m)>=0)&&(o[m]=r[m]);return o}function og(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function lg(r,s){return r.button===0&&(!s||s==="_self")&&!og(r)}const cg=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],dg="6";try{window.__reactRouterVersion=dg}catch{}const pg="startTransition",wp=zf[pg];function mg(r){let{basename:s,children:o,future:c,window:m}=r,p=v.useRef();p.current==null&&(p.current=fh({window:m,v5Compat:!0}));let u=p.current,[x,h]=v.useState({action:u.action,location:u.location}),{v7_startTransition:b}=c||{},y=v.useCallback(g=>{b&&wp?wp(()=>h(g)):h(g)},[h,b]);return v.useLayoutEffect(()=>u.listen(y),[u,y]),v.useEffect(()=>ng(c),[c]),v.createElement(rg,{basename:s,children:o,location:x.location,navigationType:x.action,navigator:u,future:c})}const ug=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",fg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ge=v.forwardRef(function(s,o){let{onClick:c,relative:m,reloadDocument:p,replace:u,state:x,target:h,to:b,preventScrollReset:y,viewTransition:g}=s,T=sg(s,cg),{basename:E}=v.useContext(ka),F,R=!1;if(typeof b=="string"&&fg.test(b)&&(F=b,ug))try{let U=new URL(window.location.href),K=b.startsWith("//")?new URL(U.protocol+b):new URL(b),V=el(K.pathname,E);K.origin===U.origin&&V!=null?b=V+K.search+K.hash:R=!0}catch{}let M=Uh(b,{relative:m}),I=hg(b,{replace:u,state:x,target:h,preventScrollReset:y,relative:m,viewTransition:g});function P(U){c&&c(U),U.defaultPrevented||I(U)}return v.createElement("a",Vo({},T,{href:F||M,onClick:R||p?c:P,ref:o,target:h}))});var Cp;(function(r){r.UseScrollRestoration="useScrollRestoration",r.UseSubmit="useSubmit",r.UseSubmitFetcher="useSubmitFetcher",r.UseFetcher="useFetcher",r.useViewTransitionState="useViewTransitionState"})(Cp||(Cp={}));var Ap;(function(r){r.UseFetcher="useFetcher",r.UseFetchers="useFetchers",r.UseScrollRestoration="useScrollRestoration"})(Ap||(Ap={}));function hg(r,s){let{target:o,replace:c,state:m,preventScrollReset:p,relative:u,viewTransition:x}=s===void 0?{}:s,h=nr(),b=da(),y=xm(r,{relative:u});return v.useCallback(g=>{if(lg(g,o)){g.preventDefault();let T=c!==void 0?c:Si(b)===Si(y);h(r,{replace:T,state:m,preventScrollReset:p,relative:u,viewTransition:x})}},[b,h,y,c,m,o,r,p,u,x])}function gg(){const{pathname:r}=da();return v.useEffect(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0,setTimeout(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0},0),setTimeout(()=>{window.scrollTo(0,0),document.documentElement.scrollTop=0,document.body.scrollTop=0},10)},[r]),null}function xg(){const r="ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ | Creative Techno College, Angul — AICTE Approved & Affiliated to Utkal University | Admissions Open for 2026-27 | BBA | BCA | B.Sc (CS) | B.Sc (Data Science) | MBA | MCA | 100% Placement Assistance | Contact: +91 9778427170";return e.jsx("div",{className:"marquee-bar",children:e.jsxs("div",{className:"marquee-track-wrap",children:[e.jsx("span",{className:"marquee-item",children:r}),e.jsx("span",{className:"marquee-item marquee-odia",children:"ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ |  "}),e.jsx("span",{className:"marquee-item",children:r}),e.jsx("span",{className:"marquee-item marquee-odia",children:"ଆମ ମହାବିଦ୍ୟାଳୟ ରେ ଆପଣଙ୍କୁ ସ୍ୱାଗତ |  "})]})})}const bg=[{label:"Home",to:"/"},{label:"About",children:[{label:"About Trust",to:"/about/trust"},{label:"About CTC",to:"/about/ctc"},{label:"Our Team",to:"/about/team"}]},{label:"Admission",to:"/admission"},{label:"Academics",children:[{label:"Courses",children:[{label:"Regular Courses",to:"/academics/regular"},{label:"Value Added Courses",to:"/academics/value-added"}]},{label:"Enhancement Programs",to:"/academics/enhancement"}]},{label:"Placement",children:[{label:"Development Program",to:"/placement/programs"},{label:"Placement Statistics",to:"/placement/statistics"},{label:"Placement Brochure",to:"/placement/brochure"}]},{label:"Gymkhana",to:"/gymkhana"},{label:"Gallery",to:"/gallery"},{label:"IQAC",children:[{label:"IQAC Item 1",to:"/iqac/item1"},{label:"IQAC Item 2",to:"/iqac/item2"},{label:"IQAC Item 3",to:"/iqac/item3"},{label:"IQAC Item 4",to:"/iqac/item4"}]},{label:"AICTE",children:[{label:"LOA 2024-25",to:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/LOA Report 2024-2025.PDF",external:!0,newTab:!0},{label:"EOA 2025-26",to:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/EOA Report 2025-26.PDF",external:!0,newTab:!0},{label:"Documents",to:"/aicte/documents"},{label:"Mandatory Disclosure",to:"/aicte/mandatory-disclosure"}]},{label:"CKF Skills",to:"/ckf-skills"},{label:"Contacts",to:"/contacts"},{label:"ICC",to:"/icc"},{label:"GRC",to:"/grc"},{label:"Logins",children:[{label:"Portal Login",to:"/login"},{label:"NBA",to:"/nba"},{label:"NAAC",to:"/naac"}]}],kp="#0a1628",Np="#e8f0fe",Ht={dropdown:{position:"absolute",top:"100%",left:0,minWidth:210,background:kp,borderRadius:10,boxShadow:"0 8px 32px rgba(10,22,40,0.35)",listStyle:"none",padding:"6px 0",margin:0,zIndex:9999,border:"1px solid rgba(255,255,255,0.1)"},subDropdown:{position:"absolute",top:0,left:"100%",minWidth:210,background:kp,borderRadius:10,boxShadow:"0 8px 32px rgba(10,22,40,0.35)",listStyle:"none",padding:"6px 0",margin:0,zIndex:9999,border:"1px solid rgba(255,255,255,0.1)"},mobileNested:{position:"static",boxShadow:"none",borderRadius:0,paddingLeft:18,background:"rgba(0,0,0,0.2)",listStyle:"none",margin:0,border:"none"},li:{position:"relative"},link:{display:"block",padding:"9px 20px",color:Np,textDecoration:"none",fontSize:"0.88rem",fontWeight:600,whiteSpace:"nowrap"},trigger:{display:"flex",alignItems:"center",gap:6,padding:"9px 20px",color:Np,fontSize:"0.88rem",fontWeight:600,whiteSpace:"nowrap",cursor:"pointer",userSelect:"none"}};function jm({item:r,isMobile:s,onClose:o}){const[c,m]=v.useState(!1),p=()=>m(b=>!b),u=()=>m(!0),x=()=>m(!1);if(!r.children){const b=r.external?e.jsx("a",{href:r.to,target:r.newTab?"_blank":"_self",rel:"noreferrer",style:Ht.link,onClick:o,children:r.label}):e.jsx(ge,{to:r.to,style:Ht.link,onClick:o,children:r.label});return e.jsx("li",{style:Ht.li,onMouseEnter:y=>{var g;return((g=y.currentTarget.querySelector("a,span"))==null?void 0:g.style)&&(y.currentTarget.style.background="#2563eb")},onMouseLeave:y=>y.currentTarget.style.background="",children:b})}const h=s?Ht.mobileNested:Ht.subDropdown;return e.jsxs("li",{style:Ht.li,onMouseEnter:s?void 0:u,onMouseLeave:s?void 0:x,children:[e.jsxs("div",{style:{...Ht.trigger,background:c?"#2563eb":""},onClick:s?p:void 0,children:[r.label,e.jsx("i",{className:"fa-solid fa-chevron-right",style:{fontSize:"0.5rem",marginLeft:"auto",transform:c?"rotate(90deg)":"none",transition:"transform 0.22s"}})]}),c&&e.jsx("ul",{style:h,children:r.children.map((b,y)=>e.jsx(jm,{item:b,isMobile:s,onClose:o},y))})]})}function yg({item:r,isMobile:s,onClose:o,isActive:c}){const[m,p]=v.useState(!1),u=da();v.useEffect(()=>{p(!1)},[u]);const x=()=>{s||p(!0)},h=()=>{s||p(!1)},b=()=>{s&&p(y=>!y)};return e.jsxs("li",{className:"nav-item",style:{position:"relative"},onMouseEnter:x,onMouseLeave:h,children:[e.jsxs("span",{className:`nav-trigger${c?" active":""}`,onClick:b,children:[r.label,e.jsx("i",{className:"fa-solid fa-chevron-down nav-arrow",style:{transform:m?"rotate(180deg)":"rotate(0)",transition:"transform 0.22s"}})]}),m&&e.jsx("ul",{style:s?{...Ht.dropdown,position:"static",boxShadow:"none",background:"rgba(0,0,0,0.2)",border:"none"}:Ht.dropdown,children:r.children.map((y,g)=>e.jsx(jm,{item:y,isMobile:s,onClose:()=>{p(!1),o()}},g))})]})}function vg(){const[r,s]=v.useState(!1),o=da();return v.useEffect(()=>{s(!1)},[o]),v.useEffect(()=>{const c=m=>{m.target.closest(".navbar")||s(!1)};return document.addEventListener("mousedown",c),()=>document.removeEventListener("mousedown",c)},[]),e.jsxs("nav",{className:"navbar",children:[e.jsx("ul",{className:`nav-list${r?" open":""}`,children:bg.map((c,m)=>c.children?e.jsx(yg,{item:c,isMobile:r,onClose:()=>s(!1),isActive:o.pathname.startsWith("/"+c.label.toLowerCase())},m):e.jsx("li",{className:"nav-item",children:e.jsx(ge,{to:c.to,className:`nav-link${o.pathname===c.to?" active":""}`,onClick:()=>s(!1),children:c.label})},m))}),e.jsxs("button",{className:`hamburger${r?" open":""}`,onClick:()=>s(c=>!c),"aria-label":"Toggle menu",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})}function jg(){return e.jsxs("footer",{className:"site-footer",children:[e.jsxs("div",{className:"footer-grid",children:[e.jsxs("div",{className:"footer-brand",children:[e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/LOGO FINAL.png",alt:"CTC Logo"}),e.jsx("p",{children:"Creative Techno College, Angul is a premier institution committed to academic excellence, innovation, and holistic development. AICTE approved & affiliated to Utkal University."}),e.jsx("div",{className:"footer-social",children:[{icon:"fa-brands fa-facebook-f",href:"https://www.facebook.com/creativetechnocollege.angul"},{icon:"fa-brands fa-instagram",href:"https://www.instagram.com/creative_techno_college_angul"},{icon:"fa-brands fa-youtube",href:"https://www.youtube.com/@creativetechnocollegeiangu9750"},{icon:"fa-brands fa-linkedin-in",href:"https://www.linkedin.com/in/creative-techno-college-angul/"},{icon:"fa-brands fa-twitter",href:"https://x.com/creative__1998?lang=en"}].map((r,s)=>e.jsx("a",{href:r.href,target:"_blank",rel:"noreferrer",children:e.jsx("i",{className:r.icon})},s))})]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Quick Links"}),[{label:"Home",to:"/"},{label:"About CTC",to:"/about/ctc"},{label:"About Trust",to:"/about/trust"},{label:"Our Team",to:"/about/team"},{label:"Admission",to:"/admission"},{label:"Gallery",to:"/gallery"},{label:"Contacts",to:"/contacts"},{label:"ICC",to:"/icc"}].map((r,s)=>e.jsx(ge,{to:r.to,children:r.label},s))]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"College Services"}),[{label:"Academics",to:"/academics/regular"},{label:"Placement",to:"/placement/statistics"},{label:"Gymkhana",to:"/gymkhana"},{label:"Technocrat",to:"/gymkhana/technocrat"},{label:"Disha & CSR",to:"/gymkhana/disha-csr"},{label:"Sports",to:"/gymkhana/sports"},{label:"Cultural",to:"/gymkhana/cultural"},{label:"Portal Login",to:"/login"}].map((r,s)=>e.jsx(ge,{to:r.to,children:r.label},s))]}),e.jsxs("div",{className:"footer-col",children:[e.jsx("h4",{children:"Contact Us"}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-location-dot"}),e.jsx("span",{children:"Creative Techno College, Angul, Odisha – 759122"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-phone"}),e.jsx("span",{children:"+91 9778427170 / 9668284222"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-envelope"}),e.jsx("span",{children:"principal.creativecollege@gmail.com"})]}),e.jsxs("div",{className:"footer-contact-item",children:[e.jsx("i",{className:"fa-solid fa-clock"}),e.jsx("span",{children:"Mon – Sat: 9:00 AM – 5:00 PM"})]})]})]}),e.jsxs("div",{className:"footer-bottom",children:[e.jsxs("p",{children:["© 2010 – 2025 ",e.jsx("span",{children:"Creative Techno College"}),". All Rights Reserved."]}),e.jsxs("p",{children:["A Unit of ",e.jsx("span",{children:"Creative Knowledge Foundation"})]}),e.jsxs("p",{children:["Developed by ",e.jsx("span",{children:"Technocrat Club"})]})]})]})}function Sg({isOpen:r,hasUnread:s,onClick:o}){return e.jsxs("button",{id:"ctc-chatbot-fab",className:"ctc-chatbot-fab",onClick:o,"aria-label":r?"Close chat":"Open CTC Assistant",title:r?"Close chat":"Chat with CTC Bot",children:[s&&!r&&e.jsx("span",{className:"ctc-fab-dot","aria-hidden":"true"}),e.jsx("span",{className:`ctc-fab-icon ${r?"open":""}`,"aria-hidden":"true",children:r?"✕":e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"Technocrat Logo",className:"fab-img"})})]})}function wg(r){return r.split(/(\*\*[^*]+\*\*)/g).map((o,c)=>o.startsWith("**")&&o.endsWith("**")?e.jsx("strong",{children:o.slice(2,-2)},c):o)}function Cg(r){return new Intl.DateTimeFormat("en-IN",{hour:"2-digit",minute:"2-digit",hour12:!0}).format(r)}function Ag({message:r,onQuickReply:s}){const o=r.sender==="bot";return e.jsxs("div",{className:`ctc-message ${o?"bot":"user"}`,children:[o&&e.jsx("div",{className:"ctc-msg-avatar",role:"img","aria-label":"CTC Bot",children:e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"CTC Bot",className:"ctc-avatar-img"})}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",maxWidth:"100%"},children:[e.jsxs("div",{className:"ctc-msg-bubble",children:[e.jsx("span",{className:"ctc-msg-text",children:wg(r.text)}),o&&r.links&&r.links.length>0&&e.jsx("div",{className:"ctc-msg-links",children:r.links.map((c,m)=>e.jsxs(ge,{to:c.path,className:"ctc-msg-link",title:`Go to ${c.label}`,children:["🔗 ",c.label]},m))})]}),e.jsx("span",{className:"ctc-msg-time",children:Cg(r.timestamp)})]})]})}const kg=[{id:"greeting",keywords:["hello","hi","hey","good morning","good afternoon","good evening","hola","namaste","greetings"],response:{text:`👋 Hello! Welcome to **Creative Techno College, Angul**!
...
I can help you with information about admissions, courses, placements, events, and more. What would you like to know?`,quickReplies:["Admissions","Courses","Placements","Gymkhana","Contact Us"],links:[],timestamp:new Date};function Tg(r){const s=r.toLowerCase().trim();if(!s)return Tp;let o=null,c=0;for(const m of kg){let p=0;for(const u of m.keywords)s.includes(u)&&(p+=u.split(" ").length*2);p>c&&(c=p,o=m)}return o&&c>0?o.response:Tp}function Eg(){return e.jsxs("div",{className:"ctc-typing-indicator",children:[e.jsx("div",{className:"ctc-msg-avatar",role:"img","aria-label":"CTC Bot",children:e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"CTC Bot",className:"ctc-avatar-img"})}),e.jsxs("div",{className:"ctc-typing-bubble",children:[e.jsx("span",{className:"ctc-typing-dot"}),e.jsx("span",{className:"ctc-typing-dot"}),e.jsx("span",{className:"ctc-typing-dot"})]})]})}function Rg({messages:r,onSendMessage:s,onClose:o,onMinimize:c,isClosing:m}){const[p,u]=v.useState(""),[x,h]=v.useState(!1),[b,y]=v.useState(["Admissions","Courses","Placements","Gymkhana","Contact Us"]),g=v.useRef(null),T=v.useRef(null);v.useEffect(()=>{var R;(R=g.current)==null||R.scrollIntoView({behavior:"smooth"})},[r,x]),v.useEffect(()=>{var M;const R=[...r].reverse().find(I=>I.sender==="bot");(M=R==null?void 0:R.quickReplies)!=null&&M.length&&y(R.quickReplies)},[r]),v.useEffect(()=>{setTimeout(()=>{var R;return(R=T.current)==null?void 0:R.focus()},400)},[]);const E=async R=>{const M=(R||p).trim();if(!M)return;u("");const I={id:Date.now(),sender:"user",text:M,links:[],quickReplies:[],timestamp:new Date};s(I),h(!0);const P=600+Math.random()*600;await new Promise(V=>setTimeout(V,P));const U=Tg(M),K={id:Date.now()+1,sender:"bot",text:U.text,links:U.links||[],quickReplies:U.quickReplies||[],timestamp:new Date};h(!1),s(K)},F=R=>{R.key==="Enter"&&!R.shiftKey&&(R.preventDefault(),E())};return e.jsxs("div",{className:`ctc-chat-window${m?" closing":""}`,role:"dialog","aria-label":"CTC Assistant Chat",children:[e.jsxs("div",{className:"ctc-chat-header",children:[e.jsx("div",{className:"ctc-chat-avatar",role:"img","aria-label":"CTC Bot Avatar",children:e.jsx("img",{src:"/CTC%20NEW%20REACT%20WEBSITE/images/chatbot/technocrat.png",alt:"CTC Bot",className:"ctc-avatar-img"})}),e.jsxs("div",{className:"ctc-chat-header-info",children:[e.jsx("div",{className:"ctc-chat-header-name",children:"CTC Assistant"}),e.jsxs("div",{className:"ctc-chat-header-status",children:[e.jsx("span",{className:"ctc-status-dot"}),"Online — Creative Techno College"]})]}),e.jsxs("div",{className:"ctc-chat-header-actions",children:[e.jsx("button",{id:"ctc-chat-minimize-btn",className:"ctc-header-btn",onClick:c,"aria-label":"Minimize chat",title:"Minimize",children:"−"}),e.jsx("button",{id:"ctc-chat-close-btn",className:"ctc-header-btn",onClick:o,"aria-label":"Close chat",title:"Close",children:"✕"})]})]}),e.jsxs("div",{className:"ctc-messages-container",role:"log","aria-live":"polite","aria-label":"Chat messages",children:[r.map(R=>e.jsx(Ag,{message:R},R.id)),x&&e.jsx(Eg,{}),e.jsx("div",{ref:g})]}),b.length>0&&!x&&e.jsx("div",{className:"ctc-quick-replies",role:"group","aria-label":"Quick reply options",children:b.map((R,M)=>e.jsx("button",{id:`ctc-quick-reply-${R.toLowerCase().replace(/\s+/g,"-")}`,className:"ctc-quick-reply-btn",onClick:()=>E(R),"aria-label":`Quick reply: ${R}`,children:R},M))}),e.jsxs("div",{className:"ctc-input-area",children:[e.jsx("input",{ref:T,id:"ctc-chat-input",type:"text",className:"ctc-chat-input",placeholder:"Type a message...",value:p,onChange:R=>u(R.target.value),onKeyDown:F,"aria-label":"Type your message to CTC Bot",maxLength:300,autoComplete:"off"}),e.jsx("button",{id:"ctc-chat-send-btn",className:"ctc-send-btn",onClick:()=>E(),disabled:!p.trim()||x,"aria-label":"Send message",title:"Send",children:"➤"})]})]})}function Pg(){const[r,s]=v.useState(!1),[o,c]=v.useState(!1),[m,p]=v.useState(!0),[u,x]=v.useState([Ng]),h=v.useCallback(()=>{s(!0),c(!1),p(!1)},[]),b=v.useCallback(()=>{c(!0),setTimeout(()=>{s(!1),c(!1)},240)},[]),y=v.useCallback(()=>{b()},[b]),g=v.useCallback(()=>{r?b():h()},[r,h,b]),T=v.useCallback(E=>{x(F=>[...F,E])},[]);return e.jsxs(e.Fragment,{children:[r&&e.jsx(Rg,{messages:u,onSendMessage:T,onClose:b,onMinimize:y,isClosing:o}),e.jsx(Sg,{isOpen:r,hasUnread:m,onClick:g})]})}function Ig({children:r}){const[s,o]=v.useState(!1);return v.useEffect(()=>{const c=()=>o(window.scrollY>400);return window.addEventListener("scroll",c),()=>window.removeEventListener("scroll",c)},[]),e.jsxs(e.Fragment,{children:[e.jsx(xg,{}),e.jsxs("header",{className:"site-header",children:[e.jsxs("div",{className:"header-brand",children:[e.jsx("div",{className:"header-logo-wrap",children:e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/LOGO FINAL.png",alt:"CTC Logo"})}),e.jsxs("div",{className:"header-text",children:[e.jsx("h1",{children:"Creative Techno College, Angul"}),e.jsx("p",{className:"sub",children:"A Unit of Creative Knowledge Foundation"}),e.jsxs("div",{className:"badges",children:[e.jsx("span",{className:"badge gold",children:"AICTE Approved"}),e.jsx("span",{className:"badge",children:"Utkal University Affiliated"}),e.jsx("span",{className:"badge",children:"Est. 2010"})]})]})]}),e.jsxs("div",{className:"header-logos",children:[e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/aicte.png",alt:"AICTE",title:"AICTE Approved"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/utkal.png",alt:"Utkal University",title:"Utkal University Affiliated"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/bput.png",alt:"BPUT",title:"Creative Knowledge Foundation"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/ckf.png",alt:"CKF",title:"Creative Knowledge Foundation"})]}),e.jsxs("div",{className:"header-clubs",children:[e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/GYMKHANA/technocrat.png",alt:"Technocrat",title:"Technocrat Club"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/GYMKHANA/cultural.png",alt:"Cultural",title:"Cultural Club"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/GYMKHANA/sports.png",alt:"Sports",title:"Sports Club"}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/GYMKHANA/disha.png",alt:"Disha CSR",title:"Disha & CSR Club"})]})]}),e.jsx(vg,{}),e.jsx("main",{children:r}),e.jsx(jg,{}),e.jsx("button",{className:`scroll-top-btn${s?" visible":""}`,onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),"aria-label":"Scroll to top",children:e.jsx("i",{className:"fa-solid fa-chevron-up"})}),e.jsx(Pg,{})]})}const Bo="Creative Techno College, Angul",Sm="https://www.creativecollege.in",Bg=`${Sm}/images/og-default.jpg`;function Ta({title:r,noSuffix:s=!1,description:o,keywords:c="",canonical:m="/",ogImage:p=Bg,ogType:u="website"}){const x=r?s?r:`${r} | ${Bo}`:Bo,h=`${Sm}${m}`;return e.jsxs(cm,{children:[e.jsx("title",{children:x}),e.jsx("meta",{name:"description",content:o}),c&&e.jsx("meta",{name:"keywords",content:c}),e.jsx("link",{rel:"canonical",href:h}),e.jsx("meta",{name:"robots",content:"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"}),e.jsx("meta",{name:"geo.region",content:"IN-OR"}),e.jsx("meta",{name:"geo.placename",content:"Angul, Odisha, India"}),e.jsx("meta",{name:"geo.position",content:"20.788118;85.086393"}),e.jsx("meta",{name:"ICBM",content:"20.788118, 85.086393"}),e.jsx("meta",{property:"og:type",content:u}),e.jsx("meta",{property:"og:title",content:x}),e.jsx("meta",{property:"og:description",content:o}),e.jsx("meta",{property:"og:url",content:h}),e.jsx("meta",{property:"og:image",content:p}),e.jsx("meta",{property:"og:image:width",content:"1200"}),e.jsx("meta",{property:"og:image:height",content:"630"}),e.jsx("meta",{property:"og:site_name",content:Bo}),e.jsx("meta",{property:"og:locale",content:"en_IN"}),e.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),e.jsx("meta",{name:"twitter:title",content:x}),e.jsx("meta",{name:"twitter:description",content:o}),e.jsx("meta",{name:"twitter:image",content:p})]})}function Mg(){const r={"@context":"https://schema.org","@graph":[{"@type":["EducationalOrganization","CollegeOrUniversity","LocalBusiness"],"@id":"https://www.creativecollege.in/#organization",name:"Creative Techno College",alternateName:["CTC Angul","Creative College Angul","CTC"],description:"Creative Techno College (CTC), Angul is an AICTE-approved, top professional and technical college in Angul, Odisha, affiliated to Utkal University. Established in 2010, CTC offers BBA, BCA, B.Sc Computer Science, B.Sc Data Science, MBA and MCA programs with 100% placement assistance.",url:"https://www.creativecollege.in",logo:"https://www.creativecollege.in/images/HOMEPAGE/LOGO FINAL.png",image:"https://www.creativecollege.in/images/HOMEPAGE/creative-campus.jpg",telephone:["+91-9778427170","+91-9668844571","+91-9668284222"],email:"principal.creativecollege@gmail.com",address:{"@type":"PostalAddress",streetAddress:"Baluakata, Saradhapur",addressLocality:"Angul",addressRegion:"Odisha",postalCode:"759143",addressCountry:"IN"},geo:{"@type":"GeoCoordinates",latitude:"20.788118",longitude:"85.086393"},openingHoursSpecification:[{"@type":"OpeningHoursSpecification",dayOfWeek:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],opens:"09:00",closes:"17:00"}],hasMap:"https://www.google.com/maps/place/Creative+Techno+College/@20.7881186,85.0863929,17z",foundingDate:"2010",numberOfEmployees:{"@type":"QuantitativeValue",value:"50"},areaServed:["Angul","Odisha","India"],keywords:"top college angul, best college angul, technical college angul, professional college angul, BCA college angul, BBA college angul, AICTE college angul, Utkal University college angul",aggregateRating:{"@type":"AggregateRating",ratingValue:"4.5",reviewCount:"120",bestRating:"5"},sameAs:["https://www.facebook.com/creativetechnocollege","https://www.instagram.com/creativetechnocollege"]},{"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"Which is the best college in Angul?",acceptedAnswer:{"@type":"Answer",text:"Creative Techno College (CTC), Angul is widely regarded as one of the best and top colleges in Angul, Odisha. AICTE-approved and affiliated to Utkal University, CTC has been providing quality technical and professional education since 2010 with 95% placement rate."}},{"@type":"Question",name:"Is Creative Techno College approved by AICTE?",acceptedAnswer:{"@type":"Answer",text:"Yes, Creative Techno College (CTC) Angul is approved by AICTE (All India Council for Technical Education) and permanently affiliated to Utkal University, recognized by the Government of Odisha, Dept. of Higher Education."}},{"@type":"Question",name:"What courses are offered at Creative Techno College, Angul?",acceptedAnswer:{"@type":"Answer",text:"CTC Angul offers UG programs: BBA (Bachelor of Business Administration) with 120 seats, BCA (Bachelor of Computer Applications) with 120 seats, B.Sc Computer Science (Honours) with 128 seats, and B.Sc Data Science with 30 seats. PG programs: MBA (Master of Business Administration) with 60 seats and MCA (Master of Computer Applications) with 60 seats."}},{"@type":"Question",name:"What is the placement record of CTC Angul?",acceptedAnswer:{"@type":"Answer",text:"Creative Techno College Angul has a 95% placement rate with over 1500+ students placed in top companies like Wipro, TCS, Infosys, HCL, Capgemini, IBM, Cognizant, Accenture, and more. The highest package offered is ₹4.5 LPA."}},{"@type":"Question",name:"How to apply for admission in Creative Techno College Angul?",acceptedAnswer:{"@type":"Answer",text:"Admission to CTC Angul requires 10+2 pass with minimum 45% marks. You can apply online through our website at creativecollege.in or visit our campus at Baluakata, Saradhapur, Angul. Call us at +91-9778427170 for more details."}},{"@type":"Question",name:"Is Creative Techno College a top technical college in Angul?",acceptedAnswer:{"@type":"Answer",text:"Yes, Creative Techno College is the top technical and professional college in Angul, Odisha. It offers computer science and IT programs like BCA, B.Sc CS, and B.Sc Data Science, making it the best choice for technical education in Angul district."}}]},{"@type":"WebSite","@id":"https://www.creativecollege.in/#website",url:"https://www.creativecollege.in",name:"Creative Techno College, Angul",description:"Official website of Creative Techno College – Top AICTE-approved college in Angul, Odisha",publisher:{"@id":"https://www.creativecollege.in/#organization"},potentialAction:{"@type":"SearchAction",target:{"@type":"EntryPoint",urlTemplate:"https://www.creativecollege.in/?s={search_term_string}"},"query-input":"required name=search_term_string"}}]};return e.jsx(cm,{children:e.jsx("script",{type:"application/ld+json",children:JSON.stringify(r,null,2)})})}const Qn=[{img:"/CTC%20NEW%20REACT%20WEBSITE/images/HOMEPAGE/MBA_MCA.jpeg",caption:"MBA & MCA Admissions Open 2026–27",sub:"Master of Business Administration • Master of Computer Applications"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/HOMEPAGE/1.jpg",caption:"Admissions Open 2026–27",sub:"BBA • BCA • B.Sc CS • B.Sc Data Science • MBA • MCA"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/HOMEPAGE/2.jpg",caption:"100% Placement Assistance",sub:"Top Recruiters • Industry-Ready Programs"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/HOMEPAGE/4.jpg",caption:"World-Class Campus & Library",sub:"Modern Infrastructure • Expert Faculty"}];function zg({onClose:r}){const[s,o]=v.useState(0),c=nr(),m=v.useRef(null);v.useEffect(()=>(m.current=setInterval(()=>o(u=>(u+1)%Qn.length),3500),()=>clearInterval(m.current)),[]);const p=u=>o((u+Qn.length)%Qn.length);return e.jsx("div",{className:"adm-banner-overlay",onClick:r,children:e.jsxs("div",{className:"adm-banner-box",onClick:u=>u.stopPropagation(),children:[e.jsx("button",{className:"adm-banner-close",onClick:r,"aria-label":"Close banner",children:e.jsx("i",{className:"fa-solid fa-xmark"})}),e.jsxs("div",{className:"adm-banner-slider",children:[Qn.map((u,x)=>e.jsxs("div",{className:`adm-banner-slide ${x===s?"active":""}`,children:[e.jsx("img",{src:u.img,alt:u.caption,className:"adm-banner-slide-img"}),e.jsx("div",{className:"adm-banner-slide-overlay"}),e.jsxs("div",{className:"adm-banner-slide-text",children:[e.jsxs("p",{className:"adm-banner-eyebrow",children:[e.jsx("i",{className:"fa-solid fa-graduation-cap"})," Creative Techno College"]}),e.jsx("h2",{children:u.caption}),e.jsx("p",{children:u.sub})]})]},x)),e.jsx("div",{className:"adm-banner-dots",children:Qn.map((u,x)=>e.jsx("button",{className:`adm-banner-dot ${x===s?"active":""}`,onClick:()=>p(x)},x))}),e.jsx("button",{className:"adm-banner-arrow left",onClick:()=>p(s-1),children:e.jsx("i",{className:"fa-solid fa-chevron-left"})}),e.jsx("button",{className:"adm-banner-arrow right",onClick:()=>p(s+1),children:e.jsx("i",{className:"fa-solid fa-chevron-right"})})]}),e.jsxs("div",{className:"adm-banner-footer",children:[e.jsxs("div",{className:"adm-banner-footer-text",children:[e.jsx("span",{className:"adm-banner-tag",children:"🎓 Admission 2026–27 Open Now!"}),e.jsx("p",{children:"Seats are filling fast. Secure your future today."})]}),e.jsxs("button",{className:"adm-banner-apply-btn",onClick:()=>{r(),c("/admission/apply")},children:[e.jsx("i",{className:"fa-solid fa-paper-plane"})," Apply Now"]})]})]})})}function Og(){v.useEffect(()=>{const r=document.querySelectorAll(".reveal, .reveal-left, .reveal-right"),s=new IntersectionObserver(o=>o.forEach(c=>{c.isIntersecting&&c.target.classList.add("visible")}),{threshold:.12});return r.forEach(o=>s.observe(o)),()=>s.disconnect()},[])}const gi=[{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/creative-campus.jpg",eyebrow:"Welcome to Excellence",title:"Shaping Leaders of Tomorrow",sub:"AICTE Approved • Utkal University Affiliated • Est. 2010"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/MBA_MCA.jpeg",eyebrow:"MBA & MCA Admissions Open 2026–27",title:"Advance Your Career with PG Programs",sub:"Master of Business Administration • Master of Computer Applications"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/7.jpg",eyebrow:"Beautiful Campus",title:"Green & Student-Friendly Environment",sub:"Sprawling campus of knowledge and growth"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/4.jpg",eyebrow:"Modern Library",title:"Resources to Empower Learning",sub:"Thousands of books, journals & digital resources"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/1.jpg",eyebrow:"World-Class Education",title:"Where Innovation Meets Tradition",sub:"BBA • BCA • B.Sc (CS) • B.Sc (Data Science) • MBA • MCA"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/2.jpg",eyebrow:"100% Placement Assistance",title:"Your Future Starts Here",sub:"1500+ Students Placed • 100+ Recruiting Companies"},{img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/5.jpg",eyebrow:"Vibrant Campus Life",title:"Learn. Grow. Excel.",sub:"Sports • Cultural • Technocrat • Disha & CSR"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/CULTURAL/saraswati_puja/sp1.jpeg",eyebrow:"Saraswati Puja Celebrations",title:"Honouring the Goddess of Knowledge",sub:"Faith • Culture • Togetherness"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/CULTURAL/funfest/f1.jpeg",eyebrow:"Fun Fest",title:"Where Talent Takes the Stage",sub:"Energy • Creativity • Unforgettable Moments"},{img:"/CTC%20NEW%20REACT%20WEBSITE/images/CULTURAL/holi/h1.jpeg",eyebrow:"Holi Celebrations",title:"A Festival of Colours & Joy",sub:"Vibrant • Festive • Full of Life"}];function Dg(){const[r,s]=v.useState(0),o=v.useRef(null),c=m=>s((m+gi.length)%gi.length);return v.useEffect(()=>(o.current=setInterval(()=>c(r+1),5e3),()=>clearInterval(o.current)),[r]),e.jsxs("section",{className:"hero-section",children:[e.jsx("div",{className:"hero-slides-wrap",style:{transform:`translateX(-${r*100}%)`},children:gi.map((m,p)=>e.jsxs("div",{className:"hero-slide",children:[e.jsx("img",{src:m.img,alt:m.title,loading:p===0?"eager":"lazy"}),e.jsx("div",{className:"hero-overlay"}),e.jsxs("div",{className:"hero-content",children:[e.jsx("p",{className:"hero-eyebrow",children:m.eyebrow}),e.jsx("h1",{className:"hero-title",dangerouslySetInnerHTML:{__html:m.title.replace(/([A-Z][a-z]+)/,"<span>$1</span>")}}),e.jsx("p",{className:"hero-sub",children:m.sub}),e.jsxs("div",{className:"hero-actions",children:[e.jsxs(ge,{to:"/admission",className:"btn-primary",children:[e.jsx("i",{className:"fa-solid fa-graduation-cap"})," Apply Now"]}),e.jsxs(ge,{to:"/about/ctc",className:"btn-outline",children:["Explore More ",e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]},p))}),e.jsx("button",{className:"hero-arrow left",onClick:()=>c(r-1),"aria-label":"Previous",children:e.jsx("i",{className:"fa-solid fa-chevron-left"})}),e.jsx("button",{className:"hero-arrow right",onClick:()=>c(r+1),"aria-label":"Next",children:e.jsx("i",{className:"fa-solid fa-chevron-right"})}),e.jsx("div",{className:"hero-dots",children:gi.map((m,p)=>e.jsx("div",{className:`hero-dot${p===r?" active":""}`,onClick:()=>c(p)},p))})]})}const Mo=[{end:5e3,suffix:"+",label:"Alumni"},{end:500,suffix:"+",label:"Students"},{end:200,suffix:"+",label:"Academic Events"},{end:1500,suffix:"+",label:"Placement"},{end:4,suffix:"",label:"Clubs"}];function Wg(){const[r,s]=v.useState(Mo.map(()=>0)),o=v.useRef(null),c=v.useRef(!1);return v.useEffect(()=>{const m=new IntersectionObserver(([p])=>{p.isIntersecting&&!c.current&&(c.current=!0,Mo.forEach((u,x)=>{const b=u.end/112.5;let y=0;const g=setInterval(()=>{y=Math.min(y+b,u.end),s(T=>{const E=[...T];return E[x]=Math.floor(y),E}),y>=u.end&&clearInterval(g)},16)}))},{threshold:.3});return o.current&&m.observe(o.current),()=>m.disconnect()},[]),e.jsxs("section",{className:"stats-section",ref:o,children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"16px",position:"relative"},children:[e.jsx("span",{className:"section-label",style:{color:"rgba(0,212,255,0.8)"},children:"By The Numbers"}),e.jsxs("h2",{className:"section-title",style:{color:"#fff"},children:["Our ",e.jsx("span",{style:{color:"var(--gold)"},children:"Impact"})]})]}),e.jsx("div",{className:"stats-grid",children:Mo.map((m,p)=>e.jsxs("div",{className:"stat-card reveal",children:[e.jsxs("div",{className:"stat-number",children:[r[p],m.suffix]}),e.jsx("div",{className:"stat-label",children:m.label})]},p))})]})}const Ep=[{abbr:"BBA",full:"Bachelor of Business Administration",seats:120,icon:"💼",desc:"Management, Marketing, Finance & Entrepreneurship",type:"UG · 4 Years"},{abbr:"BCA",full:"Bachelor of Computer Applications",seats:120,icon:"💻",desc:"Programming, Databases & Software Development",type:"UG · 4 Years"},{abbr:"B.Sc (CS)",full:"Bachelor of Science in Computer Science",seats:128,icon:"🖥️",desc:"Algorithms, Theory & Practical Programming",type:"UG · 4 Years"},{abbr:"B.Sc (DS)",full:"Bachelor of Science in Data Science",seats:30,icon:"📊",desc:"Machine Learning, Statistics & Data Analytics",type:"UG · 4 Years"},{abbr:"MBA",full:"Master of Business Administration",seats:60,icon:"🏆",desc:"Finance, Marketing, HR & Operations Management",type:"PG · 2 Years"},{abbr:"MCA",full:"Master of Computer Applications",seats:60,icon:"🚀",desc:"Software Engineering, AI/ML & Cloud Technologies",type:"PG · 2 Years"}],Lg=[{name:"Mr. Gyanendra Kumar Sahu",role:"Chairman",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Director Sir.jpg"},{name:"Er. Manoj Kumar Das",role:"Dean Academic",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Dean Sir.jpg"},{name:"Mr. Krishnasis Mishra",role:"Principal",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Principal Sir.jpg"},{name:"Mr. Bhabani Shankar Sahoo",role:"Vice Principal",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Bhabani Sir.jpg"},{name:"Mr. Subhrajyoti Behera",role:"Management HOD",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Subhrajyoti Sir.jpg"}],Hg=[{name:"Wipro",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/wipro.png"},{name:"TCS",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/tcs.jpg"},{name:"LTI Mindtree",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/lti.png"},{name:"Infosys",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/infosys.png"},{name:"HCL",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/hcl.png"},{name:"Capgemini",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/capgemini.png"},{name:"Cisco",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/cisco.png"},{name:"Tech Mahindra",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/tech.jpg"},{name:"IBM",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/ibm.jpeg.jpg"},{name:"Cognizant",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/cognizant.png"},{name:"Accenture",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/acenture.png"},{name:"Deloitte",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/DELOITTE.jpeg"},{name:"Airtel",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/airtel.png"},{name:"Corpnizer",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/corpnizers.jpeg"},{name:"DXC",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/dxc.png"},{name:"Zoho",img:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/zoho.jpg"}],Fg=[{q:"Which is the best college in Angul?",a:"Creative Techno College (CTC), Angul is the top-ranked professional and technical college in Angul, Odisha. AICTE-approved, affiliated to Utkal University, and established in 2010, CTC has consistently delivered quality education with a 95% placement rate."},{q:"Is CTC Angul approved by AICTE?",a:"Yes! CTC is approved by AICTE (All India Council for Technical Education) and permanently affiliated to Utkal University. It is also recognized by the Government of Odisha, Department of Higher Education."},{q:"What courses are offered at Creative Techno College, Angul?",a:"CTC offers UG programs: BBA (Business Administration) – 120 seats, BCA (Computer Applications) – 120 seats, B.Sc Computer Science (Honours) – 128 seats, B.Sc Data Science – 30 seats. PG programs: MBA (Master of Business Administration) – 60 seats, MCA (Master of Computer Applications) – 60 seats."},{q:"What is the placement record of Creative Techno College?",a:"1500+ students have been successfully placed in top companies like Wipro, TCS, Infosys, HCL, Capgemini, IBM, Cognizant, Accenture, and more. The highest package is ₹4.5 LPA with a 95% overall placement rate."},{q:"How to apply for admission in CTC Angul 2026-27?",a:"Eligibility: 10+2 pass with minimum 45% marks from any recognised board. Apply online at creativecollege.in or visit the campus at Baluakata, Saradhapur, Angul. Call +91-9778427170 for help."},{q:"Does CTC Angul have hostel facilities?",a:"Yes, CTC provides separate, secure hostel facilities for boys and girls with 24/7 security, comfortable rooms, and all essential amenities at affordable rates."}];function Ug(){const[r,s]=v.useState(null);return e.jsxs("section",{className:"faq-section",children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"48px"},children:[e.jsx("span",{className:"section-label",children:"Got Questions?"}),e.jsxs("h2",{className:"section-title",children:["Frequently Asked ",e.jsx("span",{children:"Questions"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Everything you need to know about Creative Techno College, Angul."})]}),e.jsx("div",{className:"faq-list",children:Fg.map((o,c)=>e.jsxs("div",{className:`faq-item${r===c?" faq-open":""}`,children:[e.jsxs("button",{id:`faq-q-${c}`,className:"faq-question",onClick:()=>s(r===c?null:c),"aria-expanded":r===c,"aria-controls":`faq-a-${c}`,children:[e.jsx("span",{children:o.q}),e.jsx("i",{className:`fa-solid fa-chevron-down faq-icon${r===c?" rotated":""}`})]}),e.jsx("div",{id:`faq-a-${c}`,className:"faq-answer",role:"region","aria-labelledby":`faq-q-${c}`,children:e.jsx("p",{children:o.a})})]},c))})]})}function _g(){Og();const[r,s]=v.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(Ta,{title:"Creative Techno College, Angul",noSuffix:!0,description:"Creative Techno College (CTC) is the top AICTE-approved college in Angul, Odisha. Offering BBA, BCA, B.Sc Computer Science, B.Sc Data Science, MBA & MCA with 95% placement record. Affiliated to Utkal University. Admission open 2026-27.",keywords:"top college in angul, best college angul, top technical college angul, top professional college angul, BCA college angul, BBA college angul, AICTE college angul, creative techno college angul, college in angul odisha",canonical:"/"}),e.jsx(Mg,{}),r&&e.jsx(zg,{onClose:()=>s(!1)}),e.jsxs(ge,{to:"/admission/apply",className:"adm-float-btn",children:[e.jsx("i",{className:"fa-solid fa-graduation-cap"}),e.jsx("span",{children:"Admission Open – Apply Now"}),e.jsx("span",{className:"adm-float-ping"})]}),e.jsx(Dg,{}),e.jsxs("section",{className:"home-about",children:[e.jsxs("div",{className:"home-about-text reveal-left",children:[e.jsx("span",{className:"section-label",children:"About Us"}),e.jsxs("h2",{className:"section-title",children:["Empowering Minds at ",e.jsx("span",{children:"Creative Techno College"})]}),e.jsxs("p",{children:["Creative Techno College (CTC), Angul – the ",e.jsx("strong",{children:"top professional and technical college in Angul, Odisha"})," – is established under the aegis of Creative Knowledge Foundation. AICTE-approved and permanently affiliated to Utkal University, CTC has been a beacon of quality education in Angul district since 2010."]}),e.jsx("p",{children:"Located at Baluakata, Saradhapur, Angul, we proudly serve students from across Angul, Dhenkanal, Sambalpur, Cuttack, and all of Odisha. We offer industry-aligned programs in BBA, BCA, B.Sc (Computer Science), B.Sc (Data Science), MBA and MCA — equipping students with skills to thrive in the modern corporate world."}),e.jsxs("p",{children:["With state-of-the-art infrastructure, experienced faculty, and strong industry connections, CTC provides a world-class education with ",e.jsx("strong",{children:"95% placement assistance"})," and partnerships with 100+ top recruiting companies."]}),e.jsx("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap",marginTop:"28px"},children:e.jsxs(ge,{to:"/about/ctc",className:"btn-primary",children:[e.jsx("i",{className:"fa-solid fa-circle-info"})," Learn More"]})})]}),e.jsxs("div",{className:"director-spotlight reveal-right",children:[e.jsx("img",{className:"director-photo",src:"/CTC NEW REACT WEBSITE/images/HOMEPAGE/Director Sir.jpg",alt:"Director"}),e.jsx("h3",{children:"Mr. Gyanendra Kumar Sahu"}),e.jsx("p",{className:"role",children:"Director"}),e.jsx("blockquote",{children:'"We strongly support inter disciplinary education and training for the benefit of student, industry and society. Our vision is to create future leaders who manage, create powerful organization in the emerging corporate landscape. Our management and IT development programs are exclusively industry focused so as to equip the students with latest techniques in the ever dynamic context of domestic and international business environment. It is an opportunity for you to avail the best course with best college in your locality. Come, be a part of our Creative family. Enjoy flexible and unlimited training programs."'})]})]}),e.jsxs("section",{className:"mv-section",children:[e.jsxs("div",{style:{textAlign:"center",position:"relative"},children:[e.jsx("span",{className:"section-label",children:"Our Foundation"}),e.jsxs("h2",{className:"section-title",style:{color:"#fff"},children:["Mission, Vision & ",e.jsx("span",{style:{color:"var(--gold)"},children:"Values"})]})]}),e.jsx("div",{className:"mv-grid",children:[{icon:e.jsx("i",{className:"fa-solid fa-bullseye"}),title:"Our Mission",content:"To provide quality education that empowers students with knowledge, skills, and values to excel in their careers and contribute positively to society.",type:"text"},{icon:e.jsx("i",{className:"fa-solid fa-eye"}),title:"Our Vision",content:"To be a globally recognized institution that nurtures innovative thinkers, ethical leaders, and responsible citizens.",type:"text"},{icon:e.jsx("i",{className:"fa-solid fa-gem"}),title:"Core Values",items:["Excellence in Education","Innovation & Creativity","Integrity & Ethics","Inclusivity & Diversity","Social Responsibility"],type:"list"},{icon:e.jsx("i",{className:"fa-solid fa-shield-halved"}),title:"Quality Policy",content:"We are committed to continuous improvement in academic standards, student outcomes, and institutional effectiveness through systematic planning and evaluation.",type:"text"}].map((o,c)=>e.jsxs("div",{className:"mv-card reveal",style:{transitionDelay:`${c*.1}s`},children:[e.jsx("div",{className:"mv-card-icon",children:o.icon}),e.jsx("h3",{children:o.title}),o.type==="text"?e.jsx("p",{children:o.content}):e.jsx("ul",{children:o.items.map((m,p)=>e.jsx("li",{children:m},p))})]},c))})]}),e.jsxs("section",{className:"courses-section",children:[e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("span",{className:"section-label",children:"Academic Programs"}),e.jsxs("h2",{className:"section-title",children:["Courses ",e.jsx("span",{children:"Offered"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Industry-aligned programs designed to prepare you for the careers of tomorrow."})]}),e.jsx("div",{style:{textAlign:"center",marginTop:"16px",marginBottom:"24px"},children:e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.5rem",fontWeight:800,color:"var(--navy)"},children:"Undergraduate (UG) Programs"})}),e.jsx("div",{className:"courses-grid",style:{marginBottom:"40px"},children:Ep.filter(o=>!["MBA","MCA"].includes(o.abbr)).map((o,c)=>e.jsxs("div",{className:"course-card reveal",style:{transitionDelay:`${c*.1}s`},children:[e.jsxs("div",{className:"course-abbr-banner",children:[e.jsx("h3",{children:o.abbr}),e.jsx("span",{className:"course-type-tag",children:o.type||"4-Year Degree"})]}),e.jsxs("div",{className:"course-body",children:[e.jsx("p",{className:"course-full",children:o.full}),e.jsx("p",{className:"course-desc",children:o.desc}),e.jsxs("div",{className:"course-seats-badge",children:[e.jsx("i",{className:"fa-solid fa-users"})," ",o.seats," Seats"]}),e.jsxs(ge,{to:"/admission",style:{display:"inline-flex",alignItems:"center",gap:"6px",marginTop:"4px",color:"var(--blue-light)",fontWeight:700,fontSize:"0.85rem",fontFamily:"var(--font-head)"},children:["Apply Now ",e.jsx("i",{className:"fa-solid fa-arrow-right",style:{fontSize:"0.72rem"}})]})]})]},c))}),e.jsx("div",{style:{textAlign:"center",marginBottom:"24px"},children:e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.5rem",fontWeight:800,color:"var(--navy)"},children:"Postgraduate (PG) Programs"})}),e.jsx("div",{className:"courses-grid",children:Ep.filter(o=>["MBA","MCA"].includes(o.abbr)).map((o,c)=>e.jsxs("div",{className:"course-card reveal",style:{transitionDelay:`${c*.1}s`},children:[e.jsxs("div",{className:"course-abbr-banner",children:[e.jsx("h3",{children:o.abbr}),e.jsx("span",{className:"course-type-tag",children:o.type||"2-Year Degree"})]}),e.jsxs("div",{className:"course-body",children:[e.jsx("p",{className:"course-full",children:o.full}),e.jsx("p",{className:"course-desc",children:o.desc}),e.jsxs("div",{className:"course-seats-badge",children:[e.jsx("i",{className:"fa-solid fa-users"})," ",o.seats," Seats"]}),e.jsxs(ge,{to:"/admission",style:{display:"inline-flex",alignItems:"center",gap:"6px",marginTop:"4px",color:"var(--blue-light)",fontWeight:700,fontSize:"0.85rem",fontFamily:"var(--font-head)"},children:["Apply Now ",e.jsx("i",{className:"fa-solid fa-arrow-right",style:{fontSize:"0.72rem"}})]})]})]},c))})]}),e.jsx(Wg,{}),e.jsxs("section",{className:"admin-section",children:[e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("span",{className:"section-label",children:"Leadership"}),e.jsxs("h2",{className:"section-title",children:["Our ",e.jsx("span",{children:"Administration"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Guided by experienced educators and visionary leaders committed to excellence."})]}),e.jsx("div",{className:"admin-grid",children:Lg.map((o,c)=>e.jsxs("div",{className:"admin-card reveal",style:{transitionDelay:`${c*.1}s`},children:[e.jsxs("div",{className:"admin-img-wrap",children:[e.jsx("img",{src:o.img,alt:o.name}),e.jsx("div",{className:"admin-img-overlay"})]}),e.jsxs("div",{className:"admin-info",children:[e.jsx("h4",{children:o.name}),e.jsx("span",{children:o.role})]})]},c))})]}),e.jsxs("section",{className:"recruiters-section",children:[e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("span",{className:"section-label",children:"Industry Partners"}),e.jsxs("h2",{className:"section-title",children:["Our Top ",e.jsx("span",{children:"Recruiters"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Leading companies trust CTC graduates for their talent, skills, and work ethic."})]}),e.jsx("div",{className:"recruiters-grid",children:Hg.map((o,c)=>e.jsxs("div",{className:"recruiter-logo reveal",style:{transitionDelay:`${c*.05}s`},children:[e.jsx("img",{src:o.img,alt:o.name}),e.jsx("span",{children:o.name})]},c))})]}),e.jsx(Ug,{}),e.jsxs("section",{className:"maps-section",children:[e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("span",{className:"section-label",children:"Find Us"}),e.jsxs("h2",{className:"section-title",children:["Our ",e.jsx("span",{children:"Locations"})]})]}),e.jsx("div",{className:"maps-grid",children:[{title:"Creative Techno College, Angul",icon:"fa-solid fa-building-columns",src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3730.0783340113476!2d85.08639287509837!3d20.788118580801687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a18a5b9850815f5%3A0xa7f8a31afad931b7!2sCreative%20Techno%20College!5e0!3m2!1sen!2sin!4v1758728395827!5m2!1sen!2sin",link:"https://www.google.com/maps/place/Creative+Techno+College/@20.7881186,85.0863929,17z"},{title:"Creative Knowledge Foundation Office",icon:"fa-solid fa-house",src:"https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3728.8844998564623!2d85.10675499999999!3d20.836369999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1m1!2zMjDCsDUwJzEwLjkiTiA4NcKwMDYnMjQuMyJF!5e0!3m2!1sen!2sin!4v1759905943185!5m2!1sen!2sin",link:"https://www.google.com/maps/place/Creative+CT+Office/@20.750000,85.000000,17z"}].map((o,c)=>e.jsxs("div",{className:"map-card reveal",style:{transitionDelay:`${c*.15}s`},children:[e.jsxs("div",{className:"map-card-header",children:[e.jsx("i",{className:o.icon}),e.jsx("h3",{children:o.title})]}),e.jsx("iframe",{src:o.src,title:o.title,allowFullScreen:!0,loading:"lazy"}),e.jsx("div",{className:"map-card-footer",children:e.jsxs("a",{href:o.link,target:"_blank",rel:"noreferrer",className:"btn-primary",style:{fontSize:"0.82rem",padding:"8px 20px"},children:[e.jsx("i",{className:"fa-solid fa-map-location-dot"})," Open in Maps"]})})]},c))})]})]})}function $g(){v.useEffect(()=>{const r=document.querySelectorAll(".reveal, .reveal-left, .reveal-right"),s=new IntersectionObserver(o=>o.forEach(c=>{c.isIntersecting&&c.target.classList.add("visible")}),{threshold:.1});return r.forEach(o=>s.observe(o)),()=>s.disconnect()},[])}const Gg=[{year:"1995",label:"Founded",desc:"Journey began with computer education as a franchise of APTECH Computer Education."},{year:"2010",label:"CTC Established",desc:"Creative Techno College officially launched, offering BBA & BCA under Utkal University."},{year:"2017",label:"1st Permanent Approved",desc:"Became the 1st Permanently Approved College of Angul in Central Odisha."},{year:"2024",label:"AICTE Approved",desc:"Received AICTE approval, marking adherence to the highest national educational standards."}],Yg=[{icon:"fa-solid fa-graduation-cap",title:"Educational Excellence",desc:"Committed to the highest standards of academic quality and student achievement across all programs."},{icon:"fa-solid fa-hands-helping",title:"Community Service",desc:"Dedicated to serving the region through education, outreach, and deep social responsibility."},{icon:"fa-solid fa-lightbulb",title:"Innovation",desc:"Fostering a culture of creativity, critical thinking, and continuous improvement in everything we do."},{icon:"fa-solid fa-seedling",title:"Holistic Development",desc:"Nurturing not just academic excellence but also character, values, and leadership in every student."}],Jg=["Spoken English","Tally ERP","Web Development","Digital Marketing","Data Analytics","Soft Skills"];function Vg(){return $g(),e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"ckf-hero",style:{textAlign:"left"},children:e.jsxs("div",{style:{maxWidth:"1100px",margin:"0 auto",display:"flex",alignItems:"center",gap:"48px",flexWrap:"wrap"},children:[e.jsxs("div",{style:{flex:"1 1 320px"},children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Our Foundation"}),e.jsxs("h1",{className:"section-title",style:{color:"#fff",margin:"12px 0 16px",textAlign:"left"},children:["About ",e.jsx("span",{style:{color:"var(--gold)"},children:"Creative Knowledge Foundation"})]}),e.jsx("p",{style:{color:"rgba(255,255,255,0.65)",lineHeight:1.8,maxWidth:"480px"},children:"The trust behind Creative Techno College, Angul — empowering education since 1995"})]}),e.jsx("div",{className:"reveal-right",style:{flex:"0 0 auto"},children:e.jsx("div",{style:{background:"#fff",padding:"20px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 10px 30px rgba(0,0,0,0.15)",width:"180px",height:"180px"},children:e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/AboutTrust/aboutckfimg1.png",alt:"CKF Logo",style:{height:"auto",width:"100%",maxWidth:"120px",opacity:1}})})})]})}),e.jsx("section",{style:{background:"var(--page-bg)",padding:"60px 5%"},children:e.jsx("div",{style:{maxWidth:"1100px",margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"20px"},children:Gg.map((r,s)=>e.jsxs("div",{className:"milestone-card reveal",style:{transitionDelay:`${s*.1}s`},children:[e.jsx("div",{className:"milestone-year",children:r.year}),e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontWeight:800,color:"var(--navy)",marginBottom:"10px",fontSize:"0.93rem"},children:r.label}),e.jsx("p",{children:r.desc})]},s))})}),e.jsx("section",{style:{background:"#fff"},children:e.jsxs("div",{className:"ckf-history",children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"40px"},children:[e.jsx("span",{className:"section-label",children:"Our Story"}),e.jsxs("h2",{className:"section-title",children:["The ",e.jsx("span",{children:"CKF Journey"})]})]}),e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/AboutTrust/aboutckfimg2.png",alt:"CKF Timeline",className:"ckf-timeline-img reveal"}),e.jsxs("div",{className:"ckf-history-text reveal",children:[e.jsx("p",{children:"CREATIVE KNOWLEDGE FOUNDATION with Regd. Office at Tamrit Colony, Angul, Odisha is running CREATIVE TECHNO COLLEGE since 2010 situated at Baluakata, Sharadhapur, Angul."}),e.jsx("p",{children:"However the journey was started at Institutional level in year 1995 with computer education as a franchise of APTECH COMPUTER EDUCATION (APTECH Ltd.) upto 2007 and run distance education BBA, BCA, MBA and MCA courses between 2001–2015."}),e.jsxs("p",{children:["Since 2010 CREATIVE TECHNO COLLEGE is offering BBA and BCA undergraduate courses in computer application and management recognized by Government of Odisha, Department of Higher Education and Affiliated to Utkal University. In 2018 another course B.Sc. in Computer Science has been added under this umbrella. The founder of the college Mr. Gyanendra Sahu has dedicatedly worked hard to make the college the ",e.jsx("strong",{children:"1st Permanent Approved College of Angul"})," in Central Odisha in 2017."]}),e.jsxs("p",{children:["In 2019 our college has been awarded as ",e.jsx("strong",{children:"Best Professional College by Odisha Education Award 2019"}),". We received AICTE approval in 2024, which ensures the college is adhering to strict standards in terms of infrastructure, faculty, teaching methodology, and overall educational excellence."]}),e.jsx("p",{children:"In Skill Development area of IT education and training: in 2009 we trained 300 trainees in association with OCAC; in 2011–12 we trained 150 trainees in association with DTET Odisha; in 2014 we worked with OKCL (Odisha Knowledge Corporation Ltd.); and in 2018 we trained 120 trainees under NALCO CSR fund in association with AISECT Bhopal."})]})]})}),e.jsxs("section",{style:{background:"var(--page-bg)"},children:[e.jsxs("div",{style:{maxWidth:"1100px",margin:"0 auto",padding:"60px 5% 0",textAlign:"center"},children:[e.jsx("span",{className:"section-label",children:"What We Stand For"}),e.jsxs("h2",{className:"section-title",children:["Our Core ",e.jsx("span",{children:"Values"})]})]}),e.jsx("div",{style:{maxWidth:"1100px",margin:"24px auto 0",padding:"0 5% 72px",display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"20px"},children:Yg.map((r,s)=>e.jsxs("div",{className:"ckf-value-card reveal",style:{transitionDelay:`${s*.1}s`},children:[e.jsx("div",{className:"ckf-value-icon",children:e.jsx("i",{className:r.icon})}),e.jsx("h3",{children:r.title}),e.jsx("p",{children:r.desc})]},s))})]}),e.jsx("section",{style:{background:"#fff",padding:"72px 5%"},children:e.jsxs("div",{className:"ckf-skills-banner reveal",style:{maxWidth:"1100px",margin:"0 auto"},children:[e.jsxs("div",{style:{flex:"1 1 300px"},children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Vocational Wing"}),e.jsx("h2",{children:"CKF Skills"}),e.jsx("p",{children:"CKF Skills is the vocational and skill development wing of Creative Knowledge Foundation, offering industry-relevant training programs to bridge the skill gap and enhance employability among youth in Odisha."})]}),e.jsx("div",{style:{flex:"1 1 260px"},children:e.jsx("div",{className:"ckf-skill-tags",children:Jg.map((r,s)=>e.jsx("span",{children:r},s))})})]})})]})}function Kg(){v.useEffect(()=>{const r=document.querySelectorAll(".reveal, .reveal-left, .reveal-right"),s=new IntersectionObserver(o=>o.forEach(c=>{c.isIntersecting&&c.target.classList.add("visible")}),{threshold:.1});return r.forEach(o=>s.observe(o)),()=>s.disconnect()},[])}const qg=[{img:"/CTC NEW REACT WEBSITE/images/AboutUs/StrongAcademic.png",title:"Strong Academics",desc:"Comprehensive programs delivered by experienced faculty to boost academic excellence and career readiness."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/PrePlacementActivity.jpg",title:"Pre-Placement Training",desc:"Mock interviews, aptitude tests, and resume workshops to prepare students for campus placements."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/LiveProjects.png",title:"Skill Development",desc:"Hands-on live projects and internship programs to bridge the gap between academics and industry."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/Hostel.jpg",title:"Hostel Facilities",desc:"Comfortable, secure, and well-maintained separate hostels for boys and girls with 24/7 security."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/transportation.png",title:"Buses & Transportation",desc:"Safe and timely college bus services covering major routes across Angul and surrounding areas."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/Playground.png",title:"Play Ground & Sports",desc:"Dedicated outdoor sports facilities to promote physical fitness, teamwork, and competitive spirit."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/Canteen_Caffeteria.jpg",title:"Canteen & Cafeteria",desc:"Hygienic and affordable canteen offering nutritious meals and refreshments throughout the day."},{img:"/CTC NEW REACT WEBSITE/images/AboutUs/GreenCampus.png",title:"Green Campus",desc:"Lush eco-friendly campus with beautiful surroundings promoting a healthy and inspiring environment."}];function Qg(){return Kg(),e.jsxs(e.Fragment,{children:[e.jsx(Ta,{title:"About Creative Techno College – Top AICTE College in Angul, Odisha",description:"Creative Techno College (CTC) Angul, established in 2010, is the best AICTE-approved college in Angul, Odisha. Located at Baluakata, Saradhapur, Angul. Affiliated to Utkal University. Hostel, transport, placement – all under one roof.",keywords:"about creative techno college angul, CTC angul about, best college angul odisha, AICTE approved college angul, Utkal University affiliated college angul, professional college angul",canonical:"/about/ctc"}),e.jsxs("div",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-dots"}),e.jsx("span",{className:"section-label",children:"Know Us Better"}),e.jsxs("h1",{children:["About ",e.jsx("span",{children:"Creative Techno College"})]}),e.jsx("p",{children:"Excellence in Education since 2010 — Angul, Odisha"})]}),e.jsx("section",{style:{padding:"80px 5%",background:"#fff"},children:e.jsxs("div",{style:{maxWidth:"1200px",margin:"0 auto",display:"flex",gap:"60px",flexWrap:"wrap",alignItems:"center"},children:[e.jsxs("div",{className:"reveal-left",style:{flex:"1 1 380px"},children:[e.jsx("span",{className:"section-label",children:"Our Story"}),e.jsxs("h2",{className:"section-title",children:["A Legacy of ",e.jsx("span",{children:"Excellence"})]}),e.jsx("p",{style:{color:"#4a6080",lineHeight:1.9,marginBottom:"16px"},children:"Creative Techno College (CTC), Angul (A Unit of Creative Knowledge Foundation) is located at Balukata, Sharadhapur, Angul. It is recognized by Govt. of Odisha, Dept. of Higher Education and affiliated to Utkal University — a pioneer college in Central Odisha providing IT and management education."}),e.jsx("p",{style:{color:"#4a6080",lineHeight:1.9,marginBottom:"16px"},children:"The college has a group of experienced faculties and supporting staff, well-equipped infrastructure and air-conditioned computer labs. Besides course curriculum, CTC emphasizes developing students' professional skills through soft skill training including spoken English, group discussions, debates, mock interviews, and more."}),e.jsx("p",{style:{color:"#4a6080",lineHeight:1.9,marginBottom:"28px"},children:"With a dedicated placement cell, experienced faculty, and vibrant campus life through Gymkhana activities, CTC provides a holistic educational experience that goes beyond textbooks and classrooms."}),e.jsx("div",{style:{display:"flex",gap:"16px",flexWrap:"wrap"},children:e.jsxs(ge,{to:"/admission",className:"btn-primary",children:[e.jsx("i",{className:"fa-solid fa-graduation-cap"})," Apply Now"]})})]}),e.jsxs("div",{className:"reveal-right",style:{flex:"1 1 340px"},children:[e.jsxs("div",{style:{borderRadius:"20px",overflow:"hidden",boxShadow:"var(--shadow-lg)",position:"relative"},children:[e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/AboutUs/creative-campus.jpg",alt:"CTC Campus",style:{width:"100%",height:"380px",objectFit:"cover",display:"block"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(10,22,40,0.45) 0%, transparent 55%)",pointerEvents:"none"}})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginTop:"12px"},children:[{val:"15+",label:"Years"},{val:"1500+",label:"Alumni"},{val:"398",label:"Seats"},{val:"95%",label:"Placement"}].map((r,s)=>e.jsxs("div",{className:"reveal",style:{transitionDelay:`${s*.08}s`,background:"linear-gradient(135deg, var(--navy), var(--blue))",borderRadius:"12px",padding:"20px",textAlign:"center",color:"#fff"},children:[e.jsx("div",{style:{fontFamily:"var(--font-head)",fontSize:"1.6rem",fontWeight:900,color:"var(--gold)"},children:r.val}),e.jsx("div",{style:{fontSize:"0.78rem",color:"rgba(255,255,255,0.7)",fontWeight:600,marginTop:"4px"},children:r.label})]},s))})]})]})}),e.jsxs("section",{style:{padding:"80px 5%",background:"linear-gradient(135deg, var(--navy) 0%, #0d2550 50%, var(--blue) 100%)",position:"relative",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",inset:0,background:"radial-gradient(ellipse at 70% 30%, rgba(0,212,255,0.1) 0%, transparent 60%)",pointerEvents:"none"}}),e.jsxs("div",{style:{maxWidth:"1200px",margin:"0 auto",position:"relative"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"48px"},children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Career Success"}),e.jsxs("h2",{className:"section-title",style:{color:"#fff"},children:["Best Placement Provider ",e.jsx("span",{style:{color:"var(--gold)"},children:"in Odisha"})]}),e.jsx("p",{style:{color:"rgba(255,255,255,0.65)",maxWidth:"680px",margin:"0 auto",lineHeight:1.9,fontSize:"0.97rem"},children:"Education is not just about subjects learned in college. Becoming educated is a lifelong exercise that can be unbelievably exciting if one jumps into the train of experience and takes a trip to every conceivable place on earth."})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"20px",maxWidth:"900px",margin:"0 auto"},children:[{val:"1500+",label:"Students Placed",icon:"fa-solid fa-user-tie"},{val:"100+",label:"Companies",icon:"fa-solid fa-building"},{val:"₹4.5 LPA",label:"Highest Package",icon:"fa-solid fa-indian-rupee-sign"},{val:"95%",label:"Placement Rate",icon:"fa-solid fa-chart-line"}].map((r,s)=>e.jsxs("div",{className:"reveal",style:{transitionDelay:`${s*.1}s`,background:"rgba(255,255,255,0.07)",border:"1px solid rgba(255,255,255,0.13)",borderRadius:"16px",padding:"28px 20px",textAlign:"center",backdropFilter:"blur(12px)"},children:[e.jsx("i",{className:r.icon,style:{color:"var(--cyan)",fontSize:"1.6rem",marginBottom:"12px",display:"block"}}),e.jsx("div",{style:{fontFamily:"var(--font-head)",fontSize:"1.6rem",fontWeight:900,color:"var(--gold)",marginBottom:"4px"},children:r.val}),e.jsx("div",{style:{fontSize:"0.78rem",color:"rgba(255,255,255,0.65)",fontWeight:600},children:r.label})]},s))}),e.jsx("div",{style:{textAlign:"center",marginTop:"40px"},children:e.jsxs(ge,{to:"/placement",className:"btn-primary",children:[e.jsx("i",{className:"fa-solid fa-briefcase"})," View Placement Details"]})})]})]}),e.jsx("section",{style:{padding:"80px 5%",background:"var(--page-bg)"},children:e.jsxs("div",{style:{maxWidth:"1200px",margin:"0 auto"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"8px"},children:[e.jsx("span",{className:"section-label",children:"Campus Life"}),e.jsxs("h2",{className:"section-title",children:["World-Class ",e.jsx("span",{children:"Facilities"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Everything you need for a complete and enriching college experience."})]}),e.jsx("div",{className:"facility-grid",children:qg.map((r,s)=>e.jsxs("div",{className:"facility-card reveal",style:{transitionDelay:`${s%4*.08}s`},children:[e.jsxs("div",{className:"facility-img-wrap",children:[e.jsx("img",{src:r.img,alt:r.title}),e.jsx("div",{className:"facility-img-overlay"})]}),e.jsxs("div",{className:"facility-info",children:[e.jsx("h3",{children:r.title}),e.jsx("p",{children:r.desc})]})]},s))})]})})]})}function Xg(){v.useEffect(()=>{const r=document.querySelectorAll(".reveal, .reveal-left, .reveal-right"),s=new IntersectionObserver(o=>o.forEach(c=>{c.isIntersecting&&c.target.classList.add("visible")}),{threshold:.08});return r.forEach(o=>s.observe(o)),()=>s.disconnect()},[])}const Zg=[{name:"Mr. Manoj Kumar Das",designation:"Dean (Academic)",qualification:"23 Years Experience",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Dean Sir.jpg",email:"dasmanojp@gmail.com",role:"admin"},{name:"Mr. Krishnashis Mishra",designation:"Principal",qualification:"M.Tech (CSE) · 15 Yrs",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Principal Sir.jpg",email:"principal.creativecollege@gmail.com",role:"admin"},{name:"Mr. Bhabani Sankar Sahoo",designation:"Vice Principal",qualification:"M.Tech (CSE) · 7 Yrs",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Bhabani Sir.jpg",email:"bhabaniwipro89@gmail.com",role:"admin"},{name:"Mr. Subhrajyoti Behera",designation:"HOD — Management Faculty",qualification:"MBA (Marketing)",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Subhrajyoti Sir.jpg",email:"subhyrajyoticafpl@gmail.com",role:"mgmt"},{name:"Ms. Neha Solanki",designation:"Management Faculty",qualification:"M.Com",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Neha Mam.jpg",email:"nehasolanki1411@gmail.com",role:"mgmt"},{name:"Ms. Pravati Pradhan",designation:"Mathematics Faculty",qualification:"MSc (Mathematics)",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Pravati Mam.jpg",email:"",role:"math"},{name:"Mr. Saumya Ranjan Pradhan",designation:"IT Faculty",qualification:"MCA",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Saumya Sir.jpg",email:"",role:"it"},{name:"Mr. Swastik Ranjan Sahoo",designation:"IT Faculty",qualification:"MCA",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Swastik Sir.jpg",email:"sahooswastik406@gmail.com",role:"it"},{name:"Ms. Arghyarupa Behera",designation:"IT Faculty",qualification:"MSc (CS)",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Arghyarupa Mam.jpg",email:"arghyarupabehera3@gmail.com",role:"it"},{name:"Ms. Itishree Nath",designation:"IT Faculty",qualification:"BCA",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/itishreemam.jpg",email:"",role:"it"},{name:"Mr. Satya S. S. Dehury",designation:"Public Relationship Officer",qualification:"MBA",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Satya Sir.jpg",email:"sssdehury89@gmail.com",role:"admin"},{name:"Ms. Monika Sahu",designation:"Librarian",qualification:"BCA, B.Lib.I.Sc",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/monikamam.jpg",email:"monika28sahu@gmail.com",role:"lib"},{name:"Mr. Abhishek Satpathy",designation:"Accountant",qualification:"B.Com (Acctg), MBA",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/abhiseksir.jpg",email:"abhisheksathpathy020@gmail.com",role:"admin"},{name:"Mr. Sarat Chandra Sahu",designation:"Campus Incharge",qualification:"General +3",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Sarat Sir.jpg",email:"saratmuna243@gmail.com",role:"admin"}];function e0(){Xg();const[r,s]=v.useState(""),o=Zg.filter(c=>c.name.toLowerCase().includes(r.toLowerCase())||c.designation.toLowerCase().includes(r.toLowerCase()));return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
            ...
            `}),e.jsxs("div",{className:"page-hero",children:[e.jsx("div",{className:"page-hero-dots"}),e.jsx("span",{className:"section-label",children:"Meet The People"}),e.jsxs("h1",{children:["Our ",e.jsx("span",{children:"Team"})]}),e.jsx("p",{children:"Dedicated educators and professionals shaping the future of our students"})]}),e.jsxs("div",{className:"team-header",children:[e.jsx("span",{className:"section-label",children:"Faculty & Staff"}),e.jsxs("h2",{children:["The ",e.jsx("span",{children:"Minds"})," Behind CTC"]}),e.jsx("p",{children:"Our team of experienced educators, industry professionals, and dedicated staff work together to provide an exceptional learning experience."})]}),e.jsx("div",{className:"search-bar",children:e.jsx("input",{type:"text",placeholder:"Search by name or designation...",value:r,onChange:c=>s(c.target.value)})}),e.jsx("div",{className:"team-grid",children:o.map((c,m)=>e.jsxs("div",{className:"team-card reveal",style:{transitionDelay:`${m%4*.08}s`},children:[e.jsx("div",{className:"team-card-img",children:e.jsx("img",{src:c.img,alt:c.name,onError:p=>{p.target.src="/CTC NEW REACT WEBSITE/images/HOMEPAGE/Director Sir.jpg"}})}),e.jsxs("div",{className:"team-card-body",children:[e.jsx("h3",{children:c.name}),e.jsx("div",{className:"designation",children:c.designation}),e.jsxs("div",{className:"qualification",children:[e.jsx("i",{className:"fa-solid fa-certificate",style:{marginRight:"5px",color:"#f5c518"}}),c.qualification]}),e.jsxs("div",{className:"email",children:[e.jsx("i",{className:"fa-solid fa-envelope"}),c.email?e.jsx("a",{href:`mailto:${c.email}`,children:c.email}):e.jsx("span",{children:"Email not available"})]})]})]},c.name))})]})}function t0(){v.useEffect(()=>{const r=document.querySelectorAll(".reveal, .reveal-left, .reveal-right"),s=new IntersectionObserver(o=>o.forEach(c=>{c.isIntersecting&&c.target.classList.add("visible")}),{threshold:.08});return r.forEach(o=>s.observe(o)),()=>s.disconnect()},[])}function a0(r,s=1800){const[o,c]=v.useState(0),m=v.useRef(null);return v.useEffect(()=>{const p=m.current;if(!p)return;const u=new IntersectionObserver(([x])=>{if(!x.isIntersecting)return;u.disconnect();let h=0;const b=Math.ceil(r/(s/16)),y=()=>{h=Math.min(h+b,r),c(h),h<r&&requestAnimationFrame(y)};requestAnimationFrame(y)},{threshold:.3});return u.observe(p),()=>u.disconnect()},[r,s]),[o,m]}function n0({pct:r,color:s,label:o,seats:c,admitted:m}){const u=2*Math.PI*54,[x,h]=v.useState(!1),b=v.useRef(null);v.useEffect(()=>{const g=new IntersectionObserver(([T])=>{T.isIntersecting&&(h(!0),g.disconnect())},{threshold:.3});return b.current&&g.observe(b.current),()=>g.disconnect()},[]);const y=x?u*(1-r/100):u;return e.jsxs("div",{ref:b,style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"14px"},children:[e.jsxs("div",{style:{position:"relative",width:"130px",height:"130px"},children:[e.jsxs("svg",{width:"130",height:"130",viewBox:"0 0 130 130",children:[e.jsx("circle",{cx:"65",cy:"65",r:54,fill:"none",stroke:"rgba(255,255,255,0.08)",strokeWidth:"10"}),e.jsx("circle",{cx:"65",cy:"65",r:54,fill:"none",stroke:s,strokeWidth:"10",strokeLinecap:"round",strokeDasharray:u,strokeDashoffset:y,style:{transition:"stroke-dashoffset 1.6s cubic-bezier(.4,0,.2,1)",transformOrigin:"65px 65px",transform:"rotate(-90deg)"}})]}),e.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsxs("span",{style:{fontFamily:"var(--font-head)",fontSize:"1.4rem",fontWeight:900,color:"#fff",lineHeight:1},children:[r,"%"]}),e.jsx("span",{style:{fontSize:"0.6rem",color:"rgba(255,255,255,0.45)",marginTop:"2px"},children:"FILLED"})]})]}),e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{fontFamily:"var(--font-head)",fontSize:"1.1rem",fontWeight:800,color:"#fff"},children:o}),e.jsxs("div",{style:{fontSize:"0.72rem",color:"rgba(255,255,255,0.45)",marginTop:"4px"},children:[m," / ",c," seats"]})]})]})}const Rp=[{abbr:"BBA",full:"Bachelor of Business Administration",seats:120,duration:"4 Years",fee:"₹50,000/yr",icon:"fa-solid fa-briefcase",tags:["Marketing","Finance","HR","Entrepreneurship"],accent:"#f5c518"},{abbr:"BCA",full:"Bachelor of Computer Applications",seats:120,duration:"4 Years",fee:"₹60,000/yr",icon:"fa-solid fa-laptop-code",tags:["Web Dev","Networking","Database","Java"],accent:"#00d4ff"},{abbr:"B.Sc CS (H)",full:"B.Sc Computer Science (Hons.)",seats:128,duration:"4 Years",fee:"₹60,000/yr",icon:"fa-solid fa-microchip",tags:["AI / ML","Python","Algorithms","Cloud"],accent:"#7b61ff"},{abbr:"B.Sc DS",full:"B.Sc Data Science",seats:30,duration:"4 Years",fee:"₹70,000/yr",icon:"fa-solid fa-chart-pie",tags:["Data Analytics","Statistics","ML","Tableau"],accent:"#ff6b6b"},{abbr:"MBA",full:"Master of Business Administration",seats:60,duration:"2 Years",fee:"Contact Office",icon:"fa-solid fa-chart-line",tags:["Finance","Marketing","HR","Operations"],accent:"#ec4899",note:"OJEE / CAT / MAT / ATMA 2026 Rank Required"},{abbr:"MCA",full:"Master of Computer Applications",seats:60,duration:"2 Years",fee:"Contact Office",icon:"fa-solid fa-code",tags:["Software Engg","Cloud","AI/ML","Cybersecurity"],accent:"#06b6d4",note:"OJEE 2026 Rank Card Required"}],Pp=[{n:"01",icon:"fa-solid fa-clipboard-check",title:"Check Eligibility",body:"10+2 pass with min. 45% from any recognised board."},{n:"02",icon:"fa-solid fa-pen-to-square",title:"Fill Application",body:"Complete the online form or visit the college office."},{n:"03",icon:"fa-solid fa-file-arrow-up",title:"Upload Documents",body:"Upload scanned copies as per the document checklist."},{n:"04",icon:"fa-solid fa-credit-card",title:"Pay Fee",body:"Pay admission fee online or at the college counter."},{n:"05",icon:"fa-solid fa-circle-check",title:"Enrolment",body:"Receive confirmation and report on the specified date."}],r0=[{icon:"fa-solid fa-file-signature",label:"10th Certificate & Mark Sheet"},{icon:"fa-solid fa-file-lines",label:"+2 Certificate & Mark Sheet"},{icon:"fa-solid fa-id-card",label:"Aadhaar Card (Self & Parent)"},{icon:"fa-solid fa-graduation-cap",label:"Character / CLC Certificate"},{icon:"fa-solid fa-passport",label:"Migration Certificate"},{icon:"fa-solid fa-camera",label:"4 Passport-Size Photographs"},{icon:"fa-solid fa-shield-halved",label:"Caste Certificate (if applicable)"},{icon:"fa-solid fa-building-columns",label:"Bank Account Details"}],i0=[{course:"BBA",name:"Mr. Subhrajyoti Behera",email:"subhrajyoticafpl@gmail.com",phone:"+91 9861071840",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Subhrajyoti Sir.jpg",accent:"#f5c518"},{course:"BCA",name:"Mr. Manoj Kumar Das",email:"dasmanojp@gmail.com",phone:"+91 9338233303",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Dean Sir.jpg",accent:"#00d4ff"},{course:"B.Sc CS(H)",name:"Mr. Krishnashis Mishra",email:"principal.creativecollege@gmail.com",phone:"+91 9853325903",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Principal Sir.jpg",accent:"#7b61ff"},{course:"B.Sc DS",name:"Mr. Bhabani Sankar Sahoo",email:"bhabaniwipro89@gmail.com",phone:"+91 9668844571",img:"/CTC NEW REACT WEBSITE/images/OURTEAM/Bhabani Sir.jpg",accent:"#ff6b6b"}],s0=[{label:"BBA",pct:100,color:"#f5c518",seats:120,admitted:120},{label:"BCA",pct:50,color:"#00d4ff",seats:120,admitted:60},{label:"B.Sc CS(H)",pct:53,color:"#7b61ff",seats:128,admitted:68},{label:"B.Sc DS",pct:83,color:"#ff6b6b",seats:36,admitted:30},{label:"MBA",pct:0,color:"#ec4899",seats:60,admitted:0},{label:"MCA",pct:0,color:"#06b6d4",seats:60,admitted:0}],o0=[{year:"2020",total:119,bba:16,bca:53,bsccs:50},{year:"2021",total:154,bba:30,bca:60,bsccs:64},{year:"2022",total:155,bba:30,bca:60,bsccs:65},{year:"2023",total:157,bba:30,bca:60,bsccs:67},{year:"2024",total:158,bba:30,bca:60,bsccs:68}],zo=200;function l0({target:r,suffix:s=""}){const[o,c]=a0(r);return e.jsxs("span",{ref:c,children:[o,s]})}function c0(){return t0(),e.jsxs(e.Fragment,{children:[e.jsx(Ta,{title:"Admission 2026-27 – BBA, BCA, B.Sc CS, Data Science, MBA & MCA | CTC Angul",description:"Apply for admission at Creative Techno College, Angul. UG: BBA (120 seats), BCA (120 seats), B.Sc CS (128 seats), B.Sc Data Science (30 seats). PG: MBA (60 seats), MCA (60 seats). AICTE approved.",keywords:"admission in angul college, CTC angul admission 2026, BCA admission angul, BBA admission angul, MBA admission angul, MCA admission angul, best college admission angul odisha, creative techno college admission",canonical:"/admission"}),e.jsxs("div",{className:"adm2-hero",children:[e.jsx("div",{className:"adm2-hero-glow"}),e.jsxs("div",{className:"adm2-hero-content",children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Admissions Open"}),e.jsxs("h1",{children:["Shape Your ",e.jsx("span",{style:{color:"var(--gold)"},children:"Future"}),e.jsx("br",{}),"at Creative Techno College"]}),e.jsx("p",{children:"AICTE Approved · Utkal University Affiliated · Angul, Odisha"}),e.jsxs("div",{className:"adm2-hero-btns",children:[e.jsxs(ge,{to:"/admission/apply",className:"btn-primary",children:[e.jsx("i",{className:"fa-solid fa-pen-to-square"})," Apply Online"]}),e.jsxs("a",{href:"/pdfs/brochure.pdf",download:!0,className:"btn-outline",children:[e.jsx("i",{className:"fa-solid fa-file-arrow-down"})," Download Brochure"]})]})]}),e.jsx("div",{className:"adm2-hero-stats",children:[{icon:"fa-solid fa-users",val:518,suf:"+",label:"Total Seats"},{icon:"fa-solid fa-graduation-cap",val:1500,suf:"+",label:"Alumni"},{icon:"fa-solid fa-trophy",val:95,suf:"%",label:"Placement Rate"},{icon:"fa-solid fa-calendar-days",val:15,suf:"+",label:"Years of Excellence"}].map((r,s)=>e.jsxs("div",{className:"adm2-qstat",children:[e.jsx("i",{className:r.icon}),e.jsx("div",{className:"adm2-qstat-val",children:e.jsx(l0,{target:r.val,suffix:r.suf})}),e.jsx("div",{className:"adm2-qstat-label",children:r.label})]},s))})]}),e.jsx("section",{className:"adm2-section",style:{background:"var(--page-bg)"},children:e.jsxs("div",{className:"adm2-wrap",children:[e.jsxs("div",{className:"adm2-heading reveal",children:[e.jsx("span",{className:"section-label",children:"Academic Programs"}),e.jsxs("h2",{className:"section-title",children:["Courses ",e.jsx("span",{children:"Offered"})]}),e.jsx("p",{className:"section-subtitle",style:{margin:"0 auto"},children:"Government recognised · Utkal University affiliated · Industry-focused curriculum"})]}),e.jsx("div",{className:"adm2-heading reveal",style:{marginBottom:"24px",marginTop:"16px",textAlign:"center"},children:e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.4rem",fontWeight:800,color:"var(--navy)"},children:"Undergraduate (UG) Programs"})}),e.jsx("div",{className:"adm2-courses",style:{marginBottom:"40px"},children:Rp.filter(r=>!["MBA","MCA"].includes(r.abbr)).map((r,s)=>e.jsxs("div",{className:"adm2-course reveal",style:{transitionDelay:`${s*.1}s`},children:[e.jsx("div",{style:{height:"4px",background:r.accent,borderRadius:"20px 20px 0 0",margin:"-28px -28px 24px",flexShrink:0}}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"12px",marginBottom:"16px"},children:[e.jsx("div",{style:{background:`${r.accent}1a`,border:`1px solid ${r.accent}44`,borderRadius:"14px",width:"52px",height:"52px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.3rem",color:r.accent,flexShrink:0},children:e.jsx("i",{className:r.icon})}),e.jsxs("div",{style:{background:"var(--page-bg)",borderRadius:"20px",padding:"4px 13px",fontSize:"0.75rem",fontFamily:"var(--font-head)",fontWeight:700,color:"var(--navy)",whiteSpace:"nowrap"},children:[r.seats," seats"]})]}),e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.4rem",fontWeight:900,color:"var(--navy)",marginBottom:"4px"},children:r.abbr}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",marginBottom:"8px",lineHeight:1.5},children:r.full}),r.note&&e.jsxs("p",{style:{fontSize:"0.69rem",color:r.accent,fontWeight:700,fontFamily:"var(--font-head)",marginBottom:"10px",background:`${r.accent}12`,border:`1px solid ${r.accent}30`,borderRadius:"8px",padding:"4px 10px",display:"inline-block"},children:[e.jsx("i",{className:"fa-solid fa-circle-info",style:{marginRight:"5px"}}),r.note]}),e.jsx("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap",marginBottom:"20px"},children:r.tags.map((o,c)=>e.jsx("span",{style:{background:`${r.accent}16`,color:r.accent,border:`1px solid ${r.accent}30`,borderRadius:"10px",padding:"3px 10px",fontSize:"0.69rem",fontFamily:"var(--font-head)",fontWeight:600},children:o},c))}),e.jsxs("div",{style:{marginTop:"auto",borderTop:"1px solid rgba(10,22,40,0.07)",paddingTop:"16px",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("span",{style:{fontSize:"0.8rem",color:"var(--text-muted)",fontFamily:"var(--font-head)",fontWeight:600},children:[e.jsx("i",{className:"fa-regular fa-clock",style:{marginRight:"5px"}}),r.duration," · ",r.fee]}),e.jsxs(ge,{to:"/admission/apply",style:{display:"inline-flex",alignItems:"center",gap:"6px",background:r.accent,color:r.accent==="#f5c518"?"#0a1628":"#fff",padding:"7px 16px",borderRadius:"20px",fontSize:"0.76rem",fontFamily:"var(--font-head)",fontWeight:700,textDecoration:"none",transition:"opacity 0.2s"},children:["Apply ",e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]},s))}),e.jsx("div",{className:"adm2-heading reveal",style:{marginBottom:"24px",textAlign:"center"},children:e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.4rem",fontWeight:800,color:"var(--navy)"},children:"Postgraduate (PG) Programs"})}),e.jsx("div",{className:"adm2-courses",children:Rp.filter(r=>["MBA","MCA"].includes(r.abbr)).map((r,s)=>e.jsxs("div",{className:"adm2-course reveal",style:{transitionDelay:`${s*.1}s`},children:[e.jsx("div",{style:{height:"4px",background:r.accent,borderRadius:"20px 20px 0 0",margin:"-28px -28px 24px",flexShrink:0}}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:"12px",marginBottom:"16px"},children:[e.jsx("div",{style:{background:`${r.accent}1a`,border:`1px solid ${r.accent}44`,borderRadius:"14px",width:"52px",height:"52px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.3rem",color:r.accent,flexShrink:0},children:e.jsx("i",{className:r.icon})}),e.jsxs("div",{style:{background:"var(--page-bg)",borderRadius:"20px",padding:"4px 13px",fontSize:"0.75rem",fontFamily:"var(--font-head)",fontWeight:700,color:"var(--navy)",whiteSpace:"nowrap"},children:[r.seats," seats"]})]}),e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.4rem",fontWeight:900,color:"var(--navy)",marginBottom:"4px"},children:r.abbr}),e.jsx("p",{style:{fontSize:"0.78rem",color:"var(--text-muted)",marginBottom:"8px",lineHeight:1.5},children:r.full}),r.note&&e.jsxs("p",{style:{fontSize:"0.69rem",color:r.accent,fontWeight:700,fontFamily:"var(--font-head)",marginBottom:"10px",background:`${r.accent}12`,border:`1px solid ${r.accent}30`,borderRadius:"8px",padding:"4px 10px",display:"inline-block"},children:[e.jsx("i",{className:"fa-solid fa-circle-info",style:{marginRight:"5px"}}),r.note]}),e.jsx("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap",marginBottom:"20px"},children:r.tags.map((o,c)=>e.jsx("span",{style:{background:`${r.accent}16`,color:r.accent,border:`1px solid ${r.accent}30`,borderRadius:"10px",padding:"3px 10px",fontSize:"0.69rem",fontFamily:"var(--font-head)",fontWeight:600},children:o},c))}),e.jsxs("div",{style:{marginTop:"auto",borderTop:"1px solid rgba(10,22,40,0.07)",paddingTop:"16px",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("span",{style:{fontSize:"0.8rem",color:"var(--text-muted)",fontFamily:"var(--font-head)",fontWeight:600},children:[e.jsx("i",{className:"fa-regular fa-clock",style:{marginRight:"5px"}}),r.duration," · ",r.fee]}),e.jsxs(ge,{to:"/admission/apply",style:{display:"inline-flex",alignItems:"center",gap:"6px",background:r.accent,color:r.accent==="#f5c518"?"#0a1628":"#fff",padding:"7px 16px",borderRadius:"20px",fontSize:"0.76rem",fontFamily:"var(--font-head)",fontWeight:700,textDecoration:"none",transition:"opacity 0.2s"},children:["Apply ",e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]},s))})]})}),e.jsxs("section",{className:"adm2-section",style:{background:"linear-gradient(160deg, #060d1a 0%, #0a1f3d 50%, #091828 100%)",position:"relative",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",top:"-80px",right:"-80px",width:"400px",height:"400px",borderRadius:"50%",background:"radial-gradient(circle, rgba(0,212,255,0.08) 0%, transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",bottom:"-60px",left:"-60px",width:"300px",height:"300px",borderRadius:"50%",background:"radial-gradient(circle, rgba(123,97,255,0.08) 0%, transparent 70%)",pointerEvents:"none"}}),e.jsxs("div",{className:"adm2-wrap",style:{position:"relative"},children:[e.jsxs("div",{className:"adm2-heading reveal",children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Data Insights"}),e.jsxs("h2",{className:"section-title",style:{color:"#fff"},children:["Admission ",e.jsx("span",{style:{color:"var(--gold)"},children:"Statistics"})]}),e.jsx("p",{style:{color:"rgba(255,255,255,0.45)",fontSize:"0.85rem",marginTop:"6px"},children:"Academic Year 2024-25 seat utilisation & year-over-year enrollment trends"})]}),e.jsx("div",{className:"adm2-rings-row",children:s0.map((r,s)=>e.jsx(n0,{...r},s))}),e.jsx("div",{style:{height:"1px",background:"rgba(255,255,255,0.07)",margin:"56px 0"}}),e.jsx("div",{className:"adm2-heading reveal",style:{marginBottom:"32px"},children:e.jsx("h3",{style:{fontFamily:"var(--font-head)",fontSize:"1.1rem",fontWeight:800,color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",textTransform:"uppercase"},children:"Year-over-Year Enrollment (2020–2024)"})}),e.jsxs("div",{className:"adm2-yoy reveal",children:[o0.map((r,s)=>e.jsxs("div",{className:"adm2-yoy-row",children:[e.jsx("div",{className:"adm2-yoy-year",children:r.year}),e.jsxs("div",{className:"adm2-yoy-bars",children:[e.jsxs("div",{className:"adm2-yoy-track",title:`BBA: ${r.bba}`,children:[e.jsx("div",{className:"adm2-yoy-fill",style:{width:`${r.bba/zo*100}%`,background:"#f5c518"}}),e.jsx("span",{className:"adm2-yoy-tip",children:r.bba})]}),e.jsxs("div",{className:"adm2-yoy-track",title:`BCA: ${r.bca}`,children:[e.jsx("div",{className:"adm2-yoy-fill",style:{width:`${r.bca/zo*100}%`,background:"#00d4ff"}}),e.jsx("span",{className:"adm2-yoy-tip",children:r.bca})]}),e.jsxs("div",{className:"adm2-yoy-track",title:`B.Sc CS: ${r.bsccs}`,children:[e.jsx("div",{className:"adm2-yoy-fill",style:{width:`${r.bsccs/zo*100}%`,background:"#7b61ff"}}),e.jsx("span",{className:"adm2-yoy-tip",children:r.bsccs})]})]}),e.jsxs("div",{className:"adm2-yoy-total",children:[e.jsx("span",{style:{fontFamily:"var(--font-head)",fontWeight:900,color:"var(--gold)",fontSize:"1.3rem"},children:r.total}),e.jsx("span",{style:{fontSize:"0.65rem",color:"rgba(255,255,255,0.35)",display:"block",marginTop:"2px"},children:"total"})]})]},s)),e.jsx("div",{className:"adm2-yoy-legend",children:[["#f5c518","BBA"],["#00d4ff","BCA"],["#7b61ff","B.Sc CS(H)"]].map(([r,s])=>e.jsxs("span",{children:[e.jsx("span",{style:{background:r}}),s]},s))})]})]})]}),e.jsx("section",{className:"adm2-section",style:{background:"#fff"},children:e.jsxs("div",{className:"adm2-wrap",children:[e.jsxs("div",{className:"adm2-heading reveal",children:[e.jsx("span",{className:"section-label",children:"Simple Process"}),e.jsxs("h2",{className:"section-title",children:["How to ",e.jsx("span",{children:"Apply"})]})]}),e.jsx("div",{className:"adm2-steps reveal",children:Pp.map((r,s)=>e.jsxs("div",{className:"adm2-step",children:[s<Pp.length-1&&e.jsx("div",{className:"adm2-step-line"}),e.jsx("div",{className:"adm2-step-circle",children:e.jsx("i",{className:r.icon})}),e.jsx("div",{className:"adm2-step-num",children:r.n}),e.jsx("h3",{children:r.title}),e.jsx("p",{children:r.body})]},s))})]})}),e.jsx("section",{className:"adm2-section",style:{background:"var(--page-bg)"},children:e.jsxs("div",{className:"adm2-wrap adm2-doc-coord",children:[e.jsxs("div",{className:"reveal-left",style:{flex:"1 1 300px"},children:[e.jsx("span",{className:"section-label",children:"Checklist"}),e.jsxs("h2",{className:"section-title",style:{marginBottom:"24px"},children:["Documents ",e.jsx("span",{children:"Required"})]}),e.jsx("div",{className:"adm2-docgrid",children:r0.map((r,s)=>e.jsxs("div",{className:"adm2-docitem",children:[e.jsx("i",{className:r.icon}),e.jsx("span",{children:r.label})]},s))})]}),e.jsxs("div",{className:"reveal-right",style:{flex:"1 1 340px"},children:[e.jsx("span",{className:"section-label",children:"Get in Touch"}),e.jsx("h2",{className:"section-title",style:{marginBottom:"24px"},children:"Coordinators"}),e.jsx("div",{className:"adm2-coords",children:i0.map((r,s)=>e.jsxs("div",{className:"adm2-coord",children:[e.jsx("img",{src:r.img,alt:r.name,className:"adm2-coord-img",onError:o=>o.target.style.display="none",style:{borderColor:r.accent}}),e.jsxs("div",{children:[e.jsx("span",{className:"adm2-coord-badge",style:{background:`${r.accent}22`,color:r.accent,border:`1px solid ${r.accent}44`},children:r.course}),e.jsx("p",{className:"adm2-coord-name",children:r.name}),e.jsxs("p",{className:"adm2-coord-info",children:[e.jsx("i",{className:"fa-solid fa-phone"}),r.phone]}),e.jsxs("p",{className:"adm2-coord-info",children:[e.jsx("i",{className:"fa-solid fa-envelope"}),r.email]})]})]},s))})]})]})}),e.jsxs("section",{style:{background:"linear-gradient(135deg, var(--navy) 0%, #0f2a4e 100%)",padding:"80px 5%",overflow:"hidden",position:"relative"},children:[e.jsx("div",{style:{position:"absolute",inset:0,background:"radial-gradient(ellipse at 70% 50%, rgba(0,212,255,0.07) 0%, transparent 60%)",pointerEvents:"none"}}),e.jsxs("div",{style:{maxWidth:"1100px",margin:"0 auto",display:"flex",gap:"60px",alignItems:"center",flexWrap:"wrap",position:"relative"},children:[e.jsxs("div",{className:"reveal-left",style:{flex:"1 1 300px"},children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Official Publication"}),e.jsxs("h2",{className:"section-title",style:{color:"#fff",marginBottom:"18px"},children:["College ",e.jsx("span",{style:{color:"var(--gold)"},children:"Brochure"})]}),e.jsx("p",{style:{color:"rgba(255,255,255,0.6)",lineHeight:1.9,fontSize:"0.9rem"},children:"Creative Techno College, Angul — permanently recognised by the Government of Odisha, Dept. of Higher Education and affiliated to Utkal University. A pioneer in IT and Management education in Central Odisha since 2010."}),e.jsxs("div",{style:{marginTop:"20px",display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsxs("p",{style:{color:"rgba(255,255,255,0.55)",fontSize:"0.82rem"},children:[e.jsx("i",{className:"fa-solid fa-location-dot",style:{color:"var(--cyan)",marginRight:"8px"}}),"Baluakata, Saradhapur, Angul, Odisha"]}),e.jsxs("p",{style:{color:"rgba(255,255,255,0.55)",fontSize:"0.82rem"},children:[e.jsx("i",{className:"fa-solid fa-building",style:{color:"var(--cyan)",marginRight:"8px"}}),"City Office: Tamrit Colony, Angul"]})]}),e.jsxs("a",{href:"/CTC NEW REACT WEBSITE/images/Admission/college brochure.pdf",download:!0,className:"btn-primary",style:{marginTop:"28px",display:"inline-flex"},children:[e.jsx("i",{className:"fa-solid fa-file-arrow-down"})," Download Brochure"]})]}),e.jsx("div",{className:"reveal-right",style:{flex:"1 1 280px",maxWidth:"460px"},children:e.jsx("img",{src:"/CTC NEW REACT WEBSITE/images/Admission/banner.png",alt:"CTC Brochure",style:{width:"100%",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.5)"},onError:r=>r.target.style.display="none"})})]})]})]})}const al=v.createContext(null),d0="/CTC%20NEW%20REACT%20WEBSITE/Admission/submit.php",Ko=[{id:1,label:"Personal Info",icon:"fa-solid fa-user"},{id:2,label:"Academic Info",icon:"fa-solid fa-graduation-cap"},{id:3,label:"Course & Details",icon:"fa-solid fa-book-open"},{id:4,label:"Review & Submit",icon:"fa-solid fa-paper-plane"}];function p0({step:r}){return e.jsx("div",{className:"af-progress",children:Ko.map((s,o)=>e.jsxs("div",{className:`af-step-node ${r>=s.id?"done":""} ${r===s.id?"active":""}`,children:[e.jsx("div",{className:"af-node-circle",children:r>s.id?e.jsx("i",{className:"fa-solid fa-check"}):e.jsx("i",{className:s.icon})}),e.jsx("span",{className:"af-node-label",children:s.label}),o<Ko.length-1&&e.jsx("div",{className:`af-node-line ${r>s.id?"done":""}`})]},s.id))})}function Pe({label:r,icon:s,error:o,children:c}){return e.jsxs("div",{className:"af-field",children:[e.jsxs("label",{className:"af-label",children:[s&&e.jsx("i",{className:s}),r]}),c,o&&e.jsxs("span",{className:"af-error",children:[e.jsx("i",{className:"fa-solid fa-circle-exclamation"})," ",o]})]})}function vt({name:r,type:s="text",placeholder:o,...c}){const{form:m,set:p,errors:u,clrErr:x}=v.useContext(al);return e.jsx("input",{className:`af-input ${u[r]?"af-input-err":""}`,type:s,value:m[r],placeholder:o,onChange:h=>{p(r,h.target.value),x(r)},...c})}function tn({name:r,children:s}){const{form:o,set:c,errors:m,clrErr:p}=v.useContext(al);return e.jsx("select",{className:`af-input ${m[r]?"af-input-err":""}`,value:o[r],onChange:u=>{c(r,u.target.value),p(r)},children:s})}function m0(){const r=nr(),[s,o]=v.useState(1),[c,m]=v.useState(!1),[p,u]=v.useState(!1),[x,h]=v.useState(""),[b,y]=v.useState(null),[g,T]=v.useState({}),[E,F]=v.useState({fullName:"",dob:"",gender:"",category:"",phone:"",email:"",school10:"",pct10:"",school12:"",stream:"",pct12:"",yearPass:"",course:"",address:"",district:"",state:"Odisha",pincode:"",havePC:"",reference:""});v.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[s]);const R=(V,te)=>F(ke=>({...ke,[V]:te})),M=V=>T(te=>{const ke={...te};return delete ke[V],ke});function I(V){const te={};return V===1&&(E.fullName.trim()||(te.fullName="Full name is required"),E.dob||(te.dob="Date of birth is required"),E.gender||(te.gender="Please select your gender"),E.phone.match(/^\d{10}$/)||(te.phone="Enter a valid 10-digit mobile number")),V===2&&(E.school10.trim()||(te.school10="Please enter your 10th school name"),E.pct10||(te.pct10="Enter 10th percentage / grade"),E.school12.trim()||(te.school12="Please enter your +2 school name"),E.pct12||(te.pct12="Enter +2 percentage / grade"),E.stream||(te.stream="Please select your +2 stream"),E.yearPass||(te.yearPass="Enter your year of passing +2")),V===3&&(E.course||(te.course="Please select a course"),E.address.trim()||(te.address="Address is required"),E.district.trim()||(te.district="District is required"),E.pincode.match(/^\d{6}$/)||(te.pincode="Enter a valid 6-digit pin code")),te}function P(){const V=I(s);if(Object.keys(V).length){T(V);return}T({}),o(te=>te+1)}function U(){o(V=>V-1),T({})}async function K(){u(!0),h("");try{const te=await(await fetch(d0,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(E)})).json();te.success?(y(te.application_id),m(!0)):h(te.error||"Submission failed. Please try again.")}catch{h("Network error. Please check your connection and try again.")}finally{u(!1)}}return c?e.jsx(u0,{name:E.fullName,course:E.course,appId:b,navigate:r}):e.jsx(al.Provider,{value:{form:E,set:R,errors:g,clrErr:M},children:e.jsxs("div",{className:"af-page",children:[e.jsxs("div",{className:"af-hero",children:[e.jsx("div",{className:"af-hero-glow"}),e.jsxs("div",{style:{position:"relative"},children:[e.jsx("span",{className:"section-label",style:{color:"var(--cyan)"},children:"Online Application"}),e.jsxs("h1",{style:{fontFamily:"var(--font-head)",fontSize:"clamp(1.6rem, 3.5vw, 2.6rem)",fontWeight:900,color:"#fff",margin:"12px 0 10px"},children:["Apply for Admission ",e.jsx("span",{style:{color:"var(--gold)"},children:"2026–27"})]}),e.jsx("p",{style:{color:"rgba(255,255,255,0.45)",fontSize:"0.88rem",letterSpacing:"0.04em"},children:"Creative Techno College, Angul · AICTE Approved · Utkal University Affiliated"})]})]}),e.jsxs("div",{className:"af-body",children:[e.jsxs("div",{className:"af-card",children:[e.jsx(p0,{step:s}),s===1&&e.jsxs("div",{className:"af-form-section",children:[e.jsxs("h2",{className:"af-form-title",children:[e.jsx("i",{className:"fa-solid fa-user"})," Personal Information"]}),e.jsxs("div",{className:"af-grid-2",children:[e.jsx(Pe,{label:"Full Name *",icon:"fa-solid fa-signature",error:g.fullName,children:e.jsx(vt,{name:"fullName",placeholder:"As per 10th certificate"})}),e.jsx(Pe,{label:"Date of Birth *",error:g.dob,children:e.jsx(vt,{name:"dob",type:"date"})}),e.jsx(Pe,{label:"Gender *",error:g.gender,children:e.jsxs(tn,{name:"gender",children:[e.jsx("option",{value:"",children:"Select Gender"}),e.jsx("option",{children:"Male"}),e.jsx("option",{children:"Female"}),e.jsx("option",{children:"Other"})]})}),e.jsx(Pe,{label:"Category",children:e.jsxs(tn,{name:"category",children:[e.jsx("option",{value:"",children:"Select Category"}),e.jsx("option",{children:"General"}),e.jsx("option",{children:"OBC"}),e.jsx("option",{children:"SC"}),e.jsx("option",{children:"ST"}),e.jsx("option",{children:"PwD"})]})}),e.jsx(Pe,{label:"Mobile Number *",icon:"fa-solid fa-phone",error:g.phone,children:e.jsx(vt,{name:"phone",type:"tel",placeholder:"10-digit mobile number",maxLength:10})}),e.jsx(Pe,{label:"Email Address",icon:"fa-solid fa-envelope",children:e.jsx(vt,{name:"email",type:"email",placeholder:"Optional"})})]})]}),s===2&&e.jsxs("div",{className:"af-form-section",children:[e.jsxs("h2",{className:"af-form-title",children:[e.jsx("i",{className:"fa-solid fa-graduation-cap"})," Academic Details"]}),e.jsx("p",{className:"af-form-subtitle",children:"10th Certificate Details"}),e.jsxs("div",{className:"af-grid-2",children:[e.jsx(Pe,{label:"10th School / Board *",error:g.school10,children:e.jsx(vt,{name:"school10",placeholder:"School name"})}),e.jsx(Pe,{label:"10th Percentage / CGPA *",error:g.pct10,children:e.jsx(vt,{name:"pct10",placeholder:"e.g. 78% or 7.8 CGPA"})})]}),e.jsx("p",{className:"af-form-subtitle",style:{marginTop:"24px"},children:"+2 / 12th / Diploma Details"}),e.jsxs("div",{className:"af-grid-2",children:[e.jsx(Pe,{label:"+2 School / College / Board *",error:g.school12,children:e.jsx(vt,{name:"school12",placeholder:"School / college name"})}),e.jsx(Pe,{label:"+2 Stream *",error:g.stream,children:e.jsxs(tn,{name:"stream",children:[e.jsx("option",{value:"",children:"Select Stream"}),e.jsx("option",{children:"Science (PCM)"}),e.jsx("option",{children:"Science (PCB)"}),e.jsx("option",{children:"Commerce"}),e.jsx("option",{children:"Arts / Humanities"}),e.jsx("option",{children:"Vocational"}),e.jsx("option",{children:"Diploma"})]})}),e.jsx(Pe,{label:"+2 Percentage / CGPA *",error:g.pct12,children:e.jsx(vt,{name:"pct12",placeholder:"e.g. 65% or 6.5 CGPA"})}),e.jsx(Pe,{label:"Year of Passing +2 *",error:g.yearPass,children:e.jsxs(tn,{name:"yearPass",children:[e.jsx("option",{value:"",children:"Select Year"}),[2026,2025,2024,2023,2022,2021,2020,2019].map(V=>e.jsx("option",{children:V},V))]})})]})]}),s===3&&e.jsxs("div",{className:"af-form-section",children:[e.jsxs("h2",{className:"af-form-title",children:[e.jsx("i",{className:"fa-solid fa-book-open"})," Course & Contact Details"]}),e.jsxs(Pe,{label:"Course Applied For *",error:g.course,children:[e.jsx("div",{className:"af-course-pick",children:[{v:"BBA",label:"BBA",sub:"Bachelor of Business Administration",color:"#f5c518"},{v:"BCA",label:"BCA",sub:"Bachelor of Computer Applications",color:"#00d4ff"},{v:"B.Sc CS(H)",label:"B.Sc CS(H)",sub:"Computer Science (Honours)",color:"#7b61ff"},{v:"B.Sc DS",label:"B.Sc DS",sub:"Data Science",color:"#ff6b6b"},{v:"MBA",label:"MBA",sub:"Master of Business Administration",color:"#ec4899"},{v:"MCA",label:"MCA",sub:"Master of Computer Applications",color:"#06b6d4"}].map(V=>e.jsxs("label",{className:`af-course-tile ${E.course===V.v?"sel":""}`,style:{"--tc":V.color},children:[e.jsx("input",{type:"radio",name:"course",value:V.v,checked:E.course===V.v,onChange:()=>{R("course",V.v),M("course")}}),e.jsx("strong",{children:V.label}),e.jsx("span",{children:V.sub})]},V.v))}),g.course&&e.jsxs("span",{className:"af-error",children:[e.jsx("i",{className:"fa-solid fa-circle-exclamation"})," ",g.course]})]}),e.jsx("p",{className:"af-form-subtitle",style:{marginTop:"24px"},children:"Permanent Address"}),e.jsxs("div",{className:"af-grid-2",children:[e.jsx(Pe,{label:"Address *",error:g.address,children:e.jsx("textarea",{className:`af-input ${g.address?"af-input-err":""}`,rows:3,placeholder:"Street / Village / Ward",value:E.address,onChange:V=>{R("address",V.target.value),M("address")}})}),e.jsxs("div",{children:[e.jsx(Pe,{label:"District *",error:g.district,children:e.jsx(vt,{name:"district",placeholder:"e.g. Angul"})}),e.jsx(Pe,{label:"State",style:{marginTop:"12px"},children:e.jsx(vt,{name:"state",placeholder:"State"})})]}),e.jsx(Pe,{label:"PIN Code *",error:g.pincode,children:e.jsx(vt,{name:"pincode",placeholder:"6-digit pin",maxLength:6})}),e.jsx(Pe,{label:"Do you have a PC / Laptop at home?",children:e.jsxs(tn,{name:"havePC",children:[e.jsx("option",{value:"",children:"Select"}),e.jsx("option",{children:"Yes"}),e.jsx("option",{children:"No"})]})}),e.jsx(Pe,{label:"How did you hear about us?",children:e.jsxs(tn,{name:"reference",children:[e.jsx("option",{value:"",children:"Select"}),e.jsx("option",{children:"Friend / Family"}),e.jsx("option",{children:"Social Media"}),e.jsx("option",{children:"News / Newspaper"}),e.jsx("option",{children:"School / Teacher"}),e.jsx("option",{children:"Walk-in / Visit"}),e.jsx("option",{children:"Other"})]})})]})]}),s===4&&e.jsxs("div",{className:"af-form-section",children:[e.jsxs("h2",{className:"af-form-title",children:[e.jsx("i",{className:"fa-solid fa-eye"})," Review Your Application"]}),e.jsxs("p",{style:{color:"var(--text-muted)",fontSize:"0.83rem",marginBottom:"24px"},children:["Please review your information carefully. Clicking ",e.jsx("strong",{children:"Submit Application"})," will securely save your details directly to the database."]}),e.jsxs("div",{className:"af-review-grid",children:[e.jsx(Oo,{title:"Personal Information",icon:"fa-solid fa-user",rows:[["Full Name",E.fullName],["Date of Birth",E.dob],["Gender",E.gender],["Category",E.category||"General"],["Mobile",E.phone],["Email",E.email||"—"]]}),e.jsx(Oo,{title:"Academic Details",icon:"fa-solid fa-graduation-cap",rows:[["10th School",E.school10],["10th Marks",E.pct10],["+2 School",E.school12],["+2 Stream",E.stream],["+2 Marks",E.pct12],["Year of Pass",E.yearPass]]}),e.jsx(Oo,{title:"Course & Address",icon:"fa-solid fa-book-open",rows:[["Course",E.course],["Address",E.address],["District",E.district],["State",E.state],["PIN Code",E.pincode],["Has PC/Laptop",E.havePC||"—"],["Reference",E.reference||"—"]]})]}),e.jsxs("div",{className:"af-wa-notice",style:{background:"rgba(45,125,210,0.08)",borderColor:"rgba(45,125,210,0.25)"},children:[e.jsx("i",{className:"fa-solid fa-database",style:{color:"var(--cyan)"}}),e.jsxs("p",{children:["Your application will be ",e.jsx("strong",{children:"securely stored"})," in the college database. The admission team will contact you on your registered mobile number for document verification."]})]})]}),e.jsxs("div",{className:"af-nav",children:[s>1?e.jsxs("button",{className:"af-btn-back",onClick:U,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"})," Back"]}):e.jsxs(ge,{to:"/admission",className:"af-btn-back",children:[e.jsx("i",{className:"fa-solid fa-arrow-left"})," Admission Info"]}),e.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"center"},children:[e.jsxs("span",{className:"af-step-count",children:["Step ",s," of ",Ko.length]}),s<4?e.jsxs("button",{className:"af-btn-next",onClick:P,children:["Next ",e.jsx("i",{className:"fa-solid fa-arrow-right"})]}):e.jsx("button",{className:"af-btn-submit",onClick:K,disabled:p,style:{opacity:p?.7:1,cursor:p?"wait":"pointer"},children:p?e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fa-solid fa-spinner fa-spin"})," Submitting…"]}):e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fa-solid fa-paper-plane"})," Submit Application"]})})]}),x&&e.jsxs("p",{style:{color:"#e53e3e",fontSize:"0.82rem",marginTop:"10px",textAlign:"right",fontFamily:"var(--font-head)"},children:[e.jsx("i",{className:"fa-solid fa-circle-exclamation"})," ",x]})]})]}),e.jsxs("aside",{className:"af-aside",children:[e.jsxs("div",{className:"af-aside-card",children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fa-solid fa-circle-info"})," Important Info"]}),e.jsxs("ul",{children:[e.jsxs("li",{children:["Admission is on a ",e.jsx("strong",{children:"first-come, first-served"})," basis."]}),e.jsx("li",{children:"Bring original documents on the day of admission."}),e.jsxs("li",{children:["Eligibility: 10+2 pass with min. ",e.jsx("strong",{children:"45%"})," marks."]}),e.jsxs("li",{children:["For queries call: ",e.jsx("strong",{children:"+91 9668844571"})]})]})]}),e.jsxs("div",{className:"af-aside-card af-aside-courses",children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fa-solid fa-table-list"})," Available Seats"]}),[{label:"BBA",seats:120,color:"#f5c518"},{label:"BCA",seats:120,color:"#00d4ff"},{label:"B.Sc CS(H)",seats:128,color:"#7b61ff"},{label:"B.Sc DS",seats:30,color:"#ff6b6b"},{label:"MBA",seats:60,color:"#ec4899"},{label:"MCA",seats:60,color:"#06b6d4"}].map(V=>e.jsxs("div",{className:"af-seat-row",children:[e.jsx("span",{style:{width:"10px",height:"10px",borderRadius:"50%",background:V.color,display:"inline-block",flexShrink:0}}),e.jsx("span",{className:"af-seat-label",children:V.label}),e.jsxs("span",{className:"af-seat-count",children:[V.seats," seats"]})]},V.label))]}),e.jsxs("div",{className:"af-aside-card",children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fa-solid fa-location-dot"})," Campus Address"]}),e.jsx("p",{children:"Baluakata, Saradhapur, Angul, Odisha — 759143"}),e.jsx("p",{style:{marginTop:"8px"},children:"City Office: Tamrit Colony, Angul"})]})]})]})]})})}function Oo({title:r,icon:s,rows:o}){return e.jsxs("div",{className:"af-review-block",children:[e.jsxs("div",{className:"af-review-block-title",children:[e.jsx("i",{className:s})," ",r]}),o.map(([c,m])=>e.jsxs("div",{className:"af-review-row",children:[e.jsx("span",{className:"af-review-key",children:c}),e.jsx("span",{className:"af-review-val",children:m||"—"})]},c))]})}function u0({name:r,course:s,appId:o,navigate:c}){return e.jsx("div",{className:"af-success-page",children:e.jsxs("div",{className:"af-success-card",children:[e.jsx("div",{className:"af-success-icon",children:e.jsx("i",{className:"fa-solid fa-circle-check"})}),e.jsx("h2",{children:"Application Submitted!"}),e.jsxs("p",{children:["Thank you, ",e.jsx("strong",{children:r}),"! Your application for ",e.jsx("strong",{children:s})," has been received by Creative Techno College."]}),o&&e.jsxs("p",{style:{marginTop:"14px",fontSize:"0.88rem",fontFamily:"var(--font-head)",color:"var(--blue-light)"},children:[e.jsx("i",{className:"fa-solid fa-hashtag"})," Application ID: ",e.jsxs("strong",{style:{color:"var(--gold)"},children:["#",o]})]}),e.jsxs("p",{style:{fontSize:"0.82rem",color:"var(--text-muted)",marginTop:"12px"},children:["Our team will contact you on ",e.jsxs("strong",{children:[r.split(" ")[0],"'s"]})," registered mobile number for further steps. Please keep your documents ready."]}),e.jsxs("div",{style:{display:"flex",gap:"12px",justifyContent:"center",flexWrap:"wrap",marginTop:"28px"},children:[e.jsxs("button",{className:"btn-primary",onClick:()=>c("/admission"),children:[e.jsx("i",{className:"fa-solid fa-arrow-left"})," Back to Admission"]}),e.jsxs("button",{className:"btn-outline",onClick:()=>c("/"),children:[e.jsx("i",{className:"fa-solid fa-house"})," Home"]})]})]})})}const f0=[{code:"BBA",full:"Bachelor of Business Administration",tagline:"Lead. Manage. Innovate.",icon:"fa-solid fa-briefcase",color:"#f59e0b",colorDark:"#d97706",colorLight:"#fef3c7",accent:"#92400e",tag:"Management",seats:120,duration:"4 Years · 8 Semesters",eligibility:"10+2 pass in any stream from a recognised board",overview:"The BBA program provides a solid foundation in management, business principles, and entrepreneurship. It blends theoretical concepts with practical applications to prepare students for leadership roles in the corporate world.",highlights:["Core subjects in Marketing, Finance, and Human Resource Management","Case studies, business simulations, and industry projects","Regular seminars, workshops, and industry visits","Focus on communication, leadership, and decision-making skills"],career:["Business Manager","Marketing Executive","HR Specialist","Entrepreneur","MBA Studies"],syllabus:"/CTC NEW REACT WEBSITE/images/REGULARCOURSES/BBA.pdf"},{code:"BCA",full:"Bachelor of Computer Applications",tagline:"Code. Build. Deploy.",icon:"fa-solid fa-laptop-code",color:"#3b82f6",colorDark:"#2563eb",colorLight:"#eff6ff",accent:"#1e3a8a",tag:"Technology",seats:120,duration:"4 Years · 8 Semesters",eligibility:"10+2 pass in any stream with Mathematics / Statistics as one subject",overview:"BCA is an undergraduate program focused on computer applications and IT skills. It prepares students to work in the software industry with a strong foundation in programming, databases, and system design.",highlights:["Programming in C, C++, Java, Python","Database Management, Web Development & Software Engineering","Exposure to cloud computing, networking & cybersecurity","Hands-on training via projects, coding competitions & workshops"],career:["Software Developer","Web Designer","Database Admin","System Analyst","MCA Studies"],syllabus:"/CTC NEW REACT WEBSITE/images/REGULARCOURSES/BCA.pdf"},{code:"B.Sc CS",full:"B.Sc. Computer Science (Honours)",tagline:"Analyse. Compute. Discover.",icon:"fa-solid fa-microchip",color:"#10b981",colorDark:"#059669",colorLight:"#ecfdf5",accent:"#064e3b",tag:"Science",seats:128,duration:"4 Years · 8 Semesters",eligibility:"10+2 pass with Science stream (compulsory)",overview:"This program offers in-depth knowledge of computer science fundamentals and advanced concepts. It emphasises analytical skills, algorithmic thinking, and research-oriented study.",highlights:["Data Structures, Algorithms & Operating Systems","Computer Networks, AI, Compiler Design, Software Development","Practical lab sessions and mini-projects every semester","Research and innovation-driven learning environment"],career:["Software Engineer","System Admin","Research Associate","M.Sc./MCA Studies"],syllabus:"/CTC NEW REACT WEBSITE/images/REGULARCOURSES/Bsc.pdf"},{code:"B.Sc DS",full:"B.Sc. Computer Science (Data Science)",tagline:"Predict. Analyse. Transform.",icon:"fa-solid fa-chart-line",color:"#8b5cf6",colorDark:"#7c3aed",colorLight:"#f5f3ff",accent:"#4c1d95",tag:"Data Science",seats:30,duration:"4 Years · 8 Semesters",eligibility:"10+2 pass with Science stream — Mathematics is compulsory",overview:"Designed for students aspiring to build a career in Data Science and AI. Focuses on data analytics, machine learning, and big data technologies for tech-driven industries.",highlights:["Python, R, Statistics & Data Visualization","Machine Learning, Deep Learning & Artificial Intelligence","Big Data Analytics & Cloud Computing concepts","Industry-based projects, internships & live case studies"],career:["Data Analyst","ML Engineer","BI Developer","AI Researcher","M.Sc. DS Studies"],syllabus:"/CTC NEW REACT WEBSITE/images/REGULARCOURSES/BscDsc.pdf"}],h0=[{code:"MCA",full:"Master of Computer Applications",tagline:"Innovate. Engineer. Lead.",icon:"fa-solid fa-code",color:"#06b6d4",colorDark:"#0891b2",colorLight:"#ecfeff",accent:"#164e63",tag:"PG · Technology",seats:60,duration:"2 Years · 4 Semesters",eligibility:"OJEE Mandatory – OJEE 2026 Rank Card Holder. Passed any Bachelor's degree (e.g. B.E./B.Tech/BSC/B.Com/BA/BCA etc.) with Mathematics and obtained at least 50% marks (45% for reserved category candidates) in the qualifying examination.",overview:"The MCA program is a postgraduate course designed to equip students with advanced knowledge of computer applications, software engineering, and modern technologies. It builds on undergraduate fundamentals to prepare professionals for senior IT roles.",highlights:["Advanced programming: Java, Python, .NET & Cloud Technologies","Software Engineering, System Design & Architecture","AI, Machine Learning, Data Science & Cybersecurity modules","Industry internships, live projects & research work"],career:["Software Architect","Senior Developer","IT Consultant","Project Manager","Research Scientist"],syllabus:null},{code:"MBA",full:"Master of Business Administration",tagline:"Strategise. Lead. Transform.",icon:"fa-solid fa-chart-pie",color:"#ec4899",colorDark:"#db2777",colorLight:"#fdf2f8",accent:"#831843",tag:"PG · Management",seats:60,duration:"2 Years · 4 Semesters",eligibility:"OJEE/CAT/MAT/ATMA-2026 Rank Card Holder. Passed any Bachelor's degree (e.g. any stream/Graduation) with at least 50% aggregate marks (45% for reserved category candidates) in the last qualifying examination.",overview:"The MBA program is a flagship postgraduate management degree that prepares students for leadership roles in business, finance, marketing, and operations. It combines strategic thinking with real-world application.",highlights:["Specialisations: Finance, Marketing, HR & Operations Management","Case study methodology, business simulations & live projects","Leadership development, communication & entrepreneurship skills","Industry interaction, guest lectures & national-level seminars"],career:["Business Strategist","Marketing Manager","Finance Analyst","HR Director","Entrepreneur"],syllabus:null}];function g0(r,s=1500,o=!1){const[c,m]=v.useState(0);return v.useEffect(()=>{if(!o)return;let p=null;const u=x=>{p||(p=x);const h=Math.min((x-p)/s,1);m(Math.floor(h*r)),h<1&&requestAnimationFrame(u)};requestAnimationFrame(u)},[r,s,o]),c}const x0=[{value:6,label:"Programs",suffix:""},{value:458,label:"Total Seats",suffix:"+"},{value:2,label:"PG Programs",suffix:""},{value:100,label:"Placement Assist",suffix:"%"}];function b0(){const r=v.useRef(null),[s,o]=v.useState(!1);return v.useEffect(()=>{const c=new IntersectionObserver(([m])=>{m.isIntersecting&&o(!0)},{threshold:.3});return r.current&&c.observe(r.current),()=>c.disconnect()},[]),e.jsx("div",{ref:r,className:"rc2-stats-row",children:x0.map((c,m)=>{const p=g0(c.value,1400,s);return e.jsxs("div",{className:"rc2-stat",style:{animationDelay:`${m*.1}s`},children:[e.jsxs("span",{className:"rc2-stat-num",children:[p,c.suffix]}),e.jsx("span",{className:"rc2-stat-label",children:c.label})]},m)})})}function Ip({course:r,index:s}){const[o,c]=v.useState(!1),m=v.useRef(null),[p,u]=v.useState(!1);return v.useEffect(()=>{const x=new IntersectionObserver(([h])=>{h.isIntersecting&&u(!0)},{threshold:.1});return m.current&&x.observe(m.current),()=>x.disconnect()},[]),e.jsxs("div",{ref:m,className:`rc2-card${p?" rc2-card--visible":""}`,style:{"--card-color":r.color,"--card-dark":r.colorDark,"--card-light":r.colorLight,animationDelay:`${s*.1}s`},children:[e.jsxs("div",{className:"rc2-card-header",style:{background:`linear-gradient(135deg, ${r.colorDark} 0%, ${r.color} 100%)`},children:[e.jsx("div",{className:"rc2-card-header-bg"}),e.jsx("div",{className:"rc2-card-tag",children:r.tag}),e.jsx("i",{className:`${r.icon} rc2-card-icon`}),e.jsx("h3",{className:"rc2-card-code",children:r.code}),e.jsx("p",{className:"rc2-card-full",children:r.full}),e.jsx("p",{className:"rc2-card-tagline",children:r.tagline}),e.jsxs("div",{className:"rc2-card-pills",children:[e.jsxs("span",{children:[e.jsx("i",{className:"fa-regular fa-clock"})," ",r.duration]}),e.jsxs("span",{children:[e.jsx("i",{className:"fa-solid fa-users"})," ",r.seats," Seats"]})]})]}),e.jsx("div",{className:"rc2-card-quick",children:e.jsxs("div",{className:"rc2-card-quick-item",children:[e.jsx("i",{className:"fa-solid fa-check-circle",style:{color:r.color}}),e.jsx("span",{children:r.eligibility})]})}),e.jsxs("button",{className:"rc2-card-toggle",style:{"--btn-color":r.color},onClick:()=>c(x=>!x),children:[e.jsx("span",{children:o?"Show Less":"Explore Course"}),e.jsx("i",{className:`fa-solid fa-chevron-${o?"up":"down"}`})]}),e.jsx("div",{className:`rc2-card-body${o?" rc2-card-body--open":""}`,children:e.jsxs("div",{className:"rc2-card-body-inner",children:[e.jsxs("div",{className:"rc2-section",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fa-solid fa-circle-info",style:{color:r.color}})," Overview"]}),e.jsx("p",{children:r.overview})]}),e.jsxs("div",{className:"rc2-section",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fa-solid fa-star",style:{color:r.color}})," Program Highlights"]}),e.jsx("ul",{className:"rc2-highlights",children:r.highlights.map((x,h)=>e.jsxs("li",{children:[e.jsx("span",{className:"rc2-bullet",style:{background:r.color}}),x]},h))})]}),e.jsxs("div",{className:"rc2-section",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fa-solid fa-rocket",style:{color:r.color}})," Career Paths"]}),e.jsx("div",{className:"rc2-career-tags",children:r.career.map((x,h)=>e.jsx("span",{className:"rc2-career-tag",style:{"--tc":r.color,"--tl":r.colorLight},children:x},h))})]}),r.syllabus&&e.jsxs("a",{href:r.syllabus,download:!0,className:"rc2-syllabus-btn",style:{background:`linear-gradient(135deg, ${r.colorDark}, ${r.color})`},children:[e.jsx("i",{className:"fa-solid fa-file-pdf"}),"Download Syllabus"]})]})})]})}function y0(){return e.jsxs("div",{className:"rc2-page",children:[e.jsx(Ta,{title:"BBA, BCA, B.Sc CS, Data Science, MBA & MCA Courses in Angul – CTC",description:"Explore UG & PG degree programs at Creative Techno College, Angul: BBA, BCA, B.Sc CS, B.Sc Data Science (UG) and MBA, MCA (PG). AICTE approved. Affiliated to Utkal University & BPUT.",keywords:"BBA college angul, BCA college angul, MBA college angul, MCA college angul, computer science college angul, data science college angul, best courses angul odisha, CTC angul courses, PG courses angul",canonical:"/academics/regular"}),e.jsx("style",{children:`
...
.tf-nav-btn-primary:hover {
  ...
  `}),e.jsxs("div",{className:"portal-page",children:[e.jsx(tb,{color:m.color}),e.jsxs("div",{className:`portal-main${P?" visible":""}`,children:[e.jsxs("div",{className:"portal-logo-area",children:[e.jsxs("div",{className:"portal-logo-ring",style:{borderColor:`${m.color}40`,boxShadow:`0 0 32px ${m.glow}`},children:[e.jsx("div",{className:"portal-logo-ring-glow",style:{borderColor:m.color}}),e.jsx("img",{src:"https://creativecollege.in/Admission_Dashboard/images/CTC%20logo.png",alt:"CTC"})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"portal-wordmark",children:["Creative Techno ",e.jsx("span",{children:"College"})]}),e.jsx("div",{className:"portal-tagline",children:"Unified Portal · Angul, Odisha"})]})]}),e.jsxs("div",{className:"portal-card",children:[M&&e.jsxs("div",{className:"portal-success-overlay",children:[e.jsx("div",{className:"portal-success-icon",children:e.jsx("i",{className:"fa-solid fa-check"})}),e.jsx("span",{style:{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,color:"#fff",fontSize:"1rem"},children:"Login Successful!"}),e.jsx("span",{style:{fontSize:"0.78rem",color:"rgba(255,255,255,0.4)"},children:"Redirecting you…"})]}),e.jsx("div",{className:"portal-role-grid",children:Lo.map(ce=>e.jsx(ab,{role:ce,isActive:m.id===ce.id,onClick:()=>V(ce)},ce.id))}),e.jsxs("div",{className:"portal-divider",children:[e.jsx("div",{className:"portal-divider-line"}),e.jsxs("span",{className:"portal-divider-text",children:["Sign in as ",m.label]}),e.jsx("div",{className:"portal-divider-line"})]}),e.jsxs("h2",{className:"portal-heading",style:{color:m.color},children:[m.emoji," ",m.label," Login"]}),e.jsx("p",{className:"portal-subhead",children:m.sub}),T&&e.jsxs("div",{className:"portal-error",children:[e.jsx("i",{className:"fa-solid fa-circle-exclamation"}),T]}),e.jsxs("form",{ref:K,onSubmit:te,noValidate:!0,children:[e.jsxs("div",{className:"portal-field",children:[e.jsxs("label",{className:"portal-field-label",children:[e.jsx("i",{className:"fa-solid fa-id-badge",style:{color:m.color}}),m.idLabel]}),e.jsxs("div",{className:"portal-input-wrap",style:{"--ac":m.color},children:[e.jsx("span",{className:"portal-input-icon",children:e.jsx("i",{className:"fa-solid fa-user"})}),e.jsx("input",{type:"text",value:u,onChange:ce=>x(ce.target.value),placeholder:m.idPlaceholder,autoComplete:"username"}),e.jsx("div",{className:"portal-input-focus-bar",style:{background:m.color}})]})]}),e.jsxs("div",{className:"portal-field",children:[e.jsxs("label",{className:"portal-field-label",children:[e.jsx("i",{className:"fa-solid fa-lock",style:{color:m.color}}),m.passLabel]}),e.jsxs("div",{className:"portal-input-wrap",children:[e.jsx("span",{className:"portal-input-icon",children:e.jsx("i",{className:"fa-solid fa-key"})}),e.jsx("input",{type:y?"text":"password",value:h,onChange:ce=>b(ce.target.value),placeholder:m.passPH,autoComplete:"current-password"}),e.jsx("button",{type:"button",className:"portal-eye-btn",onClick:()=>g(ce=>!ce),children:e.jsx("i",{className:`fa-solid ${y?"fa-eye-slash":"fa-eye"}`})}),e.jsx("div",{className:"portal-input-focus-bar",style:{background:m.color}})]})]}),e.jsxs("button",{type:"submit",className:"portal-submit",disabled:F,style:{background:m.grad,boxShadow:`0 8px 32px ${m.glow}`},children:[!F&&e.jsx("div",{className:"portal-submit-shimmer"}),F?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"portal-spinner"})," Authenticating…"]}):e.jsxs(e.Fragment,{children:[e.jsx("i",{className:"fa-solid fa-right-to-bracket"})," Sign In to Portal"]})]})]})]})]})]})]})}const Rt=({title:r})=>e.jsxs("div",{style:{textAlign:"center",padding:"80px 20px"},children:[e.jsx("h1",{style:{color:"#0c2340",fontSize:"2.5rem"},children:r}),e.jsx("p",{style:{color:"#666",marginTop:"20px",fontSize:"1.1rem"},children:"This page is coming soon."})]});function nb(){return e.jsxs(mg,{basename:"/CTC%20NEW%20REACT%20WEBSITE",children:[e.jsx(gg,{}),e.jsx(Ig,{children:e.jsxs(ig,{children:[e.jsx(Z,{path:"/",element:e.jsx(_g,{})}),e.jsx(Z,{path:"/about/trust",element:e.jsx(Vg,{})}),e.jsx(Z,{path:"/about/ctc",element:e.jsx(Qg,{})}),e.jsx(Z,{path:"/about/team",element:e.jsx(e0,{})}),e.jsx(Z,{path:"/admission",element:e.jsx(c0,{})}),e.jsx(Z,{path:"/admission/apply",element:e.jsx(m0,{})}),e.jsx(Z,{path:"/academics/regular",element:e.jsx(y0,{})}),e.jsx(Z,{path:"/academics/value-added",element:e.jsx(w0,{})}),e.jsx(Z,{path:"/academics/enhancement",element:e.jsx(N0,{})}),e.jsx(Z,{path:"/placement",element:e.jsx(Dp,{})}),e.jsx(Z,{path:"/placement/programs",element:e.jsx(L0,{})}),e.jsx(Z,{path:"/placement/statistics",element:e.jsx(Dp,{})}),e.jsx(Z,{path:"/placement/brochure",element:e.jsx(H0,{})}),e.jsx(Z,{path:"/placement/mission40",element:e.jsx(tx,{})}),e.jsx(Z,{path:"/gymkhana",element:e.jsx(rx,{})}),e.jsx(Z,{path:"/gymkhana/cultural",element:e.jsx(Mx,{})}),e.jsx(Z,{path:"/gymkhana/sports",element:e.jsx(Rx,{})}),e.jsx(Z,{path:"/gymkhana/technocrat",element:e.jsx(Nx,{})}),e.jsx(Z,{path:"/gymkhana/disha-csr",element:e.jsx(Dx,{})}),e.jsx(Z,{path:"/gymkhana/techfest/1",element:e.jsx(Qp,{})}),e.jsx(Z,{path:"/gymkhana/techfest/2",element:e.jsx(Xp,{})}),e.jsx(Z,{path:"/gymkhana/techfest/3",element:e.jsx(Zp,{})}),e.jsx(Z,{path:"/gymkhana/techfest-1",element:e.jsx(Qp,{})}),e.jsx(Z,{path:"/gymkhana/techfest-2",element:e.jsx(Xp,{})}),e.jsx(Z,{path:"/gymkhana/techfest-3",element:e.jsx(Zp,{})}),e.jsx(Z,{path:"/gallery",element:e.jsx(sx,{})}),e.jsx(Z,{path:"/iqac",element:e.jsx(Rt,{title:"IQAC"})}),e.jsx(Z,{path:"/iqac/item1",element:e.jsx(Rt,{title:"IQAC — Item 1"})}),e.jsx(Z,{path:"/iqac/item2",element:e.jsx(Rt,{title:"IQAC — Item 2"})}),e.jsx(Z,{path:"/iqac/item3",element:e.jsx(Rt,{title:"IQAC — Item 3"})}),e.jsx(Z,{path:"/iqac/item4",element:e.jsx(Rt,{title:"IQAC — Item 4"})}),e.jsx(Z,{path:"/aicte",element:e.jsx(Rt,{title:"AICTE"})}),e.jsx(Z,{path:"/aicte/documents",element:e.jsx(Rt,{title:"AICTE — Documents"})}),e.jsx(Z,{path:"/aicte/mandatory-disclosure",element:e.jsx(Rt,{title:"AICTE — Mandatory Disclosure"})}),e.jsx(Z,{path:"/ckf-skills",element:e.jsx(Rt,{title:"CKF Skills"})}),e.jsx(Z,{path:"/contacts",element:e.jsx(px,{})}),e.jsx(Z,{path:"/icc",element:e.jsx(bx,{})}),e.jsx(Z,{path:"/grc",element:e.jsx(jx,{})}),e.jsx(Z,{path:"/naac",element:e.jsx($x,{})}),e.jsx(Z,{path:"/nba",element:e.jsx(qx,{})}),e.jsx(Z,{path:"/vikshit-bharat",element:e.jsx(eb,{})}),e.jsx(Z,{path:"/login",element:e.jsx(rn,{})}),e.jsx(Z,{path:"/login/student",element:e.jsx(rn,{})}),e.jsx(Z,{path:"/login/staff",element:e.jsx(rn,{})}),e.jsx(Z,{path:"/login/admin",element:e.jsx(rn,{})}),e.jsx(Z,{path:"/login/principal",element:e.jsx(rn,{})}),e.jsx(Z,{path:"/login/admission",element:e.jsx(rn,{})}),e.jsx(Z,{path:"*",element:e.jsx(Rt,{title:"Page Not Found"})})]})})]})}typeof window<"u"&&(window.history.scrollRestoration="manual");Hf.createRoot(document.getElementById("root")).render(e.jsx(v.StrictMode,{children:e.jsx(lm,{children:e.jsx(nb,{})})}));
